...
def font_and_profile_proofs(proof_type: Any, control_type: Any) -> dict[str, Any]:
    ...
    result = {
        ...
        "P4-COLOR-FONT-ADMISSION-01": proof(
            ...
            f"{TEXT_ROOT}/font_collection/color_glyph.rs::validate",
            font_evidence,
            ...
            f"{TEXT_ROOT}/font_collection/color_glyph/bitmap.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/bitmap/cbdt.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/bitmap/sbix.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/boundedness.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/colr.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/png.rs",
            f"{TEXT_ROOT}/font_collection/color_glyph/traversal.rs",
        ),
    }
    return result
    ...
    specifications = {
        ...
        "P4-LINE-LAYOUT-01": (
            ...
            (
                ...
                f"{TEXT_ROOT}/font_collection/color_glyph/bitmap_selection.rs",
                f"{TEXT_ROOT}/font_collection/color_glyph/path.rs",
            ),
        ),
        "P4-CAPACITY-01": (

#!/usr/bin/env python3
"""Generate compact content fingerprints for Forge Store topology review rows."""
...
INVENTORY = REPO_ROOT / "_docs/forge-store/forge-store-topology-inventory.csv"
DEFAULT_OUTPUT = REPO_ROOT / "_docs/forge-store/forge-store-topology-fingerprints.csv"

//! Road 1 configuration builders for authority sealing fixture repositories.

use super::AuthoritySealingTestRepository;

const ROAD1_CONFIG_TEMPLATE: &str = r#"root_manifest = "Cargo.toml"
...
"#,
    ...
    pub fn config_with_law_substrates(&self, law_substrates_toml: &str) -> String {
        ROAD1_CONFIG_TEMPLATE.replace("{law_substrates_toml}", law_substrates_toml)
    }
}

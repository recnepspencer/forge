use worth_ui::facade::{
    WorthUiHeaderFrameRebindReceipt, WorthUiHeaderFrameRebindStatus, WorthUiProjectionFamily,
    WorthUiProjectionRebindRowReceipt, WorthUiProjectionRebindStatus,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ValidationHeaderRebindEvidence {
    ...
    rows: Vec<ValidationProjectionRebindRowEvidence>,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ValidationProjectionRebindRowEvidence {
...
impl ValidationHeaderRebindEvidence {
    pub fn from_receipt(receipt: &WorthUiHeaderFrameRebindReceipt) -> Self {
        ...
        Self {
            ...
            rows: receipt
                ...
                .rows()
                .iter()
                .map(ValidationProjectionRebindRowEvidence::from_row)
                .collect(),
        }
    }
    ...
    pub fn rows(&self) -> &[ValidationProjectionRebindRowEvidence] {
        &self.rows
    }
}

impl ValidationProjectionRebindRowEvidence {

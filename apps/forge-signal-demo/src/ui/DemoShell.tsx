...
export const DemoShell: React.FC<DemoShellProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"forge" | "alternative">("forge");
  ...
  const handleCopyCode = () => {
    const textToCopy = activeTab === "forge" ? demo.forgeCode : demo.alternativeCode;
            ...
            <div>
              ...
              {customCodeBlock ? (
                ...
                <div style={{ border: "1px solid var(--border-light)", borderRadius: "8px", overflow: "hidden" }}>
                    ...
                    <div style={{ display: "flex", gap: "0.25rem" }}>
                      <button
                        ...
                        style={{
                          ...
                          border: "none",
                          borderBottom: activeTab === "forge" ? `2px solid ${activeAccent}` : "2px solid transparent",
                          color: activeTab === "forge" ? "var(--text-primary)" : "var(--text-muted)",
                          fontWeight: 600,
                          fontSize: "0.85rem",
                          cursor: "pointer",
                        }}
                  ...
                  >
                    <code style={{ color: activeTab === "forge" ? "#cffafe" : "#fed7aa" }}>
                      {activeTab === "forge" ? demo.forgeCode : demo.alternativeCode}
                    </code>
                  </pre>
                  ...
                  <div style={{ padding: "1rem", borderTop: "1px solid var(--border-light)", fontSize: "0.85rem", color: "var(--text-secondary)", background: "rgba(255,255,255,0.01)" }}>
                    <strong>Why it matters</strong>: {activeTab === "forge" ? demo.explanationForge : demo.explanationAlternative}
                  </div>
                </div>
              )}
            </div>

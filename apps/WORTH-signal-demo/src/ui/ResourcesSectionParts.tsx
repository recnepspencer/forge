...
export function DiagnosticsComparison({
  ...
  return (
    <div className="resources-diagnostics-grid">
      ...
      <div className="resources-diagnostics-column">
        <span>WORTH diagnostics</span>
        <code data-resource-diagnostics="WORTH" data-resource-diagnostics-schema="resource-demo-diagnostics.v1" hidden>{WORTHJson}</code>
        <pre className="resources-terminal">
          {renderResourceDemoDiagnostics(WORTHDiagnostics).join("\n")}
        </pre>
      </div>
    </div>
  );
  ...
  return (
    <div className="resources-feedback-guide">
      ...
      <div>
        ...
        <p>WORTH records the admitted effect and whether rollback is available.</p>
      </div>
      <div>

  ...
  return (
    <div className="xai-section-band accent-forms">
      <div className="xai-section-heading">
        ...
        <h2>Edit a product form. Watch WORTH track the state.</h2>
        <p>
          Change the price, margin, shipping regions, or reviewer email. WORTH shows
      ...
      <div className="signals-compare-strip">
        ...
        <article className="xai-compare-card xai-compare-card-WORTH">
          <span>With WORTH</span>
      ...
      <div className="signals-cta-row">
        <div className="signals-cta-copy">Change the form and inspect the exact state WORTH uses to enable or block submit.</div>

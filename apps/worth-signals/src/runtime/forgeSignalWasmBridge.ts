import initializeRawSignals, * as rawSurface from "../../../../crates/forge-signal-wasm/pkg/raw_surface.js";
import type { Signals as RawSignals } from "../../../../crates/forge-signal-wasm/pkg/raw_surface.js";
import { createSignals as createPackagedSignals } from "../../../../crates/forge-signal-wasm/pkg/index.js";
import * as packagedSignalsModule from "../../../../crates/forge-signal-wasm/pkg/index.js";
import type {
  CallableSignals,
  CreateSignalsOptions,
} from "../../../../crates/forge-signal-wasm/pkg/index.js";
import type {
  resourcePatch as typedResourcePatch,
  resourcePolicyProfiles as typedResourcePolicyProfiles,
  wrapSignals as typedWrapSignals,
} from "../../../../crates/forge-signal-wasm/package-src/product/signals.ts";

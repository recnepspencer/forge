use forge_store_physical_format::{PhysicalGeneration, PhysicalReference};
...
pub(crate) fn mismatch_for_reference(
    ...
    let kind = match reference.kind() {
        forge_store_physical_format::PhysicalReferenceKind::PageSlot => {
            PhysicalReferenceGenerationMismatchKind::Page
        }
        forge_store_physical_format::PhysicalReferenceKind::ExtentBacked
        | forge_store_physical_format::PhysicalReferenceKind::FreeSpaceReuse => {
            PhysicalReferenceGenerationMismatchKind::Extent
        }
        forge_store_physical_format::PhysicalReferenceKind::RootPublication => {

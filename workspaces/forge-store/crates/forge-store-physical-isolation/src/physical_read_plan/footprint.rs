use forge_proof::{CanonicalVec, NonEmpty, UniqueVec};
use forge_store_physical_format::{PhysicalCellReuseDomain, PhysicalGenerationOwner};
...
pub struct PhysicalReferenceSortKey {
    ...
    allocation_class: Option<forge_store_physical_format::AllocationClassKind>,
    generation: u64,
}
    ...
    pub fn from_generation_counted_refs(
        references: impl IntoIterator<
            Item = (
                ...
                forge_store_physical_format::PhysicalGeneration,
            ),
        >,
    ) -> Result<Self, PhysicalReadPlanAdmissionDenial> {

...
fn latch_steps(
    ...
    for reference in references {
        let key = match super::footprint_ranges::latch_domain(*reference) {
            forge_store_physical_format::PhysicalCellReuseDomain::Segment => {
            ...
            | forge_store_physical_format::PhysicalCellReuseDomain::FreeSpaceReuse => {
            ...
            | forge_store_physical_format::PhysicalCellReuseDomain::SlotAllocation => {
            ...
            forge_store_physical_format::PhysicalCellReuseDomain::RootPublication => continue,
        };

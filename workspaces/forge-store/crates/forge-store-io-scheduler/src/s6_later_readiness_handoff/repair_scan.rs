use forge_store_readiness::{S10RepairScanReadinessNonClaim, S6LaterMilestoneDestination};
...
use super::{
    core::S6LaterReadinessEvidenceCore, S10RepairScanPacingEvidence,
    S6LaterReadinessReadmissionState,
};

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct S10RepairScanIoReadinessHandoff {
...
pub fn publish_s10_repair_scan_io_readiness_handoff(
    ...
    S10RepairScanIoReadinessHandoff {
        ...
        non_claims: S10RepairScanReadinessNonClaim::required(),
    }
}

pub const fn readmit_s10_repair_scan_io_readiness_after_publication(
...
impl S10RepairScanIoReadinessHandoff {

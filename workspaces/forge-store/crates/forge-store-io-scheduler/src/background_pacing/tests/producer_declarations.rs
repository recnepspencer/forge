...
fn producer_pressure_declarations_lower_into_scheduler_shapes() {
    let cases = [
        ...
        (
            forge_store_operations::replication_prep_background_pressure_shape(4),
        ...
        (
            forge_store_operations::repair_background_pressure_shape(4),
            BackgroundIoPressureClass::RepairScan,
        ),
        (
            forge_store_offline_verifier::offline_repair_scan_background_pressure_shape(4),
            BackgroundIoPressureClass::RepairScan,
        ),
        (
            forge_store_offline_verifier::offline_verification_pressure_background_pressure_shape(
                4,
            ),
...
fn quantity_bearing_producer_declarations_survive_scheduler_lowering() {
    ...
    let verification = BackgroundIoPressureShape::from_s6_background_pressure_declaration(
        forge_store_offline_verifier::offline_verification_pressure_background_pressure_shape(4),
    );

...
use forge_proof::prelude::AuthorityWitness;
use forge_proof::prelude::ProofOutcome;
...
pub(super) fn prove_foreground_reservation_progression<'request>(
    ...
    match request.capacity_admission().freshness() {
        ForegroundReservationCapacityFreshness::Current => {
            forge_proof::TransitionOutcome::success(ForegroundReservationReady {
                lane,
        ...
        ForegroundReservationCapacityFreshness::RebindRequired => {
            forge_proof::TransitionOutcome::rebind_required(ForegroundReservationRebindRequired {
                lane,
            })
            .into()
        }

use forge_foundational::performance_api::lower_lane::policy::FoundationalPolicyAdmissionReceipt;
use forge_foundational::FoundationalPerformanceBudgetKind;
use forge_proof::prelude::{AuthorityMarker, AuthorityWitness};

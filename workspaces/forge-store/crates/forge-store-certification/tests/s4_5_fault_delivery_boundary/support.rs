#[path = "../s4_recovery_offline_verifier/runtime_recovery_fixture.rs"]
...
) -> Result<forge_store_physical_certification::FaultDeliveryReceipt, FaultDeliveryDenial> {
...
pub fn readiness_scenario() -> forge_store_physical_certification::CertifiedPhysicalScenario {
...
pub fn alternate_production_trace(
    ...
    production_driver_with_profile(
        forge_store_physical_backend::BackendDurabilityProfileId::WindowsFlushFileBuffers,
    )

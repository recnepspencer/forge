#[allow(dead_code)]
#[path = "../../../scenarios/recovery/page_lsn_publication/dirty_publication_paths.rs"]
mod dirty_publication_paths;
#[allow(dead_code)]
#[path = "../recovery_source_precedence/source_precedence_fixture.rs"]
mod source_precedence_fixture;
#[allow(dead_code)]
#[path = "../../../scenarios/recovery/page_lsn_publication/wal_durability_paths.rs"]
mod wal_durability_paths;
#[allow(dead_code)]
#[path = "../../../s4_recovery_source_precedence/wal_only_tail_fixture.rs"]
...
pub(crate) use source_precedence_fixture::{trace, wal_range};

pub(crate) fn assert_grammar_denial(
...
pub(crate) fn checkpoint_plus_tail_source(start: u64, end: u64) -> AdmittedRecoverySource {
...
pub(crate) fn valid_prefix<const N: usize>(
...
pub(crate) fn redo_eligibility(current_lsn: u64, redo_lsn: u64) -> PageRedoEligibility {
    redo_eligibility_for_page(current_lsn, redo_lsn, 2)
}

pub(crate) fn redo_eligibility_for_page(
    current_lsn: u64,
    redo_lsn: u64,
    page_value: u64,
) -> PageRedoEligibility {
...
pub(crate) fn flush_receipt_for_page(redo_lsn: u64, page_value: u64) -> PageFlushRecoveryReceipt {
...
pub(crate) fn missing_generation(
    eligibility: &PageRedoEligibility,
) -> Result<RedoRecordGrammar, RedoRecordGrammarDenial> {
...
pub(crate) fn missing_integrity(
    eligibility: &PageRedoEligibility,
) -> Result<RedoRecordGrammar, RedoRecordGrammarDenial> {
    RedoRecordGrammar::admit(
        Some(eligibility.page_generation().page_id()),
...
pub(crate) fn missing_idempotence(
    eligibility: &PageRedoEligibility,
) -> Result<RedoRecordGrammar, RedoRecordGrammarDenial> {
    RedoRecordGrammar::admit(
        Some(eligibility.page_generation().page_id()),
...
pub(crate) fn frame(value: u64) -> WalPrefixIntegrityObservation {
...
pub(crate) fn stale_generation_frame(
    value: u64,
...
pub(crate) fn torn_frame(value: u64) -> WalPrefixIntegrityObservation {
...
pub(crate) fn middle_corruption_frame(value: u64) -> WalPrefixIntegrityObservation {
...
pub(crate) fn lsn(value: u64) -> LogSequenceNumber {
    LogSequenceNumber::new(value)
}

pub(crate) fn wal_generation() -> WalSegmentGeneration {

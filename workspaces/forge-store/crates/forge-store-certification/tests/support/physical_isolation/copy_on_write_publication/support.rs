...
pub(crate) struct PublicationInputs {
    pub(crate) new_authority: forge_store_physical_isolation::PhysicalReadStabilityAuthority,
    pub(crate) old_root: forge_store_physical_isolation::CurrentPhysicalRoot,
    pub(crate) new_root: forge_store_physical_isolation::CurrentPhysicalRoot,

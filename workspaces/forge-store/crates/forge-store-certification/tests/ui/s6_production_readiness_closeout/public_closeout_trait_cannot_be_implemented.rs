...
struct ForgedCloseoutEvidence;

impl S6MaterializedCertificationCloseoutEvidence for ForgedCloseoutEvidence {
...
fn main() {
    let adoption =
        adopt_materialized_s6_certification_evidence_for_closeout(&ForgedCloseoutEvidence).unwrap();

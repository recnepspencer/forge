...
fn cleaned_phase_boundaries_stay_under_declared_file_count_caps() {
    ...
    for boundary in [
        ...
        DirectoryBoundary::new("workspaces/forge-store/crates/forge-store-layout-indexes/src", 3),
    ] {
...
fn facade_visibility_stays_narrow_at_closeout() {
    ...
    assert_public_mods(
        &repo_root.join("workspaces/forge-store/crates/forge-store-layout-indexes/src/lib.rs"),
        &[],
    );
}

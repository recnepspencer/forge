...
use forge_store_physical_certification::CompactionInterlockObservation;
...
pub(crate) fn store_compaction_observation() -> CompactionInterlockObservation {
    CompactionInterlockObservation::from_store_interlock_evidence(compaction_interlock_evidence())
        .unwrap()
}

pub(crate) fn publication_only_compaction_observation() -> CompactionInterlockObservation {

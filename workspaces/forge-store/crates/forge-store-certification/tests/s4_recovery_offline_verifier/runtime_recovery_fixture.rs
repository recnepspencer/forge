...
fn bounded_recovery_plan_fixture() -> forge_store_recovery_physics::BoundedRecoveryPlan {
    ...
    .discover(forge_store_recovery_physics::RecoverySourceCandidate::checkpoint_base(checkpoint))
    .unwrap()
    .discover(forge_store_recovery_physics::RecoverySourceCandidate::wal_tail(tail))
    .unwrap()
    .admit_sources();

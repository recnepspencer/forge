#[path = "s4_recovery_offline_verifier/assertions.rs"]
mod assertions;
...
fn runtime_report(
    offline: &forge_store_recovery_physics::OfflineRecoveryVerificationReport,
    artifacts: &forge_store_recovery_physics::PersistedRecoveryArtifacts,
    receipt: &forge_store_recovery_physics::BoundedRecoveryReceipt,
    execution: forge_store_recovery_physics::FreshRuntimeRecoveryExecution,

    ...
    let denial = lower_physical_simulation_plan(
        ...
        complete_context()
            .with_driver_contracts(
                forge_store_physical_certification::AdmittedDriverContractSet::empty(),
            )
...
fn bound_schedule_scenario() -> forge_store_physical_certification::CertifiedPhysicalScenario {
...
fn admitted_production_driver() -> forge_store_physical_certification::PhysicalSimulationDriver {
...
fn unbound_schedule_scenario() -> forge_store_physical_certification::CertifiedPhysicalScenario {

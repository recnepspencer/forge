...
use forge_store_physical_certification::{OracleFamilyKind, PhysicalProofOracleVerdict};
...
fn loose_logs_terminal_json_and_same_run_comparisons_are_denials() {
    assert_eq!(
        forge_store_physical_certification::reject_loose_log_transcript_attempt().unwrap_err(),
        TranscriptReplayDenial::LooseLogDenied
    );
    assert_eq!(
        forge_store_physical_certification::reject_terminal_json_transcript_attempt().unwrap_err(),
        TranscriptReplayDenial::TerminalJsonDenied
    );
    assert_eq!(
        forge_store_physical_certification::reject_same_run_self_comparison_transcript_attempt()
            .unwrap_err(),
    ...
    assert_eq!(
        ...
        forge_store_physical_certification::PhysicalEvidenceBundleDenial::LooseLogDenied
    );
    assert_eq!(
        forge_store_physical_certification::reject_terminal_json_evidence_attempt().unwrap_err(),

...
fn public_wal_before_data_denies_page_lsn_not_covered_by_durable_wal_range() {
    ...
    let unrelated_later_ack = forge_store_recovery_physics::DurableAckReceipt::acknowledge(
        forge_store_recovery_physics::AcknowledgmentPrecondition::from_append_receipt(

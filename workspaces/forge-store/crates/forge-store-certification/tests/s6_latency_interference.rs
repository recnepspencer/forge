...
fn admitted_read_ahead_plan() -> QueueExecutionReadyPlan {
    ...
    admit_queue_execution_plan(
        forge_store_io_scheduler::QueueExecutionAdmissionRequest::new(
            work,
            &backend,
...
fn s6_security_scope_admission() -> forge_store_io_scheduler::IoSchedulerS6SecurityScopeAdmission {

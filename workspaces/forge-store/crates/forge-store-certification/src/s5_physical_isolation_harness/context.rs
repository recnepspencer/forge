...
pub fn physical_isolation_physical_isolation_planning_context(
...
pub fn physical_isolation_physical_isolation_ci_certification_planning_context(
    registration: PhysicalIsolationCertificationLaneRegistration,
    compaction_mutation_origin: CompactionMutationLaneOrigin,
) -> SimulationPlanningContext {
...
pub fn physical_isolation_physical_isolation_context_without_lane_registration(
    compaction_mutation_origin: CompactionMutationLaneOrigin,
) -> SimulationPlanningContext {
...
pub fn physical_isolation_physical_isolation_ci_certification_context_without_lane_registration(
    compaction_mutation_origin: CompactionMutationLaneOrigin,
) -> SimulationPlanningContext {

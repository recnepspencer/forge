...
fn public_authority_source_paths() -> Vec<&'static str> {
    vec![
        ...
        "workspaces/forge-store/crates/forge-store-aspect-native/src/authoritative_state.rs",
        "workspaces/forge-store/crates/forge-store-aspect-native/src/authoritative_patch.rs",

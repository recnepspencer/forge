...
struct ManifestFixtureCells {
    root: forge_store_physical_format::RootPublicationCell,
    old_root: forge_store_physical_format::RootPublicationCell,
    old_free_space: forge_store_physical_format::FreeSpaceReuseCell,
    residue_slot: forge_store_physical_format::SlotGenerationCell,
}

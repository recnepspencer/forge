...
impl ProtectedIntegrityViewEvidence {
    pub fn from_zero_copy_report(
        ...
        forged_view_access_denied: bool,
        ...
        if !forged_view_access_denied {
            return Err(ProtectedIntegrityViewEvidenceDenial::ForgedViewDenialMissing);
        }

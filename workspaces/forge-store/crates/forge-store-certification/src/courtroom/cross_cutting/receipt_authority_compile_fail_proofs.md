...
use forge_store_certification::CompletedResidencyBoundaryReceipt;
...
```compile_fail
use forge_store_buffer_pool::RecordViewAdmission;
use forge_store_certification::CompletedResidencyBoundaryReceipt;
...
```compile_fail
use forge_store_buffer_pool::ResidentFrameTable;
use forge_store_certification::BufferPoolProvenanceAttachment;
...
```compile_fail
use forge_store_buffer_pool::ResidentFrameTable;
use forge_store_certification::ZeroCopyLayoutPostureReport;
...
```compile_fail
use forge_store_buffer_pool::ResidentFrameTable;
use forge_store_certification::MaterializationProfileReport;
...
```compile_fail
use forge_store_buffer_pool::ResidentFrameCounterSnapshot;
use forge_store_certification::ResidentMemoryPerformanceReceipt;
...
```compile_fail
use forge_store_buffer_pool::AllocationCounterSnapshot;
use forge_store_certification::AllocationEnvelopePerformanceReceipt;
...
```compile_fail
use forge_store_buffer_pool::RecordCopyCounterSnapshot;
use forge_store_certification::CopyMaterializationPerformanceReceipt;
...
```compile_fail
use forge_store_buffer_pool::BufferPoolCounterSnapshot;
use forge_store_certification::{FoundationalEvidenceProfile, MaterializationProfileReport};

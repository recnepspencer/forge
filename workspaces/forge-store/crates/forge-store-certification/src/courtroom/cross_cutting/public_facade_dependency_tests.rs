...
fn workspace_serde_json_dependency_is_terminal_only() {
    let workspace_manifest = workspace_file("workspaces/forge-store/Cargo.toml");
    let facade_manifest = workspace_file("workspaces/forge-store/crates/forge-store/Cargo.toml");
    let aspect_native_manifest =
        workspace_file("workspaces/forge-store/crates/forge-store-aspect-native/Cargo.toml");
    let certification_manifest =
        workspace_file("workspaces/forge-store/crates/forge-store-certification/Cargo.toml");
...
fn public_authority_source_paths() -> Vec<&'static str> {
    vec![
        ...
        "workspaces/forge-store/crates/forge-store-aspect-native/src/authority/authoritative_state.rs",
        "workspaces/forge-store/crates/forge-store-aspect-native/src/authority/authoritative_patch.rs",
        "workspaces/forge-store/crates/forge-store-aspect-native/src/contract_admission.rs",
        "workspaces/forge-store/crates/forge-store-aspect-native/src/value_admission.rs",
        "workspaces/forge-store/crates/forge-store-aspect-native/src/physical_witness.rs",

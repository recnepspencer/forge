...
pub(super) fn backend_admission() -> forge_store_io_scheduler::IoSchedulerBackendCapabilityAdmission
{
...
pub(super) fn io_qos_readiness() -> forge_store_io_scheduler::IoSchedulerIsolationAdmission {
...
pub(super) fn performance_claim() -> forge_foundational::FoundationalPolicyAdmissionPerformanceClaim
{
    performance()
        .claim()
        .policy_admission()

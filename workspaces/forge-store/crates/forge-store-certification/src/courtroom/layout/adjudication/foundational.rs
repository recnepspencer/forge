...
use forge_store_layout_indexes::LayoutAccessPerformanceReceipt;
...
pub struct LayoutFoundationalCloseoutEvidence {
    ...
    plan_binding: forge_store_layout_indexes::AccessPlanIdentity,
...
fn closeout_profile() -> forge_foundational::FoundationalProfileSet {
    profiles()
        .set()
...
impl LayoutFoundationalCloseoutEvidence {
    ...
    pub const fn plan_binding(&self) -> &forge_store_layout_indexes::AccessPlanIdentity {
        &self.plan_binding
    }

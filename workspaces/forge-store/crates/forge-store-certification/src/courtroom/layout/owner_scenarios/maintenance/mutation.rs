...
use forge_store_physical_format::PhysicalStoreIdentity;
use forge_store_security::{
    StoreAuthenticityRequirement, StoreAuthenticityRequirementClass, StoreCustodyPosture,
    StoreKeyScope, StoreTenantScope,
};
use forge_store_test_support::harness::physical_isolation::publication::{
...
fn record_copy_on_write_admission(
    ...
    strategy: forge_store_layout_indexes::LayoutStrategyRegistrySnapshot,
...
) -> forge_store_layout_indexes::CopyOnWriteLayoutMutationReceipt {
...
fn publication_materialization(
    ...
    receipt: &forge_store_layout_indexes::CopyOnWriteLayoutMutationReceipt,
) -> forge_store_layout_indexes::AdmittedLayoutMaterialization {
    access_planning()
        .admit_btree_publication_materialization(

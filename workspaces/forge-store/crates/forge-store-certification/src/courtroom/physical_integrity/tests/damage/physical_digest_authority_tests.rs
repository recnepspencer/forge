...
fn physical_authority_claim_carries_typed_store_digest_evidence() {
    ...
    assert_eq!(
        ...
        forge_store_aspect_native::StoreCanonicalBasisSourceKind::StorePhysicalIntegrityEvidence
    );
    assert_eq!(
...
) -> forge_store_physical_integrity::StorePhysicalAuthorityBoundaryClaim {

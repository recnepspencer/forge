...
fn assert_handoff_artifact_denial(
    canonical_basis: forge_foundational::CanonicalBasisReadyArtifact,
...
fn completed_receipt() -> forge_foundational::FoundationalBoundaryEvidenceCompletedReceiptArtifact {
    common_path::receipt()
...
fn support_report() -> forge_foundational::FoundationalDiagnosticSupportReport {

...
pub(crate) fn resident_rows(
    counters: forge_store_buffer_pool::ResidentFrameCounterSnapshot,
) -> [(&'static str, u64); 4] {
    [
        (
...
pub(crate) fn allocation_rows(
    counters: forge_store_buffer_pool::AllocationCounterSnapshot,
) -> Vec<(&'static str, u64)> {
    let mut rows = Vec::with_capacity(19);
    for scope in forge_store_buffer_pool::AllocationScope::ALL {
...
pub(crate) fn copy_rows(
    counters: forge_store_buffer_pool::RecordCopyCounterSnapshot,
) -> [(&'static str, u64); 5] {
    [
        (
...
fn allocation_scope_prefix(
    scope: forge_store_buffer_pool::AllocationScope,
) -> AllocationScopePrefix {
    match scope {
        forge_store_buffer_pool::AllocationScope::Foreground => AllocationScopePrefix {
        ...
        forge_store_buffer_pool::AllocationScope::Maintenance => AllocationScopePrefix {
        ...
        forge_store_buffer_pool::AllocationScope::Recovery => AllocationScopePrefix {
        ...
        forge_store_buffer_pool::AllocationScope::Scrub => AllocationScopePrefix {
        ...
        forge_store_buffer_pool::AllocationScope::ImportExport => AllocationScopePrefix {
        ...
        forge_store_buffer_pool::AllocationScope::Streaming => AllocationScopePrefix {

...
pub struct S8PlannedVsObservedCounterReceipt {
    fingerprint: crate::planning::S8PlanFingerprint,
...
impl S8PlannedVsObservedCounterReceipt {
    pub fn from_executed(executed: &crate::execution::S8ExecutedAccessReceipt) -> Self {
        Self::new(
    ...
    pub const fn fingerprint(self) -> crate::planning::S8PlanFingerprint {
        self.fingerprint
    }

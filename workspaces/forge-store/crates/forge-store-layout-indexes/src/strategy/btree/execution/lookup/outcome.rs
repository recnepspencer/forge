...
pub struct StableBTreeLookupExecution {
    ...
    stable_read: forge_store_physical_isolation::StablePhysicalReadReceipt,
    protected: forge_store_physical_isolation::CompactionProtectedReferenceSet,
...
impl StableBTreeLookupExecution {
    ...
    pub const fn stable_read(&self) -> &forge_store_physical_isolation::StablePhysicalReadReceipt {
        &self.stable_read
    }

    pub const fn protected(
        &self,
    ) -> &forge_store_physical_isolation::CompactionProtectedReferenceSet {
        &self.protected
    }

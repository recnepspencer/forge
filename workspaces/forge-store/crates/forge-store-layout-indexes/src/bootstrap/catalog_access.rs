...
use super::{
    bootstrap_only_path::BootstrapOnlyAccessPath, catalog::BootstrapLayoutCatalog,
    catalog_read_admission::BootstrapCatalogReadAdmission, denial::BootstrapOnlyAccessDenied,
    root_discovery::MinimalRootDiscoveryLayout,
};
...
impl BootstrapCatalogFacade {
    ...
    ) -> Result<(), BootstrapOnlyAccessDenied> {
        Err(BootstrapOnlyAccessDenied::OrdinaryFamilyAccessForbidden { family })
    }
}

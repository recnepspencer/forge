...
use crate::access::shape::{S8AccessAuthorityPosture, S8AccessShape, S8AccessShapeContract};
use crate::catalog::{declare_authority_role, ArtifactFamilyLifecycleAdmission, AuthorityRole};
...
const fn planning_capability(
    capability: crate::strategy::registry::S8LayoutStrategyCapability,
) -> S8PlanningCapabilityGrant {
    match capability {
        crate::strategy::registry::S8LayoutStrategyCapability::PointLookup => {
            S8PlanningCapabilityGrant::PointLookup
        }
        crate::strategy::registry::S8LayoutStrategyCapability::OrderedRange => {
            S8PlanningCapabilityGrant::OrderedRange
        }
        crate::strategy::registry::S8LayoutStrategyCapability::PrefixTraversal => {
            S8PlanningCapabilityGrant::PrefixTraversal
        }
        crate::strategy::registry::S8LayoutStrategyCapability::BlobStreaming => {
            S8PlanningCapabilityGrant::BlobStreaming
        }
        crate::strategy::registry::S8LayoutStrategyCapability::ExactScan => {

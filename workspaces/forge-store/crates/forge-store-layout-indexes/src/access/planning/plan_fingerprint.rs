...
impl S8PlanFingerprint {
    ...
    pub const fn shape(self) -> crate::access::shape::S8AccessShape {
        self.detail.shape()
    }
...
fn mix_snapshot(snapshot: crate::access::execution::S8AccessPathCounterSnapshot) -> u64 {
    mix_values(&[
...
const fn domain_code(domain: crate::keyspace::PhysicalKeyDomain) -> u8 {
    match domain {
        crate::keyspace::PhysicalKeyDomain::RootManifestKey => 1,
        crate::keyspace::PhysicalKeyDomain::PageAddressKey => 2,
        crate::keyspace::PhysicalKeyDomain::SegmentAddressKey => 3,
        crate::keyspace::PhysicalKeyDomain::ExtentAddressKey => 4,
        crate::keyspace::PhysicalKeyDomain::PhysicalReferenceKey => 5,
        crate::keyspace::PhysicalKeyDomain::WalRecordKey => 6,
        crate::keyspace::PhysicalKeyDomain::BlobIdentityKey => 7,
    }
}

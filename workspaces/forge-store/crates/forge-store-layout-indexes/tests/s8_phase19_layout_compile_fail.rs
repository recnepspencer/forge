#[test]
fn phase19_layout_surfaces_reject_forgeable_admission_shortcuts() {
...
const fn fixtures() -> [CompileFailFixture; 2] {
    [
        CompileFailFixture {
            name: "caller_defined_rule_cannot_open_page_layout.rs",
            expected_stderr: &["AdmittedPageLayoutRule", "mismatched types"],
        },
        CompileFailFixture {
            name: "admitted_page_layout_rule_constructor_is_not_public.rs",
            expected_stderr: &["phase19", "AdmittedPageLayoutRule"],
        },
    ]
}

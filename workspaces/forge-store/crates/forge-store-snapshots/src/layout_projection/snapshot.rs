...
use crate::{PublishedSnapshotHandle, SnapshotId, SnapshotImageBundle, SnapshotReadRequest};
...
impl SnapshotImageSupportPlan {
    fn from_admitted(handle: &PublishedSnapshotHandle, requested_page_count: u32) -> Self {
        Self {

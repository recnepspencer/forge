...
fn compile_fail_cases() -> [CompileFailCase; 4] {
    [
        CompileFailCase {
            ...
            source: include_str!(
                "ui/qualification/backend_public_boundary/copied_row_cannot_publish.rs"
            ),
        ...
        CompileFailCase {
            ...
            source: include_str!(
                "ui/qualification/backend_public_boundary/proof_authority_constructor_is_private.rs"
            ),
        ...
        CompileFailCase {
            ...
            source: include_str!(
                "ui/qualification/backend_public_boundary/proof_authority_factory_is_private.rs"
            ),
        ...
        CompileFailCase {
            ...
            source: include_str!(
                "ui/qualification/backend_public_boundary/row_proof_constructor_is_private.rs"
            ),
...
[dependencies]
forge-store-physical-backend = {{ path = "{}/workspaces/forge-store/crates/forge-store-physical-backend", features = ["certification-test-authority"] }}

...
use forge_foundational::{
    aspects, AspectContract, AspectKey, AspectValue, BoundaryArtifactField, BoundaryArtifactId,
    BoundaryArtifactLocator, InternedString, ScalarAspectType,
};
...
fn sample_for_profile(profile: PhysicalSimulationProfile) -> S6PressureExecutionSample {
    match profile {

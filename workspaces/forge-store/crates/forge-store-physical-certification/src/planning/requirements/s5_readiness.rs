...
pub(super) fn s5_readiness_shape(actor_step_count: u64) -> RequiredSimulationPlanShape {
    RequiredSimulationPlanShape {
        ...
        counter_contracts: RequiredCounterContractSet::from_contracts(base_s5_counter_contracts(
            actor_step_count,
        )),
...
pub(super) fn s5_readiness_with_shortcut_rejection_shape(
    actor_step_count: u64,
) -> RequiredSimulationPlanShape {
    let mut counter_contracts = base_s5_counter_contracts(actor_step_count);
...
pub(super) fn s5_readiness_drivers_for_yieldpoint(yieldpoint: &str) -> RequiredPhysicalDriverSet {
    match yieldpoint {

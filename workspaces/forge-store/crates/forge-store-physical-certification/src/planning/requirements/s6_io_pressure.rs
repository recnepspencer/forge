...
pub(super) fn s6_io_pressure_shape(actor_step_count: u64) -> RequiredSimulationPlanShape {
...
mod tests {
    ...
    use super::s6_io_pressure_shape;

    #[test]
    fn s6_io_pressure_shape_uses_existing_s45_harness_surfaces() {
        let shape = s6_io_pressure_shape(2);
        ...
        assert!(shape
            .oracle_families
            .contains(OracleFamilyKind::S6IoPressureSimulation));
        assert!(shape
            .counter_contracts

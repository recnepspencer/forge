use super::model::LsmMembershipKey;
use crate::{
...
pub(crate) fn lsm_membership_record_bytes(
    ...
    let body = format!(
        "forge-store:wal-lsm-membership:v1 {} {} {} {} {} {} {} {} {} {} {} {}",
...
pub(crate) fn lsm_membership_manifest_bytes(scope: &CheckpointDurablePublicationScope) -> Vec<u8> {
    ...
    bytes.extend_from_slice(b"forge-store:wal-lsm-manifest:v1\0");
...
pub(crate) fn lsm_membership_output_bytes(scope: &WalFrameDurablePublicationScope) -> Vec<u8> {
    let mut bytes = Vec::with_capacity(4096);
    bytes.extend_from_slice(b"forge-store:wal-lsm-output:v1\0");
...
pub(crate) const fn tenant_code(value: forge_store_security::StoreTenantScope) -> u8 {
...
pub(crate) const fn key_scope_code(value: forge_store_security::StoreKeyScope) -> u8 {
...
pub(crate) const fn decode_tenant(code: u8) -> Option<forge_store_security::StoreTenantScope> {
    use forge_store_security::StoreTenantScope;
    match code {
...
pub(crate) const fn decode_key_scope(code: u8) -> Option<forge_store_security::StoreKeyScope> {
    use forge_store_security::StoreKeyScope;
    match code {

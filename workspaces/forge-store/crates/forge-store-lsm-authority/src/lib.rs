...
pub use membership::{
    ...
    LsmMembershipKey, LsmMembershipOpenOutcome,
    LsmMembershipOpenView, LsmMembershipOperation, LsmMembershipOwnerCaseDeclaration,
    LsmMembershipOwnerCaseId, LsmMembershipOwnerCaseObservation, LsmMembershipPersistOutcome,
    LsmMembershipPersistView, LsmMembershipRecord, LsmMembershipReopenCounters,
    LsmMembershipReplacementOutcome, LsmMembershipReplacementView, LsmMembershipReplayPosture,
    LsmMembershipSelectionOutcome, LsmMembershipSelectionView, LsmMembershipSession,
    LsmPublishedMembershipLookupOutcome, LsmPublishedMembershipLookupView,

...
impl BlobCorruptionCounterSnapshot {
    ...
    pub(crate) const fn record_damage_case(self, _case: BlobDamageCase) -> Self {
        Self {
            damage_case_classifications: self.damage_case_classifications + 1,
            ..self
        }
    }
    ...
    pub(crate) const fn record_localization(
        self,
        source: super::types::BlobCorruptionDetectionSource,
        affected_edges: u64,
    ) -> Self {
        let counters = match source {
            super::types::BlobCorruptionDetectionSource::VerifiedRead => Self {
                read_detections: self.read_detections + 1,
                ..self
            },
            super::types::BlobCorruptionDetectionSource::Scrub => Self {
                scrub_detections: self.scrub_detections + 1,
                ..self
            },
            super::types::BlobCorruptionDetectionSource::ColdFetch => Self {
                cold_fetch_detections: self.cold_fetch_detections + 1,
                ..self
            },
            super::types::BlobCorruptionDetectionSource::ImportReadmission => Self {
                import_detections: self.import_detections + 1,
                ..self
            },
            super::types::BlobCorruptionDetectionSource::CapsuleMaterialization => Self {
    ...
    pub const fn damage_case_classifications(self) -> u64 {
        self.damage_case_classifications
    }

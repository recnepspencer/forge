...
pub use crate::placement::{
    ...
    BlobPlacementIntent, BlobPlacementMovementAuthority, BlobPlacementMovementForegroundReservation,
    BlobPlacementMovementPhysicalExecutionIntent, BlobPlacementMovementRequest,
    BlobPlacementNonClaim, BlobPlacementProof, BlobReadDuringPlacementMove,
    StoreOwnedPlacementMovementExecution, StoreOwnedPlacementMovementPublication,
};
// --- Outcomes (transition receipts) ---
pub use crate::placement::{
    BlobMovementReadPhase, BlobMovementVerifiedReadEvidence, BlobPlacementMovementColdCapsuleOutcome,
    ...
    BlobPlacementMovementCounterBackedPerformanceReceipt, BlobPlacementMovementFreshness,
    BlobPlacementMovementReadHold, BlobPlacementMovementResidue, BlobPlacementMovementRestartOutcome,
    BlobReadDuringPlacementMoveReceipt, ExecutedBlobPlacementMovementReceipt,
    PublishedBlobPlacementObservation, StoreOwnedPlacementMovementExecutionReceipt,
};
...
pub use crate::placement::{
    BlobPlacementCounterSnapshot, BlobPlacementMovementCounterSnapshot,
};
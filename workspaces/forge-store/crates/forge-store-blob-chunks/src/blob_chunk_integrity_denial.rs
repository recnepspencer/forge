use forge_store_physical_format::PhysicalChunkChecksumDenial;
...
pub fn reject_checksum_only_evidence_as_blob_chunk_integrity(
    _checksum: forge_store_physical_format::PhysicalChunkChecksumWitness,
...
pub fn reject_digest_only_evidence_as_blob_chunk_integrity(
    _digest: forge_store_contracts::StableDigest,
) -> BlobChunkIntegrityDenial {

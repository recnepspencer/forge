...
fn map_triggered_security_denial(
    trigger: &StoreTrustBoundaryReadmissionTrigger,
    denial: forge_store_security::StoreSecurityScopeAdmissionDenial,
    counters: BlobImportReadmissionCounters,
) -> BlobImportReadmissionDenial {
    match trigger.crossing() {
        forge_store_security::StoreTrustBoundaryCrossing::KeyScopeGenerationChanged
        | forge_store_security::StoreTrustBoundaryCrossing::BackupRestoreAfterKeyRotation => {
            return BlobImportReadmissionDenial::StaleKeyGeneration {
                counters: counters.record_stale_scope_denial(),
            }
        }
        forge_store_security::StoreTrustBoundaryCrossing::TenantScopeAuthorityChanged => {
            return BlobImportReadmissionDenial::WrongTenantAuthority {
                counters: counters.record_stale_scope_denial(),
            }
        }
        forge_store_security::StoreTrustBoundaryCrossing::CustodyDomainChanged => {
    ...
    match denial {
        ...
        forge_store_security::StoreSecurityScopeAdmissionDenial::WrongTenantScope => {

...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobPublicationSessionCloseout, BlobVisibleGeneration};
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobPublicationWalRecord, BlobVisibleGeneration};
//!
//! fn requires_visible(_: BlobVisibleGeneration) {}
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPublicationWalRecord;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobPublicationCrashPoint, BlobPublicationRecoveryReplay};
//!
...
//! ```compile_fail
//! use forge_store_recovery_physics::PartialPublicationPersistedBytes;
//!
...
//! ```compile_fail
//! use forge_store_recovery_physics::PartialPublicationReplayReadSource;
//!
...
//! ```compile_fail
//! use forge_store_recovery_physics::RecoveryReplayEntryGate;
//!
//! let replay_entry: RecoveryReplayEntryGate = todo!();
...
//! ```compile_fail
//! use forge_store_recovery_physics::RecoveryEntryAdmission;
//!
...
//! use forge_store_recovery_physics::PartialPublicationBeforeWalReplayRead;
//!
//! let raw: &[u8] = b"forge-store.partial-publication.v1\nbefore-wal-append\ncopied";
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobGenerationObservation, BlobVisibleGeneration};
//!
//! fn requires_visible(_: BlobVisibleGeneration) {}
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobGenerationPublished;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPublicationCounterReceiptIdentity;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPublicationRecoveryOperationDigest;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPublicationPreWalReplayEvidence;
//!

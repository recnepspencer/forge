...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkSecurityScope;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkSecurityScope;
//! use forge_store_security::StoreJwtSubjectClaim;
//!
//! fn requires_scope(_: BlobChunkSecurityScope) {}
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkSecurityScope;
//! use forge_store_security::StoreKmsKeyIdentifier;
//!
//! fn requires_scope(_: BlobChunkSecurityScope) {}
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkSecurityMetadataWitness;
//!

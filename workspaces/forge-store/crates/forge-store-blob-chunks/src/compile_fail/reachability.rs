...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkReachabilityProofSet;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobChunkReachabilityProofSet, BlobReachabilityProof};
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobReachabilityEdge;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobGenerationPublished, BlobReachabilityProtectedHold};
//! use forge_store_physical_isolation::StablePhysicalReadPlan;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobGenerationPublished, BlobReachabilityProtectedHold};
//! use forge_store_physical_isolation::ReadDuringCheckpointVerdict;

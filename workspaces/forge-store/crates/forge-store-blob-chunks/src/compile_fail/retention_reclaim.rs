...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobRetentionReclaimPermit;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobReachabilityReclaimRelease, BlobRetentionReclaimPermit};
//! fn requires_permit(_: BlobRetentionReclaimPermit) {}
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobRetentionReclaimReceipt;
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobRetentionPhysicalOrphanIdentity;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobReachabilityReclaimRelease, BlobRetentionOrphanCandidate};
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobRetentionReclaimAdmission, BlobRetentionReclaimRequest};
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobRetentionPhysicalOrphanClaim, BlobRetentionPhysicalOrphanIdentity};

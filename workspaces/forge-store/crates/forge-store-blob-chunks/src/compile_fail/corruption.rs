...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobCorruptedChunkLocalization;
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobChunkQuarantine;
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobCorruptionCounterSnapshot, BlobCorruptionGuard};
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobCorruptionReferenceEdges, BlobVisibleGeneration};
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobCorruptionReferenceEdges, BlobGenerationPublished};
...
//! ```compile_fail
//! use forge_store_blob_chunks::{BlobCorruptionReferenceEdge, LifecycleReceipt};

...
//! ```compile_fail
//! use forge_store_blob_chunks::ExecutedBlobPlacementMovementReceipt;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::PublishedBlobPlacementObservation;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPlacementMovementReadHold;
//! use forge_store_physical_isolation::StablePhysicalReadReceipt;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPlacementMovementPhysicalExecutionIntent;
...
//! ```compile_fail
//! use forge_store_physical_isolation::PhysicalPlacementMovementExecutionAuthority;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::StoreOwnedPlacementMovementExecutionReceipt;
//!

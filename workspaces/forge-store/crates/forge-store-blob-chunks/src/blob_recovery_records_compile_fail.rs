...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobRecoveryRecordSet;
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobReachabilityManifestRow;
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobGenerationPublicationRecord;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobResumeSessionCheckpointRecord;
//!
...
//! ```compile_fail
//! use forge_store_blob_chunks::BlobPlacementManifestRow;
//!
...
//! ```compile_fail
//! use forge_store_physical_format::BlobPhysicalManifestTraversal;
//!
...
//! ```compile_fail
//! use forge_store_physical_backend::BlobPhysicalManifestObservation;
//!
...
//! ```compile_fail
//! use forge_store_physical_format::BlobPhysicalManifestObservationSource;
//! ```

...
use super::{
    BlobPublicationCounterSnapshot, BlobReachabilityStaging, BlobReachabilityStagingIdentity,
...
impl BlobPublicationRecoveryOperationDigest {
    ...
    pub(crate) fn root_candidate(candidate: &BlobRootCandidateForPublication) -> Self {
    ...
    pub(crate) fn reachability_staged(staged: &BlobReachabilityStaging) -> Self {
        Self::from_stable_parts(
            "reachability-staged",
            staged
                .staging_identity()
    ...
    fn from_stable_parts(phase: &str, stable_basis: &str) -> Self {
        Self {

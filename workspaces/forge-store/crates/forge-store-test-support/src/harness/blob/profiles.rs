...
pub fn local_blob_harness_seed() -> Result<BlobHarnessScenarioSeed, BlobHarnessShortcutDenial> {
    seed_for_profile(BlobHarnessProfile::local())
}

pub fn ci_memory_envelope_blob_harness_seed(
) -> Result<BlobHarnessScenarioSeed, BlobHarnessShortcutDenial> {
    seed_for_profile(BlobHarnessProfile::ci_memory_envelope_exceeding())
}

pub fn heavy_multi_gb_blob_harness_seed(
) -> Result<BlobHarnessScenarioSeed, BlobHarnessShortcutDenial> {

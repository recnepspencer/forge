...
fn admit_replay(
    ...
    forge_store_layout_indexes::BaselineLsmReplayAdmission,
    forge_store_layout_indexes::LsmMaintenanceAdmissionDenied,
> {
...
fn fully_covering_checkpoint(
    world: &ReaderCutoverWorld,
) -> forge_store_wal::AdmittedCheckpointPublicationReceipt {
    let scope = world
        .plan
...
fn execute_replay_lanes(
    wal: forge_store_layout_indexes::BaselineLsmReplayAdmission,
    checkpoint: forge_store_layout_indexes::BaselineLsmReplayAdmission,
) {

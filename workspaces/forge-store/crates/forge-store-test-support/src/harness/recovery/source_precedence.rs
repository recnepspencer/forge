...
pub fn physical_integrity_readiness() -> forge_store_readiness::PhysicalIntegrityReadiness {
...
pub fn wal_tail_quarantine_record() -> forge_store_physical_integrity::QuarantineRecord {

...
pub fn physical_isolation_scenario() -> forge_store_physical_certification::CertifiedPhysicalScenario
{
...
pub fn shortcut_scenario() -> forge_store_physical_certification::CertifiedPhysicalScenario {

...
pub struct PublicationInputs {
    pub new_authority: forge_store_physical_isolation::PhysicalReadStabilityAuthority,
    pub old_root: forge_store_physical_isolation::CurrentPhysicalRoot,
    pub new_root: forge_store_physical_isolation::CurrentPhysicalRoot,

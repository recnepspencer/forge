...
) -> forge_store_compatibility::RollingWindowCompatibilityReceipt {
...
pub(super) fn foreign_compatibility() -> forge_store_compatibility::RollingWindowCompatibilityReceipt
{
    compatibility_admission()
        .admit_rolling(RollingUpgradeAdmissionPlan::new(
...
pub(super) fn binding_outcome(
    ...
    authority: StoreCurrentAuthorityWitness,
    compatibility: forge_store_compatibility::RollingWindowCompatibilityReceipt,
    source: PublicationRootCandidate,
) -> forge_store_layout_indexes::evolution::migration::LayoutBindingAdmissionOutcome {

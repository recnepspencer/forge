...
use forge_store_physical_isolation::PhysicalRootPublicationRuntime;
...
fn execute_migration_request(
    ...
    current_root: Option<forge_store_physical_isolation::CurrentPhysicalRoot>,
) -> forge_store_layout_indexes::evolution::migration::LayoutMigrationExecutionOutcome {
...
fn rollback_request(
    declaration: forge_store_layout_indexes::evolution::migration::LayoutEvolutionDeclaration,
...
fn execute_rollback_request(
    ...
    current_root: Option<forge_store_physical_isolation::CurrentPhysicalRoot>,
) -> forge_store_layout_indexes::evolution::migration::LayoutRollbackExecutionOutcome {
    let root = current_root.unwrap_or_else(|| request.publication_source_root());
    let mut runtime = PhysicalRootPublicationRuntime::from_current_root(root);

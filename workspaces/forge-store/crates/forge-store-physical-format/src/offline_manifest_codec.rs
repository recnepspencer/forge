...
impl OfflineManifestCodec {
    pub fn encode_root_manifest(
        ...
        crate::offline_manifest_codec_encode::encode_root_manifest(byte_order, root)
    }
    ...
    pub fn encode_segment_manifest(
        ...
        crate::offline_manifest_codec_encode::encode_segment_manifest(
    ...
    pub fn encode_extent_manifest(
        ...
        crate::offline_manifest_codec_encode::encode_extent_manifest(
            byte_order,
            extents,
            allocation_classes,
        )
    ...
    pub fn encode_free_space_map(
        ...
        crate::offline_manifest_codec_encode::encode_free_space_map(byte_order, entries)
    }
    ...
    pub(crate) fn decode(
        ...
        crate::offline_manifest_codec_decode::decode(
            byte_order,
            root,
            segment_manifest,
            extent_manifest,

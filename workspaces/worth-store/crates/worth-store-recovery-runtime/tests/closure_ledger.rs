...
const FINDINGS: [&str; 28] = [
    ...
    "C8-P2-F28|High|C8-P2-ROOT-01 C8-P2-AUTHORITY-01 C8-P2-BINDING-01 C8-P2-IDENTITY-01 C8-P2-SESSION-01 C8-P2-COORDINATION-01 C8-P2-EFFECT-01 C8-P2-API-01 C8-P2-COMPILE-01 C8-P2-LEDGER-01|Phase 7 extended cleanup authority media settlement lifecycle and facade paths inside inherited Phase 2 causal closures while their source identities still described the pre-cleanup implementation|Rebound every affected Phase 2 guarantee to its exact current causal sources while preserving existing-root admission owner-issued authority semantic binding session coordination zero-entry-effect and compiler-sealing contracts|warnings-denied Phase 2 ledger full recovery runtime C8 boundary C7 boundary and Phase 7 cleanup journeys pass",
];

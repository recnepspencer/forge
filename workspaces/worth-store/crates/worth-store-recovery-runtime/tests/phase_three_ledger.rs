...
const GUARANTEE_CONTRACTS: [&str; 12] = [
    ...
    "C8-P3-WAL-01|3|WAL selection sorts semantic segment identity and admits one checkpoint-contiguous prefix while every segment scanner receives the cumulative remaining frame budget before retaining a crossing frame|recovery physics WAL-tail admission|reversed enumeration continuity corruption torn-tail scanned-versus-valid and exact one-over versus exact-at-limit bounded scanner tests|PROVED|C8-P3-F06 C8-P3-F08 C8-P3-F10 C8-P3-F12 C8-P3-F13 C8-P3-F17|persisted WAL security binding is delivered in Phase 4",
    ...
    "C8-P3-RESIDUE-01|3|Noncanonical nonregular trailing-empty interrupted-terminal-first-frame and unreferenced recovery artifacts remain typed residue with exact observed bytes and can never supply a missing authoritative source|recovery physics residue classification|plausible newest WAL terminal interruption repeated-selection and compaction residue mutants|PROVED|C8-P3-F06 C8-P3-F08 C8-P3-F17|cleanup eligibility remains post-publication Phase 7 work",

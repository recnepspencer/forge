...
const FINDINGS: [&str; 19] = [
    ...
    "C8-P3-F19|High|C8-P3-DISCOVERY-01 C8-P3-ROOT-01 C8-P3-PAGE-FACTS-01 C8-P3-CHECKPOINT-01 C8-P3-WAL-01 C8-P3-COMPACTION-01 C8-P3-RESIDUE-01 C8-P3-LIMITS-01 C8-P3-PROGRESSION-01 C8-P3-API-01 C8-P3-EFFECT-01 C8-P3-LEDGER-01|Phase 7 cleanup closeout changed shared recovery freshness coordination outcome facade compiler and ledger sources after the narrower WAL-cut continuity finding had already closed|Retain the distinct cross-phase event and rebind every Phase 3 guarantee only after discovery selection and all later runtime ledgers pass together without weakening read-only predecessor semantics|warnings-denied Phase 3 ledger full recovery-runtime Phase 7 ledger exact C8 boundary and inherited C7 boundary pass on one final source graph",
];

...
const FINDINGS: [(&str, &str); 30] = [
    ...
    ("C8-P5-F30", "C8-P5-PLAN-01 C8-P5-MEDIA-01 C8-P5-DURABILITY-01 C8-P5-EFFECT-01 C8-P5-FAILURE-01 C8-P5-CONVERGENCE-01 C8-P5-COUNTERS-01 C8-P5-MULTIPAGE-01 C8-P5-PROGRESSION-01 C8-P5-API-01 C8-P5-LEDGER-01"),
];

const FINDING_HISTORY_SHA256: &str =
    "a82559abb2e20ed12d265e211a44b0ed606d51789dea602d5b9244085fa8e729";

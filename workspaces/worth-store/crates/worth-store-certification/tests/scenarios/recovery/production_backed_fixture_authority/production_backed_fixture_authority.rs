...
use worth_store_test_support::production_backed_physical_fixture_materialization;
...
) -> worth_store_physical_certification::ProductionBackedPhysicalFixture {
...
fn declared_capability_boundaries(
    fixture: &worth_store_physical_certification::ProductionBackedPhysicalFixture,

...
fn assert_acceptance_suite_sources_and_basis(
    acceptance: &worth_store_physical_certification::SimulationHarnessAcceptanceSuiteMap,
) {
...
fn future_extension_slots_are_visible_without_future_behavior_or_readiness() {
    let inventory =
        worth_store_physical_certification::FutureHarnessExtensionSlotInventory::

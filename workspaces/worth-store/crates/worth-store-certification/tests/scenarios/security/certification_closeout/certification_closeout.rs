...
use worth_store_readiness::PhysicalFoundationEvidenceField;
...
) -> Vec<worth_store_physical_certification::SecurityScopeHarnessEvidence> {
...
) -> Vec<worth_store_physical_certification::SecurityScopeHarnessReplayTranscript> {

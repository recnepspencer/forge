...
fn owned_read_buffer_guard_rejects_extent_scope() {
    ...
    assert_eq!(
        ...
        PhysicalByteGuardDenial::GuardScopeKindMismatch {
            expected: worth_store_physical_isolation::PhysicalByteGuardScopeKind::OwnedReadBuffer,
            observed: worth_store_physical_isolation::PhysicalByteGuardScopeKind::ExtentWindow
        }
    );
}

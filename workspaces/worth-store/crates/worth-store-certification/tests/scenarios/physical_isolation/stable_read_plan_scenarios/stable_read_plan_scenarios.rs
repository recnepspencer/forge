...
fn complete_context() -> SimulationPlanningContext {
    SimulationPlanningContext::for_profile(PhysicalSimulationProfile::DeveloperSmoke)
        ...
        .with_forbidden_shortcuts(
            worth_store_physical_certification::ForbiddenShortcutSet::physical_certification_baseline(),
        )
}
...
fn executed_evidence_bundle(
    ...
    let sources =
        worth_store_physical_certification::PhysicalCounterExecutionSources::admit_for_plan(
            plan,
            &schedule,
            &trace,
    ...
    let replay =
        worth_store_physical_certification::DetachedSimulationReplayParts::from_transcript(
            &transcript,
        )
        .admit_replay_bundle()
        .unwrap();
...
fn production_fixture() -> worth_store_physical_certification::ProductionBackedPhysicalFixture {

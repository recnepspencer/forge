...
pub struct BudgetFixture {
    ...
    eligibility: worth_store_recovery_physics::PageRedoEligibility,
    ...
    let facts = pages
        ...
        .map(|(page_value, current_lsn, redo_lsn)| {
            ...
            RedoApplicationPageFact::new(
                ...
                eligibility,
                worth_store_recovery_physics::PageRedoDigestState::new(
                    page_generation,
...
fn admitted_frame_for_page(
    redo_lsn: u64,
    page_value: u64,
    prefix: &worth_store_recovery_physics::WalValidPrefix,
) -> AdmittedRedoFrame {
    let eligibility = redo_eligibility_for_page(redo_lsn - 1, redo_lsn, page_value);

...
pub(crate) fn complete_acceptance_suite_receipts(
    ...
    worth_store_physical_certification::PhysicalSimulationHarnessCloseoutSuite::simulation_admission()
...
fn closeout_context(
    ...
    worth_store_physical_certification::SimulationPlanningContext::for_profile(profile)
        ...
        .with_capabilities(
            worth_store_physical_certification::PhysicalSimulationCapabilitySet::physical_isolation_readiness_shape_probe(),
        )

    ...
    pub fn from_decode_report(
        ...
        Ok(Self {
            ...
            artifact_id: StableArtifactId::new(
                "worth_store.header_decode.for_canonical_physical_format",
            )
...
fn header_decode_rule_version() -> CanonicalizationRuleVersion {
    CanonicalizationRuleVersion::new("worth-store.header-decode.for_canonical_physical_format.v1")
        .expect("static header decode canonicalization rule version")
}

const fn header_decode_domain() -> CanonicalBasisDomain {
    CanonicalBasisDomain::Future("worth-store.header-decode.for_canonical_physical_format")
}
...
mod tests {
    ...
    fn header_decode_evidence_exports_real_report_at_foundational_boundary() {
        ...
        assert_eq!(
            ...
            &StableArtifactId::new("worth_store.header_decode.for_canonical_physical_format")
                .unwrap()
        );
        assert_eq!(
    ...
    fn decoded_frame_header_report() -> worth_store_physical_format::PhysicalHeaderDecodeReport {

...
pub use phase_defects::{
    ...
    localize_s10_formal_phase_defect, localize_s10_harness_phase_defect,
    localize_s10_observation_phase_defect, localize_s10_runtime_phase_defect,
    localize_s10_structural_phase_defect, S10PhaseDefectDenial, S10PhaseDefectLocalization,
...
pub use structural_preflight::{
    execute_s10_structural_preflight, S10StructuralPreflightDenial, S10StructuralPreflightEvidence,
};

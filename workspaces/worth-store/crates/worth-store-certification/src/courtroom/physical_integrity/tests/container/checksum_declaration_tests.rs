...
fn coverage_map_answers_all_region_dispositions() {
    ...
    assert_eq!(
        ...
        worth_store_physical_format::ChecksumCoverageDisposition::Covered
    );
    assert_eq!(
        map.disposition_for_region(ChecksumCoverageRegion::HeaderField(
            ChecksumHeaderField::ChecksumField,
        )),
        worth_store_physical_format::ChecksumCoverageDisposition::Excluded
    );
    assert_eq!(
        map.disposition_for_region(ChecksumCoverageRegion::HeaderField(
            ChecksumHeaderField::PublicationState,
        )),
        worth_store_physical_format::ChecksumCoverageDisposition::Preserved
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        worth_store_physical_format::ChecksumCoverageDisposition::Skipped
    );
    assert_eq!(
        map.disposition_for_region(ChecksumCoverageRegion::UnknownFutureField),
        worth_store_physical_format::ChecksumCoverageDisposition::Denied
    );
}
...
) -> worth_store_physical_integrity::ChecksumAlgorithmDeclaration {
...
fn explicit_physical_format_builder() -> worth_store_physical_format::ChecksumCoverageMapBuilder {

...
pub(crate) fn complete_physical_integrity_closeout_suite(
    s4_readiness: &worth_store_recovery_physics::AdmittedRecoveryIntegrityInput,
...
pub(crate) fn physical_integrity_readiness() -> worth_store_readiness::PhysicalIntegrityReadiness {

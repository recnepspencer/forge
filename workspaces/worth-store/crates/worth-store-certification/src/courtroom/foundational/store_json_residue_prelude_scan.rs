use crate::{
    courtroom::source_tree::store_crate_source, StoreJsonResidueDenial, StoreJsonResidueOccurrence,
...
{
    let path = store_crate_source("worth-store-test-support").join("lib.rs");

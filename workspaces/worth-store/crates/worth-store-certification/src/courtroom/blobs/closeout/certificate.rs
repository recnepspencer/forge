...
use worth_store_blob_chunks::{BlobObjectId, ChunkTreeRoot};
...
pub(crate) fn build_closeout_certificate(
    request: VerifiedBlobCloseoutRequest,
) -> BlobStoreCloseoutCertificate {
    ...
    let binding_tag = format!(
        "blob-closeout:{}:{}:{:02x}{:02x}{:02x}{:02x}:{:02x}{:02x}{:02x}{:02x}",
...
impl BlobStoreCloseoutCertificate {

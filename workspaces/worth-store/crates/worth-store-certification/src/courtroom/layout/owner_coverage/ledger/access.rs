...
impl LayoutOwnerObservationLedger {
    record_layout_observation!(
        ...
        worth_store_layout_indexes::ArtifactFamilyAdmissionCaseId,
        as_str
    );
    pub fn record_physical_key_domain_admission(
        &mut self,
        observed: worth_store_layout_indexes::OwnerCaseObservation<
            worth_store_layout_indexes::PhysicalKeyDomainAdmissionCaseId,
        >,
    ) {
    ...
    record_layout_observation!(
        ...
        worth_store_layout_indexes::BootstrapCatalogReadCaseId,
        as_str
    );
    record_layout_observation!(
        record_access_plan_selection,
        AccessPlanSelection,
        worth_store_layout_indexes::AccessPlanSelectionCaseId,
        as_str
    );
    pub fn record_full_declared_scan(
        &mut self,
        observed: worth_store_layout_indexes::OwnerCaseObservation<
            worth_store_layout_indexes::FullDeclaredScanCaseId,
        >,
    ) {
        let case = observed.case_id();
        if case == worth_store_layout_indexes::FullDeclaredScanCaseId::HiddenBroadScanDenied {
    ...
    pub fn record_btree_lookup_readiness(
        &mut self,
        observed: worth_store_layout_indexes::OwnerCaseObservation<
            worth_store_layout_indexes::BTreeLookupReadinessCaseId,
        >,
    ) {
        let case = observed.case_id();
    ...
    pub fn record_btree_lookup_execution(
        &mut self,
        observed: worth_store_layout_indexes::OwnerCaseObservation<
            worth_store_layout_indexes::BTreeLookupExecutionCaseId,
        >,
    ) {
    ...
    record_layout_observation!(
        ...
        worth_store_layout_indexes::BTreeReplayCaseId,
        as_str
    );
    record_layout_observation!(
        record_degraded_scan_readiness,
        DegradedScanReadiness,
        worth_store_layout_indexes::DegradedScanReadinessCaseId,
        name
    );
    record_layout_observation!(
        record_lsm_lookup_readiness,
        LsmLookupReadiness,
        worth_store_layout_indexes::BaselineLsmLookupAdmissionCaseId,
        name
    );
    record_layout_observation!(
        record_lsm_lookup_execution,
        LsmLookupExecution,
        worth_store_layout_indexes::BaselineLsmLookupCaseId,
        name
    );
    record_layout_observation!(
        record_imported_blob_read_admission,
        ImportedBlobReadAdmission,
        worth_store_layout_indexes::ImportedBlobReadAdmissionCaseId,
        as_str
    );

    pub fn record_pre_execution_budget_admission(
        &mut self,
        observed: worth_store_budgets::PreExecutionBudgetAdmissionObservation,
    ) {
        self.record(

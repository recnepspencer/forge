...
use worth_store_layout_indexes::declarations::ArtifactFamilyAccessLane;
...
pub(super) fn page_security() -> worth_store_security::StoreAdmittedSecurityScope {
    security_scope(
...
pub(super) fn wal_security() -> worth_store_security::StoreAdmittedSecurityScope {
    security_scope(
        SecurityScopeFixtureAuthority::Current,

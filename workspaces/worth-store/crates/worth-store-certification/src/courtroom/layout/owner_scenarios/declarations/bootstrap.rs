use worth_store_layout_indexes::{bootstrap_catalog, BootstrapOnlyAccessPath, ObserveOwnerCase};
use worth_store_physical_format::physical_bootstrap_catalog;

use super::super::LayoutOwnerObservationLedger;

pub(super) fn execute(ledger: &mut LayoutOwnerObservationLedger) {
    let mut physical = worth_store_test_support::open_layout_physical_facade();

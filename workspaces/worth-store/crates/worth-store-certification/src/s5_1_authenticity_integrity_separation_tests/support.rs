...
use worth_store_physical_format::{PhysicalAuthenticityIdentity, PhysicalFrameKind};
    ...
    with_pre_decode_admission(
        ...
        |admission, validation, witness| {
            ...
            assert_eq!(
                ...
                worth_store_physical_integrity::PreDecodePhysicalDenialKind::AuthenticityRequiredPhysicalDenial
            );
            assert_eq!(
                physical_denial.authenticity_denial().unwrap().kind(),
                expected_kind
...
pub(super) fn admitted_witness(
    scope: &worth_store_security::StoreCurrentAuthenticityScopeWitness,

...
pub(super) fn emit(input: ScaleCourtroomEvidence<'_>) {
    ...
    super::super::scenario_evidence::emit(ScenarioEvidence {
        ...
        counters: serde_json::json!({
            "point_media_reads": input.observation.point_media_reads,
            "point_media_bytes": input.observation.point_media_bytes,
            "point_manifest_bytes": input.observation.point_manifest_bytes,
            ...
            "scan_media_reads": input.observation.scan_media_reads,
            "scan_media_bytes": input.observation.scan_media_bytes,
            "scan_manifest_bytes": input.observation.scan_manifest_bytes,

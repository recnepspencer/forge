...
pub(super) enum PersistedPhysicalRecord {
    CheckpointManifest(CheckpointManifestRecord),
    WalRedoFrame(WalRedoFrameRecord),
    CheckpointPageImage(CheckpointPageImageRecord),
}

impl PersistedPhysicalRecord {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct WalRedoFrameRecord {
    pub(super) lsn: u64,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct CheckpointPageImageRecord {
    pub(super) page_id: u64,
...
pub(super) fn parse_physical_record(
    record_id: &str,
    bytes: &[u8],
...
fn parse_wal_redo_frame(
    ...
    Ok(PersistedPhysicalRecord::WalRedoFrame(WalRedoFrameRecord {
...
fn parse_checkpoint_page_image(
    ...
    Ok(PersistedPhysicalRecord::CheckpointPageImage(
        CheckpointPageImageRecord {

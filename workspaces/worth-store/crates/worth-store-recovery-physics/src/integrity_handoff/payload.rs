use super::inspection_envelope::{BoundedInspectionEnvelopeEvidence, ChecksumAlgorithmScopeBasis};
use crate::{
...
pub struct IntegrityHandoffCounters {
...
pub struct IntegrityHandoffPayload {
...
pub(crate) struct SealedIntegrityHandoffPayloadParts {
    ...
    pub(crate) checksum_basis: ChecksumAlgorithmScopeBasis,
    pub(crate) counters: IntegrityHandoffCounters,
...
impl IntegrityHandoffPayload {
    pub fn declare() -> super::IntegrityHandoffDeclaration {
        super::IntegrityHandoffDeclaration::default()
    }

    pub(crate) fn from_sealed_parts(parts: SealedIntegrityHandoffPayloadParts) -> Self {
...
fn payload_identity(parts: &SealedIntegrityHandoffPayloadParts) -> StableDigest {
    ...
    .expect("integrity handoff identity basis is non-empty")
}

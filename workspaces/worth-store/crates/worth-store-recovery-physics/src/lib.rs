...
pub use source_precedence::{
    ...
    CheckpointCoveredWalArtifact, InspectedPhysicalWalArtifacts, PageLsnSkipApplyDecision,
    ...
    PhysicalWalArtifactInspectionDenial, PhysicalWalSegmentCandidate, SelectedCompactionProduct,

...
pub struct LayoutRebindRequired {
    ...
    bound_security: worth_store_security::StoreSecurityScopeIdentity,
    current_authority: worth_store_authority::StoreCurrentAuthorityIdentity,
    current_security: worth_store_security::StoreSecurityScopeIdentity,
}
...
impl LayoutRebindRequired {
    ...
    pub const fn bound_security(&self) -> worth_store_security::StoreSecurityScopeIdentity {
        self.bound_security
    }

    pub const fn current_authority(&self) -> worth_store_authority::StoreCurrentAuthorityIdentity {
        self.current_authority
    }

    pub const fn current_security(&self) -> worth_store_security::StoreSecurityScopeIdentity {

use worth_proof::raw::{ExecuteReadyRecipeTransition, ExecutedRecipe, Transition};

use super::DegradedScanLoweringBasis;
use crate::planning::SelectedDegradedExactScan;
use worth_store_physical_format::PlatformPhysicalDegradedExecutionObservation;

type DegradedScanReadyRecipe = worth_proof::raw::ExecutionReadyRecipe<
    SelectedDegradedExactScan,
    worth_proof::raw::FreshnessScopedBasis<
        worth_proof::raw::CurrentValidity,
        worth_proof::raw::AssumptionBasis<DegradedScanLoweringBasis>,
    >,
>;

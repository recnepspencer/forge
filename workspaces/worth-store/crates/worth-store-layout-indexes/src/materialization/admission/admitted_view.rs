...
impl AdmittedLayoutMaterialization {
    ...
    pub fn source_root_owner(&self) -> worth_store_physical_format::PhysicalGenerationOwner {
        self.inner.coverage.source().root_owner()
    }

    pub fn source_format_version(&self) -> worth_store_physical_format::PhysicalFormatVersion {

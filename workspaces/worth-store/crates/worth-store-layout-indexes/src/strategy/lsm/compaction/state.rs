...
pub struct PreparedLsmCompaction {
    pub(super) membership: worth_store_lsm_authority::LsmCompactionMembership,
    pub(super) replay_tail: super::LsmCompactionReplayTail,
    pub(super) output: worth_store_lsm_authority::AdmittedLsmReplacementOutput,
...
pub struct PublishedLsmCompaction {
    ...
    pub(super) membership_replacement: worth_store_lsm_authority::PublishedLsmMembershipReplacement,
}

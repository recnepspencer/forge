...
use super::{
    SecurityScopeHarnessEvidence, SecurityScopeHarnessOutcomeKind, SecurityScopeHarnessSchedule,
    SecurityScopePhysicalReplayDenial, SecurityScopePhysicalReplayEvidence,
};

#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum SecurityScopeReplayMutationKind {
    ChangedTenantScope,
...
pub struct SecurityScopeHarnessReplayCounterSnapshot {
...
pub struct SecurityScopeHarnessReplayTranscript {
    ...
    counters: SecurityScopeHarnessReplayCounterSnapshot,
}

impl SecurityScopeHarnessReplayTranscript {
    pub fn from_physical_replay(
        ...
        Ok(Self {
            ...
            baseline_evidence,
            replay_evidence,
            counters: SecurityScopeHarnessReplayCounterSnapshot::from_evidence_pair(
                baseline_evidence,
                replay_evidence,
            ),
        })
    ...
    pub const fn mutation(&self) -> SecurityScopeReplayMutationKind {
        self.mutation
    }

    pub const fn baseline_evidence(&self) -> SecurityScopeHarnessEvidence {
        self.baseline_evidence
    }

    pub const fn replay_evidence(&self) -> SecurityScopeHarnessEvidence {
        self.replay_evidence
    }

    pub const fn baseline_physical_replay(&self) -> &SecurityScopePhysicalReplayEvidence {
        &self.baseline_physical_replay
    }

    pub const fn replay_physical_replay(&self) -> &SecurityScopePhysicalReplayEvidence {
        &self.replay_physical_replay
    }

    pub const fn counters(&self) -> SecurityScopeHarnessReplayCounterSnapshot {
        self.counters
    }
...
impl SecurityScopeHarnessReplayCounterSnapshot {

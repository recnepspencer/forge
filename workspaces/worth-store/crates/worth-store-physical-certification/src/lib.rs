...
pub use physical_isolation_handoff::{
    accept_store_owned_physical_isolation_harness_readiness, admit_physical_isolation_entry,
    admit_physical_isolation_entry_checked, physical_isolation_required_mutation_rows,
    ...
    ExecutedPhysicalIsolationSourceDenial, PhysicalIsolationAdmittedEntryRecipe,
    PhysicalIsolationCertificationLaneRegistration, PhysicalIsolationCounterContractReadiness,
    PhysicalIsolationEntryAdmission, PhysicalIsolationEntryCheckedOutcome,
    PhysicalIsolationEntryDenial, PhysicalIsolationEntryEvidence,
    PhysicalIsolationEntryFoundationalEvidence, PhysicalIsolationEntryIdentity,
    PhysicalIsolationEntryProofProgression, PhysicalIsolationEntryProofRequest,
    PhysicalIsolationEntryRebindRequired, PhysicalIsolationEntryRequest,
    PhysicalIsolationEvidenceProfileCounterSet, PhysicalIsolationHarnessFutureExtensionReservation,
    ...
    PhysicalIsolationLoweredEntryRecipe, PhysicalIsolationMaintenanceActorCapability,
    PhysicalIsolationMutationEvidence, PhysicalIsolationMutationReplayBasis,
    PhysicalIsolationProductionDriverCapability, PhysicalIsolationRequiredYieldpoint,
    PhysicalIsolationResolvedEntryRecipe, PhysicalIsolationReusableOracleReadiness,

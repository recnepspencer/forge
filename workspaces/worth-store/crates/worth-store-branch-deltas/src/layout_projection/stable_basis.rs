...
use worth_store_live_query::{ContinuationRetentionStatus, StableBasisId, StableBasisReadPlan};
...
pub(crate) fn admit_stable_basis_layout_support(
    ...
    Ok(StableBasisLayoutReport::from_admitted_support(
...
impl StableBasisLayoutSupportEstimate {
    ...
    pub const fn planned_point_lookups(self) -> u16 {
        self.planned_point_lookups
    }

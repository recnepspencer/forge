...
pub use physical_residency::{
    ...
    OperationAllocationGrant, OperationAllocationObservation, PhysicalBoundedFrameAccess,
    PhysicalBoundedFrameFaultOwner, PhysicalBoundedFrameFaultWaiter, PhysicalBoundedFrameKey,
    PhysicalCandidateBatchAdmission, PhysicalCandidateBatchReservation, PhysicalCandidateFrameKey,
    PhysicalCandidateFrameReservation, PhysicalDirtyFrameBasis, PhysicalDirtyGeneration,
    ...
    PhysicalDirtyReplacementError, PhysicalDirtyReplacementReservation, PhysicalFrameAccess,
    PhysicalFrameFaultError, PhysicalFrameFaultOwner, PhysicalFrameFaultWaiter, PhysicalFrameKey,
    PhysicalFrameLease, PhysicalFrameLoadTerminal, PhysicalFrameLoadTerminalKind,
    PhysicalFrameLoadingIdentity, PhysicalOperationAllocationScope,
    ...
    PhysicalResidencyAllocationTrace, PhysicalResidencyCounters, PhysicalResidencyDenial,
    PhysicalResidencyDimension, PhysicalResidencyIncarnation, PhysicalResidencyLimits,
    PhysicalResidencyLimitsAdmissionDenial, PhysicalResidencyLimitsBuilder, PhysicalResidencyPool,
    PhysicalResidencyPoolOwner, PhysicalResidencyPressureDenial, PhysicalResidencyShutdown,

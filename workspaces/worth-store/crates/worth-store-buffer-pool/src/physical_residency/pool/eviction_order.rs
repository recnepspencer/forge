...
impl PoolState {
    pub(super) fn append_evictable(&mut self, coordinate: RecordFrameCoordinate) {
    ...
    pub(super) fn detach_evictable(&mut self, coordinate: RecordFrameCoordinate) {
    ...
    pub(super) fn pop_oldest_evictable(&mut self) -> Option<RecordFrameCoordinate> {

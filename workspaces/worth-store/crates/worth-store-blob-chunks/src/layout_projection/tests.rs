...
fn layout_admission_uses_published_and_verified_runtime_path() {
    ...
    assert_eq!(
        ...
        worth_store_contracts::DurableArtifactFamilyId::BlobChunk
    );
    assert_eq!(
        streaming.family_id(),
        worth_store_contracts::DurableArtifactFamilyId::BlobStream
    );
    assert_eq!(
        publication.family_id(),
        worth_store_contracts::DurableArtifactFamilyId::PublicationWalPublicationProgress
    );
    assert_eq!(
        resume.family_id(),

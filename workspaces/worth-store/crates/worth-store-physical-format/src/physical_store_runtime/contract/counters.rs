...
pub struct PhysicalStoreRuntimeCounterSnapshot {
    opens: u32,
    appends: u32,
    reads: u32,
    locates: u32,
...
impl PhysicalStoreRuntimeCounterSnapshot {
    ...
    pub(in crate::physical_store_runtime) const fn with_scan_materializations(mut self) -> Self {

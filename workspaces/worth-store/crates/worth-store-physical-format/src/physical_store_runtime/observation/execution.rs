...
use super::{
    PhysicalStoreRuntime, PhysicalStoreRuntimeCounterSnapshot, PhysicalStoreRuntimeDenial,
...
pub struct PlatformPhysicalRootPublicationObservation {
    ...
    payload_bytes: u64,
    counters_before: PhysicalStoreRuntimeCounterSnapshot,
    counters_after: PhysicalStoreRuntimeCounterSnapshot,
}
...
impl PlatformPhysicalRootPublicationObservation {
    ...
    pub const fn counters_before(&self) -> PhysicalStoreRuntimeCounterSnapshot {
        self.counters_before
    }
    pub const fn counters_after(&self) -> PhysicalStoreRuntimeCounterSnapshot {
        self.counters_after
    }
...
impl PlatformPhysicalDegradedExactScanReady {
    ...
    pub(in crate::physical_store_runtime) const fn budget(self) -> PreExecutionBudgetEnvelope {
        self.budget
    }
}
...
impl PlatformPhysicalDegradedExecutionObservation {
    pub(in crate::physical_store_runtime) const fn issue(
        budget: PreExecutionBudgetEnvelope,
        scan: PlatformPhysicalDegradedExactScanReceipt,
        allocation_events: u64,
    ) -> Self {

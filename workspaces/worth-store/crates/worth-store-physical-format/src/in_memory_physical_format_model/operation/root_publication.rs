...
use super::{InMemoryPhysicalFormatModel, PlatformPhysicalRootPublicationReport};

impl InMemoryPhysicalFormatModel {
    pub fn publish_physical_root(
        &mut self,
    ) -> Result<PlatformPhysicalRootPublicationReport, InMemoryPhysicalFormatModelDenial> {
...
) -> Result<EncodedRootPublication, InMemoryPhysicalFormatModelDenial> {
...
fn advance_root_generation(
    next_root_generation: &mut u64,
) -> Result<PhysicalGeneration, InMemoryPhysicalFormatModelDenial> {

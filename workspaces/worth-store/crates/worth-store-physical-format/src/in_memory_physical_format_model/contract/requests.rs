...
impl PhysicalStoreIdentity {
    ...
    pub fn authority_identity(&self) -> worth_store_authority::StoreCurrentAuthorityIdentity {
        worth_store_authority::StoreCurrentAuthorityIdentity::from_aspect_identity(&self.0)
    }
...
/// Inputs for constructing detached in-memory physical-format model state.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct InMemoryPhysicalFormatModelRequest {
    headers: PhysicalHeaderAuthority,
    store_identity: PhysicalStoreIdentity,
}

impl InMemoryPhysicalFormatModelRequest {

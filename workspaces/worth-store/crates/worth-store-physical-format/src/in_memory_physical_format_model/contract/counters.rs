...
pub struct InMemoryPhysicalFormatModelCounterSnapshot {
    opens: u32,
    appends: u32,
    reads: u32,
    locates: u32,
...
impl InMemoryPhysicalFormatModelCounterSnapshot {
    ...
    pub const fn with_restore(mut self) -> Self {
        self.restores += 1;
        self
    }
    ...
    pub(in crate::in_memory_physical_format_model) const fn with_scan_materializations(
        mut self,
    ) -> Self {
    ...
    pub const fn restores(self) -> u32 {
        self.restores
    }
    ...
    pub const fn is_exact_hidden_scan_denial_delta_from(self, before: Self) -> bool {
        self.opens == before.opens
            ...
            && self.allocation_events == before.allocation_events
    }
}

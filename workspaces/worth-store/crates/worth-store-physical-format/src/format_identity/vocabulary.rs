...
use worth_store_contracts::{PhysicalAuthorityScope, StorePhysicalAuthorityWitness};
...
mod tests {
    use super::*;
    use worth_store_contracts::StorePhysicalAuthorityWitness;
    ...
    fn physical_vocabulary_admits_all_required_terms() {
        let authority = StorePhysicalAuthorityWitness::for_physical_format_vocabulary(
            worth_store_contracts::ROADMAP_2_S1_SCOPE,
        )

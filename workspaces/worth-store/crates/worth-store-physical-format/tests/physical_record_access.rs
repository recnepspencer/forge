...
fn slot_cell(value: u16) -> worth_store_physical_format::SlotGenerationCell {
...
fn extent_cell(value: u64) -> worth_store_physical_format::ExtentGenerationCell {
    extent_cell_for(extent(value))
}

fn extent_cell_for(
    extent_id: PhysicalExtentId,
) -> worth_store_physical_format::ExtentGenerationCell {
    PhysicalGenerationAuthority::for_canonical_physical_format()

...
pub use crate::recovery_media::{
    ...
    QualifiedRecoveryFilesystemMedia, RecoveryCleanupRemovalOutcome, RecoveryDiscoveryArtifact,
    RecoveryDiscoveryByteLimitScope, RecoveryDiscoveryCounters, RecoveryDiscoveryFailure,
    RecoveryFilesystemQualificationError, RecoveryMediaHandleObservation,
    RecoveryReopenReadOutcome, RecoveryRootProtocolPublicationDenial,
    RecoveryRootProtocolPublicationPlan, RecoveryStagingSynchronizationOutcome,
    RecoveryStagingWriteDisposition, RecoveryStagingWriteOutcome, RecoveryWalArtifactCoordinate,
};

    ...
    pub fn require_checked(
        ...
        match self.support.posture(kind) {
            BackendCapabilitySupportPosture::Supported => {
                worth_proof::TransitionOutcome::success(BackendCapabilityClaimWitness {
            ...
            BackendCapabilitySupportPosture::Unsupported => worth_proof::TransitionOutcome::denied(
            ...
            .into(),
            BackendCapabilitySupportPosture::Unavailable => worth_proof::TransitionOutcome::denied(
            ...
            .into(),
            BackendCapabilitySupportPosture::Unknown => worth_proof::TransitionOutcome::denied(
            ...
            BackendCapabilitySupportPosture::Stale => {
                worth_proof::TransitionOutcome::stale(BackendCapabilityStale { kind }).into()
            }
            BackendCapabilitySupportPosture::RebindRequired => {
                worth_proof::TransitionOutcome::rebind_required(BackendCapabilityRebindRequired {
                    kind,

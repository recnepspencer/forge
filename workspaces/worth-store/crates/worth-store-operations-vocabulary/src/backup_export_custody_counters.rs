...
impl BackupExportCustodyCounterSnapshot {
    pub const fn for_declaration(_: BackupExportCustodyMode) -> Self {
        Self {
    ...
    pub const fn from_readiness() -> Self {
        Self {
    ...
    pub const fn record_custody_admitted(self) -> Self {
        Self {
    ...
    pub const fn record_custody_denied(self) -> Self {
        Self {
    ...
    pub const fn record_stale_key_version(self) -> Self {
        Self {
    ...
    pub const fn record_unsupported_secure_posture(self) -> Self {
        Self {
    ...
    pub const fn record_unavailable_custody_evidence(self) -> Self {
        Self {
    ...
    pub const fn prepared_emission(self) -> Self {
        Self {
    ...
    pub const fn prepared_terminal_projection(self) -> Self {
        Self {
    ...
    pub const fn crossed_trust_boundary(self) -> Self {
        Self {
    ...
    pub const fn readmitted(self) -> Self {
        Self {
    ...
    pub const fn record_readmission_required(self) -> Self {
        Self {

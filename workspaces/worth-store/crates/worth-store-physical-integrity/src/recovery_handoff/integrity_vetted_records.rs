...
pub struct IntegrityVettedPageFrameRecord {
    ...
    counters: crate::ContainerIntegrityCounters,
    receipt: RecoveryIntegrityHandoffReceipt,
}
...
impl IntegrityVettedPageFrameRecord {
    ...
    pub const fn counters(&self) -> crate::ContainerIntegrityCounters {
        self.counters
    }
...
fn authority_basis_denial(_: crate::PhysicalIntegrityEvidenceDenial) -> IntegrityHandoffDenial {

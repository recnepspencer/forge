...
pub struct LsmMembershipKey {
    pub(crate) security_identity: worth_store_security::StoreSecurityScopeIdentity,
    pub(crate) authority_identity: worth_store_authority::StoreCurrentAuthorityIdentity,
...
pub(super) struct LsmMembershipReadmissionAuthority {
    security_identity: worth_store_security::StoreSecurityScopeIdentity,
...
impl LsmMembershipReadmissionAuthority {
    pub(super) fn from_current_scope(
        witnesses: &worth_store_security::StoreCurrentSecurityScopeWitnessSet,
    ) -> Self {
        Self {

...
use worth_store_lsm_authority::{LsmMembershipArtifactDeclaration, LsmMembershipSession};
use worth_store_physical_isolation::CompactionRewritePublication;
use worth_store_wal::{
...
impl LsmExecutionWorld {
    pub fn demand(&self) -> worth_store_layout_indexes::AdmittedLsmCompactionDemand {
        lsm_strategy()

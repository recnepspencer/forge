...
struct ReaderCutoverWorld {
    access: worth_store_layout_indexes::LsmStrategy,
    physical_plan: worth_store_physical_isolation::CompactionReadInterlockPlan,
    physical_manifest_epoch: u64,
    physical_publication: worth_store_physical_isolation::CompactionRewritePublication,
    physical_recovery: worth_store_recovery_physics::CompactionCutoverRecoveryPosture,
    ...
    compaction: worth_store_layout_indexes::BaselineLsmCompactionAdmission,
    publication: worth_store_layout_indexes::BaselineLsmRunPublicationAdmission,
    wrong_publication: worth_store_layout_indexes::BaselineLsmRunPublicationAdmission,
    key: LsmMembershipKey,
    first_durable: AdmittedWalAppendReceipt,
    persisted: worth_store_lsm_authority::LsmMembershipSession,
    plan: worth_store_layout_indexes::BaselineLsmCompactionPlan,
}
...
fn admit_publication(
    security: &worth_store_security::StoreAdmittedSecurityScope,
    record_identity: u64,
) -> worth_store_layout_indexes::BaselineLsmRunPublicationAdmission {

...
fn reject_unrelated_physical_publications(
    ...
    prepared: &worth_store_layout_indexes::PreparedLsmCompaction,
) {
...
fn reject_wrong_selected_publication(
    persisted: &mut worth_store_lsm_authority::LsmMembershipSession,
    wrong: worth_store_layout_indexes::BaselineLsmRunPublicationAdmission,

...
use worth_store_recovery_physics::{CheckpointCutoverReceipt, CheckpointPublicationPlan};

use crate::harness::{
    physical_isolation::{epoch_scope as epoch_support, read_plan as plan_admission},
    recovery::{
        checkpoint_basis as checkpoint_basis_fixture,
        checkpoint_durability as checkpoint_durability_fixture,
    },
};

pub(super) fn checkpoint_evidence_for_operation(

...
pub fn lowered_ci_plan() -> PhysicalSimulationPlan {
    worth_store_physical_certification::lower_physical_simulation_plan(
        scenario(),
...
pub fn shortcut_plan() -> PhysicalSimulationPlan {
    worth_store_physical_certification::lower_physical_simulation_plan(
        shortcut_scenario(),
        complete_context_for_profile(PhysicalSimulationProfile::DeveloperSmoke),
    )
...
pub fn ci_plan_without_supported_driver(
    driver: worth_store_physical_certification::PhysicalDriverKind,
...
pub fn ci_plan_without_supported_oracle(
...
pub fn shortcut_scenario() -> CertifiedPhysicalScenario {
    counter_support::shortcut_scenario()
}

pub fn scenario() -> CertifiedPhysicalScenario {
...
pub fn replay_bundle_without_mutation_denial(
    plan: &PhysicalSimulationPlan,
) -> SimulationReplayBundle {
    replay_bundle_with_trace_builder(plan, |plan, _schedule| {
...
pub fn mutation_evidence_denial(replay: &SimulationReplayBundle) -> CoverageGapDenial {

...
pub(super) const MUTATIONS: &[ControlledMutation] = &[
    ...
    ControlledMutation {
        ...
        replacement: "        self.record(format!(\"method:{}\", call.method));\n        visit::visit_expr_method_call(self, call);",
        package: "store-test-runner",
        target: MutationTarget::Library,
    ...
    ControlledMutation {
        ...
        needle: "    \"workspaces/worth-store/tools/store-test-runner/src/durable_publication_boundary_gate/contract/wal_source_syntax\",\n",
        replacement: "",
        package: "store-test-runner",
        target: MutationTarget::Library,

...
pub use visual_snapshot::{
    ...
    UiSnapshotClientRegion, UiVisualCancellationPosture, UiVisualCancellationReceipt,
    UiVisualCapturePoll, UiVisualCaptureShutdownReport, UiVisualCoordinateScope,
    ...
    UiVisualPixelCaptureGrant, UiVisualSnapshotDisposalReceipt, UiVisualSnapshotIdentity,
    UiVisualSnapshotOutcome, UiVisualSnapshotReceipt, UiVisualTarget,

...
pub use crate::runtime::intent::{
    ...
    UiIntentConfirmationTimeBasisKind, UiIntentDraftInputRevision, UiIntentInoperableCause,
    UiIntentInoperableCauseIter, UiIntentInputBasisReceipt, UiIntentInputOwnerRevision,
    UiIntentMutabilityPosture, UiIntentOccupancyPosture, UiIntentOperabilityCost,
    UiIntentOperabilityDecision, UiIntentOperabilityOutcome, UiIntentOperabilityProof,
    UiIntentPayloadProjectionCost, UiIntentPayloadStop, UiIntentPolicyPosture,

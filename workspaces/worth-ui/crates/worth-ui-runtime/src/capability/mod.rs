...
pub use registry::{
    ...
    ThemeTokenValue, UiIntent, UiIntentAcceptedInteractions, UiIntentBoolean, UiIntentDefinition,
...
pub(crate) use registry::{
    ...
    UiIntentProjectedValue, UiSealedIntentPayload, ViewBindingAcceptedRegistrationProof,

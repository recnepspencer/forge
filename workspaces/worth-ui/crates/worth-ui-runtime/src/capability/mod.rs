...
pub use registry::{
    ...
    ComponentHitTestOrder, ComponentPortalChildContract, ComponentPropSchema,
    ...
    ComponentViewportRegion, FrozenCommandCapabilities, FrozenCommandProjectionCapabilities,
    FrozenCommandProjectionEntry, FrozenComponentCapabilities, FrozenIconCapabilities,
    FrozenIconEntry, FrozenIntentDefinitionCapabilities, FrozenMosaicPlacementCapabilities,

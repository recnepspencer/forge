...
pub use registry::{
    ...
    ComponentDescriptor, ComponentExecutionLane, ComponentFocusSupport, ComponentHitTestContract,
    ...
    ComponentRealtimeOverlayPriority, ComponentStateOwnership, ComponentStaticPaintContract,
    ComponentStaticPaintOrder, ComponentViewportInset, FrozenCommandCapabilities,

...
pub(crate) fn intrinsic_policy() -> UiDeclaredMeasurementPolicyPosture {
...
pub(crate) fn open_policy() -> UiDeclaredMeasurementPolicyPosture {
    UiDeclaredMeasurementPolicyPosture::new(
        Some(UiDeclaredMeasurementMode::HugHeight),
        None,
        None,
...
pub(crate) fn viewport_basis_policy(bounded: bool) -> UiDeclaredMeasurementPolicyPosture {
    ...
    .expect("viewport basis policy should admit")
}
...
fn control_spec(
    ...
    let spec = UiDslSemanticArtifactSpec::new(
        ...
        UiDslSourceProvenance::file_authored(
            "app/allocation_constraint_equal_share_tests.wui",
            declaration_index,
        ),
    )
...
pub(crate) fn graph_node_identity_for_provenance(
    ...
    let artifact = app
        ...
        .find(|artifact| {
            ...
            provenance.module_path() == "app/allocation_constraint_equal_share_tests.wui"

...
pub(crate) struct WorthUiArtifactEquivalenceMetrics {
    ...
    structural_entries_compared: usize,
    broad_scans: usize,
}
...
impl WorthUiArtifactEquivalenceMetrics {
    pub(crate) fn record_module_compared(&mut self) {
        ...
        self.structural_entries_compared += 1;
    }
    ...
    pub(crate) fn structural_entries_compared(self) -> usize {
        self.structural_entries_compared
    }

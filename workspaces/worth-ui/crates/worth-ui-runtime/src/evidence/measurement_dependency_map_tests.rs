...
use super::measurement_projection_variant_test_support::display_field_plus_entity_identity_projection_context;
...
use super::{
    admit_measurement_basis, MeasurementEvidenceInput, UiMeasurementDependencyLineageKind,
...
fn basis_dependency_map_preserves_typed_lineage_families() {
    ...
    let receipt = super::consume_declared_measurement_projection_facts(
...
fn unrelated_query_projection_facts_do_not_widen_measurement_neighborhood() {
    ...
    let baseline_receipt = super::consume_declared_measurement_projection_facts(
        declaration_identity.clone(),
        generation,
        &scroll_viewport_policy(),
    ...
    let expanded_receipt = super::consume_declared_measurement_projection_facts(
        declaration_identity.clone(),
        generation,
        &scroll_viewport_policy(),
...
fn entry_class(
    entries: &[super::measurement_dependency_map::UiMeasurementDependencyMapEntry],

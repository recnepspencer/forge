use crate::runtime::{planning_pair_for_certification_suite, WorthUiAllocationPlanning};
...
pub fn certify_allocation_neighborhood_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::AllocationNeighborhood)
}

pub fn certify_constraint_edge_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::ConstraintEdge)
}

pub fn certify_parent_child_propagation_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::ParentChildPropagation)
}

pub fn certify_intrinsic_return_flow_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::IntrinsicReturnFlow)
}

pub fn certify_sibling_negotiation_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::SiblingNegotiation)
}

pub fn certify_equal_share_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::EqualShare)
}

pub fn certify_bounded_reconciliation_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::BoundedReconciliation)
}

pub fn certify_special_input_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::SpecialInput)
}

pub fn certify_durable_resize_input_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::DurableResizeInput)
}

pub fn certify_plan_handoff_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::PlanHandoff)
}

pub fn certify_activation_boundary_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::ActivationBoundary)
}

pub fn certify_allocation_inspection_suite() -> UiAllocationPlanningCertificationReport {
    certify_suite_runner(UiAllocationPlanningCertificationSuiteKind::AllocationInspection)
}
...
fn certify_suite_runner(
    suite_kind: UiAllocationPlanningCertificationSuiteKind,
) -> UiAllocationPlanningCertificationReport {
    let (first, second) = planning_pair_for_certification_suite(suite_kind);
    certify_allocation_planning_suite(suite_kind, &first, &second)
}

fn suite_contract_satisfied(
    suite_kind: UiAllocationPlanningCertificationSuiteKind,

...
use super::{
    MeasurementEvidenceInput, UiMeasurementBasisGeneration, UiMeasurementDependencyLineage,
    UiMeasurementDependencyMap, UiMeasurementNeighborhoodClassHint, UiMeasurementResult,
...
pub(super) fn basis_identity_digest(
    ...
    generation_compatibility: &super::UiMeasurementGenerationCompatibility,
    denial_posture: Option<&super::UiMeasurementBasisDenial>,
) -> u64 {
...
fn compatibility_digest(compatibility: &super::UiMeasurementGenerationCompatibility) -> u64 {
    match compatibility {
        super::UiMeasurementGenerationCompatibility::Compatible => {
            stable_text_digest("compatibility:compatible")
        }
        super::UiMeasurementGenerationCompatibility::StaleQueryFactReceipt {
            expected,
            observed,
        } => {
        ...
        super::UiMeasurementGenerationCompatibility::StaleHostEvidence { expected, observed } => {
            stable_text_digest("compatibility:stale-host-evidence")
                ^ expected.as_u64().rotate_left(7)
                ^ observed.as_u64().rotate_left(13)
        }
        super::UiMeasurementGenerationCompatibility::StaleHostCapability { expected, observed } => {
            stable_text_digest("compatibility:stale-host-capability")
                ^ expected.as_u64().rotate_left(7)
                ^ observed.as_u64().rotate_left(13)
        }
        super::UiMeasurementGenerationCompatibility::IncompatibleWorld {
        ...
        super::UiMeasurementGenerationCompatibility::IncompatibleHostProfile {
...
fn denial_digest(denial_posture: Option<&super::UiMeasurementBasisDenial>) -> u64 {
    match denial_posture {
        None => stable_text_digest("denial:none"),
        Some(super::UiMeasurementBasisDenial::GenerationIncompatible { compatibility }) => {
            stable_text_digest("denial:generation-incompatible")
                ^ compatibility_digest(compatibility).rotate_left(7)
        }
        Some(super::UiMeasurementBasisDenial::MissingEvidence { slot }) => {
            stable_text_digest("denial:missing-evidence") ^ slot_digest(*slot).rotate_left(7)
        }
        Some(super::UiMeasurementBasisDenial::MissingBasisSourceEvidence {
            basis_source,
            slot,
        }) => {
        ...
        Some(super::UiMeasurementBasisDenial::MissingOwnershipEvidence {
            ownership_posture,
            slot,
        }) => {
        ...
        Some(super::UiMeasurementBasisDenial::MissingRequiredMeasurementEvidence {
            category,
            slot,
        }) => {
        ...
        Some(super::UiMeasurementBasisDenial::ConflictingEvidenceInputs { slot }) => {
...
fn slot_digest(slot: super::UiMeasurementEvidenceSlot) -> u64 {
    stable_text_digest(match slot {
        super::UiMeasurementEvidenceSlot::QueryProjectionFactReceipt => {
...
fn measurement_category_digest(category: super::UiMeasurementEvidenceCategory) -> u64 {
    stable_text_digest(match category {
        super::UiMeasurementEvidenceCategory::TextIntrinsicSize => "text-intrinsic-size",
        super::UiMeasurementEvidenceCategory::TextBaselineMetrics => "text-baseline-metrics",
        super::UiMeasurementEvidenceCategory::FontMetrics => "font-metrics",
        super::UiMeasurementEvidenceCategory::NativeControlIntrinsicSize => {
            "native-control-intrinsic-size"
        }
        super::UiMeasurementEvidenceCategory::ViewportExtent => "viewport-extent",
        super::UiMeasurementEvidenceCategory::DpiScaleFactor => "dpi-scale-factor",
        super::UiMeasurementEvidenceCategory::PortalAnchorRect => "portal-anchor-rect",
        super::UiMeasurementEvidenceCategory::ScrollContainerViewport => {

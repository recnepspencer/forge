...
impl WorthUiPlanTopologyAssembler {
    pub(crate) fn assemble_from_authority_with_lane_admission(
        ...
        let lane_admission = crate::runtime::lane_admission::WorthUiLaneAdmissionPlanner::admit(
            authority,
            authority
    ...
    pub(crate) fn assemble_successor_from_authority_with_lane_admission(
        ...
        let lane_admission =
            crate::runtime::lane_admission::WorthUiLaneAdmissionPlanner::admit_regional_successor(
                authority,
                authority
                    .candidate_application_authority()
                    .execution_lane_support(),

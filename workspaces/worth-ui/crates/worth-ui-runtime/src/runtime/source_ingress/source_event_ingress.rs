use crate::runtime::source_ingress::debounce::{
    WorthUiReloadDebounce, WorthUiSettledSourceSnapshot,
};
...
pub struct WorthUiSourceEventIngress {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthUiSourceEventIngressSession {
    provider: WorthUiSourceProvider,
    debounce: WorthUiReloadDebounce,
    hooks: Vec<WorthUiSourceIngressHook>,
    next_sequence: u64,
...
impl WorthUiSourceEventIngress {
    ...
    pub fn start(self) -> WorthUiSourceEventIngressSession {
        WorthUiSourceEventIngressSession {
...
impl WorthUiSourceEventIngressSession {
    pub fn ingest(
        &mut self,

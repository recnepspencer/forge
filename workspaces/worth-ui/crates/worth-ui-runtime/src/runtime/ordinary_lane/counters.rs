...
pub struct WorthUiOrdinaryLaneCounters {
    ...
    non_ordinary_claim_denial_count: usize,
    certification_failure_count: usize,
    denial_count: usize,
}

impl WorthUiOrdinaryLaneCounters {
    pub(crate) fn record_ordinary_plan_row(&mut self) {
        self.ordinary_plan_row_count += 1;
    }

    pub(crate) fn record_skipped_nonordinary_plan_row(&mut self) {
        self.skipped_nonordinary_plan_row_count += 1;
    }
    ...
    #[cfg(test)]
    pub(crate) fn record_registry_lookup(&mut self) {
        self.registry_lookup_count += 1;
    }

    #[cfg(test)]
    pub(crate) fn record_artifact_tree_scan(&mut self) {
        self.artifact_tree_scan_count += 1;
    }

    #[cfg(test)]
    pub(crate) fn record_full_plan_scan(&mut self) {
        self.full_plan_scan_count += 1;
    }

    #[cfg(test)]
    pub(crate) fn record_component_string_resolution(&mut self) {
        self.component_string_resolution_count += 1;
    }

    #[cfg(test)]
    pub(crate) fn record_command_string_resolution(&mut self) {
        self.command_string_resolution_count += 1;
    }

    #[cfg(test)]
    pub(crate) fn record_non_ordinary_claim_denial(&mut self) {
        self.non_ordinary_claim_denial_count += 1;
        self.record_denial();
    }
    ...
    pub(crate) fn merge_plan_counters(&mut self, plan_counters: Self) {
        self.ordinary_plan_row_count = plan_counters.ordinary_plan_row_count;
        self.skipped_nonordinary_plan_row_count = plan_counters.skipped_nonordinary_plan_row_count;
    }
    ...
    pub fn non_ordinary_claim_denial_count(self) -> usize {
        self.non_ordinary_claim_denial_count
    }

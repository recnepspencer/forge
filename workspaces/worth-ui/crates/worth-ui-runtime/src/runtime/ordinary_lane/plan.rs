...
pub struct WorthUiOrdinaryLanePlan {
    ...
    root_shell_slots: crate::runtime::plan_topology::WorthUiPlanRegionSlotSetView<1>,
...
pub(crate) struct WorthUiOrdinaryLanePlanInput {
    ...
    pub root_shell_slots: crate::runtime::plan_topology::WorthUiPlanRegionSlotSetView<1>,
...
impl WorthUiOrdinaryLanePlan {
    ...
    pub(crate) fn root_shell_slots(
        &self,
    ) -> &crate::runtime::plan_topology::WorthUiPlanRegionSlotSetView<1> {

use crate::runtime::{
    WorthUiHudNode, WorthUiRealtimeCertification, WorthUiRuntimeHandleAllocationReceipt,
};
...
pub struct WorthUiHudPlan {
    ...
    realtime_slots: crate::runtime::planning::plan_topology::WorthUiPlanRegionSlotSetView<1>,
}
...
pub(crate) struct WorthUiHudPlanInput {
    ...
    pub realtime_slots: crate::runtime::planning::plan_topology::WorthUiPlanRegionSlotSetView<1>,
}

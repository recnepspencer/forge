...
pub(crate) enum WorthUiExecutionPlanLoweringAuthorityDenial {
    ...
    RegionalDelta(crate::runtime::plan_topology::WorthUiPlanRegionDeltaDenial),
...
enum WorthUiExecutionPlanLoweringSource {
    Launch(crate::runtime::allocation_planning::WorthUiInitialAllocationCommit),
    Replacement {
...
pub(crate) struct WorthUiExecutionPlanLoweringFacts {
    ...
    region_delta: Option<crate::runtime::plan_topology::WorthUiPlanRegionDelta>,
    #[cfg(test)]
...
impl WorthUiExecutionPlanLoweringAuthority {
    ...
    fn seal_successor(
        ...
        let region_delta = crate::runtime::plan_topology::WorthUiPlanRegionDelta::from_replacement(
...
impl WorthUiExecutionPlanLoweringFacts {
    ...
    pub(crate) fn region_delta(
        &self,
    ) -> Option<&crate::runtime::plan_topology::WorthUiPlanRegionDelta> {

use crate::runtime::host_observation::diagnostics::mapping::activation::{
    diagnostic_for_activation_gate, diagnostic_for_activation_staging,
    diagnostic_for_reconciliation,
};
use crate::runtime::host_observation::diagnostics::mapping::lane::diagnostic_for_lane_admission;
use crate::runtime::host_observation::diagnostics::mapping::plan::{
    diagnostic_for_plan_inspection, diagnostic_for_plan_lowering,
};
use crate::runtime::host_observation::diagnostics::mapping::projection::diagnostic_for_projection_hook;
use crate::runtime::host_observation::diagnostics::mapping::query::{
    diagnostic_for_query_live_rebind, diagnostic_for_query_recovery,
};
use crate::runtime::host_observation::diagnostics::mapping::reload::diagnostic_for_reload_failure;
use crate::runtime::host_observation::diagnostics::mapping::replacement::{
...
use crate::runtime::host_observation::diagnostics::mapping::swap::diagnostic_for_committed_allocation_denial;

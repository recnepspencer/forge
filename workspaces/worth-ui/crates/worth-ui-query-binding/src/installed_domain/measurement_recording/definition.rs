use worth_foundational::facade::{AspectContractRevision, AspectKey, AspectMask, ProjectionMask};
...
> {
    ...
    semantics.native_projection = domain::WorthQueryOperationNativeProjectionContract {
        aspect_key: AspectKey::new("measurement").expect("static aspect key must admit"),
        aspect_identity: native_aspect_contracts::MEASUREMENT_ASPECT_IDENTITY,

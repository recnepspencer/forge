use worth_ui::facade::{
    ...
    WorthUiViewBindingHandle, WorthUiVisibleRange, WorthUiVisibleRangeDenial,
    WorthUiVisibleRangeDenialReason,
};

fn accepts_virtualized_data_lane_types(
    _posture: Option<WorthUiQueryPatchPosture>,
...
fn main() {
    ...
    let _ = WorthUiVirtualizedDataFrameDenialReason::OffsetPaginationSubstitute;

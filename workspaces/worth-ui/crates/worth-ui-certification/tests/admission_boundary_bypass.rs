...
use worth_ui_certification::topology::certify_consumers_route_admission_through_worth_ui_facade;
...
#[test]
fn anti_bypass_certification_rejects_hostile_admission_consumer_fixture() {
    ...
    assert_fixture_violation(
        &violations,
        "fake-admission-consumer-direct-alias\\Cargo.toml",
        "depends on `worth-ui-runtime` directly",
    );
    assert_fixture_violation(
        &violations,
        "fake-admission-consumer-direct-alias\\src\\lib.rs",
        "must enter through `worth_ui::facade::admission`",
    );
    assert_fixture_violation(
        &violations,
        "fake-admission-consumer-extern-alias\\Cargo.toml",
        "depends on `worth-ui-runtime` directly",
    );
    assert_fixture_violation(
        &violations,
        "fake-admission-consumer-extern-alias\\src\\lib.rs",
        "must enter through `worth_ui::facade::admission`",
    );
}

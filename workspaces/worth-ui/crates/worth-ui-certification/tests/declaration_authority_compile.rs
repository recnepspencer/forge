...
fn declaration_authority_compile_failures_prevent_forged_artifacts_and_receipts() {
    ...
    tests.compile_fail("tests/ui/declaration/external_callers_cannot_construct_semantic_artifact.rs");
    tests.compile_fail("tests/ui/declaration/external_callers_cannot_mint_dsl_lowering_receipt.rs");
    tests.compile_fail("tests/ui/declaration/external_callers_cannot_seed_dsl_package_with_semantic_artifact.rs");

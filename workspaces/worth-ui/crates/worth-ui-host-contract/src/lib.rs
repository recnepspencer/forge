...
pub use mounted_frame::{
    ...
    UiHostSurfaceRegistrationRequest, UiHostSurfaceStopReason, UiMountIncarnation,
    UiMountedCompletedEffects, UiMountedContentGeneration, UiMountedContractIdentityExhaustion,
    UiMountedEffectFamily, UiMountedFrameCanonicalCore, UiMountedFrameConsumptionInput,
    UiMountedFrameConsumptionView, UiMountedFrameIdentity, UiMountedFrameIntegrity,
    UiMountedFrameManifest, UiMountedFrameSchemaVersion, UiMountedInstanceIdentity,
    UiMountedLaneParticipation, UiMountedLogicalDamage, UiMountedNodeReceiptAffinity,
    UiMountedNodeReceiptIdentity, UiMountedNodeReceiptIssuer, UiMountedPaintCommand,
    UiMountedPaintCommandChange, UiMountedPaintCommandIdentity, UiMountedPaintOrderEdit,
    UiMountedPaintOrderIdentity, UiMountedPaintOrderIntegrity, UiMountedPresentationAffinity,
    ...
    UiMountedPresentationReconstructionInput, UiMountedPresentationSchemaVersion,

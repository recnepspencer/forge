use worth_ui_host_contract::{
    ...
    UiMountedInstanceIdentity, UiMountedNodeReceiptIdentity, UiMountedPaintCommandIdentity,
    UiMountedRgba8, UiMountedStaticPaintSchemaVersion, UiSemanticSurfaceIdentity,
...
pub(crate) struct UiHeadlessFilledRectMechanicInput {
...
impl UiHeadlessFilledRectMechanic {
    pub(crate) const fn new(input: UiHeadlessFilledRectMechanicInput) -> Self {
        Self {

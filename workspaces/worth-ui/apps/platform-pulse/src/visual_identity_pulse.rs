...
pub const PLATFORM_PULSE_CANONICAL_LOGICAL_EXTENT: [u32; 2] = [960, 600];
pub const PLATFORM_PULSE_PRODUCT_LOGICAL_EXTENT: [u32; 2] = [960, 600];
pub const PLATFORM_PULSE_BACKGROUND_LOGICAL_POINT: [u32; 2] = [8, 8];
pub const PLATFORM_PULSE_TARGET_LOGICAL_POINT: [u32; 2] = [304, 424];
pub const PLATFORM_PULSE_MAXIMUM_CAPTURE_SCALE: u32 = 4;
pub const PLATFORM_PULSE_MAXIMUM_PIXEL_BYTES: u64 = 50_176_000;

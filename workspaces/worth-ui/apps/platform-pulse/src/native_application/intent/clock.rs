...
pub(in crate::native_application) struct PlatformPulseIntentClock {
    origin: Instant,
    last_tick: u64,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::native_application) enum PlatformPulseIntentClockDenial {
    Regressed,
    TickExhausted,
...
impl PlatformPulseIntentClock {
    pub(in crate::native_application) fn new() -> Self {

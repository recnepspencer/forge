...
use worth_store_tiering::admit_s7_placement_io_readiness_seed;
...
pub(in crate::harness_execution) fn placement_readiness(
    ...
    admit_s7_placement_io_readiness_seed(
        handoff,
        worth_store_tiering::S6ColdTierIoPosture::from_reclaim_receipt(cold_tier_reclaim_receipt(
            security_scope,
        ))
...
fn admitted_security_scope_for_identity(
    ...
    match admit_store_security_scope(StoreSecurityScopeAdmissionRequest::new(
        ...
        worth_proof::TransitionOutcome::Success(scope) => scope,

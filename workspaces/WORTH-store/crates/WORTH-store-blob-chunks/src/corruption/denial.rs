...
pub enum WORTHableCorruptionEvidenceKind {
...
pub enum BlobCorruptionDenial {
    ...
    WORTHableCorruptionEvidenceRejected {
        evidence_kind: WORTHableCorruptionEvidenceKind,
    },
...
pub const fn reject_chunk_integrity_report_as_blob_corruption_authority<T>(
    ...
    BlobCorruptionDenial::WORTHableCorruptionEvidenceRejected {
        evidence_kind: WORTHableCorruptionEvidenceKind::ChunkIntegrityReport,
    }
}
...
pub const fn reject_physical_quarantine_record_as_blob_corruption_authority<T>(
    ...
    BlobCorruptionDenial::WORTHableCorruptionEvidenceRejected {
        evidence_kind: WORTHableCorruptionEvidenceKind::PhysicalQuarantineRecord,
    }
}

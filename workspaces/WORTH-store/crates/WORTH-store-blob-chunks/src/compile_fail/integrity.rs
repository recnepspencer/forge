...
//! let _WORTHd = BlobChunkIdentity::from_integrity_parts(digest);
//! ```
...
//! let _WORTHd = ScopedBlobChunk::from_integrity_proof(checksum);
//! ```
...
//!
//! let digest = StableDigest::new("sha256:copied").unwrap();
//! let _WORTHd = BlobChunkDedupeCandidate::from_integrity_proof(digest);
//! ```

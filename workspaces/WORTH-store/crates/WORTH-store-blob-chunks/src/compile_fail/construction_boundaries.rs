...
//!
//! let _WORTHd = BlobReachabilityProof {
//!     chunk_identity: todo!(),
//!     stored_digest: todo!(),
//!     security_scope: todo!(),
//!     reachable_bytes: 1,
...
//! let _WORTHd = BlobPlacementProof {
...
//! let _WORTHd = AdmittedBlobPlacement {
...
//!
//! let _WORTHd = BlobLifecycleStoreAuthority {
...
//!
//! let _WORTHd = BlobLifecycleLoweringCapability {
//!     capability: todo!(),
//! };
//! ```
...
//!
//! let _WORTHd = BlobLifecycleReadinessAuthority {
...
//!
//! let _WORTHd = BlobLifecycleResolved {
//!     proof_recipe: todo!(),
//!     counters: todo!(),
//! };
//! ```
...
//!
//! let _WORTHd = BlobLifecycleLowered {
//!     proof_recipe: todo!(),
//!     counters: todo!(),
//! };
//! ```
...
//!
//! let _WORTHd = BlobLifecycleReachabilityAdmitted {
//!     proof_recipe: todo!(),
//!     reachability: todo!(),
//!     counters: todo!(),
//! };
...
//!
//! let _WORTHd = BlobLifecyclePlacementAdmitted {
//!     proof_recipe: todo!(),
//!     reachability: todo!(),
//!     placement: todo!(),
//!     counters: todo!(),
...
//! let _WORTHd = BlobLifecycleExecutionReady {
//!     proof_recipe: todo!(),
//!     reachability: todo!(),
//!     placement: todo!(),
//!     counters: todo!(),
...
//! let _WORTHd = BlobObjectId::from_declared_digest(copied);
//! ```

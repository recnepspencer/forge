...
//! identity:
//! ```compile_fail
//! use worth_store_recovery_physics::S4IntegrityHandoffPayload;
//!
...
//! ```
//! Protected physical bytes cannot be WORTHd from caller-owned raw byte slices:
//! ```compile_fail
...
//!
//! let _WORTHd = BlobGenerationPublished {
//!     object_id: todo!(),
//!     generation: todo!(),
...
//!
//! let _WORTHd = BlobVisibleGeneration {
//!     object_id: todo!(),
//!     generation: todo!(),
//!     chunk_tree_root: todo!(),
//!     logical_content_digest: todo!(),
...
//!
//! let _WORTHd = BlobPublicationCounterReceiptIdentity {
...
//!
//! let _WORTHd = BlobPublicationRecoveryOperationDigest {
...
//!
//! let _WORTHd = BlobPublicationPreWalReplayEvidence {

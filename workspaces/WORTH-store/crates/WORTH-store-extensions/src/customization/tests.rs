...
fn phase_nine_extensions_targets_own_capability_and_workload_semantics() {
    ...
    assert_eq!(
        ...
        TransitionOutcome::Denied(FutureLayoutCustomizationDenial::StoreDenied(
            worth_store_layout_indexes::S8FutureLayoutCustomizationDenial::NoStrategySupportsRequestedCapability {
    ...
    assert_eq!(
        ...
        TransitionOutcome::Denied(FutureLayoutCustomizationDenial::StoreDenied(
            worth_store_layout_indexes::S8FutureLayoutCustomizationDenial::RebuildableProjectionNotYetSupported {
                key_domain: page_domain,
            }
        ))
    );

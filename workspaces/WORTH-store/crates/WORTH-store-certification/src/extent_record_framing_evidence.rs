...
fn contract_name() -> worth_foundational::FoundationalPerformanceContractName {
    worth_foundational::FoundationalPerformanceContractName::new("physical.extent_record_locate")

...
fn slot_cell(
    value: u16,
) -> Result<worth_store_physical_format::SlotGenerationCell, PhysicalSubstrateCertificationDenial> {
...
fn extent_cell(
    value: u64,
) -> Result<worth_store_physical_format::ExtentGenerationCell, PhysicalSubstrateCertificationDenial>
{
    Ok(PhysicalGenerationAuthority::s1()

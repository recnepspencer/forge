...
fn public_authority_source_paths() -> Vec<&'static str> {
    vec![
        ...
        "workspaces/worth-store/crates/worth-store-aspect-native/src/authoritative_state.rs",
        "workspaces/worth-store/crates/worth-store-aspect-native/src/authoritative_patch.rs",

...
fn mismatched_counters(
    counters: worth_store_io_scheduler::IoSchedulerS6CounterSnapshot,
) -> worth_store_io_scheduler::IoSchedulerS6CounterSnapshot {
...
fn backend_admission() -> worth_store_io_scheduler::IoSchedulerBackendCapabilityAdmission {
...
fn s6_readiness() -> worth_store_io_scheduler::IoSchedulerS6ReadinessAdmission {

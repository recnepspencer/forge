...
impl FullLayoutFixture {
    fn new(root_reference: u64) -> Self {
        ...
        let root = worth_store_physical_format::PhysicalManifestUniverseBuilder::s1(root_cell)
...
fn header_bytes(
    ...
    bytes.extend_from_slice(
        &byte_order
            .write_u16(worth_store_physical_format::PhysicalFormatVersion::s1_initial().value()),
    );

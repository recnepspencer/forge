...
fn cause_tag(cause: S6PostAdmissionViolationCause) -> u64 {
    match cause {
        S6PostAdmissionViolationCause::QueueExecution(cause) => match cause {
            worth_store_io_scheduler::queue_execution::QueueExecutionViolationCause::BackendContradictedWitness => 11,
            worth_store_io_scheduler::queue_execution::QueueExecutionViolationCause::ExecutionReclassifiedWork => 12,
        },
        S6PostAdmissionViolationCause::BackgroundPacing(kind) => match kind {
            worth_store_io_scheduler::BackgroundDebtKind::CompactionDebt => 21,
            worth_store_io_scheduler::BackgroundDebtKind::CheckpointFlushDebt => 22,
            worth_store_io_scheduler::BackgroundDebtKind::ScrubPressure => 23,
            worth_store_io_scheduler::BackgroundDebtKind::ReplicationPrepPressure => 24,
            worth_store_io_scheduler::BackgroundDebtKind::BlobContention => 25,
            worth_store_io_scheduler::BackgroundDebtKind::BackupPressure => 26,
            worth_store_io_scheduler::BackgroundDebtKind::RepairPressure => 27,
        },

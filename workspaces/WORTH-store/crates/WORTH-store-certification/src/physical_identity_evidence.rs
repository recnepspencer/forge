...
use worth_store_physical_format::PhysicalReferenceValidationCounterSnapshot;
...
pub enum PhysicalIdentityEvidenceRow {
    ...
    WORTHdReferenceConstructionRejected,
    WORTHdAdmissionWitnessRejected,
}
...
impl PhysicalIdentityEvidenceRow {
    pub const fn s1_required() -> [Self; 12] {
        [
            ...
            Self::WORTHdReferenceConstructionRejected,
            Self::WORTHdAdmissionWitnessRejected,
        ]
    }
    ...
    pub const fn physical_substrate_lane(self) -> PhysicalSubstrateLane {
        match self {
            ...
            | Self::StaleRootPublicationReferenceDeniedBeforeDecode
            | Self::WORTHdReferenceConstructionRejected
            | Self::WORTHdAdmissionWitnessRejected => PhysicalSubstrateLane::HostileReference,
        }
    }
}
...
mod tests {
    ...
    fn stale_identity_evidence_rejects_declaration_without_stale_counter() {
        let counters = worth_store_physical_format::PhysicalReferenceValidationCounterSnapshot::for_page_slot_attempt()

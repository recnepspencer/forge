...
pub(crate) fn s5_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {
    named_s5_scenario("store.physical.s45.phase8.counter-strength")
}

fn named_s5_scenario(name: &str) -> worth_store_physical_certification::CertifiedPhysicalScenario {
...
pub(crate) fn shortcut_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {
...
pub(crate) fn s5_shortcut_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario
{

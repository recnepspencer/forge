...
fn cleaned_phase_boundaries_stay_under_declared_file_count_caps() {
    ...
    for boundary in [
        DirectoryBoundary::new("workspaces/worth-store/crates/worth-store-blob-chunks/src", 1),
        DirectoryBoundary::new("workspaces/worth-store/crates/worth-store-physical-format/src", 1),
        DirectoryBoundary::new(
            "workspaces/worth-store/crates/worth-store-recovery-physics/src/s4_integrity_handoff_payload",
            4,
        ),
        DirectoryBoundary::new("workspaces/worth-store/crates/worth-store-test-support/src", 10),
        DirectoryBoundary::new("workspaces/worth-store/crates/worth-store-layout-indexes/src", 3),
    ] {
...
fn aggregation_files_remain_aggregation_only() {
    ...
    for relative_path in [
        ...
        "workspaces/worth-store/crates/worth-store-recovery-physics/src/s4_integrity_handoff_payload/mod.rs",
        "workspaces/worth-store/crates/worth-store-test-support/src/lib.rs",
        "workspaces/worth-store/crates/worth-store-layout-indexes/src/lib.rs",
    ] {
...
fn facade_visibility_stays_narrow_at_closeout() {
    let repo_root = repo_root();
    assert_public_mods(
        &repo_root.join("workspaces/worth-store/crates/worth-store-blob-chunks/src/lib.rs"),
        &[
    ...
    assert_public_mods(
        &repo_root.join("workspaces/worth-store/crates/worth-store-layout-indexes/src/lib.rs"),
        &[],
    );
}

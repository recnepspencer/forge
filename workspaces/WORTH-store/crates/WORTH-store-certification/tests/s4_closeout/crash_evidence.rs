use worth_store_certification::{RecoveryPhysicsCrashLane, RecoveryPhysicsCrashMatrix};
...
use worth_store_test_support::{ExecutedS4CrashHarnessTranscript, FreshRuntimeRecoveryDriver};
...
fn fresh_runtime_evidence(
    ...
    let artifacts = worth_store_test_support::deterministic_s4_recovery_artifacts();

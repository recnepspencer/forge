...
use worth_store_physical_certification::QualificationMatrixPublisher;
...
fn from_parts_with_access_policy(
    witness: AdmittedBackendCapabilityWitness,
    access_rows: Vec<worth_store_certification::S6AccessPolicyEvidenceRow>,
) -> Result<StoreOwnedS6CertificationMaterializationSources, S6CertificationMaterializationDenial> {
...
fn from_parts_with_later_handoffs(
    witness: AdmittedBackendCapabilityWitness,
    later: worth_store_certification::S6LaterReadinessHandoffCertification,
) -> Result<StoreOwnedS6CertificationMaterializationSources, S6CertificationMaterializationDenial> {
...
fn from_parts_with_qualification(
    witness: AdmittedBackendCapabilityWitness,
    qualification: worth_store_certification::S6BackendQualificationMatrixCertification,
) -> Result<StoreOwnedS6CertificationMaterializationSources, S6CertificationMaterializationDenial> {
    from_parts_full(
        witness,
...
fn qualification_for_harness(
    harness: &worth_store_physical_certification::S6IoPressureHarnessEvidence,
) -> worth_store_certification::S6BackendQualificationMatrixCertification {
    certify_s6_backend_qualification_matrix(
...
fn later_handoffs_for_operator_backend(
    witness: &AdmittedBackendCapabilityWitness,
) -> worth_store_certification::S6LaterReadinessHandoffCertification {

#[test]
fn phase_14_closeout_boundaries_reject_public_WORTHry() {
...
fn compile_fail_cases() -> Vec<CompileFailCase> {
    vec![
        ...
        live_case(
            "s7_handoff_cannot_satisfy_backup_export_seed.rs",
            &[
                "expected `S6ClosedS10BackupExportAdmissionSeed`",
                "found `S6ClosedS7PlacementAdmissionSeed`",
            ],
        ),
        live_case(
            "s7_handoff_cannot_satisfy_s10_repair_seed.rs",
            &[
                "expected `S6ClosedS10RepairAdmissionSeed`",
                "found `S6ClosedS7PlacementAdmissionSeed`",
            ],
        ),
        live_case(
            "s7_handoff_cannot_satisfy_s11_secure_io_seed.rs",
            &[
                "expected `S6ClosedS11SecureIoFoundationAdmissionSeed`",
                "found `S6ClosedS7PlacementAdmissionSeed`",
            ],
        ),
        live_case(
            "s10_backup_export_handoff_cannot_satisfy_s7_seed.rs",
            &[
                "expected `S6ClosedS7PlacementAdmissionSeed`",
                "found `S6ClosedS10BackupExportAdmissionSeed`",
            ],
        ),
        live_case(
            "s10_backup_export_handoff_cannot_satisfy_s10_repair_seed.rs",
            &[
                "expected `S6ClosedS10RepairAdmissionSeed`",
                "found `S6ClosedS10BackupExportAdmissionSeed`",
            ],
        ...
        live_case(
            "s10_backup_export_handoff_cannot_satisfy_s11_secure_io_seed.rs",
            &[
                "expected `S6ClosedS11SecureIoFoundationAdmissionSeed`",
                "found `S6ClosedS10BackupExportAdmissionSeed`",
            ],
        ...
        live_case(
            "s10_repair_handoff_cannot_satisfy_s7_seed.rs",
            &[
                "expected `S6ClosedS7PlacementAdmissionSeed`",
                "found `S6ClosedS10RepairAdmissionSeed`",
            ],
        ),
        live_case(
            "s10_repair_handoff_cannot_satisfy_s10_backup_export_seed.rs",
            &[
                "expected `S6ClosedS10BackupExportAdmissionSeed`",
                "found `S6ClosedS10RepairAdmissionSeed`",
            ],
        ...
        live_case(
            "s10_repair_handoff_cannot_satisfy_s11_secure_io_seed.rs",
            &[
                "expected `S6ClosedS11SecureIoFoundationAdmissionSeed`",
                "found `S6ClosedS10RepairAdmissionSeed`",
            ],
        ...
        live_case(
            "s11_secure_io_handoff_cannot_satisfy_s7_seed.rs",
            &[
                "expected `S6ClosedS7PlacementAdmissionSeed`",
                "found `S6ClosedS11SecureIoFoundationAdmissionSeed`",
            ],
        ),
        live_case(
            "s11_secure_io_handoff_cannot_satisfy_s10_backup_export_seed.rs",
            &[
                "expected `S6ClosedS10BackupExportAdmissionSeed`",
                "found `S6ClosedS11SecureIoFoundationAdmissionSeed`",
            ],
        ...
        live_case(
            "s11_secure_io_handoff_cannot_satisfy_s10_repair_seed.rs",
            &[
                "expected `S6ClosedS10RepairAdmissionSeed`",
                "found `S6ClosedS11SecureIoFoundationAdmissionSeed`",
            ],

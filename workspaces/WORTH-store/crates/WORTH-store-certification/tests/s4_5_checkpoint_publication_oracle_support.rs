...
#[path = "s4_5_checkpoint_publication_evidence_support.rs"]
...
fn checkpoint_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {
...
fn checkpoint_shortcut_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {

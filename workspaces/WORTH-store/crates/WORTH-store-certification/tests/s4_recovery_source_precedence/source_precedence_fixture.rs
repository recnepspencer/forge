...
pub(crate) fn s3_integrity_readiness() -> worth_store_readiness::S3PhysicalIntegrityReadiness {
...
pub(crate) fn wal_tail_quarantine_record() -> worth_store_physical_integrity::QuarantineRecord {

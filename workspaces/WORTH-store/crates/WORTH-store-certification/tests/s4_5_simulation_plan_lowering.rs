...
fn mismatched_scenario_meaning_denies_instead_of_defaulting_to_s5_shape() {
    ...
    assert_eq!(
        ...
        SimulationPlanDenial::UnsupportedScenarioShape {
            ...
            expectation: worth_store_physical_certification::PhysicalScenarioExpectationKind::S5ReadinessShapeProbe,
        }
    );
}
...
fn s4_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {
...
fn mismatched_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {
...
fn shortcut_scenario() -> worth_store_physical_certification::CertifiedPhysicalScenario {

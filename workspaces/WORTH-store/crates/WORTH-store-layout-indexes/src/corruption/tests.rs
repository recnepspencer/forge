...
fn materialization_states_keep_not_found_stale_and_quarantine_distinct() {
    ...
    let quarantined = crate::facade::access_planning()
        .quarantined_wal_lsn_coverage(
            layout_declarations().seed_family(),
            worth_store_recovery_physics::LogSequenceNumber::new(21),
            worth_store_recovery_physics::LogSequenceNumber::new(24),
            worth_store_recovery_physics::CheckpointCoveredLsnRange::new(
                worth_store_recovery_physics::LogSequenceNumber::new(22),
                worth_store_recovery_physics::LogSequenceNumber::new(23),
            )
            .unwrap(),
        )
        .unwrap();

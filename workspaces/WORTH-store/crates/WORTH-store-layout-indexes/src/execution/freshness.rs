use worth_proof::raw::{AuthorityMarker, AuthorityWitness, CapabilityMarker, CapabilityWitness};

use crate::execution::{S8AccessLoweringBasis, S8AccessPathCounterSnapshot};

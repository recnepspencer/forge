use worth_store_budgets::{CounterEvidenceStrength, S8PreExecutionPlanBinding};
use worth_store_physical_format::layout_access::baseline_btree_counter_observation::{
...
mod private {
    ...
    impl Sealed for worth_store_physical_format::layout_access::baseline_btree_counter_observation::BaselineBTreeLookupExecution {}
    impl Sealed for worth_store_physical_format::layout_access::baseline_btree_counter_observation::BaselineBTreeRootPublicationExecution {}
    impl Sealed for worth_store_physical_format::layout_access::baseline_btree_counter_observation::BaselineBTreeReplayRecoveryExecution {}
}

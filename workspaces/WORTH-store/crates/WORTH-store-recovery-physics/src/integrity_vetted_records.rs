...
pub struct IntegrityVettedPageFrameRecord {
    ...
    counters: worth_store_physical_integrity::ContainerIntegrityCounters,
    receipt: RecoveryIntegrityHandoffReceipt,
}
...
impl IntegrityVettedPageFrameRecord {
    ...
    pub const fn counters(&self) -> worth_store_physical_integrity::ContainerIntegrityCounters {
        self.counters
    }
...
fn authority_basis_denial(
    _: worth_store_physical_integrity::PhysicalIntegrityEvidenceDenial,

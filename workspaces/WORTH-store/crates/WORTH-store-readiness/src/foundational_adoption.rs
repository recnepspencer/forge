...
impl FoundationalAdoptionFamily {
    pub const fn public_lane(self) -> &'static str {
        match self {
            Self::Canonicalization => "worth_foundational::canonicalization_api::lower_lane",
            Self::Diagnostics => "worth_foundational::facade::FoundationalDiagnostic*",
            Self::Profiles => "worth_foundational::profiles_api::lower_lane",
            Self::BoundaryEvidence => "worth_foundational::boundary_evidence_api::lower_lane",
            Self::ProvenanceReceipts => "worth_foundational::boundary_evidence_api::lower_lane",
            Self::Performance => "worth_foundational::performance_api::lower_lane",
        }
    }

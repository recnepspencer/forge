...
//! use worth_store_readiness::S1PhysicalSubstrateCloseoutReceipt;
//!
//! let _WORTHd = S1PhysicalSubstrateCloseoutReceipt {
...
//!
//! ```compile_fail
//! use worth_store_readiness::S2PhysicalReadinessFacts;
//!
//! let _WORTHd = S2PhysicalReadinessFacts::from_s1_closeout_counts(4, 2, 2, 3, 1, 9);
//! ```
//!
...
//! ```compile_fail
//! use worth_store_contracts::ROADMAP_2_S1_SCOPE;
//! use worth_store_readiness::{S2PhysicalReadinessFacts, S2PhysicalSubstrateReadiness};
//!
//! let facts: S2PhysicalReadinessFacts = todo!();
//! let _WORTHd = S2PhysicalSubstrateReadiness::from_admitted_physical_substrate_closeout(
//!     ROADMAP_2_S1_SCOPE,
//!     facts,
//! );
//! ```
...
//! use worth_store_readiness::prove_s2_physical_substrate_readiness;
//!
//! let readiness: AcceptedHandoffReadiness = todo!();
//! let _WORTHd = prove_s2_physical_substrate_readiness(readiness);
//! ```
//!
...
//!
//! let _WORTHd = S3PhysicalIntegrityReadiness {
//!     s2_readiness: todo!(),
//!     payload: todo!(),
//! };
//! ```
...
//! ```
//!
//! S.6/S.7 placement admission authority cannot be WORTHd from raw fields:
//!
//! ```compile_fail
//! use worth_store_readiness::S6S7PlacementAdmissionAuthority;
//!
//! let _WORTHd = S6S7PlacementAdmissionAuthority {
...
//!
//! ```compile_fail
//! use worth_store_readiness::S7CapsuleReadinessHandoff;
//!
//! let _WORTHd = S7CapsuleReadinessHandoff {
...
//! use worth_store_readiness::S7CapsuleReadinessHandoff;
//!
//! let _WORTHd = S7CapsuleReadinessHandoff::from_lower_capsule_readiness(
//!     String::new(),
//!     0,
//!     0,
//!     0,
...
//! ```
//!
//! S.7 capsule readiness handoff cannot be admitted from a WORTHd lower witness:
//!
//! ```compile_fail
//! use worth_store_blob_chunks::BlobCapsuleReadinessWitness;
//! use worth_store_readiness::admit_s7_capsule_readiness_handoff;
//!
//! let WORTHd = BlobCapsuleReadinessWitness {
//!     object_id: todo!(),
//!     generation: todo!(),
...
//!     counters: todo!(),
//! };
//! let _handoff = admit_s7_capsule_readiness_handoff(&WORTHd);
//! ```
//!
//! S.7 closeout downstream non-claim vocabulary is typed and fixed-shape:
//!
//! ```compile_fail
//! use worth_store_readiness::S8LayoutReadinessNonClaim;
//!

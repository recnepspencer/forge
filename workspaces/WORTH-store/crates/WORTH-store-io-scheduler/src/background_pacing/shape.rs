...
impl BackgroundIoPressureShape {
    ...
    pub const fn from_physical_isolation_pressure(
        ...
        match pressure {
            worth_store_physical_isolation::PhysicalIsolationBackgroundPressureKind::CompactionRewrite => {
                Self::compaction_rewrite()
            }
            worth_store_physical_isolation::PhysicalIsolationBackgroundPressureKind::CheckpointFlush => {
                Self::checkpoint_flush()
            }
            worth_store_physical_isolation::PhysicalIsolationBackgroundPressureKind::ScrubScan => {
                Self::scrub_scan()
            }
        }
    }

use worth_query_declaration::facade::authoring::{AuthoringError, RelationName};
...
impl RelationshipProofDescriptor {
    ...
    pub fn host_callback_forbidden(callback_label: impl Into<String>) -> Self {
        Self::HostCallbackForbidden {
            callback_label: callback_label.into(),
        }
    }

    pub fn topology_width(&self) -> Option<usize> {
        match self {

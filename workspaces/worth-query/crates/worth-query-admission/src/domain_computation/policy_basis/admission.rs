...
use super::super::tenant_basis::{
    admit_tenant_bases as admit_tenant_bases_inner, SchemaVariantSnapshot, TenantBasisCounters,
    TenantBindingSnapshot, TenantSchemaBasis, TenantTruthBasis,
};
use super::artifacts::policy_basis_identity;
...
pub fn admit_policy_tenant_context_for_query_identity(
...
fn admit_tenant_bases(
    tenant: &TenantBindingSnapshot,
    schema: &SchemaVariantSnapshot,
) -> Result<(TenantTruthBasis, TenantSchemaBasis, TenantBasisCounters), PolicyTenantAdmissionError>
{

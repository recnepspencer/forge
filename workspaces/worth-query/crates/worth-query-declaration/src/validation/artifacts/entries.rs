...
impl ValidatedProjectionEntry {
    ...
    pub fn from_canonical(entry: &CanonicalProjectionEntry, field_kind: ScalarAspectType) -> Self {
        Self {
...
impl ValidatedTraversalEntry {
    ...
    pub fn from_canonical(entry: &CanonicalTraversalEntry, max_depth: u8) -> Self {
        Self {
...
impl ValidatedResultShapeBinding {
    ...
    pub fn binding_proof(
        &self,
        binding_index: usize,
    ) -> Option<crate::view_declaration::QueryResultBindingProof> {
        crate::view_declaration::QueryResultBindingProof::from_validated_binding(
            self,
            binding_index,
        )
    }

    pub fn from_canonical(field: &CanonicalResultField, field_kind: ScalarAspectType) -> Self {
        Self {

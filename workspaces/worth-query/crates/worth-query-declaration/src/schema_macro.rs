...
macro_rules! worth_query_schema {
    (
        ...
        impl $crate::facade::typed::TypedSchemaRoot for $Schema {
            const ROOT_ENTITY: &'static str = $root;
        }

        impl $Schema {
            pub fn schema_view() -> $crate::facade::typed::QuerySchemaView {
                $crate::facade::typed::QuerySchemaView::new(
                    stringify!($Schema),
                    [
                        $(
                    ...
                    [
                        $(
                            $crate::facade::typed::SchemaRelationView::new(
        ...
        $(
            ...
            impl $crate::facade::typed::TypedSchemaField for $Field {
                type Schema = $Schema;
        ...
        $(
            ...
            impl $crate::facade::typed::TypedTraversalRelation for $Relation {
                type Schema = $Schema;
    ...
    (@schema_field $aspect:literal, $field:literal, $kind:ident, [ $($caps:tt)* ]) => {
        $crate::worth_query_schema!(
            @apply_schema_caps
            $crate::facade::typed::SchemaFieldView::new(
                ...
                $crate::facade::typed::ScalarAspectType::$kind
            ),
            [ $($caps)* ]
        )
    };
    ...
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ projectable $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedProjectableField for $Field {}
    ...
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ equality($ty:tt) $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedEqualityField for $Field {
            type Value = $ty;
    ...
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ native_comparable $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedNativeComparableField for $Field {}
        $crate::worth_query_schema!(@impl_field_caps $Schema, $Field, $kind, [ $($($rest)*)? ]);
    };
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ contains $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedStringContainsField for $Field {}
        $crate::worth_query_schema!(@impl_field_caps $Schema, $Field, $kind, [ $($($rest)*)? ]);
    };
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ membership $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedMembershipField for $Field {}
        $crate::worth_query_schema!(@impl_field_caps $Schema, $Field, $kind, [ $($($rest)*)? ]);
    };
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ presence $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedPresenceField for $Field {}
        $crate::worth_query_schema!(@impl_field_caps $Schema, $Field, $kind, [ $($($rest)*)? ]);
    };
    ...
    (@impl_field_caps $Schema:ident, $Field:ident, $kind:ident, [ orderable $(, $($rest:tt)*)? ]) => {
        impl $crate::facade::typed::TypedOrderableField for $Field {}
        $crate::worth_query_schema!(@impl_field_caps $Schema, $Field, $kind, [ $($($rest)*)? ]);
    };

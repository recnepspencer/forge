...
impl BindingRequirements {
    pub fn new(requirements: Vec<BindingRequirement>) -> Self {
        Self { requirements }
    }
...
impl BoundBindings {
    pub fn new(bindings: Vec<BoundBinding>) -> Self {
        Self { bindings }
    }
...
impl BindingResolution {
    ...
    pub fn new(requirements: BindingRequirements, bindings: BoundBindings) -> Self {

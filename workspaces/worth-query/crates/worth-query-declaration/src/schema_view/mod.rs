...
pub struct QuerySchemaView {
    ...
    basis_authority: QuerySchemaBasisAuthority,
...
impl QuerySchemaView {
    pub fn new(
        ...
        let basis = SchemaBasisDigest::from_parts(&digest_parts);
        Self {
            basis_authority: QuerySchemaBasisAuthority::mint(basis.clone()),
            basis,

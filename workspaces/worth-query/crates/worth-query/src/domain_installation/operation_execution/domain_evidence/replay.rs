...
pub(crate) struct WorthQueryDomainEvidenceReplayMeaning {
    contract_identity: String,
    core: WorthQueryDomainEvidenceCore,
}

impl WorthQueryAdmittedDomainEvidence {
    pub(crate) fn replay_meaning(&self) -> WorthQueryDomainEvidenceReplayMeaning {
...
impl WorthQueryDomainEvidenceReplayMeaning {
    ...
    pub(crate) fn semantic_material(&self) -> String {

...
use super::{
    ...
    WorthQueryWorkflowStageMaterialParts, WorthQueryWorkflowStageReceipt, WorthQueryWorkflowValue,
};
...
impl<D: 'static, O: 'static, F: 'static, L: BasisOperationLane> WorthQueryWorkflowRun<D, O, F, L> {
    ...
    fn predecessor_receipt_indices(
        &mut self,
        stage: &worth_query_installation::facade::WorthQueryPortableWorkflowStage,
    ...
    fn assert_predecessor_authority(&self, receipts: &[&WorthQueryWorkflowStageReceipt]) {

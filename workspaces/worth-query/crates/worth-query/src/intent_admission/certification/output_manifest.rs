...
pub fn worth_query_intent_admission_required_certification_outputs() -> &'static [&'static str] {
    &REQUIRED_CERTIFICATION_OUTPUT_MANIFEST
}

pub fn worth_query_intent_admission_closeout_extension_outputs() -> &'static [&'static str] {
    &CLOSEOUT_EXTENSION_OUTPUT_MANIFEST
}

pub fn worth_query_intent_admission_certification_output_manifest() -> &'static [&'static str] {

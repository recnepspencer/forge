...
impl CausalInspectionAdmissionSubject {
        ...
        let mut subject = Self {
            ...
            subject_identity: CausalInspectionAdmissionSubjectIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionAdmissionSubject,
                )
                .seal(),
            ),
        };
    ...
    pub(super) fn query_observation_evidence_identity(&self) -> &crate::WorthQueryEvidenceIdentity {
    ...
    fn new(
        ...
        let mut decision = Self {
            ...
            decision_identity: CausalInspectionAdmissionDecisionIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionAdmissionDecision,
                )
                .seal(),
            ),
        };

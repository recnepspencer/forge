...
pub(crate) struct WorthQueryBridgeBackedVerificationSupportProfileRow {
...
impl WorthQueryBridgeBackedVerificationSupportProfileRow {
    pub(crate) fn new(
...
pub(crate) fn default_bridge_backed_verification_support_rows(
    ...
    for (operation_family, denial_class) in [
        ...
        for target_binding_family in ["direct_entity_identity", "direct_relation_identity"] {
            rows.push(WorthQueryBridgeBackedVerificationSupportProfileRow::new(
                operation_family,

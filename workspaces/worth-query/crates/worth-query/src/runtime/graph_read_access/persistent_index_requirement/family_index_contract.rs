use super::WorthQueryPersistentGraphIndexRequirementDeclaration;
use crate::identity::hash_parts;
use crate::runtime::WorthQueryGraphReadAccessRequirementSet;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryGraphReadFamilyIndexContract {
    digest: String,
...
impl WorthQueryGraphReadFamilyIndexContract {
    ...
    pub(crate) fn from_admission_parts(
        ...
        let digest = hash_parts(
            &[
                "worth_query_graph_read_family_index_contract_v1".to_string(),

...
use crate::binding_pipeline::{
    ...
    WorthQueryBindingRequestDescriptor, WorthQueryBindingTranscript, WorthQueryBindingUnsupported,
...
>(
    ...
    let Some(family_contract) = I::Family::bridge_continuation_contract() else {
        return WorthQueryBindingTranscript::new(
            ...
            WorthQueryBindingOutcome::Unsupported(WorthQueryBindingUnsupported::new(
    ...
    WorthQueryBindingTranscript::new(
        ...
        WorthQueryBindingOutcome::Bound(WorthQueryContinuationBindingInput::bridge(

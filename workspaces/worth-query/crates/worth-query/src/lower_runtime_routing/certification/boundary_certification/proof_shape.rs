...
pub enum WorthQueryLowerRuntimeProofShapeViolation {
...
impl WorthQueryLowerRuntimeProofShapeViolation {
...
pub struct WorthQueryLowerRuntimeProofShapeAuditRow {
    violation: WorthQueryLowerRuntimeProofShapeViolation,
    attempted_shortcut: &'static str,
    required_prior_artifact: &'static str,
    rejected_artifact: &'static str,
    enforcement: WorthQueryLowerRuntimeProofShapeEnforcement,
    enforcement_proof: &'static str,
    row_digest: String,
}

impl WorthQueryLowerRuntimeProofShapeAuditRow {
    fn new(
        violation: WorthQueryLowerRuntimeProofShapeViolation,
        attempted_shortcut: &'static str,
        required_prior_artifact: &'static str,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryLowerRuntimeProofShapeAudit {
    rows: Vec<WorthQueryLowerRuntimeProofShapeAuditRow>,
    proof_shape_digest: String,
    phase_progression_digest: String,
}

impl WorthQueryLowerRuntimeProofShapeAudit {
    fn new(rows: Vec<WorthQueryLowerRuntimeProofShapeAuditRow>) -> Self {
    ...
    pub fn rows(&self) -> &[WorthQueryLowerRuntimeProofShapeAuditRow] {
        &self.rows
    }
...
pub fn worth_query_lower_runtime_proof_shape_audit() -> WorthQueryLowerRuntimeProofShapeAudit {
    use WorthQueryLowerRuntimeProofShapeEnforcement::*;
    use WorthQueryLowerRuntimeProofShapeViolation::*;

    WorthQueryLowerRuntimeProofShapeAudit::new(vec![
        row(
            DirectLowerRuntimeImportBypass,
...
pub fn worth_query_lower_runtime_proof_shape_digest() -> String {
    worth_query_lower_runtime_proof_shape_audit()
        .proof_shape_digest()
        .to_string()
}

pub fn worth_query_lower_runtime_phase_progression_digest() -> String {
    worth_query_lower_runtime_proof_shape_audit()
        .phase_progression_digest()
        .to_string()
}
...
fn row(
    ...
    enforcement: WorthQueryLowerRuntimeProofShapeEnforcement,
    enforcement_proof: &'static str,
) -> WorthQueryLowerRuntimeProofShapeAuditRow {
    WorthQueryLowerRuntimeProofShapeAuditRow::new(
        violation,
        attempted_shortcut,
        required_prior_artifact,
        rejected_artifact,
...
mod tests {
    ...
    fn proof_shape_audit_tracks_phase_progression() {
        let audit = worth_query_lower_runtime_proof_shape_audit();

...
pub(super) struct WorthQuerySupportPinRequirementDocument {
    family: String,
    surface: String,
...
#[derive(Clone, Debug, Eq, PartialEq, serde::Deserialize, serde::Serialize)]
pub(super) struct WorthQueryObservedSupportPinDocument {
    family: String,
    surface: String,
...
impl WorthQuerySupportPinRequirementDocument {
    pub(super) fn from_requirement(requirement: &WorthQuerySupportPinRequirement) -> Self {
        Self {
    ...
    pub(super) fn validate(
        &self,
    ) -> Result<WorthQuerySupportPinRequirement, WorthQuerySupportPinningError> {
        Ok(WorthQuerySupportPinRequirement::from_validated_parts(
...
impl WorthQueryObservedSupportPinDocument {
    pub(super) fn from_observed(observed: &WorthQueryObservedSupportPin) -> Self {
        Self {
    ...
    pub(super) fn validate(
        &self,
    ) -> Result<WorthQueryObservedSupportPin, WorthQuerySupportPinningError> {
        admit_pinned_status(&self.observed_status)?;
        admit_pinned_teaching_posture(&self.observed_teaching_posture)?;
        Ok(WorthQueryObservedSupportPin::from_validated_parts(
            admit_pinned_facade_family(&self.family)?,
            self.surface.clone(),

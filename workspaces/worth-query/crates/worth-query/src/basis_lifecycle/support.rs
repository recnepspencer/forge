...
fn support_rows() -> &'static [(BasisFamily, &'static str, BasisSupportPosture)] {
    ...
    &[
        ...
        (Preview, "subscription_declaration", Admitted),
        (Preview, "subscription_activation", Admitted),
        (PreviewDerived, "inspection", Advisory),
        (PreviewDerived, "observation", Admitted),
        (RuntimeSnapshot, "observation", Admitted),
        (RuntimeSnapshot, "inspection", Admitted),
        (RuntimeSnapshot, "subscription_declaration", Admitted),
        (RuntimeSnapshot, "subscription_activation", Admitted),
        (HistoricalSnapshot, "observation", Admitted),
        (HistoricalSnapshot, "replay", Admitted),
        (HistoricalSnapshot, "inspection", Admitted),
        (HistoricalSnapshot, "materialization", Admitted),
        (HistoricalSnapshot, "subscription_declaration", Admitted),
        (HistoricalSnapshot, "subscription_activation", Admitted),
        (HistoricalCommit, "observation", Admitted),
        (HistoricalCommit, "replay", Admitted),
        (HistoricalCommit, "inspection", Admitted),
        (HistoricalCommit, "materialization", Admitted),
        (HistoricalCommit, "subscription_declaration", Admitted),
        (HistoricalCommit, "subscription_activation", Admitted),
        (TenantScoped, "observation", Admitted),
        (TenantScoped, "mutation_preparation", Admitted),
        (TenantScoped, "inspection", Admitted),
        (TenantScoped, "subscription_declaration", Admitted),
        (TenantScoped, "subscription_activation", Admitted),
        (PolicyScoped, "observation", Admitted),
        (PolicyScoped, "mutation_preparation", Admitted),
        (PolicyScoped, "inspection", Admitted),
        (PolicyScoped, "subscription_declaration", Admitted),
        (PolicyScoped, "subscription_activation", Admitted),

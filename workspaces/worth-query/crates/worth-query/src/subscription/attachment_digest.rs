...
pub struct SubscriptionConsumerAttachmentDigest(WorthQueryEvidenceIdentity);
...
impl Ord for SubscriptionConsumerAttachmentDigest {
...
impl PartialOrd for SubscriptionConsumerAttachmentDigest {

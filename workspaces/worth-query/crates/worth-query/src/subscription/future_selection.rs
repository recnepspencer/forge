...
pub struct QuerySubscriptionFutureSelection {
    ...
    projection_identity: WorthQueryEvidenceIdentity,
}
...
impl QuerySubscriptionFutureSelection {
    ...
    fn new(
        ...
        let mut projection_identity = WorthQueryEvidenceIdentity::compose(

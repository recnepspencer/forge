pub struct WorthQueryIdentityPhaseOneFamily {
    family: &'static str,
...
impl WorthQueryIdentityPhaseOneFamily {
    pub const fn new(
        family: &'static str,
        owner_authority: &'static str,
        kind_marker: &'static str,
...
const WORTH_QUERY_IDENTITY_PHASE_ONE_FAMILIES: &[WorthQueryIdentityPhaseOneFamily] = &[
...
pub const fn worth_query_identity_phase_one_families() -> &'static [WorthQueryIdentityPhaseOneFamily]
{
    WORTH_QUERY_IDENTITY_PHASE_ONE_FAMILIES
}

...
pub mod consumer_kit {
    pub use crate::consumer_kit::{
        advance_test_workspace_domain_installation_generation, audit_domain_authority_sources,
        audit_public_authority_surface_symbols, audit_workspace_domain_authority_inventory,
        compare_test_backend_write_receipts, current_domain_authority_inventory_audit,
        downstream_authority_adoption, evidence_report_adoption_audit, graph_read_bypass_adoption,
        graph_read_bypass_audit, hard_prohibition_boundary_audit,
        hard_prohibition_boundary_audit_coverage, hard_prohibition_documentation_rows,
        ...
        WorthQueryControlledTestWorkspace, WorthQueryDomainAuthorityClass,
        ...
        WorthQueryExternalSupportSnapshotTerminalJsonDocument, WorthQueryGraphReadBypassAdoption,

...
pub enum WorthQueryDeclarationLegalityClass {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct WorthQueryDeclarationLegalityContract {
...
impl WorthQueryDeclarationLegalityContract {
    pub(crate) fn new(
        legality_class: WorthQueryDeclarationLegalityClass,
        category: FoundationalBoundaryArtifactCategory,
        role: FoundationalBoundaryArtifactRole,
    ...
    pub fn planned_unavailable_support() -> Self {
        Self::new(
            WorthQueryDeclarationLegalityClass::PlannedUnavailableSupport,
    ...
    pub fn receipt_hot_boundary() -> Self {
        Self::new(
            WorthQueryDeclarationLegalityClass::ReceiptHotBoundary,
    ...
    pub fn legality_class(&self) -> WorthQueryDeclarationLegalityClass {
        self.legality_class
    }

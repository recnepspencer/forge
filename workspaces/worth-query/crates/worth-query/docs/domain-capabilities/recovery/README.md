...
- `WorthQueryRecoveryBrief` answers what stopped and what to do next
- `WorthQueryRecoveryExplanation` answers why and how strong that answer is
- `WorthQueryRecoveryRequest` gives you one typed next-step request shape

...
pub struct WorthQueryInstalledPackageIndexCounters {
    ...
    pub application_schema_catalogs_compiled: usize,
    pub application_aspect_contracts_compiled: usize,
    pub application_aspect_fields_compiled: usize,
    pub application_aspect_canonical_bases_prepared: usize,

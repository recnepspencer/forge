...
worth_query_aspect!(pub ExternalIdentity in FinancialHostSchema, ExternalMapping);
worth_query_aspect!(pub PrincipalFacts in FinancialHostSchema, Principal);
worth_query_aspect!(pub MarketIdentity in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub CurveFacts in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub VolatilityFacts in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub PriceFacts in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub RiskFacts in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub PortfolioFacts in FinancialHostSchema, MarketObservation);
worth_query_aspect!(pub AuditFacts in FinancialHostSchema, MarketObservation);

...
use crate::domain_computation::{
    WorthQueryInvariantStateLocator, WorthQueryProviderCompareAndCommitOutcome,
};

pub(super) struct WorthQueryProviderProgression<'a, 'provider, Schema, Operation, Input, Scope> {
    pub(super) application:
        &'a crate::domain_computation::primary_graph::WorthQueryPrimaryGraphApplicationRuntime<
            Schema,
        >,
    pub(super) running: &'a mut crate::domain_computation::WorthQueryRunningDirectRun,
    pub(super) graph:
        &'a worth_query_installation::facade::WorthQueryInstalledGraphParticipationAuthority,
    pub(super) provider:
    ...
    pub(super) admission:
        &'a crate::domain_computation::primary_graph::WorthQueryAdmittedApplicationOperation<
            ...
            Scope,
        >,
    pub(super) prepared: WorthQueryPreparedApplicationProviderAttempt,
    ...
    pub(super) mutation_run:
        &'a crate::domain_computation::provider_session::WorthQueryMutationRunBinding,

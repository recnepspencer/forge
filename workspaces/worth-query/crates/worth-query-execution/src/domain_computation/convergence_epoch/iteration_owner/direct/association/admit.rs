...
use super::super::super::super::{
    admission::{direct_rejection, WorthQueryDirectConvergenceAdmissionRejection},
    WorthQueryConvergenceEpochDenialKind as Kind,
};
use super::super::super::core::{
    WorthQueryConvergenceEpochCore, WorthQueryConvergenceEpochLifecycle,
};
use super::super::WorthQueryAdmittedDirectConvergenceEpoch;
use super::DirectAdmittedEpochAssociation;
...
use crate::domain_computation::{
    WorthQueryAdmittedDirectRun, WorthQueryConvergenceDomainProvider,
...
) -> Result<WorthQueryAdmittedDirectConvergenceEpoch, WorthQueryDirectConvergenceAdmissionRejection>
{
    let mut lifecycle = WorthQueryConvergenceEpochLifecycle::begin(
        DirectAdmissionLifecycleEvent::operation_checked(),
    );
    ...
    lifecycle.record(DirectAdmissionLifecycleEvent::contract_checked());
    ...
    lifecycle.record(DirectAdmissionLifecycleEvent::managed_run_checked());
    ...
    lifecycle.record(DirectAdmissionLifecycleEvent::graph_checked());
    ...
    Ok(WorthQueryAdmittedDirectConvergenceEpoch {
        association: DirectAdmittedEpochAssociation {
            core,
            managed_run,
...
pub(in crate::domain_computation::convergence_epoch) struct DirectAdmissionLifecycleEvent {
    kind: DirectAdmissionLifecycleEventKind,
}

pub(in crate::domain_computation::convergence_epoch) enum DirectAdmissionLifecycleEventKind {
    OperationChecked,
    ContractChecked,
    ManagedRunChecked,
    GraphChecked,
...
impl DirectAdmissionLifecycleEvent {
    fn operation_checked() -> Self {
        Self {
            kind: DirectAdmissionLifecycleEventKind::OperationChecked,
        }
    }

    fn contract_checked() -> Self {
        Self {
            kind: DirectAdmissionLifecycleEventKind::ContractChecked,
        }
    }

    fn managed_run_checked() -> Self {
        Self {
            kind: DirectAdmissionLifecycleEventKind::ManagedRunChecked,
        }
    }

    fn graph_checked() -> Self {
        Self {
            kind: DirectAdmissionLifecycleEventKind::GraphChecked,
        }
    }

    pub(in crate::domain_computation::convergence_epoch) fn into_kind(
        self,
    ) -> DirectAdmissionLifecycleEventKind {
        self.kind
    }
}

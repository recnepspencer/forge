...
use super::super::super::super::WorthQueryRetainedCapabilityAuthorization;
...
pub(in crate::domain_computation::authorization) use exact_observation::WorthQueryDelegationResolvedRequest;

pub(in crate::domain_computation::authorization) use crate::domain_computation::authorization::operation_progression::{
    ...
    Input: ApplicationCapabilityRequest<Schema, Capability>,
{
    ...
    pub(in crate::domain_computation::authorization) fn transition_operation(
        self,
        runtime: &crate::domain_computation::primary_graph::WorthQueryPrimaryGraphApplicationRuntime<Schema>,
        operation: &worth_query_installation::facade::WorthQueryInstalledApplicationOperation<Schema, Operation, Input>,
        preconditions: crate::domain_computation::primary_graph::WorthQueryBoundMutationPreconditions,
        permit: crate::domain_computation::authorization::operation_progression::WorthQueryCapabilityTransitionPermit,
    ) -> Result<
        crate::domain_computation::authorization::operation_progression::WorthQueryAuthorizedCapabilityOperation<Input>,
        crate::domain_computation::authorization::WorthQueryOperationAuthorizationDenial,
    >
    where
        Schema: ApplicationSchema,
    ...
    pub(in crate::domain_computation::authorization) fn retain_observed_support(
        &mut self,
        supporting: super::super::super::super::WorthQueryRetainedCapabilitySupport,
    ) -> Result<(), ()> {

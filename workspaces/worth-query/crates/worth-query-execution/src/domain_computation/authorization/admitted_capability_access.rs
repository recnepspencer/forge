...
pub(super) struct WorthQueryAdmittedApplicationCapabilityAccessInput<
    Schema,
    Capability,
    Operation,
    Input,
    ...
    Input: ApplicationCapabilityRequest<Schema, Capability>,
{
    ...
    pub(super) graph_work:
        crate::domain_computation::provider_session::WorthQueryManagedGraphWorkSession,
    pub(super) _operation: PhantomData<fn() -> Operation>,
}
...
{
    pub(super) fn mint(
        input: WorthQueryAdmittedApplicationCapabilityAccessInput<
            Schema,
            Capability,
            Operation,
            Input,
        ...
        let WorthQueryAdmittedApplicationCapabilityAccessInput {
            runtime_authority,
            binding_identity,
            capability,
            capability_type,

...
`forge-runtime-bridge` is the causal protocol boundary between
`forge-relational` truth and `forge-signal` computation.
...
For ordinary usage, start with [`forge_runtime_bridge::facade`].
...
fn demo(
    truth_source: impl forge_runtime_bridge::facade::RelationalBridgeSource + Clone + 'static,
    branch_heads: impl forge_runtime_bridge::facade::TruthBranchHeadSource + Clone + 'static,
    compute_sink: impl forge_runtime_bridge::facade::SignalBridgeSink + Clone + 'static,
    ...
    let bridge = RuntimeBridge::builder()
        ...
        .register_mapping(forge_runtime_bridge::facade::BridgeMappingRegistration::new(
            forge_runtime_bridge::facade::BridgeMappingId::new("pricing:steel"),
            forge_runtime_bridge::facade::TruthPatchScope::new(
                forge_runtime_bridge::facade::MappingSelector::exact("component:steel"),
                forge_runtime_bridge::facade::MappingSelector::exact("cost"),
                forge_runtime_bridge::facade::MappingSelector::exact("usd"),
            ),
            forge_runtime_bridge::facade::SignalInvalidationScope::new("price:bicycle"),
            forge_runtime_bridge::facade::CoarseRoutingMode::Direct,
        ))
        .build()?;
...
Use [`forge_runtime_bridge::facade`] when you want the canonical public
workflow:
...
- Use `forge_runtime_bridge::facade` as the public import path for new code.

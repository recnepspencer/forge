...
impl StreamProtocolCounters {
    ...
    pub fn stream_member_count(&self) -> usize { self.stream_member_count }
    pub fn stream_window_count(&self) -> usize { self.stream_window_count }
    pub fn stream_window_member_count(&self) -> usize { self.stream_window_member_count }
    pub fn stream_consumer_contract_count(&self) -> usize { self.stream_consumer_contract_count }
    pub fn stream_checkpoint_count(&self) -> usize { self.stream_checkpoint_count }
    pub fn stream_checkpoint_member_count(&self) -> usize { self.stream_checkpoint_member_count }
    pub fn stream_resume_attempt_count(&self) -> usize { self.stream_resume_attempt_count }
    pub fn stream_resume_rejection_count(&self) -> usize { self.stream_resume_rejection_count }
    pub fn stream_replay_count(&self) -> usize { self.stream_replay_count }
    pub fn stream_replay_mismatch_count(&self) -> usize { self.stream_replay_mismatch_count }
    pub fn stream_coalesced_member_count(&self) -> usize { self.stream_coalesced_member_count }
    pub fn stream_coalesced_window_count(&self) -> usize { self.stream_coalesced_window_count }
    pub fn stream_duplicate_member_observation_count(&self) -> usize { self.stream_duplicate_member_observation_count }
    pub fn stream_backpressure_signal_count(&self) -> usize { self.stream_backpressure_signal_count }
    pub fn stream_consumer_saturated_count(&self) -> usize { self.stream_consumer_saturated_count }
    pub fn stream_checkpoint_lag_count(&self) -> usize { self.stream_checkpoint_lag_count }
    pub fn stream_protocol_mismatch_count(&self) -> usize { self.stream_protocol_mismatch_count }
}

...
impl MergeClassAdmissionStage {
    fn new(bridge_class: BridgeMergeConsumptionClass) -> Self {
        Self { bridge_class }
    }
...
impl MergeAuthoritativeLineageStage {
    fn new(disposition: BridgeMergeAuthoritativeLineageDisposition) -> Self {
        Self { disposition }
    }
...
impl MergeCausalFrontierStage {
    fn new(disposition: BridgeMergeCausalFrontierDisposition) -> Self {
        Self { disposition }
    }
...
impl MergeSchemaPolicyStage {
    fn new(disposition: BridgeMergeSchemaPolicyDisposition) -> Self {
        Self { disposition }
    }
...
impl MergeStructuralAdvisoryStage {
    fn new(disposition: BridgeMergeStructuralAdvisoryDisposition) -> Self {
        Self { disposition }
    }
...
#[cfg(test)]
mod tests {
    use super::LoweredMergeHistoryPacketSet;
    ...
    ) -> crate::merge::AdmittedMergeHistoryContract {

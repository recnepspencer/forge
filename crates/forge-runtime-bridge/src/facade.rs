...
pub use crate::diagnostics::{
    ...
    BridgeHistoricalEvaluationRecord, BridgeHistoricalEvaluationReplaySummary, BridgeHistoricalMaterializationPath,
    BridgeLoweringDiagnosticsRecord, BridgeMergeExplanation, BridgeMergeRecord,
    BridgeMergeRecordIdentity, BridgeMergeReplaySummary, BridgePreviewDiscardExplanation,
    ...
    BridgeRouteExplanation, BridgeRouteExplanationEntry, BridgeRouteRecord,
    BridgeRouteRecordEntry, BridgeRouteRecordMatch, BridgeRouteSourceRecord, BridgeRoutingDiagnosticsRecord,
    ...
    BridgeStreamResumeSummary, BridgeStructuralBranchComparisonExplanation,
    BridgeStructuralBranchComparisonRecord, BridgeStructuralBranchComparisonReplaySummary,
    BridgeStructuralCounters, BridgeStructuralRemapExplanation,
    BridgeStructuralRemapRecord, BridgeStructuralRemapReplaySummary,
    BRIDGE_CANONICAL_CONTINUITY_RECORD_SCHEMA_V1, BRIDGE_CANONICAL_HISTORICAL_EVALUATION_RECORD_SCHEMA_V1,
...
pub use crate::speculation::{
    ...
    BridgePreviewExecutionRecord, BridgePreviewLifecycleStateKind,
    BridgePreviewLifecycleTransitionKind, BridgePreviewResidueClass,
    BridgePreviewPromotionRecord, BridgePreviewPromotionRecordIdentity,
    BridgePreviewReplayBundle, BridgePreviewResidueReport, BridgePreviewReuseEquivalence,
    BridgePreviewSession, BridgePreviewSessionDeclaration,
    BridgePreviewSessionDeclarationIdentity, BridgePreviewSessionIdentity,
    BridgePromotionAdmissibilityProof, BridgeRequestKind, BridgeSignalBranchIdentity,
    BridgeSpeculationCounters, BridgeSpeculativeBranchBinding,
    BridgeSpeculativeBranchBindingIdentity, BridgeSpeculationFailureClass, PreviewActive,

...
fn canonical_basis_domain_text(
    ...
    Ok(match sequence.domain() {
        forge_foundational::facade::CanonicalBasisDomain::Value => "value".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::AspectContract => {
            "aspect-contract".to_string()
        }
        forge_foundational::facade::CanonicalBasisDomain::AspectMask => "aspect-mask".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::AuthoritativeState => {
            "authoritative-state".to_string()
        }
        forge_foundational::facade::CanonicalBasisDomain::AuthoritativePatch => {
            "authoritative-patch".to_string()
        }
        forge_foundational::facade::CanonicalBasisDomain::Identity => "identity".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::Locator => "locator".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::Profile => "profile".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::Performance => "performance".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::BoundaryArtifact => {
            "boundary-artifact".to_string()
        }
        forge_foundational::facade::CanonicalBasisDomain::Transition => "transition".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::Diagnostic => "diagnostic".to_string(),
        forge_foundational::facade::CanonicalBasisDomain::Future(name) => name.to_string(),

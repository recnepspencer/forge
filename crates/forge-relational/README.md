...
`forge-relational` is a standalone truth runtime for graph-shaped state.
...
- `cargo run -p forge-relational --example basic_runtime`
- `cargo run -p forge-relational --example snapshots`
- `cargo run -p forge-relational --example history_and_replay`
- `cargo run -p forge-relational --example derived_indexes`
- `cargo run -p forge-relational --example validation_and_durability`

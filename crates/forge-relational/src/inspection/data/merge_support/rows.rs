...
impl RelationalMergeSupportInspectionRow {
    ...
    pub(crate) fn branch_basis(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.branch_basis.v1",
            &basis_digest,
    ...
    pub(crate) fn request_admission(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.request_admission.v1",
            &request_digest,
            &packet_digest,
            admission_posture,
            absence,
    ...
    pub(crate) fn correspondence(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.correspondence.v1",
            &witness_digest,
            admitted_count,
            denied_count,
            unavailable_count,
    ...
    pub(crate) fn schema(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.schema.v1",
            &witness_digest,
            reconciled_count,
            denied_count,
            &sample_record,
    ...
    pub(crate) fn strategy(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.strategy.v1",
            &witness_digest,
            aspect_policy_count,
            topology_count,
            deletion_count,
    ...
    pub(crate) fn compatibility(
        ...
        let row_digest = row_digest(&(
            "forge.relational.merge_support.compatibility.v1",
            posture,
            absence,
        ));
        Self::Compatibility {

...
use crate::replay::data::{CanonicalCommitEnvelope, ReplayFailureClass};

pub(in crate::replay::logic) fn load_replay_envelope(
...
pub(in crate::replay::logic) fn replay_commit_closure_by_commit_id_order(

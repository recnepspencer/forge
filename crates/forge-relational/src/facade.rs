...
pub mod schema {
    pub use crate::schema::data::{
        ...
        ConnectivityMinimumEnforcement, ContractId, DeclaredAspect,
        DescriptorCanonicalBasisSupportPolicy, DescriptorCanonicalBasisVersion,
        DescriptorSemanticsSupportPolicy, DescriptorSemanticsVersion, DirectedTraversalKind,
        ...
        LoweredAcyclicityContract, LoweredAspectBinding, LoweredAspectPlan,
        ...
        PartitionIsolationContractDeclaration, PartitionIsolationMode, ProposedSchemaTransition,
        RelationIntegrityDeclarations, RelationIntegrityPlanCatalog, RelationIntegrityPlanRevision,
        RelationKindRegistration, RelationalSchemaRegistry, SchemaBoundaryFingerprint,

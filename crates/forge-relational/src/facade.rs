...
pub mod schema {
    ...
    pub use crate::schema::data::{
        ...
        LoweredCardinalityMinimumContract, LoweredAcyclicityContract,
        ...
        LoweredUniquenessContract, PartitionIsolationContractDeclaration,
        PartitionIsolationMode, PayloadContractRecordKind, PayloadFieldConstraint,
        PayloadFieldConstraintDeclaration, PayloadSchemaDeclaration, PayloadSchemaValueType,
        ProposedSchemaTransition, RelationIntegrityDeclarations,

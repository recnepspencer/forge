...
fn prepare_policy_value_locator_for_canonical_basis(
    ...
    let version = CanonicalizationRuleVersion::new("forge.relational.merge.policy_value_basis.v1")
...
fn foundational_merge_basis(
    ...
    Some(FoundationalMergeBasis::new(
        ...
        FoundationalTransitionBasisFamily::new("forge.relational.merge.policy_value_basis").ok()?,

...
const PHASE_6_CANONICAL_RULE_VERSION: &str = "forge.relational.merge.proof_packet.canonical.v1";
...
fn admitted_surface_row_digest(row: &RelationalMergeAdmittedSurfaceRow) -> String {
    ...
    bytes.extend_from_slice(b"forge.relational.merge.admitted_surface.row.v1");

use forge_harness::facade::{InvariantCheck, RegressionTarget, RegressionTargetKind, WorkflowPlan, WorkflowState};
...
pub(super) fn relational_fintech_replay_regression_plan() -> WorkflowPlan<FintechWorkflowStep> {
    WorkflowPlan::new(
        ...
        .with_regression_target(RegressionTarget {
            ...
            summary:
                "Known replay drift under partitioned fintech branch trade correction workflow"
                    .to_string(),

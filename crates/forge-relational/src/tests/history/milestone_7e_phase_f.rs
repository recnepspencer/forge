...
use forge_foundational::{CanonicalBasisLocus, CanonicalBasisValue, InternedString};
...
fn merge_proof_packet_canonical_basis_localizes_single_field_drift() {
    ...
    let forge_foundational::FoundationalMergeAdmissionOutcome::Success(drifted_request_lowering) =

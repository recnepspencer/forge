...
//!
//! Contract:
//! - `worth-signal` owns evaluation DAG scheduling.
...
pub mod core {
    ...
    pub use crate::data::authorization::{
        ...
        SignalAuthorizationObservation, SignalAuthorizationPathContract,
        SignalAuthorizationPathEffect, SignalAuthorizationPathObservation,
    ...
    pub use crate::data::conditional_execution::{
        resolve_signal_delta_threshold, InstalledSignalComparatorUse,
        ...
        SignalConditionalComparisonWork, SignalConditionalCondition,
        SignalConditionalConditionClass, SignalConditionalContractDefinition,
        ...
        SignalConditionalExecutionAffinity, SignalConditionalExecutionAffinityComparisonMismatch,
    ...
    pub use crate::data::resource::{
        ...
        ResourceManagedQueueDenial, ResourceManagedQueueDenialClass,
        ...
        ResourcePolicyVersion, ResourceQueuePressureClass, ResourceQueuePressureObservation,
        ResourceRejectionDenialClass, ResourceRejectionOrdinal, ResourceRejectionReason,
        ResourceRejectionReport, ResourceReplayReconstructionReport, ResourceRequestHandle,
        ResourceRequestId, ResourceRequestIntent, ResourceRequestIntentDigest,
        ...
        ResourceRevalidationIntent, ResourceRevalidationPolicyDeclaration,
        ResourceRevalidationReport, ResourceRuntimeSummaryReadReport,
        ...
        ResourceSafePointObservationReport, ResourceStaleAfterDecisionClass,
...
pub use self::core::{
    ...
    SignalAspectLoweringOwner, SignalAspectLoweringOwnershipDenial, SignalAuthorizationDecision,
    SignalAuthorizationDecisionEvidence, SignalAuthorizationDenial,
    SignalAuthorizationDependencyCardinality, SignalAuthorizationEvaluationCounters,
    ...
    SignalAuthorizationPolicyIdentity, SignalConditionalArtifactReuse,
    SignalConditionalArtifactReuseClass, SignalConditionalArtifactReusePolicy,
    SignalConditionalComparatorClass, SignalConditionalComparatorPosition,

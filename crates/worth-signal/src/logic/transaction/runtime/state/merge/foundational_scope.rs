...
pub(crate) fn foundational_branch_id(
    ...
    worth_foundational::facade::FoundationalBranchId::new(format!(
        "signal-branch:{}:{}",
...
) -> worth_foundational::facade::FoundationalSelectedNodeLocus {
    worth_foundational::facade::FoundationalSelectedNodeLocus::new(
...
) -> worth_foundational::facade::FoundationalSelectedAspectRequestEntry {
    worth_foundational::facade::FoundationalSelectedAspectRequestEntry::new(
        foundational_denied_node_locus(aspect.node()),
        worth_foundational::facade::FoundationalSelectedAspectLocus::new(
            foundational_selected_aspect_locus(aspect.aspect().id()),
        )
...
pub fn foundational_scope_family_label(
    family: worth_foundational::facade::FoundationalMergeScopeFamily,
) -> &'static str {
    match family {
        worth_foundational::facade::FoundationalMergeScopeFamily::FullBranch => "full-branch",
        worth_foundational::facade::FoundationalMergeScopeFamily::SelectedNodes => "selected-nodes",
...
pub fn signal_scope_family_matches_foundational_family(
    ...
    foundational_family: worth_foundational::facade::FoundationalMergeScopeFamily,
) -> bool {
    matches!(

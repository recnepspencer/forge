...
impl WorthUiSteadyFrameCounterReceiptBuilder {
    ...
    pub fn minimal_diagnostics(mut self) -> Self {
        self.diagnostic_policy = WorthUiSteadyFrameDiagnosticPolicy::Minimal;
        self
    }

    pub fn standard_diagnostics(mut self) -> Self {
        self.diagnostic_policy = WorthUiSteadyFrameDiagnosticPolicy::Standard;
        self
    }

    pub fn support_diagnostics(mut self) -> Self {
        self.diagnostic_policy = WorthUiSteadyFrameDiagnosticPolicy::Support;
        self
    }

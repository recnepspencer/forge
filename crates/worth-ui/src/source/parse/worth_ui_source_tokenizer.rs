use crate::source::{
    WorthUiParseDiagnostic, WorthUiParseDiagnosticCode, WorthUiSourceModuleId,
    WorthUiSourceModuleRecord, WorthUiSourceSpan, WorthUiSourceToken, WorthUiSourceTokenKind,
};
...
pub(crate) fn tokenize_module_source(
    ...
    let module_id = module_record.module_id().clone();
    let source_text = module_record.source_text();

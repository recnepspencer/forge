...
pub use crate::transitions::{
    ...
    FoundationalBranchCandidateId, FoundationalBranchCloseoutCause,
    ...
    FoundationalDeniedScopeLocus, FoundationalMergeAdmissionDeferred,
    ...
    FoundationalMergeAncestryBasis, FoundationalMergeBaseSelectionBasis, FoundationalMergeBasis,
    FoundationalMergeBuilder, FoundationalMergeCandidate, FoundationalMergeConflictLocus,

...
impl forge_proof::PhaseMarker for FoundationalDiagnosticProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalDiagnosticProductionReadinessCertified;
impl forge_proof::ProofMarker for FoundationalDiagnosticProductionReadinessCertified {}
...
pub use readiness::{
    ...
    FoundationalDiagnosticCompileFailEvidence, FoundationalDiagnosticForgeProofApi,
    FoundationalDiagnosticForgeProofApiEvidence, FoundationalDiagnosticForgeProofForbiddenSurface,
    FoundationalDiagnosticForgeProofSurface, FoundationalDiagnosticHarnessExpansionEvidence,

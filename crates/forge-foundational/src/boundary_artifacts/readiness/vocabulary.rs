...
impl FoundationalBoundaryArtifactProductionReadinessScope {
    pub(super) const fn milestone_4() -> Self {
        Self {
            milestone: "forge-foundational.milestone-4",
        }
    }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalBoundaryArtifactForgeProofSurface {
    AuthorityWitness,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalBoundaryArtifactForgeProofApi {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalBoundaryArtifactForgeProofForbiddenSurface {

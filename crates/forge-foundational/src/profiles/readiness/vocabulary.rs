...
impl FoundationalProfileProductionReadinessScope {
    pub(super) const fn milestone_3() -> Self {
        Self {
            milestone: "forge-foundational.milestone-3",
        }
    }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalProfileForgeProofApi {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalProfileForgeProofForbiddenSurface {

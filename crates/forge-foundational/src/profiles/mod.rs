...
impl forge_proof::PhaseMarker for FoundationalProfileProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalProfileProductionReadinessCertified;
impl forge_proof::ProofMarker for FoundationalProfileProductionReadinessCertified {}

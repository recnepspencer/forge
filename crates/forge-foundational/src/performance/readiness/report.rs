use super::inventory::{
    ...
    documentation_surface_inventory, forge_proof_api_appendix, forge_proof_forbidden_surfaces,
    forge_proof_required_surfaces, harness_expansion_points, phase_gates,
...
pub struct FoundationalPerformanceProductionReadinessReport {
    ...
    forge_proof_required_surfaces: Vec<FoundationalPerformanceForgeProofSurface>,
    forge_proof_api_appendix: Vec<FoundationalPerformanceForgeProofApi>,
    forge_proof_forbidden_surfaces: Vec<FoundationalPerformanceForgeProofForbiddenSurface>,
...
impl FoundationalPerformanceProductionReadinessReport {
    ...
    pub fn forge_proof_required_surfaces(&self) -> &[FoundationalPerformanceForgeProofSurface] {
        &self.forge_proof_required_surfaces
    }

    pub fn forge_proof_api_appendix(&self) -> &[FoundationalPerformanceForgeProofApi] {
        &self.forge_proof_api_appendix
    }

    pub fn forge_proof_forbidden_surfaces(
        &self,
    ) -> &[FoundationalPerformanceForgeProofForbiddenSurface] {

...
impl FoundationalPerformanceProductionReadinessScope {
    pub(super) const fn milestone_8() -> Self {
        Self {
            milestone: "forge-foundational.milestone-8",
        }
    }
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalPerformanceForgeProofSurface {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalPerformanceForgeProofApi {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum FoundationalPerformanceForgeProofForbiddenSurface {
...
pub enum FoundationalPerformanceRuntimeAssumption {
    ForgeProofAuthorityLaneRemainsAvailable,

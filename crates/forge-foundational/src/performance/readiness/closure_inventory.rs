use super::vocabulary::{
    ...
    FoundationalPerformanceForgeProofSurface,
...
pub(super) fn forge_proof_required_surfaces() -> Vec<FoundationalPerformanceForgeProofSurface> {
    vec![
...
pub(super) fn forge_proof_api_appendix() -> Vec<FoundationalPerformanceForgeProofApi> {
    vec![
...
) -> Vec<FoundationalPerformanceForgeProofForbiddenSurface> {
    vec![

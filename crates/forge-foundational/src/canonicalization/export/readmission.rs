use forge_proof::{Artifact, AuthorityWitness};
...
pub type BoundaryBridgedCanonicalExportArtifact = Artifact<
    ...
    CanonicalExportBundle,
    CanonicalExportReadinessProofs,
    forge_proof::BoundaryBridgedAuthorityRevalidationRequiredBasis<CanonicalizationRuleVersion>,
>;
...
mod tests {
    ...
    fn export_readmission_requires_milestone_owned_authority_witness() {
        ...
        let authority = forge_proof::AuthorityWitness::from_authority_marker(

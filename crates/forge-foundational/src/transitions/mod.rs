...
impl forge_proof::PhaseMarker for FoundationalTransitionProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalTransitionProductionReadinessCertified;
impl forge_proof::ProofMarker for FoundationalTransitionProductionReadinessCertified {}
...
pub use merges::{
    foundational_merge, FoundationalBranchBasisDrift, FoundationalBranchBasisDriftKind,

...
This feature is the shared continuity vocabulary for Milestone 7. It lets Forge
...
- `forge_foundational::boundary_evidence_api::common_path::lineage()`
...
```rust
use forge_foundational::{boundary_evidence, FoundationalBoundaryEvidenceLineageSubject};

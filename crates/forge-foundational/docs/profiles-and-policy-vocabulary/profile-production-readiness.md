...
```rust
use forge_foundational::foundational_profile_milestone3_readiness_report;
...
- `report.forge_proof_required_surfaces()` and
  `report.forge_proof_forbidden_surfaces()` when you need the exact proof

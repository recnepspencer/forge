...
- to make “verified”, “widened”, “rejected”, and “deferred” mechanically
  distinct outcomes
...
```rust
use forge_foundational::performance_api::common_path as performance;
use forge_foundational::performance_api::lower_lane::policy;
...
let receipt = policy::policy_admission_receipt(claim)
    .budget_decision(
        forge_foundational::FoundationalPerformanceBudgetKind::Density,
        4,
        6,
    )
    .widen_work(forge_foundational::FoundationalPerformanceWorkClass::ForensicParity)
    .finish()?;
```
...
- widening budget under a “verified” receipt

...
```rust
use forge_foundational::performance_api::common_path as performance;
use forge_foundational::FoundationalPerformanceAllocationPosture;
...
let layout = performance::performance().define_layout_intent(
    forge_foundational::FoundationalPerformanceLayoutIntent::AoS,
    forge_foundational::FoundationalPerformanceAccessPatternPosture::PointLookup,

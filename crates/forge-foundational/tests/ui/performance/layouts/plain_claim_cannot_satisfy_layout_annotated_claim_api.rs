...
use forge_foundational::{
    FoundationalLayoutAnnotatedClaim, FoundationalPerformanceAccessPatternPosture,
...
fn require_layout_annotated(
    _claim: &FoundationalLayoutAnnotatedClaim<forge_foundational::FoundationalAuthoritativePerformanceClaim>,
) {
}
...
fn main() {
    ...
    require_layout_annotated(&claim);
}

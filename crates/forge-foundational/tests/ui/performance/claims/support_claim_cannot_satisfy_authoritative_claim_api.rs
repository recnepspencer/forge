...
fn requires_authoritative(_: forge_foundational::FoundationalAuthoritativePerformanceClaim) {}
...
fn main() {
    let support_claim = performance_common::performance()
        ...
        .access_pattern(forge_foundational::FoundationalPerformanceAccessPatternPosture::TraversalLocal)

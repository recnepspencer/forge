use forge_foundational::{
    ...
    EquivalenceBasisId, FoundationalBranchCandidateId, FoundationalBranchForkBasis,
    FoundationalBranchId, FoundationalBranchObservationBasis, FoundationalMergeBaseSelectionBasis,

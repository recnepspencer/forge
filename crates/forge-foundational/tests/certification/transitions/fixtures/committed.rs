...
) -> AuthorityWitness<forge_foundational::FoundationalCommittedAuthorityAdmission> {
...
pub fn accepted_verdict(
    payload: &'static str,
) -> forge_foundational::FoundationalMergeVerdict<&'static str> {
...
pub fn conflict_verdict(
    ...
    let locus = forge_foundational::FoundationalMergeConflictLocus::new(
        "geometry-face",
        "source:face-7",
        "target:face-7",
    );

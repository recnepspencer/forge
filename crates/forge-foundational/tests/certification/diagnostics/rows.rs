use forge_foundational::EquivalenceBasisId;
use forge_foundational::FoundationalMergeConflictLocator;
...
use forge_foundational::{FoundationalCommittedDeltaLocator, FoundationalCommittedDeltaLocus};
        ...
        FoundationalDiagnosticRow::Decision(FoundationalDiagnosticDecisionRow::new(
            ...
            foundational_diagnostic_locator_transition(
                FoundationalTransitionLocator::BranchCandidate(
                    forge_foundational::FoundationalBranchCandidateLocator::new(
                        branch("feature"),
                        candidate(1),
                    ),
                ),

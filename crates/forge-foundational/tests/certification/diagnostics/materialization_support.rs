...
pub fn subject() -> forge_foundational::FoundationalDiagnosticSubject {
...
pub fn locator() -> forge_foundational::FoundationalDiagnosticLocator {
...
pub fn required_row() -> FoundationalDiagnosticRow {
    FoundationalDiagnosticRow::Support(FoundationalDiagnosticSupportRow::new(
        ...
        FoundationalDiagnosticSupportEvidencePosture::Present(
            forge_foundational::FoundationalDiagnosticEvidencePosture::RetainedDirect,
        ),
...
pub fn forensic_row() -> FoundationalDiagnosticRow {
    FoundationalDiagnosticRow::Support(FoundationalDiagnosticSupportRow::new(
        ...
        labels(["forensic"]),
        FoundationalDiagnosticSupportEvidencePosture::Present(
            forge_foundational::FoundationalDiagnosticEvidencePosture::Reconstructed,
        ),

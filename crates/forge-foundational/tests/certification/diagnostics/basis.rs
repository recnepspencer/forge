...
fn support_report_comparison_bundle_reuses_same_mismatch_surface() {
    ...
    assert_eq!(
        ...
        forge_foundational::FoundationalDiagnosticArtifactKind::SupportReport
    );
}

fn ready_support(
    report: &forge_foundational::FoundationalDiagnosticSupportReport,
...
fn ready_explanation(
    bundle: &forge_foundational::FoundationalDiagnosticExplanationBundle,
) -> forge_foundational::CanonicalBasisReadyArtifact {

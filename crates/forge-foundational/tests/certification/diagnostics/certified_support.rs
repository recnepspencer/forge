...
pub fn production_certified_profile() -> FoundationalProfileSet {
    FoundationalProfileSet::new(FoundationalProfileSetInput {
        ...
        admission_readiness: forge_foundational::AdmissionReadinessProfile::ProductionGateReady,
...
pub fn certified_support_report_complete() -> FoundationalDiagnosticSupportReport {
    forge_foundational::materialize_diagnostic_support_report(
        ...
        forge_foundational::FoundationalDiagnosticDeliveryClass::CanDefer,
    )
...
pub fn certification_authority() -> forge_proof::AuthorityWitness<
    forge_foundational::FoundationalDiagnosticCertifiedAttachmentAuthority,
> {

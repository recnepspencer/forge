use forge_foundational::{
    ...
    FoundationalProfileForgeProofSurface, FoundationalProfileMilestone3PhaseGate,
...
fn accepts_profile_readiness_proof(
    _: &forge_proof::Proof<
        FoundationalProfileProductionReadinessCertified,
        forge_foundational::FoundationalProfileProductionReadinessAuthority,
    >,
) {
}
...
fn production_readiness_artifact_carries_complete_machine_checkable_inventory() {
    ...
    assert_eq!(
        ...
        "forge-foundational.milestone-3"
    );

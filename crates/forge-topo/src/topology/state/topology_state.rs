...
pub struct TopologyState {
    ...
    pub(super) arena: Arc<TopologyArena>,
    ...
    pub(super) lineage_events: Arc<Vec<LineageEvent>>,
    ...
    #[serde(default)]
    pub(super) reidentification_link_index: Arc<ReidentificationLinkIndex>,
}

pub use crate::projection::data::{
    ProjectedBodyData, ProjectedBodyId, ProjectedEdgeData, ProjectedEdgeId, ProjectedEntityRef,
    ProjectedFaceData, ProjectedFaceId, ProjectedHalfEdgeData, ProjectedHalfEdgeId,
    ProjectedLoopData, ProjectedLoopId, ProjectedLumpData, ProjectedLumpId, ProjectedRegionData,
    ProjectedRegionId, ProjectedShellData, ProjectedShellId, ProjectedTopology,
    ProjectedTopologyError, ProjectedVertexData, ProjectedVertexId,
};
pub use crate::projection::logic::{
    compute_projected_topology_hash, validate_projected_acyclic_containment,
    validate_projected_bidirectional_links, validate_projected_broken_boundary,
    validate_projected_disk_closure, validate_projected_edge_endpoints_match_loop_vertices,
    validate_projected_face_adjacency, validate_projected_face_has_at_least_one_loop,

...
pub use forge_core::{InvariantContract, InvariantId, InvariantRelation, ValidatorCost};
...
pub fn validator_for(id: InvariantId) -> ValidatorEntry {
    ...
    match id {
        ...
        | InvariantId::EdgeCurveConsistency => ValidatorEntry::noop(),
    }
}

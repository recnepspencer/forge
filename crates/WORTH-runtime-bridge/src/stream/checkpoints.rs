...
impl ConsumerCheckpointToken {
    pub(crate) fn from_window(
        ...
        let basis = format!(
            "consumer-checkpoint-token|contract={}|protocol={}|frontier-kind={}|through-position={}|member-set-digest={}|retention-anchor={}|protocol-semantics-version=worth-runtime-bridge.stream.v1",
        ...
        Self {
            ...
            protocol_semantics_version: Arc::from("worth-runtime-bridge.stream.v1"),
            counters: window
                .counters()
                .clone()

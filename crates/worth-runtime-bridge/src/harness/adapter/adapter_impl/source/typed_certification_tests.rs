use worth_harness::facade::{ExecutionProfile, HarnessAdapter, ScenarioPlan};
...
fn source_fixture(name: &str) -> worth_harness::facade::ScenarioFixture<BridgeHarnessFixture> {
    ScenarioPlan::new(
        name,

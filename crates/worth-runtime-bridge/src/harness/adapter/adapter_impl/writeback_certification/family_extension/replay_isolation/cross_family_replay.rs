...
pub(in crate::harness::adapter::adapter_impl) struct FamilyExtensionCrossFamilyReplayIsolation {
...
impl FamilyExtensionCrossFamilyReplayIsolation {
    pub(in crate::harness::adapter::adapter_impl::writeback_certification::family_extension) fn from_replay_error(
        projected_bundle: &BridgeWritebackReplayBundle,
        aspect_bundle: &BridgeWritebackReplayBundle,
        error: &BridgeWritebackError,
        replay_record: &BridgeWritebackReplayRecord,

...
use forge_ui_components::{
    fg_alert, fg_button, fg_card, fg_dropdown, fg_form, fg_input, fg_modal, fg_textarea, fg_toast,
    AlertAction, DropdownItem, DropdownState, FgAlert, FgButton, FgButtonSize, FgButtonVariant,
    FgCard, FgDropdown, FgIcon, FgInput, FgTextArea, FgToast, FgToastVariant, IconStore,
};
    ...
    DEMO.with(|cell| {
            ...
            .show(ctx, |ui| {
                egui::ScrollArea::both().show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ui.add_space(32.0);
                        ui.label(
                            egui::RichText::new("Component Test Board")
                        ...
                        .show(ui, |ui| {
                            ui.horizontal(|ui| {
                                ...
                                fg_button(
                                    ...
                                    &t,
                                    icons,
                                    FgButton::new("Secondary").variant(FgButtonVariant::Secondary),
                                );
                                ui.add_space(8.0);
                                fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Danger").variant(FgButtonVariant::Danger),
                                );
                                ui.add_space(8.0);
                                fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Ghost").variant(FgButtonVariant::Ghost),
                                );
                                ui.add_space(8.0);
                                fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Link").variant(FgButtonVariant::Link),
                                );
                            });
                            ui.add_space(8.0);
                            ui.horizontal(|ui| {
                                fg_button(
                                    ...
                                    &t,
                                    icons,
                                    FgButton::new("Small").size(FgButtonSize::Sm),
                                );
                                ui.add_space(8.0);
                                fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Medium").size(FgButtonSize::Md),
                                );
                                ui.add_space(8.0);
                                fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Large").size(FgButtonSize::Lg),
                                );
                                ui.add_space(8.0);
                    ...
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            ui.horizontal(|ui| {
                                let resp =
                                    fg_button(ui, &t, icons, FgButton::new("Open Custom Modal"));
                                if resp.clicked() {
                                ...
                                let alert_resp = fg_button(
                                    ui,
                                    &t,
                                    icons,
                                    FgButton::new("Trigger Alert Dialog")
                                        .variant(FgButtonVariant::Danger),
                                );
                                if alert_resp.clicked() {
                                    demo.show_alert_dialog = true;
                                }
                            });
                        });
                    ui.add_space(24.0);
                        ...
                        .show(ui, |ui| {
                            ui.horizontal(|ui| {
                                for (label, variant) in [
                                    ...
                                    let resp =
                                        fg_button(ui, &t, icons, FgButton::new(label).variant(v));
                                    if resp.clicked() {
                            ...
                            if demo.toast_visible {
                                let msg = match demo.toast_variant {
                                    ...
                                    FgToastVariant::Error => {
                                        "Something went wrong. Please try again."
                                    }
                                    FgToastVariant::Info => "Here is some helpful information.",
                                };
                                let dismissed = fg_toast(
                                    ctx,
                                    &t,
                                    icons,
                                    "demo_toast",
                                    FgToast::new(msg)
                                        .variant(demo.toast_variant)
                                        .dismissible(true),
                                );
                                if dismissed {
                    ...
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            fg_input(
                                ui,
                                &t,
                                FgInput::new(&mut demo.input_demo)
                                    .label("Text Input")
                            ...
                            fg_textarea(
                                ui,
                                &t,
                                FgTextArea::new(&mut demo.textarea_demo)
                                    .label("Text Area")
                    ...
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            let items = vec![
                                ...
                                DropdownItem::new("subtract", "Boolean Subtract")
                                    .group("Operations"),
                                DropdownItem::new("intersect", "Boolean Intersect")
                                    .group("Operations"),
                            ...
                            let selection = fg_dropdown(
                                ...
                                FgDropdown::new(
                                    &items,
                                    demo.dropdown_selected.as_deref(),
                                    &mut demo.dropdown_state,
                                )
                    ...
                    section_header(
                        ui,
                        &t,
                        "Form Component (with built-in padding + button footer)",
                    );
                        ...
                        fg_form(
                            ...
                            |ui| {
                                fg_input(
                                    ui,
                                    &t,
                                    FgInput::new(&mut demo.form_name)
                                        .label("Full Name")
                                ...
                                fg_input(
                                    ui,
                                    &t,
                                    FgInput::new(&mut demo.form_email)
                                        .label("Email")
                                        .placeholder("jane@forge.dev"),
                                );
                                ui.add_space(12.0);
                                let sel = fg_dropdown(
                                    ui,
                                    ...
                                    FgDropdown::new(
                                        &role_items,
                                        demo.form_role_selected.as_deref(),
                                        &mut demo.form_role_state,
                                    )
                                    .label("Role")
                                    .placeholder("Select role…"),
                                );
                                if let Some(id) = sel {
                                    demo.form_role_selected = Some(id);
                                }
                                ui.add_space(12.0);
                                fg_textarea(
                                    ui,
                                    &t,
                                    FgTextArea::new(&mut demo.form_notes)
                                        .label("Notes")
                    ...
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            ui.label(
                                egui::RichText::new("XL — 20px Heading")
                                    .size(t.font_size_xl)
                                    .color(t.text_primary)
                                    .strong(),
                            );
                            ui.label(
                                egui::RichText::new("LG — 16px Subheading")
                                    .size(t.font_size_lg)
                                    .color(t.text_primary),
                            );
                            ui.label(
                                egui::RichText::new("MD — 14px Body")
                                    .size(t.font_size_md)
                                    .color(t.text_primary),
                            );
                            ui.label(
                                egui::RichText::new("SM — 12px Caption")
                                    .size(t.font_size_sm)
                                    .color(t.text_secondary),
                            );
                            ui.label(
                                egui::RichText::new("XS — 11px Fine print")
                                    .size(t.font_size_xs)
                                    .color(t.text_muted),
                            );
                        });
                    ...
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            let all_icons = [
                                ...
                                (FgIcon::Check, "Check"),
                                (FgIcon::X, "X"),
                                (FgIcon::Search, "Search"),
                                (FgIcon::Eye, "Eye"),
                                (FgIcon::PenLine, "PenLine"),
                                (FgIcon::Trash2, "Trash2"),
                                (FgIcon::Box, "Box"),
                                (FgIcon::Layers3, "Layers3"),
                                (FgIcon::Grid2x2, "Grid2x2"),
                                (FgIcon::Ruler, "Ruler"),
                                (FgIcon::Move3d, "Move3d"),
                                (FgIcon::Sun, "Sun"),
                                (FgIcon::Moon, "Moon"),
                                (FgIcon::ChevronRight, "ChevronRight"),
                                (FgIcon::ChevronDown, "ChevronDown"),
                                (FgIcon::MessageSquare, "MsgSq"),
                            ];
                            ui.horizontal_wrapped(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        fg_card(ui, &t, FgCard::flat(), |ui| {
                            ...
                            ui.label(
                                egui::RichText::new("Flat Card")
                                    .color(t.text_primary)
                                    .size(t.font_size_md)
                                    .strong(),
                            );
                            ui.label(
                                egui::RichText::new("bg_surface")
                                    .color(t.text_muted)
                                    .size(t.font_size_xs),
                            );
                        });
                        ...
                        fg_card(ui, &t, FgCard::raised(), |ui| {
                            ui.set_min_width(180.0);
                            ui.label(
                                egui::RichText::new("Raised Card")
                                    .color(t.text_primary)
                                    .size(t.font_size_md)
                                    .strong(),
                            );
                            ui.label(
                                egui::RichText::new("bg_raised")
                                    .color(t.text_muted)
                                    .size(t.font_size_xs),
                            );
                        });
                        ...
                        fg_card(ui, &t, FgCard::accent(), |ui| {
                            ui.set_min_width(180.0);
                            ui.label(
                                egui::RichText::new("Accent Card")
                                    .color(t.accent_primary)
                                    .size(t.font_size_md)
                                    .strong(),
                            );
                            ui.label(
                                egui::RichText::new("accent_subtle")
                                    .color(t.text_muted)
                                    .size(t.font_size_xs),
                            );
                        });
        ...
        if demo.show_modal {
            fg_modal(ctx, &t, "demo_modal", 400.0, |ui| {
                ui.label(
                    egui::RichText::new("Create Feature")
                        .color(t.text_primary)
                        .size(t.font_size_lg)
                        .strong(),
                );
                ...
                fg_input(
                    ui,
                    &t,
                    FgInput::new(&mut demo.modal_form_name)
                        .label("Name")
                        .placeholder("New Cube…"),
                );
                ui.add_space(12.0);
                fg_textarea(
                    ui,
                    &t,
                    FgTextArea::new(&mut demo.modal_form_desc)
                        .label("Description")
...
fn color_swatch(ui: &mut egui::Ui, name: &str, color: Color32, t: &forge_ui_theme::ForgeTheme) {
    ui.vertical(|ui| {
        ...
        ui.painter()
            .rect_filled(r, CornerRadius::same(4), Color32::from_rgb(40, 40, 40));

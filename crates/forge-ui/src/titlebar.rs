...
use forge_ui_components::{
    fg_icon_button, fg_page_tab, fg_search_bar,
    FgIcon, FgIconButton, FgPageTab, IconStore, SearchBarProps,
};
        ...
        .show(ctx, |ui| {
            ui.horizontal_centered(|ui| {
                ...
                let galley = ui.fonts(|f|
                    f.layout_no_wrap(logo_text.to_string(), egui::FontId::proportional(t.font_size_md), Color32::WHITE));
                ...
                if ui.is_rect_visible(logo_rect) {
                    ui.painter().rect_filled(logo_rect, CornerRadius::same(t.radius_sm as u8), t.accent_primary);
                ...
                if current == Page::Editor {
                    Frame::new()
                        ...
                        .show(ui, |ui| {
                            ui.label(egui::RichText::new("my_model.fg ●").color(t.text_secondary).size(t.font_size_sm));
                        });
                }

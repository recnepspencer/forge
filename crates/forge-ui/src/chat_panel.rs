...
pub fn draw_chat_panel(ui: &mut egui::Ui, state: &mut AppState) {
                ...
                .show(ui, |ui| {
                    ...
                    for msg in &messages {
                        ...
                        let text = match &msg.content {
                            ...
                            forge_ui_types::MessageContent::CodeBlock { source, .. } => {
                                source.clone()
                            }
                            forge_ui_types::MessageContent::KernelEvent(s) => {
                                format!("[event] {s}")
                            }
                        };
                            ...
                            Frame::new()
                                ...
                                .show(ui, |ui| {
                                    let (sender, color) = match msg.role {
                                        ...
                                        forge_ui_types::MessageRole::System => {
                                            ("System", t.text_muted)
                                        }
                                        forge_ui_types::MessageRole::User => {
                                            ("You", t.accent_primary)
                                        }
                                    };
                                    ui.label(
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ...
                            if ui.is_rect_visible(btn_rect) {
                                ...
                                let bg = if send_ready {
                                    t.accent_primary
                                } else {
                                    t.bg_raised
                                };
                                let bdr = if send_ready {
                                    t.accent_primary
                                } else {
                                    t.border_default
                                };
    ...
    ui.horizontal(|ui| {
        ...
        ui.add_space(4.0);
        ui.label(
            egui::RichText::new("Forge Kernel v0.1")
                .color(t.text_muted)
                .size(t.font_size_xs),
        );
    });

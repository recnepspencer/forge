...
use crate::data::temporal::{
    RuntimeClockBasis, TemporalExecutionSummary, TemporalFrontierSnapshot, TemporalWakeSummary,
};
...
impl Default for TemporalCostContractSummary {
    fn default() -> Self {
        Self {
            ...
            previous_value_lookup:
                "committed branch lineage access for the requested node".to_owned(),
            branch_restore:

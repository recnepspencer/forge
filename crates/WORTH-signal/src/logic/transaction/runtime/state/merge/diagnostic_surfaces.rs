...
) -> worth_foundational::facade::FoundationalMergeScope {
    match proof.scope_family() {
        BranchMergeRequestScopeFamily::FullBranch => {
            worth_foundational::facade::FoundationalMergeScope::full_branch()
        }
        BranchMergeRequestScopeFamily::SelectedNodes => {
            worth_foundational::facade::FoundationalMergeScope::selected_nodes(
                proof
                    .requested_nodes()
                    .iter()
                    .copied()
        ...
        BranchMergeRequestScopeFamily::SelectedAspects => {
            worth_foundational::facade::FoundationalMergeScope::selected_aspects(
                proof
                    .requested_aspects()
                    .iter()
...
fn lower_locators(
    version: CanonicalizationRuleVersion,
    locators: &[worth_foundational::facade::FoundationalTransitionLocator],
...
fn lower_locator(
    version: CanonicalizationRuleVersion,
    locator: worth_foundational::facade::FoundationalTransitionLocator,

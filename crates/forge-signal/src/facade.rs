...
pub mod core {
    ...
    pub use crate::data::resource::{
        ...
        resource_milestone_b_scenario_matrix, ActiveResourceRevalidationProof,
        ...
        ResourceNodeDeclaration, ResourceNodeId, ResourceObservationBatchReport,
        ResourceObservationDecisionClass, ResourceObservationDecisionPlan,
        ResourceObservationEvent, ResourceObservationPolicyDeclaration,
        ResourceOldHostWorkCancellationAdvisory, ResourceOutputContinuity,
        ResourceOutputContinuityDecisionClass, ResourceOutputContinuityDecisionPlan,
        ResourceOutputContinuityPolicyDeclaration, ResourceOverlappingGenerationAdmission,
        ResourcePayloadContract, ResourcePayloadContractDigest, ResourcePayloadContractId,
        ResourcePolicyCompatibilityClass, ResourcePolicyCompatibilityFamilyReport,
        ResourcePolicyCompatibilityPosture, ResourcePolicyCompatibilityReport,
        ResourcePolicyDescriptor, ResourcePolicyDescriptorId, ResourcePolicyDigest,
        ResourcePolicyKind, ResourcePolicyName, ResourcePolicyRegistration,

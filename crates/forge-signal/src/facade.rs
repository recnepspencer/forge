...
pub mod core {
    ...
    pub use crate::data::resource::{
        ...
        resource_milestone_b_scenario_matrix, AdmittedResourceCompletion, AdmittedResourceRequest,
        AdmittedResourceRetry, AdmittedResourceRevalidation, AsyncDenialId,
        ...
        InFlightResourceRequest, RawCompletionEnvelope, ResourceAttemptId, ResourceBranchEpoch,
        ...
        ResourceDensityStrategy, ResourceDiagnosticsExpansionBudget,
        ResourceDiagnosticsExpansionDenial, ResourceDiagnosticsExpansionDenialClass,
        ResourceDiagnosticsSummary, ResourceGeneration, ResourceInFlightStatus,
        ResourceInitialLifecycleClass, ResourceLifecycleClass, ResourceLifecycleOrdinal,
        ResourceLifecyclePolicyDeclaration, ResourceLifecycleRetentionCompactionReport,
        ResourceLifecycleTransition, ResourceLifecycleTransitionKind,
        ...
        ResourceMilestoneBScenarioRow, ResourceNodeDeclaration, ResourceNodeId,
...
pub mod runtime {
    ...
    pub use crate::data::resource::{
        ...
        ResourceDescriptorId, ResourceDescriptorVersion, ResourceDiagnosticsExpansionBudget,
        ResourceDiagnosticsExpansionDenial, ResourceDiagnosticsExpansionDenialClass,
        ...
        ResourcePayloadContractDigest, ResourcePolicyDescriptor, ResourcePolicyDigest,
        ResourcePolicyKind, ResourcePolicySelectionBasis, ResourceReplayReconstructionReport,
...
pub use crate::data::resource::{
    ...
    ResourceCompletionRollbackReport, ResourceCompletionRollbackSubject,
    ResourceCompletionStagingReport, ResourceCostContractId, ResourceCostPosture,
    ResourceDeclarationReport, ResourceDensityStrategy, ResourceDescriptorId,

        ...
        Ok(DiagnosticsRecord {
            ...
            extensions: BTreeMap::from([
                (
                    ...
                    SignalHarnessBridge::runtime_policy_summary(runtime_policy),
                ),
                (
...
impl ExplanationHarnessAdapter for SignalHarnessBridge {
            ...
            .map(|label| {
                ...
                let summary = if let Some(explanation) = explanation {
                    if let Some(fact) = runtime.graph.explanation_fact(node) {
                        json!({
                            ...
                            "artifact_materialization": SignalHarnessBridge::artifact_materialization_label(materialization_mode),
                        ...
                        if let Some(map) = summary.as_object_mut() {
                            map.insert(
                                ...
                                json!(SignalHarnessBridge::artifact_materialization_label(
                ...
                Ok(ExplanationRecord {
                    ...
                    extensions: BTreeMap::from([
                        (
                            "runtime_policy".to_string(),
                            SignalHarnessBridge::runtime_policy_summary(Self::runtime_policy(
...
impl ProvenanceHarnessAdapter for SignalHarnessBridge {
...
impl PerformanceHarnessAdapter for SignalHarnessBridge {
...
impl ReplayHarnessAdapter for SignalHarnessBridge {
    fn capture_replay(
        &self,
        ...
        Ok(ReplayRecord {
            ...
            summary: json!({
                ...
                "runtime_policy": SignalHarnessBridge::runtime_policy_summary(

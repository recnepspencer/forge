...
pub const TEMPORAL_REPLAY_PARITY_SCHEMA_VERSION: &str = "forge-signal-temporal-replay-parity-v1";
pub const TEMPORAL_CERTIFICATION_BUNDLE_SCHEMA_VERSION: &str =
    "forge-signal-temporal-certification-bundle-v1";
pub const TEMPORAL_CERTIFICATION_BUNDLE_PARITY_SCHEMA_VERSION: &str =
    "forge-signal-temporal-certification-bundle-parity-v1";

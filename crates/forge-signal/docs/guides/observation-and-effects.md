...
Forge Signal now has one runtime-backed observation story.
...
In Forge Signal, those are not separate subsystems stitched together later.
...
If you want the shortest path, use `forge_signal::easy::*`.

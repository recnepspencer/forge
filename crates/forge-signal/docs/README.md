...
Forge Signal is not just about rerunning less work.
...
Forge Signal keeps change propagation, transactional truth, explanation, and
...
Start with `forge_signal::easy` if you want the shortest guided path.
Start with `forge_signal::facade::*` if you want the broader runtime surface.

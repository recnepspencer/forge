...
impl WorkerRuntimeShell {
    pub fn record_worker_replay_checkpoint_retained_history(
        ...
        branch_id: u64,
        checkpoint: RuntimeSnapshot,
    ) -> Result<WorkerReplayCheckpointRetainedHistoryReport, WorthSignalJsError> {
    ...
    pub fn certify_worker_replay_checkpoint_retained_history(
        &mut self,
    ) -> Result<WorkerReplayCheckpointRetainedHistoryCertificationPackage, WorthSignalJsError> {
        let package =

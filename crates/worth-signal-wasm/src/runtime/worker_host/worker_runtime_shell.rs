...
impl WorkerRuntimeShell {
    ...
    ) -> Result<WorkerHostCapabilityIngressReport, WorthSignalJsError> {
    ...
    ) -> Result<WorkerBrowserHistoryIngressReport, WorthSignalJsError> {
        let runtime_values =
    ...
    ) -> Result<WorkerHostEffectRequestEnvelope, WorthSignalJsError> {
    ...
    ) -> Result<WorkerHostEffectAcknowledgementReport, WorthSignalJsError> {
    ...
    pub fn certify_main_thread_host_bridge(
        &self,
    ) -> Result<WorkerMainThreadHostBridgeCertificationPackage, WorthSignalJsError> {

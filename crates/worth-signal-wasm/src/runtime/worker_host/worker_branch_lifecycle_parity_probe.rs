...
) -> Result<WorkerBranchLifecycleParityProbeReport, WorthSignalJsError> {
...
fn capture_feature_branch_snapshots(
    ...
    feature_transaction_ops: Vec<TransactionOp>,
) -> Result<(RuntimeSnapshot, RuntimeSnapshot), WorthSignalJsError> {
...
fn commit_main_branch_after_feature_snapshot(
    ...
    main_transaction_ops: Vec<TransactionOp>,
) -> Result<WorkerBranchLifecycleTruthReport, WorthSignalJsError> {

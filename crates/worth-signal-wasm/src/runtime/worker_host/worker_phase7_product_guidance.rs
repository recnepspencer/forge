...
) -> Result<WorkerPhase7ProductGuidanceCertificationPackage, WorthSignalJsError> {
...
pub(crate) fn required_product_guidance_rules() -> Vec<WorkerPhase7CompatibilityGuidanceRule> {
    vec![
        guidance_rule(
            ...
            "workerRuntime",
            "Use worker-first deployment for heavy applications; runtime-owned semantics live in the worker-owned Worth proof chain.",
        ),
        guidance_rule(
            ...
            "workerRuntimeAfterWorthProofReadmission",

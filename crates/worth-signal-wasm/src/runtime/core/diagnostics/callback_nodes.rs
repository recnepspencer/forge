...
impl RuntimeCore {
    ...
    ) -> Result<Option<CallbackRuntimeNodeSummary>, WorthSignalJsError> {
    ...
    pub(super) fn callback_nodes_for_node_ids(
        &self,
        nodes: impl IntoIterator<Item = worth_signal::facade::NodeId>,
    ) -> Result<Vec<CallbackRuntimeNodeSummary>, WorthSignalJsError> {

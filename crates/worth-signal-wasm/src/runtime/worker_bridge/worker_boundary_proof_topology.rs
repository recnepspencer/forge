...
pub struct WorkerBoundaryProofStageSummary {
    ...
    pub worth_proof_stage: &'static str,
...
pub(in crate::runtime::worker_bridge) fn worker_boundary_proof_stages(
    ...
    vec![
        WorkerBoundaryProofStageSummary {
            ...
            worth_proof_stage: "Recipe<Unresolved, RawPlacementDeclaration>",
        ...
        WorkerBoundaryProofStageSummary {
            ...
            worth_proof_stage: "Recipe<Lowered, LoweredWorkerExecutionPlan>",
        ...
        WorkerBoundaryProofStageSummary {
            ...
            worth_proof_stage: "Recipe<Lowered, LoweredMainThreadHostedExecutionPlan>",
            owner: "runtime/placement/lowering/lowered_plan_proof",
            rust_type: type_name::<LoweredMainThreadHostedExecutionPlanProof>(),
        },
        WorkerBoundaryProofStageSummary {
            label: "boundaryBridgedReadmission",
            worth_proof_stage: "Recipe<Admitted, BoundaryBridgedWorkerEnvelope>",

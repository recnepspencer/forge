        ...
        let invocation = match compute_callbacks::invoke_compute(token) {
            ...
            Err(failure) => {
                ...
                return Err(JsValue::from(
                    crate::boundary::errors::WorthSignalJsError::from_compute_callback_failure(
                        failure,
                    ),
                ));
            }
...
impl Signals {
    pub(crate) fn output_callback_deferred_error_for_test(
        &self,
        id: &str,
    ) -> crate::boundary::errors::WorthSignalJsError {
    ...
    pub(crate) fn input_for_test(
        ...
        id: &str,
        initial: SignalValue,
    ) -> Result<InputSignal, crate::boundary::errors::WorthSignalJsError> {
    ...
    pub(crate) fn computed_for_test(
        ...
        id: &str,
        spec: ComputedSpec,
    ) -> Result<ComputedSignal, crate::boundary::errors::WorthSignalJsError> {
        self.core
            .borrow_mut()
    ...
    pub(crate) fn output_for_test(
        ...
        id: &str,
        spec: OutputSpec,
    ) -> Result<OutputSignal, crate::boundary::errors::WorthSignalJsError> {
        self.core
            .borrow_mut()
    ...
    pub(crate) fn read_for_test(
        &self,
        id: &str,
    ) -> Result<SignalValue, crate::boundary::errors::WorthSignalJsError> {

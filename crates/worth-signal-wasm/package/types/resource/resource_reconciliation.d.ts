...
declare const WorthSignalResourceItemAspectsBrand: unique symbol;
declare const WorthSignalResourceCollectionShapeBrand: unique symbol;
declare const WorthSignalResourcePatchBrand: unique symbol;
declare const WorthSignalResourceValueSummariesBrand: unique symbol;
declare const WorthSignalResourceDeliveryBrand: unique symbol;
...
> {
  ...
  readonly [WorthSignalResourceItemAspectsBrand]: "resourceItemAspects";
}
...
> {
  ...
  readonly [WorthSignalResourceValueSummariesBrand]: "resourceValueSummaries";
}
...
> {
  ...
  readonly [WorthSignalResourceCollectionShapeBrand]: "resourceCollectionShape";
}
...
> {
  ...
  readonly [WorthSignalResourcePatchBrand]: "resourcePatch";
}
...
export interface ReplaceResourceDelivery<TValue> {
  ...
  readonly nextValue: TValue;
  readonly [WorthSignalResourceDeliveryBrand]: "resourceDelivery";
}

export const HOST_CAPABILITY_PLAN_BRAND = Symbol("WorthSignal.hostCapabilityPlan");
export const HOST_VIEWPORT_REGISTRATION_BRAND = Symbol("WorthSignal.hostViewportRegistration");
export const HOST_VIEWPORT_HANDLE_BRAND = Symbol("WorthSignal.hostViewportHandle");
export const HOST_VISIBILITY_REGISTRATION_BRAND = Symbol("WorthSignal.hostVisibilityRegistration");
export const HOST_VISIBILITY_HANDLE_BRAND = Symbol("WorthSignal.hostVisibilityHandle");
export const HOST_ONLINE_REGISTRATION_BRAND = Symbol("WorthSignal.hostOnlineRegistration");
export const HOST_ONLINE_HANDLE_BRAND = Symbol("WorthSignal.hostOnlineHandle");
export const HOST_CLOCK_REGISTRATION_BRAND = Symbol("WorthSignal.hostClockRegistration");
export const HOST_CLOCK_HANDLE_BRAND = Symbol("WorthSignal.hostClockHandle");
export const HOST_PERSISTENCE_REGISTRATION_BRAND = Symbol("WorthSignal.hostPersistenceRegistration");
export const HOST_PERSISTENCE_HANDLE_BRAND = Symbol("WorthSignal.hostPersistenceHandle");
...
export function requireFunction(value, message) {
...
export function normalizeBinaryCapabilityState(
  family,
  value,
  positiveState,
  negativeState,
...
export function normalizeSubscription(value, family) {
...
export function nextHiddenHostSignalId(rawSignals, family) {
  const next = (HIDDEN_HOST_SIGNAL_COUNTERS.get(rawSignals) ?? 0) + 1;
  HIDDEN_HOST_SIGNAL_COUNTERS.set(rawSignals, next);
  return `__WorthSignal.host.${family}.${next}`;
}

export function emptyPerformanceSummary() {
  return {
...
export function unavailableArtifactKey(artifact) {
...
export function parseHostCapabilityPlan(options) {

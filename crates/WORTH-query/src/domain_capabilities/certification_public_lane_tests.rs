...
fn projection_contract_request() -> crate::domain_capabilities::WorthQueryProjectionContractRequest
{
...
) -> crate::domain_capabilities::WorthQueryLowerRuntimeExplanationRequest {

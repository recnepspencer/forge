...
) -> super::WorthQueryMaterializationReadyInvariantCapabilityContribution<
    super::WorthQueryLowerRuntimeBoundaryBoundContributionTarget,
> {
...
fn ready_invariant_registration(
    ...
    super::WorthQueryDeclarationBoundContributionTarget,
> {

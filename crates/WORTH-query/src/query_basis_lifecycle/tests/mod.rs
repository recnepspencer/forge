...
fn test_branch_identity(label: &str) -> worth_runtime_bridge::facade::BridgeIdentityEvidence {
    test_branch_truth_identity(label).bridge_admission_evidence()
}

fn test_snapshot_identity(label: &str) -> worth_runtime_bridge::facade::BridgeIdentityEvidence {
    test_snapshot_truth_identity(label).bridge_admission_evidence()
}

fn test_commit_identity(label: &str) -> worth_runtime_bridge::facade::BridgeIdentityEvidence {
    test_commit_truth_identity(label).bridge_admission_evidence()
}

fn test_branch_truth_identity(label: &str) -> worth_runtime_bridge::facade::TruthBranchIdentity {
    worth_runtime_bridge::facade::TruthBranchIdentity::from_relational_branch_id(label)
}
...
fn test_commit_truth_identity(label: &str) -> worth_runtime_bridge::facade::TruthCommitIdentity {
    worth_runtime_bridge::facade::TruthCommitIdentity::from_relational_commit_id(
        test_fixture_position("commit", label),
    )
}

fn test_preview_identity(label: &str) -> worth_runtime_bridge::facade::BridgeIdentityEvidence {
    worth_runtime_bridge::facade::BridgePreviewSessionIdentity::from_stable_name(label)

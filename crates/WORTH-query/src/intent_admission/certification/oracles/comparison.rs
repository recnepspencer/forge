use crate::facade::runtime::{
    ...
    WorthQueryIntentAdmissionFamily, WorthQueryIntentSourceLane,
};
...
fn actual_admitted_parts(
    ...
    vec![
        ...
        match fixture.decision {
            WorthQueryIntentAdmissionDecision::Admitted(_) => "admitted".to_string(),
...
fn actual_advisory_parts(
    ...
    vec![
        ...
        fixture
            ...
            .to_string(),
        match fixture.decision {
            WorthQueryIntentAdmissionDecision::Advisory(_) => "advisory".to_string(),
...
fn actual_violation_parts(
    ...
    vec![
        ...
        fixture
            ...
            .to_string(),
        match fixture.decision {
            WorthQueryIntentAdmissionDecision::Violation(_) => "violation".to_string(),
...
fn actual_deferred_parts(
    ...
    vec![
        ...
        fixture
            ...
            .to_string(),
        match fixture.decision {
            WorthQueryIntentAdmissionDecision::Advisory(_) => "deferred".to_string(),
...
fn actual_unsupported_parts(
    ...
    vec![
        ...
        fixture
            ...
            .to_string(),
        match fixture.decision {
            WorthQueryIntentAdmissionDecision::Violation(_) => "unsupported".to_string(),
...
trait EligibilityEvidenceExt {
    fn eligibility_evidence(
        &self,
    ) -> Option<&crate::intent_admission::WorthQueryIntentEligibilityTraceEvidence>;
}

impl EligibilityEvidenceExt for crate::intent_admission::WorthQueryIntentDecisionTraceRow {
    fn eligibility_evidence(
        &self,
    ) -> Option<&crate::intent_admission::WorthQueryIntentEligibilityTraceEvidence> {
        match self.evidence() {
            crate::intent_admission::WorthQueryIntentDecisionTraceEvidence::Eligibility(
                evidence,
            ) => Some(evidence),
            _ => None,
        }

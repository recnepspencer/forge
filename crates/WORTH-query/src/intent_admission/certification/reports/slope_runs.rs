...
pub enum WorthQueryIntentAdmissionSlopeLane {
...
impl WorthQueryIntentAdmissionSlopeLane {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum WorthQueryIntentAdmissionWidthRunScale {
    Small,
    Medium,
    Large,
}

impl WorthQueryIntentAdmissionWidthRunScale {
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            Self::Small => "small",
            Self::Medium => "medium",
...
pub struct WorthQueryIntentAdmissionWidthRunRow {
    lane: WorthQueryIntentAdmissionSlopeLane,
    scale: WorthQueryIntentAdmissionWidthRunScale,
    width: usize,
    row_digest: String,
}

impl WorthQueryIntentAdmissionWidthRunRow {
    pub fn lane(&self) -> WorthQueryIntentAdmissionSlopeLane {
        self.lane
    }

    pub fn scale(&self) -> WorthQueryIntentAdmissionWidthRunScale {
        self.scale
    }
...
pub(crate) fn lane_width_runs(
    lane: WorthQueryIntentAdmissionSlopeLane,
    tokens: Vec<String>,
) -> Vec<WorthQueryIntentAdmissionWidthRunRow> {
    [
        WorthQueryIntentAdmissionWidthRunScale::Small,
        WorthQueryIntentAdmissionWidthRunScale::Medium,
        WorthQueryIntentAdmissionWidthRunScale::Large,
    ]
    .into_iter()
...
pub(crate) fn slope_digest(
    width_runs: &[WorthQueryIntentAdmissionWidthRunRow],
    lane: WorthQueryIntentAdmissionSlopeLane,
) -> String {
    hash_parts(
        &width_runs
...
fn width_run_row(
    ...
    WorthQueryIntentAdmissionWidthRunRow {
        ...
        row_digest: hash_parts(&[
            "worth_query_intent_admission_width_run_row_v1".to_string(),

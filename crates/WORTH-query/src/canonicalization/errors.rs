...
pub enum QueryCanonicalizationError {
    UnsupportedAuthoredQueryFamily {
        family: &'static str,
    },
    UnsupportedAuthoredResultShapeFamily {
        family: &'static str,
    },
    EmptyRootEntityKey,
    ...
    NonCanonicalHelperResidueDetected {
        residue: &'static str,
    },
...
impl QueryCanonicalizationError {
    pub fn failure_class(&self) -> CanonicalizationFailureClass {
        match self {
            Self::UnsupportedAuthoredQueryFamily { .. }
            | Self::UnsupportedAuthoredResultShapeFamily { .. }
            ...
            | Self::NonCanonicalHelperResidueDetected { .. }

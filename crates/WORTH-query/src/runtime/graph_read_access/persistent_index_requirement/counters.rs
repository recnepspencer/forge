...
pub struct WorthQueryPersistentGraphIndexRequirementCounters {
...
impl WorthQueryPersistentGraphIndexRequirementCounters {
    ...
    pub(crate) fn digest_part(&self) -> String {
        hash_parts(&[
            "worth_query_persistent_graph_index_requirement_counters_v1".to_string(),

...
pub enum WorthQueryGraphReadSchemaReferenceAdmissionErrorKind {
    MissingFieldInFrozenSchemaView,
}

impl WorthQueryGraphReadSchemaReferenceAdmissionErrorKind {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryGraphReadSchemaReferenceAdmissionError {
    kind: WorthQueryGraphReadSchemaReferenceAdmissionErrorKind,
    read_graph_digest: String,
    aspect: AspectKey,
    field: FieldKey,
}

impl WorthQueryGraphReadSchemaReferenceAdmissionError {
    pub fn kind(&self) -> &WorthQueryGraphReadSchemaReferenceAdmissionErrorKind {
        &self.kind
    }
    ...
    pub(crate) fn missing_field(
        ...
        Self {
            kind:
                WorthQueryGraphReadSchemaReferenceAdmissionErrorKind::MissingFieldInFrozenSchemaView,

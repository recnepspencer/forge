...
pub struct WorthQueryLiveGraphReadMaintenanceCounters {
...
impl WorthQueryLiveGraphReadMaintenanceCounters {
    pub(crate) fn observed_live_read(
        affected_requirement_row_count: usize,
        live_view_update_count: usize,
    ) -> Self {
        WorthQueryLiveGraphReadMaintenanceCounterRecorder::live_read()
    ...
    pub(crate) fn observed_mutation_delivery(
        ...
        WorthQueryLiveGraphReadMaintenanceCounterRecorder::mutation_delivery()
            .observe_affected_requirement_rows(affected_requirement_row_count)
    ...
    pub(crate) fn digest(&self) -> String {
        hash_parts(&[
            "worth_query_live_graph_read_maintenance_counters_v1".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) struct WorthQueryLiveGraphReadMaintenanceCounterRecorder {
    mutation_delta_count: usize,
    affected_requirement_row_count: usize,
    touched_edge_count: usize,
    touched_frontier_count: usize,
...
impl WorthQueryLiveGraphReadMaintenanceCounterRecorder {
    ...
    pub(crate) fn finish(self) -> WorthQueryLiveGraphReadMaintenanceCounters {
        WorthQueryLiveGraphReadMaintenanceCounters {

...
use super::{
    WorthQueryAuthorityLane, WorthQueryRuntime, WorthQueryRuntimeError, WorthQueryRuntimeStateKind,
...
impl WorthQueryRuntimeStateTarget for &ScopedObservationBasis {
    fn into_state_snapshot(
        self,
        _runtime: &WorthQueryRuntime,
    ) -> Result<WorthQueryRuntimeStateSnapshot, WorthQueryRuntimeError> {
...
impl WorthQueryRuntimeStateTarget for &ScopedInspectionBasis {
    fn into_state_snapshot(
        self,
        _runtime: &WorthQueryRuntime,
    ) -> Result<WorthQueryRuntimeStateSnapshot, WorthQueryRuntimeError> {
            ...
            fn into_state_snapshot(
                ...
                Ok(match admission {
                    ...
                    BasisCapabilityAdmission::Advisory(advisory) => {
                        WorthQueryRuntimeStateSnapshot::deferred(
...
impl WorthQueryRuntimeStateTarget for &DeniedBasisCapability {
    fn into_state_snapshot(
        self,
        _runtime: &WorthQueryRuntime,
    ) -> Result<WorthQueryRuntimeStateSnapshot, WorthQueryRuntimeError> {
...
impl WorthQueryRuntimeStateTarget for &BasisIntentDenial {
    fn into_state_snapshot(
        self,
        _runtime: &WorthQueryRuntime,
    ) -> Result<WorthQueryRuntimeStateSnapshot, WorthQueryRuntimeError> {
...
fn snapshot_for_basis_admission(
    ...
    match admission {
        ...
        BasisCapabilityAdmission::Advisory(advisory) => WorthQueryRuntimeStateSnapshot::deferred(
            WorthQueryRuntimeStateKind::Pending,
...
fn basis_shape_identity(admission: &BasisCapabilityAdmission) -> WorthQueryEvidenceIdentity {
    match admission {

...
use crate::application::{
    ...
    WorthQueryDeclarationAspectPublication, WorthQueryDeclarationInput,
    WorthQueryDomainEntryMarker,
};

use super::{
    bundle::build_bundle, class::WorthQueryDeclarationFoundationalEvidenceClass,
    denial::WorthQueryDeclarationFoundationalEvidenceDenial, provenance::build_provenance,
    receipt::build_primary_receipt, subject::WorthQueryDeclarationFoundationalEvidenceInput,
    support::build_support_attachment,
};

pub struct WorthQueryDeclarationFoundationalEvidence<
    ...
    WorthQueryDeclarationFoundationalEvidence<D, I>
{
    ...
    pub fn legality_contract(&self) -> crate::application::WorthQueryDeclarationLegalityContract {
    ...
    pub fn subject(&self) -> &WorthQueryDeclarationFoundationalEvidenceInput<D, I> {
        &self.subject
    }
}

pub(crate) fn worth_query_declaration_foundational_evidence<
    D: WorthQueryDomainEntryMarker,
    I: WorthQueryDeclarationInput<D>,
>(
    expected_world_basis: &WorthQueryAdmittedWorldBasis,
    subject: WorthQueryDeclarationFoundationalEvidenceInput<D, I>,
...
> {
    ...
    if wrong_handle_identity {
        return Err(
            WorthQueryDeclarationFoundationalEvidenceDenial::wrong_world(
                subject.class(),
    ...
    Ok(WorthQueryDeclarationFoundationalEvidence::new(
        subject,

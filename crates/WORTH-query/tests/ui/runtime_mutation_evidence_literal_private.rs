...
fn main() {
    let declared = WorthQueryMutationTargetDescriptor {
        target_class: WorthQueryMutationTargetClass::Collection,
        collection: Some(String::new()),
        entity_identity: None,
    };
    let resolved = WorthQueryMutationTargetDescriptor {
        target_class: WorthQueryMutationTargetClass::Entity,
        collection: Some(String::new()),
        entity_identity: Some(String::new()),
    };
    let _ = WorthQueryMutationTargetEvidence { declared, resolved };
    let _ = WorthQueryMutationCausalityEvidence {
    ...
    let _ = WorthQueryMutationProvenanceEvidence {
    ...
    let _ = WorthQueryBatchMutationEvidence {
        component_count: 0,

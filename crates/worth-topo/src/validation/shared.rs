...
pub fn err(validator: &'static str, message: impl Into<String>) -> TopologyValidationError {
    TopologyValidationError::new(validator, message)
}
...
pub fn face_outer_loop_map(view: &TopologyView) -> BTreeMap<EntityId, EntityId> {
    view.faces
        .iter()
...
pub fn loop_face_map(view: &TopologyView) -> BTreeMap<EntityId, EntityId> {

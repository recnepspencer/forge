...
#[test]
fn query_native_edit_runner_executes_rehome_all_owned_faces_to_new_shell_workflow() {
    let mut runtime = build_worth_milestone_one_runtime().expect("worth runtime");
    let verified = seed_milestone_one_primitive(
        &mut runtime,
        "worth.query-native-edit.attach-shell-face-set",
    ...
    let mut workspace =
        worth_topology_runtime(adapters, "worth.query-native-edit.attach-shell-face-set")
            .expect("workspace");
    let assembly = WorthTopologyQueryAssembly::declare(&mut workspace).expect("declare assembly");
    let shell_key = WorthCreateKey::new("worth.query-native-edit.attach-shell-face-set.new_shell");
    let batch = WorthTopologyEditBatch::new(vec![
        ...
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set.region-owns-shell",
            WorthShellOrWireMembershipKind::RegionOwnsShell,
            region,
            created_ref(shell_key.as_str()),
        ),
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set.shell-owns-face-1",
            WorthShellOrWireMembershipKind::ShellOwnsFace,
            created_ref(shell_key.as_str()),
            face_ids[0],
        ),
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set.shell-owns-face-2",
            WorthShellOrWireMembershipKind::ShellOwnsFace,
            created_ref(shell_key.as_str()),
            face_ids[1],
        ),
...
#[test]
fn query_native_edit_runner_denies_shell_face_set_rehome_with_duplicate_face_membership() {
    let mut runtime = build_worth_milestone_one_runtime().expect("worth runtime");
    let verified = seed_milestone_one_primitive(
        &mut runtime,
        "worth.query-native-edit.attach-shell-face-set-duplicate",
        &WorthMilestoneOnePrimitiveCase::SheetPatch { face_count: 2 },
    )
    .expect("seed");
    let (region, shell, face_ids) =
    ...
    let assembly = WorthTopologyQueryAssembly::declare(&mut workspace).expect("declare assembly");
    let shell_key =
        WorthCreateKey::new("worth.query-native-edit.attach-shell-face-set-duplicate.new_shell");
    let batch = WorthTopologyEditBatch::new(vec![
        WorthTopologyEditContract::create_topology_entity(
            shell_key.as_str(),
            WorthTopologyEntityKind::Shell,
        ...
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set-duplicate.region-owns-shell",
            WorthShellOrWireMembershipKind::RegionOwnsShell,
            region,
            created_ref(shell_key.as_str()),
        ),
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set-duplicate.shell-owns-face-1",
            WorthShellOrWireMembershipKind::ShellOwnsFace,
            created_ref(shell_key.as_str()),
            face_ids[0],
        ),
        WorthTopologyEditContract::attach_shell_or_wire_membership(
            "worth.query-native-edit.attach-shell-face-set-duplicate.shell-owns-face-2",
            WorthShellOrWireMembershipKind::ShellOwnsFace,
            created_ref(shell_key.as_str()),
            face_ids[0],
        ),

...
pub use crate::projection::{
    ...
    topology_current_head_authoritative_context, topology_diagnostics_computed_declaration,
    ...
    topology_query_domain, topology_query_domain_entry, topology_query_domain_entry_checked,
    topology_query_domain_proof_root, topology_relation_live_view_declaration,
    topology_snapshot_read_only_context, topology_validation_computed_declaration,
    ...
    TopologyNoNPlusOneContractStatus, TopologyQueryDomain, TopologyQueryMutationEvidence,
    TopologyQuerySurfaceError, TopologySnapshotReadOnlyConfiguredDomainHandle,

...
use crate::edit::{
    ...
    TopologyEditRejectionClass, TopologyQueryEditExecutionError,
};
...
fn current_head_runtime_denies_splice_radial_adjacency_with_mismatched_source_binding() {
    ...
    assert!(report.rows[0]
        .changed_scopes
        .contains(&crate::edit::TopologyEditChangedScope::RadialNeighborhood));
    assert!(report.rows[0]
        .derived_regions
        .contains(&crate::edit::TopologyDerivedRegion::RadialNeighborhoodRegion));
}

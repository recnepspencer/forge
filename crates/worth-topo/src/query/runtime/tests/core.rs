use crate::query::{
    topology_runtime, TopologyQueryAssembly, TopologyQueryEditFamilySupportStatus,
    TopologyQueryEditLane, TopologyQueryEditLaneSupportStatus, TopologyRuntimeAdapters,
...
fn current_head_runtime_support_reports_authoritative_current_head_posture() {
    ...
    assert_eq!(
        support.query_edit_family_support_status(
            crate::edit::TopologyEditFamily::AttachBoundaryMembership
        ),
    ...
    assert_eq!(
        support
            .query_edit_family_support_status(crate::edit::TopologyEditFamily::RewireLoopSuccessor),
        TopologyQueryEditFamilySupportStatus::PartiallyAdmittedByLane
    );
    for lane in [
    ...
    for family in [
        crate::edit::TopologyEditFamily::CreateTopologyEntity,
        crate::edit::TopologyEditFamily::DetachBoundaryMembership,
        crate::edit::TopologyEditFamily::DetachRadialAdjacency,
        crate::edit::TopologyEditFamily::DetachShellOrWireMembership,
        crate::edit::TopologyEditFamily::RetireTopologyEntity,
        crate::edit::TopologyEditFamily::RewireLoopEndpoint,
        crate::edit::TopologyEditFamily::SpliceRadialAdjacency,
    ] {
        assert_eq!(

...
use schema::facade::{
    ...
    QueryLiveDeclarationBuilder, QueryLiveField, QuerySchemaBasis, RelationKind,
};
use serde_json::json;
...
pub(crate) fn topology_relation_dependency_path(kind: RelationKind) -> Option<&'static str> {
    match kind {
        RelationKind::Topology(
            schema::facade::TopologyRelationKind::ModelOwnsBody
            | schema::facade::TopologyRelationKind::BodyOwnsLump
            | schema::facade::TopologyRelationKind::LumpOwnsRegion
        ...
        RelationKind::Topology(
            schema::facade::TopologyRelationKind::FaceOuterLoop
            | schema::facade::TopologyRelationKind::FaceInnerLoop
            ...
            | schema::facade::TopologyRelationKind::HalfEdgeUsesEdge
        ...
        RelationKind::Topology(schema::facade::TopologyRelationKind::HalfEdgeRadialNext) => {

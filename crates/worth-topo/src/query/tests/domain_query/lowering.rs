...
use crate::query::domain::error::TopologyDomainQueryErrorKind;
...
use crate::query::domain::report::TopologyDomainQueryExecutionEngine;
use crate::query::domain::request::TopologyDomainQueryRequest;
...
use schema::facade::{QuerySchemaBasis, TopologyRelationKind};
...
fn topology_domain_views_expose_canonical_lowering_and_explicit_debt_rows() {
    ...
    let domain_query = crate::query::domain::TopologyDomainQuery::load();

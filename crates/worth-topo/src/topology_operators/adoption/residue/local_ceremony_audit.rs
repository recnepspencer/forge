...
pub(in crate::topology_operators::adoption) fn topology_operator_graph_obligation_local_ceremony_audit(
...
fn topology_operator_graph_obligation_audit_sources() -> ForgeQueryBoundaryAuditSourceSet {

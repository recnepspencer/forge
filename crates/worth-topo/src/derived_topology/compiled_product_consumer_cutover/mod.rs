...
pub use topology_derived_cluster::{
    ...
    digest_materialized_topology_view, topology_cutover_planned_disposition_from_update_posture,
    DerivedEquivalenceContractReport, DerivedInvalidationPlannedDisposition,
};
#[cfg(test)]
pub use topology_derived_cluster::{

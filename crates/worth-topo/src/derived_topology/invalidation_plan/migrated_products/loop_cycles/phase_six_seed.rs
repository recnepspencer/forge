...
use super::{LoopCycleMigrationCounters, LoopCycleOldAuthorityResidue};

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct LoopCyclePhaseSixSeed {
...
impl LoopCyclePhaseSixSeed {
    pub(crate) fn from_closeout_parts(
        ...
        let seed_digest = super::super::super::catalog::catalog_digest([
            "worth-topo:loop-cycle-phase-six-seed:v1".to_string(),

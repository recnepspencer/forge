...
pub(crate) fn selected_radial_rings_plan(
    operator_family: &'static str,
) -> DerivedInvalidationSelectedPlan {
    DerivedInvalidationSelectedPlan::lower(
        &catalog_closeout(),
        &selected_radial_ring_touched_closure(operator_family),
...
pub(crate) fn selected_radial_rings_plan_with_query_read_digest(
    operator_family: &'static str,
...
pub(crate) fn selected_radial_rings_plan_for_shell(
    operator_family: &'static str,
    shell_slot: u64,
) -> DerivedInvalidationSelectedPlan {
    DerivedInvalidationSelectedPlan::lower(
        &catalog_closeout(),
        &selected_radial_ring_touched_closure_for_shell(operator_family, shell_slot),
        &admitted_query_support(),
        &admitted_legality_support(),
        DerivedInvalidationDensityPolicy::Sparse,
    )

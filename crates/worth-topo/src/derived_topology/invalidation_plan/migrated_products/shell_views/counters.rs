...
use super::ShellViewDerivedProductOutput;

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ShellViewMigrationCounters {
...
impl ShellViewMigrationCounters {
    pub(crate) fn new(
        ...
        let touched_closure_shell_view_bound = output.touched_closure_shell_view_bound();
        ...
        let counters_digest = super::super::super::catalog::catalog_digest([
            "worth-topo:shell-view-migration-counters:v1".to_string(),

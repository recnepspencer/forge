...
use super::{ShellViewMigrationCounters, ShellViewOldAuthorityResidue};

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct ShellViewFamilyCloseoutSeed {
...
impl ShellViewFamilyCloseoutSeed {
    pub(crate) fn from_closeout_parts(
        ...
        let seed_digest = super::super::super::catalog::catalog_digest([
            "worth-topo:shell-view-family-closeout-seed:v1".to_string(),

...
use super::{WireViewMigrationCounters, WireViewOldAuthorityResidue};

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct WireViewFamilyCloseoutSeed {
...
impl WireViewFamilyCloseoutSeed {
    pub(crate) fn from_closeout_parts(
        ...
        let seed_digest = super::super::super::catalog::catalog_digest([
            "worth-topo:wire-view-family-closeout-seed:v1".to_string(),

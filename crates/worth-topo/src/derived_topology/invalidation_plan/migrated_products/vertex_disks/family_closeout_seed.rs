...
use super::{VertexDiskMigrationCounters, VertexDiskOldAuthorityResidue};

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub struct VertexDiskFamilyCloseoutSeed {
...
impl VertexDiskFamilyCloseoutSeed {
    pub(crate) fn from_closeout_parts(
        ...
        let seed_digest = super::super::super::catalog::catalog_digest([
            "worth-topo:vertex-disk-family-closeout-seed:v1".to_string(),

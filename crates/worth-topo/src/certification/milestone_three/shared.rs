...
use crate::edit::{
    ...
    TopologyQueryEditExecution, TopologyQueryEditExecutionError,
};
...
pub(super) type DeterministicDigestBackedEditDigest = crate::edit::TopologyEditDigest;
...
pub(super) fn accepted_step_row(
    ...
    execution: &TopologyQueryEditExecution,

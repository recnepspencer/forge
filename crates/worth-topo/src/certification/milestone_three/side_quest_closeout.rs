...
use crate::query::{
    build_domain_query_view_parity_artifact, query_entity_identity, topology_runtime,
    TopologyDomainQuery, TopologyDomainQueryParityKind, TopologyDomainQueryViewParityArtifact,
    TopologyDomainQueryViewRef, TopologyQueryAssembly, TopologyRuntimeAdapters,
};

pub(crate) fn certify_milestone_three_side_quest_closeout_impl<F>(

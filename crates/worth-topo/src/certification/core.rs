...
pub enum CertificationRequiredOutput {
    ...
    MilestoneThreeTopologyMutationDigestRows,
    MilestoneThreeNamingContinuityMatrixRows,
    MilestoneThreeNamingContinuityBreadthRows,
    MilestoneThreeRejectedMutationScopeReportRows,
    MilestoneThreeMutationReplayParityRows,
    MilestoneThreeMutationBranchLocalParityRows,
    MilestoneThreeReplayBranchBreadthRows,
    MilestoneThreeMutationTopologyQueryTraversalRows,
    ...
    MilestoneThreeMutationBreadthCounterRows,
    MilestoneThreeMutationFalloutBreadthRows,

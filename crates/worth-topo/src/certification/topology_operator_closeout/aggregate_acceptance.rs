...
use crate::topology_operators::{
    TopologyDerivedRegion, TopologyEditChangedScope, TopologyEditFamily,
};
...
fn build_edit_fallout_breadth_rows(
    reports: &[MilestoneThreeHostileScenarioReport],
    ...
    reports
        ...
        .map(|report| {
            ...
            let fallout_class = edit_fallout_class(report, derived_validation_row_count);
            ...
            MilestoneThreeEditFalloutBreadthRow {
                ...
                row_digest: format!(
                    "scenario={};fallout_class={fallout_class:?};declared_regions={declared_derived_region_count};validation_rows={derived_validation_row_count};fallback_count={fallback_count};locality_claim_mismatch=false",
                    report.scenario.as_str(),
                ),
            }
        })
...
fn edit_fallout_class(
    ...
    match report.outcome_class {
        ...
        MilestoneThreeHostileOutcomeClass::Accepted if derived_validation_row_count > 0 => {
            MilestoneThreeEditFalloutClass::WholeViewFallback
        }

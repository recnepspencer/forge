...
pub(super) fn build_determinism_rule_rows(
    ...
    for report in reports {
        rows.push(stable_edit_order_row(report));
        rows.push(stable_edit_digest_row(report));
...
fn stable_edit_order_row(
    ...
    MilestoneThreeDeterminismRuleRow {
        ...
        rule_kind: MilestoneThreeDeterminismRuleKind::StableEditOrder,
        evidence_count: report.topology_edit_digest.contract_count + replay.step_rows.len(),
        ...
        row_digest: format!(
            "scenario={};rule={};order_policy=sequence_preserving;digest={};contracts={};steps={};replay_steps={}",
            report.scenario.as_str(),
            MilestoneThreeDeterminismRuleKind::StableEditOrder.as_str(),
...
fn stable_edit_digest_row(
    report: &MilestoneThreeHostileScenarioReport,
) -> MilestoneThreeDeterminismRuleRow {
    let replay = &report.edit_replay_parity_report;
    MilestoneThreeDeterminismRuleRow {
        scenario: report.scenario,
        rule_kind: MilestoneThreeDeterminismRuleKind::StableEditDigest,
        ...
        row_digest: format!(
            ...
            report.scenario.as_str(),
            MilestoneThreeDeterminismRuleKind::StableEditDigest.as_str(),
            report.topology_edit_digest.digest.digest_hex,
            replay.step_rows.len(),
            replay.replay_step_rows.len(),
...
fn stable_rejection_classification_row(
    ...
    MilestoneThreeDeterminismRuleRow {
        ...
        replay_verified: report.edit_replay_parity_report.replay_checked
            && report.edit_replay_parity_report.mismatch_count == 0,
        diagnostic_classification_stable: report.rejection_class.is_some()
            && report.rejected_edit_scope_report.is_some(),
        tie_break_evidence_stable: false,
        row_digest: format!(

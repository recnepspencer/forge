...
use super::validator_family_record::family_digest;
...
pub struct WorthTopologyInvariantFamilyRecord {
    identity: WorthTopologyInvariantFamilyIdentity,
...
impl WorthTopologyInvariantFamilyRecord {
    pub(in crate::validator_invariant_catalog) fn from_input(
        input: WorthTopologyLegalityFamilyRecordInput<WorthTopologyInvariantFamilyIdentity>,
    ...
    pub fn identity(&self) -> &WorthTopologyInvariantFamilyIdentity {
        &self.identity
    }

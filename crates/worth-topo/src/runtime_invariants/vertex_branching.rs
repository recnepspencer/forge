...
pub fn registration(
) -> Result<CustomInvariantRegistration, forge_relational::facade::runtime::CustomInvariantRegistrationError>
{
...
impl CustomInvariantRule for VertexBranchingRule {
        ...
        CustomInvariantDescriptor {
            identity: CustomInvariantSemanticIdentity {
                rule_id: forge_relational::facade::runtime::CustomInvariantRuleId::new(
                    "worth.m1.topology.vertex_branching",
                ),
                semantic_version: CustomInvariantSemanticVersion::new(1, 0),
            },
            display_name: Arc::from("Worth Milestone 1 Vertex Branching"),
    ...
    fn evaluate(
        ...
        for (wire_id, kind_id) in &scope.topology_entities {
            ...
            let mut vertex_incident_halfedges: BTreeMap<RuntimeEntityRef, BTreeSet<RuntimeEntityRef>> =
                BTreeMap::new();

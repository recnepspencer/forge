...
pub struct QuerySubscriptionBasisVariationSet {
    digests: Vec<String>,
    identities: Vec<ForgeQueryEvidenceIdentity>,
    variation_identity: ForgeQueryEvidenceIdentity,
}
...
macro_rules! variation_set_impl {
    ($name:ident, $prefix:literal) => {
        impl $name {
            ...
            pub fn identities(&self) -> &[ForgeQueryEvidenceIdentity] {
                &self.identities
            }

            pub fn variation_identity(&self) -> &ForgeQueryEvidenceIdentity {
...
fn same_evidence_identity(
    left: &mut ForgeQueryEvidenceIdentity,
    right: &mut ForgeQueryEvidenceIdentity,
) -> bool {

...
impl QuerySubscriptionFamilyCoverageRow {
    ...
    fn new(
        ...
        let row_digest = hash_parts(&[
            ...
            lifecycle.subscription_family_for_reporting().to_string(),
        ...
        Self {
            ...
            subscription_family_digest: lifecycle.subscription_family_for_reporting().to_string(),
            ...
            basis_digest: lifecycle.basis_for_reporting().to_string(),
            ...
            view_shape_digest: lifecycle.view_shape_for_reporting().to_string(),
            lifecycle_class,
            row_digest,
        }
    }

pub struct ForgeQuerySubscriptionPhaseSevenCompileFailTarget {
    path: &'static str,
    forbidden_substitution: &'static str,
}

impl ForgeQuerySubscriptionPhaseSevenCompileFailTarget {
...
pub struct ForgeQuerySubscriptionPhaseSevenGoldenPath {
    path: &'static str,
}

impl ForgeQuerySubscriptionPhaseSevenGoldenPath {
...
const COMPILE_FAIL_TARGETS: &[ForgeQuerySubscriptionPhaseSevenCompileFailTarget] = &[
    ForgeQuerySubscriptionPhaseSevenCompileFailTarget::new(
...
const GOLDEN_PATHS: &[ForgeQuerySubscriptionPhaseSevenGoldenPath] = &[
    ForgeQuerySubscriptionPhaseSevenGoldenPath::new(
...
pub const fn forge_query_subscription_phase_seven_compile_fail_targets(
) -> &'static [ForgeQuerySubscriptionPhaseSevenCompileFailTarget] {
    COMPILE_FAIL_TARGETS
}

pub const fn forge_query_subscription_phase_seven_golden_paths(
) -> &'static [ForgeQuerySubscriptionPhaseSevenGoldenPath] {
    GOLDEN_PATHS
}

pub const FORGE_QUERY_SUBSCRIPTION_PHASE_SEVEN_COMPILE_FAIL_TARGET_COUNT: usize =
    COMPILE_FAIL_TARGETS.len();

pub const FORGE_QUERY_SUBSCRIPTION_PHASE_SEVEN_GOLDEN_PATH_COUNT: usize = GOLDEN_PATHS.len();

...
impl ActiveSubscriptionCounters {
    pub fn evidence_identity(&self) -> ForgeQueryEvidenceIdentity {
        ForgeQueryEvidenceIdentity::compose(ForgeQueryEvidenceScope::SubscriptionActivationReceipt)
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_registry_lookup"),
                self.active_lane_registry_lookup_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_lookup_class"),
                self.active_lane_lookup_class_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_linear_scan_debt"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_join_denial"),
                self.active_lane_join_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("shared_lane"),
                self.shared_lane_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_linear_scan_denial"),
                self.active_lane_linear_scan_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_allocation_denial"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("fanout_delivery"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("acknowledgement_frontier_advance"),
                self.acknowledgement_frontier_advance_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("acknowledgement_receipt_mismatch_denial"),
                self.acknowledgement_receipt_mismatch_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("acknowledgement_sequence_regression_denial"),
                self.acknowledgement_sequence_regression_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("delivery_gap_notice"),
                self.delivery_gap_notice_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("backpressure_denial"),
                self.backpressure_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("delivery_window_open"),
                self.delivery_window_open_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("delivery_window_overflow"),
                self.delivery_window_overflow_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("maintenance_delta_lowering"),
                self.maintenance_delta_lowering_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("maintenance_delta_width"),
                self.maintenance_delta_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_work_packet"),
                self.active_delivery_work_packet_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_work_packet_width"),
                self.active_delivery_work_packet_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_density_sparse"),
                self.active_delivery_density_sparse_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_density_burst_coalesced"),
                self.active_delivery_density_burst_coalesced_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_density_dense_debt"),
                self.active_delivery_density_dense_debt_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_delivery_density_dense_denial"),
                self.active_delivery_density_dense_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("raw_cdc_delivery_denial"),
                self.raw_cdc_delivery_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("raw_bridge_invalidation_denial"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("delivery_window_width"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("detail_field_patch_width"),
                self.detail_field_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("focused_inspector_patch_width"),
                self.focused_inspector_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("collection_membership_patch_width"),
                self.collection_membership_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("collection_order_patch_width"),
                self.collection_order_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("grouped_membership_patch_width"),
                self.grouped_membership_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("bounded_materialization_scope_patch_width"),
                self.bounded_materialization_scope_patch_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("continuation_remap"),
                self.continuation_remap_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("continuation_remap_width"),
                self.continuation_remap_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("continuation_remap_denial"),
                self.continuation_remap_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("continuation_advisory"),
                self.continuation_advisory_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("continuation_identity_break"),
                self.continuation_identity_break_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("preview_active_lane"),
                self.preview_active_lane_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("preview_authoritative_sharing_denial"),
                self.preview_authoritative_sharing_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("preview_discard_residue_check"),
            ...
            .field_usize(
                ForgeQueryEvidenceTag::new("preview_authoritative_residue"),
                self.preview_authoritative_residue_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("preview_promotion_handoff"),
                self.preview_promotion_handoff_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("consumer_attachment_close"),
                self.consumer_attachment_close_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("active_lane_close"),
                self.active_lane_close_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("subscription_lifecycle_closeout"),
                self.subscription_lifecycle_closeout_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("subscription_lifecycle_closeout_denial"),
                self.subscription_lifecycle_closeout_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("durable_checkpoint_overclaim_denial"),
                self.durable_checkpoint_overclaim_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("store_backed_restart_overclaim_denial"),
                self.store_backed_restart_overclaim_denial_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("subscription_performance_receipt"),
                self.subscription_performance_receipt_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("subscription_budget_consumption_width"),
                self.subscription_budget_consumption_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("subscription_budget_remaining_width"),
                self.subscription_budget_remaining_width as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("heap_allocation_debt"),
                self.heap_allocation_debt_count as usize,
            )
            .field_usize(
                ForgeQueryEvidenceTag::new("heap_allocation_denial"),

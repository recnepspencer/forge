...
pub use inspection::{
    ...
    CausalObservationOutcome, DeniedCausalInspection, ForgeQueryBatchWriteComponentInspection,
    ...
    ForgeQueryPreviewOutcomeInspection, ForgeQueryWriteReceiptInspection, QueryObservationReceipt,

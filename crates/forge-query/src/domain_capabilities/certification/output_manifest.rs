...
pub fn forge_query_domain_capability_certification_output_manifest() -> &'static [&'static str] {
...
mod tests {
    ...
    fn output_manifest_is_duplicate_free_and_matches_spec_shape() {
        let manifest = forge_query_domain_capability_certification_output_manifest();

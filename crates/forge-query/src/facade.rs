...
pub use crate::composition::{
    runtime_backed_query_composition_support_profile, BasisScopeEvidence, ComposedCanonicalQueryBundle,
    CompositionCounters, CompositionDigest, CompositionReport, ExpandedComposedIntent,
    ExpandedScopeArtifact, GuidedCompositionPath, QueryCompositionAdmissionFailureClass,
    QueryCompositionComplexityStatus, QueryCompositionDeferredScopeMarker,
    QueryCompositionError, QueryCompositionFamily, QueryCompositionSupportProfile,
    QueryScopeDescriptor, QueryTemplateDescriptor, ScopeFamily, ScopeLineageDigest,
    TemplateBindingDigest, TemplateBindingSet, TemplateFamily, TemplateInstantiationArtifact,
...
pub use crate::saved_query::{
    ...
    SavedQueryPersistenceClaim, SavedQueryPersistenceFamily, SavedQueryReuseDecision,
    SavedQueryReuseDenial, SavedQueryReuseDescriptor, SavedQueryReuseOutcome,
    SavedQueryRebindingDimension, SavedQueryRebindingLegality, SchemaBasisEquivalenceEvidence,
};
pub use crate::view_shape::{
    ...
    QueryResultBindingProof,
    ViewShapeCompatibilityMatrixArtifact, ViewShapeComplexityReport, ViewShapeComplexityStatus,
    ViewShapeCostClass, ViewShapeDeliveryMetadata, ViewShapeDescriptor, ViewShapeDigest,
    ViewShapeError, ViewShapeFailureClass, ViewShapeFamily, ViewShapeInvalidationPosture,
...
pub use crate::view_shape_live::{
    ...
    AuthoritativeGroupedBaselineArtifact, DetailFieldPatchArtifact,
    FocusedInspectorAspectPatchArtifact, GroupedDeltaArtifact, GroupedDeltaComputation,
    GroupedDesiredStateArtifact, GroupedExecutionLaneValue, GroupedExecutionMemberRow,
    GroupedExecutionSurfaceArtifact, GroupedLaneIdentity, GroupedLiveViewShapeArtifact,
    GroupedMemberState,
    GroupedMembershipTransition, GroupedMembershipTransitionKind, GroupedRefreshReason,
    GroupedViewResultArtifact, LiveViewShapeArtifact, LiveViewShapeExecutionEnvelope,
    LiveViewShapeFamily, ObservedInspectorPatchArtifact, TableRowPatchArtifact,
    ViewShapeLiveCounters, ViewShapeLiveError, ViewShapeLiveFailureClass,

...
pub mod consumer_kit {
    ...
    pub use crate::{
        ...
        ForgeQueryBoundaryAuditSyntaxClass, ForgeQueryConsumerResidueAudit,
        ForgeQueryConsumerResidueCertificationCaseEvidence, ForgeQueryConsumerResidueClass,
        ForgeQueryConsumerResidueDetection, ForgeQueryConsumerResidueFinding,
        ForgeQueryConsumerResidueQueryOwnedRootAuthority, ForgeQueryConsumerResidueRegistryRow,
        ForgeQueryConsumerResidueReport, ForgeQueryConsumerResidueSourceInventory,
        ForgeQueryConsumerResidueSourceSite, ForgeQueryEvidenceReportAdoptionAudit,
        ...
        ForgeQuerySupportSnapshot, ForgeQuerySupportSnapshotError,
        ForgeQuerySupportSnapshotErrorKind, ForgeQuerySupportSnapshotRow,
        ForgeQuerySupportSnapshotSchemaVersion, ForgeQuerySupportSnapshotTerminalJsonDocument,

...
pub enum BasisLifecycleProofShapeViolation {
    ...
    StaleProofReuse,
    OperationLaneForgery,
    ForgedLowerRuntimeAuthority,
}
...
impl BasisLifecycleProofShapeViolation {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::OperationLaneForgery => "operation_lane_forgery",
            Self::ForgedLowerRuntimeAuthority => "forged_lower_runtime_authority",
        }
    }
}
...
pub fn basis_lifecycle_proof_shape_audit() -> BasisLifecycleProofShapeAudit {
    ...
    BasisLifecycleProofShapeAudit::new(vec![
        ...
        row(
            ...
            "forged lower-runtime authority",
            CompileFailFixture,

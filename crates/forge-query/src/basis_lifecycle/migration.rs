...
pub fn basis_lifecycle_migration_audit() -> BasisLifecycleMigrationAudit {
    BasisLifecycleMigrationAudit::new(vec![
        BasisLifecycleMigrationAuditRow::new(
            ...
            "adapt_branch_admission_to_lifecycle / adapt_preview_admission_to_lifecycle",
            None,
        ),
        BasisLifecycleMigrationAuditRow::new(
            ...
            "adapt_query_basis_context_to_lifecycle",
            None,
        ),
        BasisLifecycleMigrationAuditRow::new(
            ...
            "adapt_subscription_basis_posture_to_lifecycle",
            None,
        ),
        BasisLifecycleMigrationAuditRow::new(
            ...
            "adapt_causal_inspection_evidence_to_lifecycle",
            None,
        ),
        BasisLifecycleMigrationAuditRow::new(
            ...
            "adapt_historical_materialization_to_lifecycle",
            None,
        ),
        BasisLifecycleMigrationAuditRow::new(

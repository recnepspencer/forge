...
pub struct CollectionCertificationBundle {
    ...
    pub cursor_progress_report: String,
    pub counter_snapshot: ExecutionCounters,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct CollectionRejectionBundle {
    pub profile: CertificationProfile,
...
pub enum CollectionPerturbationClass {
    OrderedCollectionParity,
    CursorRepeatability,
    TraversalBoundParity,
    AggregateRollupParity,
    DerivedFieldParity,
    OrderingDifference,
    CdcResultDifference,
    CollectionRejection,
...
pub type CollectionHostileExpectation = HostileExpectation;
pub type CollectionCertificationRow =
    CanonicalCertificationRow<CollectionPerturbationClass, CollectionCertificationBundle>;
pub type CollectionRejectionRow = RejectionCertificationRow<
    CollectionPerturbationClass,
    CollectionCertificationBundle,
    CollectionRejectionBundle,
>;
pub type CollectionCertificationMatrix = CertificationMatrix<
    CollectionPerturbationClass,
    CollectionCertificationBundle,
    CollectionRejectionBundle,
>;
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct CollectionBundleCompletenessReport {
    ...
    pub covered_perturbation_classes: Vec<CollectionPerturbationClass>,
    ...
    pub covers_full_milestone_four_spec_matrix: bool,
    pub offline_analysis_ready: bool,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct MilestoneFourCollectionCertificationArtifact {
    pub suite_name: &'static str,
    pub certification_bundle_digest: String,
    pub coverage_matrix_digest: String,
    pub bundle_completeness_report: CollectionBundleCompletenessReport,
    pub counter_snapshot: ExecutionCounters,
    pub matrix: CollectionCertificationMatrix,
}

impl CollectionCertificationMatrix {
    pub fn into_milestone_four_artifact(self) -> MilestoneFourCollectionCertificationArtifact {
...
impl CollectionCertificationBundle {
    pub fn has_required_outputs(&self) -> bool {
        !self.query_digest.is_empty()
            ...
            && !self.cursor_progress_report.is_empty()
            && self.counter_snapshot.executor_semantic_rediscovery_count() == 0
    }
}

impl CollectionCertificationRow {
    pub fn has_required_outputs(&self) -> bool {
        ...
        match self.hostile_expectation {
            HostileExpectation::EquivalentToControl => {
                self.control_lane.plan_digest == self.hostile_lane.plan_digest
                    ...
                    && self.control_lane.cursor_progress_report
                        == self.hostile_lane.cursor_progress_report

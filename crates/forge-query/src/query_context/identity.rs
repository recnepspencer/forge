...
pub(crate) fn compose_preview_derived_result_shape_digest(
    ...
    .field_shape(
        ForgeQueryEvidenceTag::new("shape_class"),
...
pub(crate) fn compose_query_basis_replay_digest(
    ...
    .field_shape(ForgeQueryEvidenceTag::new("query"), context.query_digest())
    .field_shape(ForgeQueryEvidenceTag::new("basis"), context.basis_digest())
    .field_shape(
    ...
    .field_shape(
        ForgeQueryEvidenceTag::new("metadata_result"),
        metadata_result_digest,
    )
    .field_shape(
        ForgeQueryEvidenceTag::new("prediction"),
        prediction_drift
...
pub(crate) fn compose_query_basis_counter_snapshot_digest(
    ...
    .field_usize(
        ForgeQueryEvidenceTag::new("binding_count"),
        context.counters().query_basis_binding_count(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("historical_lookup"),
        context.counters().historical_basis_lookup_count(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("binding_width"),
        context.counters().basis_binding_width(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("historical_width"),
        context.counters().historical_lookup_width(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("execution_count"),
    ...
    .field_usize(
        ForgeQueryEvidenceTag::new("result_shape_width"),
...
pub(crate) fn compose_query_diff_replay_digest(
    ...
    .field_shape(
        ForgeQueryEvidenceTag::new("comparison_family"),
        context.family().as_str(),
    )
    .field_shape(
        ForgeQueryEvidenceTag::new("left_basis"),
        context.left().basis_digest(),
    )
    .field_shape(
        ForgeQueryEvidenceTag::new("right_basis"),
        context.right().basis_digest(),
    )
    .field_shape(
        ForgeQueryEvidenceTag::new("comparison_result"),
...
pub(crate) fn compose_query_diff_counter_snapshot_digest(
    ...
    .field_usize(
        ForgeQueryEvidenceTag::new("comparison_lookups"),
        context.counters().comparison_basis_lookup_count(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("comparison_scope_width"),
        context.counters().comparison_scope_width(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("comparison_row_width"),
        context.counters().comparison_row_width(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("diff_input_breadth"),
        context.counters().diff_input_breadth(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("comparison_broadening_denials"),
        context.counters().comparison_broadening_denial_count(),
    )
    .field_usize(
        ForgeQueryEvidenceTag::new("change_rows"),
        change_set.rows().len(),
    )
    .seal()
    .as_str()
...
pub fn compose_construction_branch_basis_preparation_digest(
    ...
    preview_basis_admission: &crate::ForgeQueryEvidenceIdentity,
    branch_basis_admission: &crate::ForgeQueryEvidenceIdentity,
) -> String {
    ForgeQueryEvidenceIdentity::compose(
        ForgeQueryEvidenceScope::QueryContextCompatibilityBasisLabel,
    )
    ...
    .field_shape(
        ForgeQueryEvidenceTag::new("construction_family"),
        construction_family,
    )
    .field_shape(
        ForgeQueryEvidenceTag::new("branch_preview_contract"),
        branch_preview_contract_digest,
    )
    .field_evidence_identity(
        ForgeQueryEvidenceTag::new("preview_basis_admission"),
        preview_basis_admission,
    )
    .field_evidence_identity(
        ForgeQueryEvidenceTag::new("branch_basis_admission"),

...
pub use crate::query_basis_lifecycle::{
    admit_basis_capability, admit_certification_basis, admit_certification_basis_intent,
    admit_inspection_basis, admit_inspection_basis_intent, admit_materialization_basis,
    admit_materialization_basis_intent, admit_mutation_preparation_basis,
    admit_mutation_preparation_basis_intent, admit_observation_basis,
    admit_observation_basis_intent, admit_preview_closeout_basis,
    ...
    AdmittedBasisCapability, AdvisoryBasisCapability, BasisAuthorityPosture,
    BasisCapabilityAdmission, BasisCompatibilityDebtPosture, BasisCompatibilityDebtRegistry,
    BasisCompatibilityDebtRow, BasisEligibility, BasisEligibilityCounters,
    BasisEligibilityDisposition, BasisEligibilityTrace, BasisIntentDenial, BasisIntentDenialKind,
    BasisInventory, BasisInventoryDisposition, BasisInventoryOwner, BasisInventoryRow,
    BasisLaneSupportRow, BasisLaneSupportStatus, BasisLifecyclePosture, BasisNormalizationCounters,
    ...
    LowerRuntimeApiReuseClass, LowerRuntimeApiReuseMatrix, LowerRuntimeApiReuseRow,
    ...
    NormalizedBasisIntent, ObservationBasisCapability, PreviewCloseoutBasisCapability,
    QueryBasisLifecycleSupportReport, RawBasisIntent, RawBasisSelector, RawBasisSourcePath,
    RawFutureBasisNeighborFamily, ReplayBasisCapability, ScopedBasisConstructionCounters,
    ...
    TargetDxTranscriptInventory, TargetDxTranscriptKind, TargetDxTranscriptRow,
...
pub use crate::query_context::{
    ...
    build_scoped_query_basis_result_bundle, execute_and_build_scoped_query_basis_result_bundle,
    execute_query_basis_context, execute_scoped_query_basis_context, shape_query_diff_change_set,

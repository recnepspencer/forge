pub use crate::authoring::{
    ...
    EqualityPredicate, FieldName, ForgeQueryAdmittedGraphReadDomainOperationReference,
    ...
    ForgeQueryGraphReadOperationVersion, GuidedAuthoringPath, IntegerComparisonOperator,
...
pub use crate::projection_consumption::{
    ...
    ProjectionFactKind, ProjectionFactRequest, ProjectionSourceFamily,
    ProjectionSourceReferenceIdentity, SelfDescribingProjectionConsumptionEnvelope,

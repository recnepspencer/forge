...
pub use crate::effect_lifecycle::{
    ...
    normalize_raw_effect_intent, scope_admitted_effect_plan, AdmittedEffectIntent,
    AuthorityScopedEffectPlan, DeferredEffectEligibility, DeniedEffectEligibility,
    DeniedEffectEligibilityKind, EffectArtifactPolicy, EffectAuthoringBasis, EffectAuthorityLane,
    EffectAuthorityOwner, EffectConflictFootprint, EffectEligibility,
    EffectEligibilityDecisionTrace, EffectEligibilityOutcome, EffectExecutionAuthority,
    EffectExecutionDenial, EffectExecutionDenialKind, EffectFamily, EffectIntentDenial,
    ...
    EffectLoweringDenial, EffectLoweringDenialKind, EffectOperationInput,
    EffectPermittedLoweringFamily, EffectPolicyPosture, EffectPreviewPosture,
    EffectStrategyIdentityTarget, EffectSupportPosture, ExecutedEffectAuthorityArtifact,
    ExecutedEffectPlan, LoweredEffectExecutionArtifact, LoweredEffectExecutionPlan,
    NormalizedEffectIntent, RawEffectIntent, RebindRequiredEffectEligibility,
};

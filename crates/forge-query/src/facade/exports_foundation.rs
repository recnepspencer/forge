...
pub use crate::effect_lifecycle::{
    admit_effect_batch_components, admit_effect_intent, certify_effect_lifecycle_phase4,
    certify_effect_lifecycle_seeded, discover_effect_lifecycle_support, effect_batch,
    ...
    EffectEligibilityOutcome, EffectEnvelopePrimaryResult, EffectExecutionAuthority,
    ...
    EffectLifecycleSeededOutcomeClass, EffectLifecycleSupportDiscovery,
    EffectLifecycleSupportMatrix, EffectLifecycleSupportRow, EffectLoweredArtifactKind,
    ...
    EffectStrategyIdentityTarget, EffectSupportCause, EffectSupportPosture,
    ExecutedEffectAuthorityArtifact, ExecutedEffectBatchPlan, ExecutedEffectPlan,

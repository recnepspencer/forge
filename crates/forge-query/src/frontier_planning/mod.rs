...
impl PlannedWorkPacket {
    pub(crate) fn source_plan_digest(&self) -> &PlanDigest {
    ...
    pub(crate) fn scope_summary(&self) -> &str {
        &self.scope_summary
    }
...
impl FrontierPlanningCounters {
    ...
    fn mixed_basis_denial(route_count: usize) -> Self {
        Self {
            frontier_planning_invocation_count: 1,
            planned_packet_count: 0,
            planned_bundle_route_count: route_count,
            mixed_basis_denial_count: 1,
            predicted_breadth: 0,
            planned_packet_merge_boundary_count: 0,
        }
    }
}
...
impl FrontierPlanningReport {
    ...
    pub(crate) fn packet_merge_boundary_count(&self) -> usize {
        self.packet_merge_boundary_count
    }
...
impl FrontierRouteEvidence {
    ...
    pub(crate) fn route_posture_digest_for_test(
        ...
        self.route_posture_digest(frontier_plan)
    }
}

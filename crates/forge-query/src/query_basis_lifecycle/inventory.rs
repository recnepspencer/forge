...
const BASIS_INVENTORY_ROWS: &[BasisInventoryRow] = &[
    ...
    BasisInventoryRow {
        ...
        surface_label: "forge_relational::facade::{history,runtime,snapshots,replay,bridge}",
        disposition: BasisInventoryDisposition::ReusedAuthority,
    ...
    BasisInventoryRow {
        ...
        surface_label: "forge_signal::facade::{history,diagnostics,specialist}",
        disposition: BasisInventoryDisposition::ReusedAuthority,
...
const LOWER_RUNTIME_API_REUSE_ROWS: &[LowerRuntimeApiReuseRow] = &[
    ...
    LowerRuntimeApiReuseRow {
        owner: BasisInventoryOwner::Relational,
        api_label: "forge_relational::facade truth/history/snapshot/lineage APIs",
        reuse_class: LowerRuntimeApiReuseClass::ReusedAuthority,
        note: "relational branch, head, snapshot, and lineage evidence remains authority-owned",
    },
    LowerRuntimeApiReuseRow {
        owner: BasisInventoryOwner::Signal,
        api_label: "forge_signal::facade live observation and invalidation APIs",
        reuse_class: LowerRuntimeApiReuseClass::ReusedAuthority,
        note: "signal observation and invalidation evidence must be facade-returned rather than Query-forged",
    },
    LowerRuntimeApiReuseRow {
        owner: BasisInventoryOwner::Signal,
        api_label: "forge_signal::facade snapshot/replay/lineage/forensic APIs",

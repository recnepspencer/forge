...
impl AuthorityScopedEffectPlan {
    ...
    pub fn authority_owner(&self) -> EffectAuthorityOwner {
            ...
            .authority_target_family()
        {
            ...
            WorkflowAuthorityTargetFamily::QueryInspection => EffectAuthorityOwner::ForgeQuery,
        }
    }
...
planning_enum_as_str!(EffectAuthorityOwner {
    ForgeRelational => "forge-relational",
    ForgeRuntimeBridge => "forge-runtime-bridge",
    ForgeQuery => "forge-query",
});

...
pub(super) fn support_rows() -> &'static [SupportRowDescriptor] {
    ...
    &[
        SupportRowDescriptor {
            ...
            authority_owner: ForgeRelational,
            lowered_artifact_kind: LoweredMutationIntentDeclaration,
            receipt_artifact_kind: ForgeQueryIntentExecution,
            posture: Admitted,
            cause: Supported,
        },
        SupportRowDescriptor {
        ...
        SupportRowDescriptor {
            ...
            authority_owner: ForgeRuntimeBridge,
            lowered_artifact_kind: QueryWritebackDeclaration,
            receipt_artifact_kind: ForgeQueryWriteReceipt,
            posture: Admitted,
            cause: Supported,
        },
        SupportRowDescriptor {

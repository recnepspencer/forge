...
impl ForgeQueryLowerRuntimeCertificationLane {
...
pub struct ForgeQueryLowerRuntimeCertificationRow {
...
impl ForgeQueryLowerRuntimeCertificationRow {
    pub(crate) fn new(
        lane: ForgeQueryLowerRuntimeCertificationLane,
    ...
    pub fn lane(&self) -> ForgeQueryLowerRuntimeCertificationLane {
        self.lane
    }
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryLowerRuntimeCertificationOutputDigest {
    name: &'static str,
    digest: String,
}

impl ForgeQueryLowerRuntimeCertificationOutputDigest {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryLowerRuntimeCertificationBundle {
    rows: Vec<ForgeQueryLowerRuntimeCertificationRow>,
    output_digests: Vec<ForgeQueryLowerRuntimeCertificationOutputDigest>,
    certification_bundle_digest: String,
}

impl ForgeQueryLowerRuntimeCertificationBundle {
    pub(crate) fn new(
        rows: Vec<ForgeQueryLowerRuntimeCertificationRow>,
        output_digests: Vec<ForgeQueryLowerRuntimeCertificationOutputDigest>,
    ) -> Self {
    ...
    pub fn rows(&self) -> &[ForgeQueryLowerRuntimeCertificationRow] {
        &self.rows
    }

    pub fn output_digests(&self) -> &[ForgeQueryLowerRuntimeCertificationOutputDigest] {
        &self.output_digests
    }
    ...
    pub fn output_digest(&self, name: &str) -> Option<&str> {
        self.output_digests
            ...
            .map(ForgeQueryLowerRuntimeCertificationOutputDigest::digest)
    }
}

...
pub fn forge_query_lower_runtime_required_certification_outputs() -> &'static [&'static str] {
    &REQUIRED_CERTIFICATION_OUTPUT_MANIFEST
}

pub fn forge_query_lower_runtime_closeout_extension_outputs() -> &'static [&'static str] {
    &CLOSEOUT_EXTENSION_OUTPUT_MANIFEST
}

pub fn forge_query_lower_runtime_certification_output_manifest() -> &'static [&'static str] {

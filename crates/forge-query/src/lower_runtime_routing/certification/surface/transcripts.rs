...
pub struct ForgeQueryLowerRuntimeGoldenTranscript {
    label: &'static str,
    path: &'static str,
    dx_focus: &'static str,
}

impl ForgeQueryLowerRuntimeGoldenTranscript {
...
const GOLDEN_TRANSCRIPTS: [ForgeQueryLowerRuntimeGoldenTranscript; 3] = [
    ForgeQueryLowerRuntimeGoldenTranscript::new(
...
pub fn forge_query_lower_runtime_golden_transcripts(
) -> &'static [ForgeQueryLowerRuntimeGoldenTranscript] {
    &GOLDEN_TRANSCRIPTS
}

pub fn forge_query_lower_runtime_target_dx_digest() -> String {
    hash_parts(
        &GOLDEN_TRANSCRIPTS
            .iter()
...
pub(crate) fn forge_query_lower_runtime_golden_transcript_digest() -> String {
    hash_parts(
        &GOLDEN_TRANSCRIPTS
            .iter()
...
mod tests {
    ...
    fn golden_transcript_manifest_is_duplicate_free_and_nonempty() {
        let rows = forge_query_lower_runtime_golden_transcripts();

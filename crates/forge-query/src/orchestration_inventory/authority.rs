...
pub enum ForgeQueryOrchestrationBasisPosture {
    DeclarationEntry,
    ReadmissionAware,
...
impl ForgeQueryOrchestrationBasisPosture {
...
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Hash)]
pub enum ForgeQueryOrchestrationPolicyTenantPosture {
    InheritedPlatformPolicy,
    WorkflowPreviewAware,
}

impl ForgeQueryOrchestrationPolicyTenantPosture {
    pub fn as_str(self) -> &'static str {
        match self {
...
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Hash)]
pub enum ForgeQueryOrchestrationCollaborativeExtensionPosture {
    PlatformEntryReady,
    CollaborativePhasesReady,
}

impl ForgeQueryOrchestrationCollaborativeExtensionPosture {
    pub fn as_str(self) -> &'static str {
        match self {
...
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Hash)]
pub struct ForgeQueryOrchestrationLowerAuthorityAttachment {
    relational: bool,
    signal: bool,
    runtime_bridge: bool,
...
impl ForgeQueryOrchestrationLowerAuthorityAttachment {
    pub const fn new(
        relational: bool,
        signal: bool,
        runtime_bridge: bool,

...
pub(super) struct RepresentativeEligibilityDigests {
    pub(super) admitted: ForgeQueryIntentEligibilityTraceEvidence,
    pub(super) advisory: ForgeQueryIntentEligibilityTraceEvidence,
    pub(super) violation: ForgeQueryIntentEligibilityTraceEvidence,
    pub(super) failure: ForgeQueryIntentEligibilityTraceEvidence,
    pub(super) read: ForgeQueryIntentEligibilityTraceEvidence,
    pub(super) routing: ForgeQueryIntentEligibilityTraceEvidence,
}
...
pub(super) fn decision_digest(decision: &ForgeQueryIntentAdmissionDecision) -> String {
    match decision {
...
pub(super) fn admitted_plan_digest(plan: &ForgeQueryAdmittedIntentPlan) -> String {
    hash_parts(&[
...
pub(super) fn trace_row_digest(traces: &[&ForgeQueryIntentDecisionTraceEnvelope]) -> String {
    hash_parts(
        &traces
            .iter()
            .flat_map(|trace| {

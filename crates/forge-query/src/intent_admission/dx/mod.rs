...
pub(crate) const INTENT_ADMISSION_DX_EXPORTED_SURFACE: &[&str] = &[
    "ForgeQueryAdmittedRuntimeIntent",
    "ForgeQueryRuntimeIntentAdmissionReview",
    "ForgeQueryRuntimeIntentAuthoring",
    "forge_query_basis_observation_intent",
    "forge_query_projection_consumption_intent",
    "ForgeQueryBasisObservationAdmittedIntent",
    "ForgeQueryBasisObservationIntentAuthoring",
    "ForgeQueryBasisObservationIntentReview",
    "ForgeQueryProjectionConsumptionAdmittedIntent",
    "ForgeQueryProjectionConsumptionIntentAuthoring",
    "ForgeQueryProjectionConsumptionIntentReview",
    "ForgeQueryAdmittedRuntimeWriteBatchIntent",
    "ForgeQueryRuntimeWriteBatchIntentAdmissionReview",
    "ForgeQueryRuntimeWriteBatchIntentAuthoring",
    "ForgeQueryAdmittedRuntimeEffectWriteIntent",
    "ForgeQueryRuntimeEffectWriteIntentAdmissionReview",
    ...
    "ForgeQueryAdmittedWorkspaceLiveReadIntent",
    "ForgeQueryWorkspaceLiveReadIntentAdmissionReview",
    "ForgeQueryWorkspaceLiveReadIntentAuthoring",
    "ForgeQueryAdmittedRuntimeWriteIntent",
    "ForgeQueryRuntimeWriteIntentAdmissionReview",
    "ForgeQueryRuntimeWriteIntentAuthoring",
    "ForgeQueryAdmittedWorkspaceReadIntent",
    "ForgeQueryWorkspaceReadIntentAdmissionReview",
    "ForgeQueryWorkspaceReadIntentAuthoring",
    "ForgeQueryAdmittedRuntimeExistingTruthProbeIntent",
    "ForgeQueryRuntimeExistingTruthProbeIntentAdmissionReview",
    "ForgeQueryRuntimeExistingTruthProbeIntentAuthoring",
    "ForgeQueryAdmittedRuntimeInspectionIntent",
    "ForgeQueryRuntimeInspectionIntentAdmissionReview",
    "ForgeQueryRuntimeInspectionIntentAuthoring",
];
...
pub use batch_mutation::{
    ForgeQueryAdmittedRuntimeWriteBatchIntent, ForgeQueryRuntimeWriteBatchIntentAdmissionReview,
    ForgeQueryRuntimeWriteBatchIntentAuthoring,
};
pub use effect::{
...
pub use live_read::{
    ForgeQueryAdmittedWorkspaceLiveReadIntent, ForgeQueryWorkspaceLiveReadIntentAdmissionReview,
    ForgeQueryWorkspaceLiveReadIntentAuthoring,
};
pub use mutation::{
    ForgeQueryAdmittedRuntimeWriteIntent, ForgeQueryRuntimeWriteIntentAdmissionReview,
    ForgeQueryRuntimeWriteIntentAuthoring,
};
pub use read::{
    ForgeQueryAdmittedWorkspaceReadIntent, ForgeQueryWorkspaceReadIntentAdmissionReview,
    ForgeQueryWorkspaceReadIntentAuthoring,
};
pub use routing::{
    ForgeQueryAdmittedRuntimeExistingTruthProbeIntent,
...
pub use unified_inspection::{
    ForgeQueryAdmittedRuntimeInspectionIntent, ForgeQueryRuntimeInspectionIntentAdmissionReview,
    ForgeQueryRuntimeInspectionIntentAuthoring,
};

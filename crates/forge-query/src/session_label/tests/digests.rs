use super::super::ForgeQuerySessionLabelError;
...
fn canonical_session_label_phase_five_outputs_are_non_empty_and_stable() {
    ...
    let strings =
        super::super::ForgeQuerySessionLabel::scoped_strs("worth-kernel", ["temporal", "preview"])
    ...
    let failure_digest = crate::identity::hash_parts(&[
        ForgeQuerySessionLabelError::EmptyNamespace.to_string(),
        ForgeQuerySessionLabelError::EmptyNameSegment.to_string(),
        ForgeQuerySessionLabelError::MissingNameSegments.to_string(),
    ]);

...
pub enum ForgeQueryGraphObligationPreflightWitness {
    Missing,
    Satisfied { witness_digest: String },
}

impl ForgeQueryGraphObligationPreflightWitness {
    pub fn missing() -> Self {
        Self::Missing
    }
...
impl Default for ForgeQueryGraphObligationPreflightWitness {
    fn default() -> Self {
        Self::Missing
    }
}

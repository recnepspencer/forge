use super::*;
use crate::runtime::mutation::graph_composition::obligation::ForgeQueryGraphMutationPolicyGateVerdict;
use crate::runtime::{
    ForgeQueryGraphObligationBudgetExceededPolicy,
    ForgeQueryGraphObligationDiagnosticMaterialization,
    ForgeQueryGraphObligationExecutionCostClass, ForgeQueryGraphObligationExecutionResultRow,
...
pub struct ForgeQueryAuthoritativeMutationObligationDispatchProjection {
    selection_digest: String,
    dispatch_digest: String,
    envelope_digest: Option<String>,
    context_kind: Option<ForgeQueryGraphObligationDispatchContextKind>,
    ...
    policy_gate_verdict: Option<ForgeQueryGraphMutationPolicyGateVerdict>,
    rows: Vec<ForgeQueryAuthoritativeMutationObligationDispatchProjectionRow>,
}

#[derive(Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
pub struct ForgeQueryAuthoritativeMutationObligationDispatchProjectionRow {
    ...
    execution_cost_class: ForgeQueryGraphObligationExecutionCostClass,
    ...
    diagnostic_materialization: Option<ForgeQueryGraphObligationDiagnosticMaterialization>,
}

impl ForgeQueryAuthoritativeMutationObligationDispatchProjection {
                    ...
                    .filter_map(|plan| {
                        dispatch
                            ...
                            .map(|input| {
                                ...
                                ForgeQueryAuthoritativeMutationObligationDispatchProjectionRow::from_plan_and_input(
                                    plan,
                                    &input,
                                    result_row,
                                )
    ...
    pub fn context_kind(&self) -> Option<ForgeQueryGraphObligationDispatchContextKind> {
        self.context_kind
    }
    ...
    pub fn policy_gate_verdict(&self) -> Option<ForgeQueryGraphMutationPolicyGateVerdict> {
        self.policy_gate_verdict
    }

    pub fn rows(&self) -> &[ForgeQueryAuthoritativeMutationObligationDispatchProjectionRow] {
        &self.rows
    }
}

impl ForgeQueryAuthoritativeMutationObligationDispatchProjectionRow {
    fn from_plan_and_input(
        plan: &ForgeQueryGraphObligationDispatchPlan,
        input: &ForgeQueryGraphObligationExecutionInput,
        result_row: Option<&ForgeQueryGraphObligationExecutionResultRow>,
    ) -> Self {
        ...
        let verdict = result_row
            .and_then(ForgeQueryGraphObligationExecutionResultRow::verdict)
    ...
    pub fn execution_cost_class(&self) -> ForgeQueryGraphObligationExecutionCostClass {
    ...
    pub fn diagnostic_materialization(
        &self,
    ) -> Option<ForgeQueryGraphObligationDiagnosticMaterialization> {

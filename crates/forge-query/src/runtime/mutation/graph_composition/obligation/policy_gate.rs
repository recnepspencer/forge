...
use super::{
    ForgeQueryGraphObligationOperatingWorldDescriptor, ForgeQueryGraphObligationSelection,
    ForgeQueryGraphObligationSupportStatus,
};

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ForgeQueryGraphMutationPolicyGateVerdict {
    Allow,
    Advise,
    Deny,
}

impl ForgeQueryGraphMutationPolicyGateVerdict {
...
pub struct ForgeQueryGraphMutationPolicyGateEvidence {
...
impl ForgeQueryGraphMutationPolicyGateEvidence {
    pub(crate) fn from_admitted_context_and_selection(
        ...
        .field_value(
            ForgeQueryEvidenceTag::new("policy_tenant_admission"),
            bundle.digest().as_str(),
        )
        .field_value(ForgeQueryEvidenceTag::new("policy"), bundle.policy_digest())
        .field_value(
        ...
        .field_value(
            ForgeQueryEvidenceTag::new("branch"),
    ...
    pub fn verdict(&self) -> ForgeQueryGraphMutationPolicyGateVerdict {
        self.verdict
    }
...
fn policy_gate_verdict(
    ...
    selection: &ForgeQueryGraphObligationSelection,
) -> ForgeQueryGraphMutationPolicyGateVerdict {
    if selection
    ...
    {
        return ForgeQueryGraphMutationPolicyGateVerdict::Deny;
    }
    ...
    {
        return ForgeQueryGraphMutationPolicyGateVerdict::Advise;
    }

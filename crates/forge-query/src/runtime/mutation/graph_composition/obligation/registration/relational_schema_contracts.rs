...
) -> Result<ForgeQueryGraphObligationRegistration, ForgeQueryGraphObligationRegistrationDenial> {
    Ok(
...
fn schema_contract_rule_identity(rule: &InvariantRule) -> ForgeQueryGraphObligationRuleIdentity {
...
fn schema_contract_touch_selector(
    ...
    Ok(ForgeQueryGraphTouchSelector::relation_kind_id(

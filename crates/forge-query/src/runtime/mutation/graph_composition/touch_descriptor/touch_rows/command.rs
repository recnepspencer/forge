...
use crate::runtime::{
    ForgeQueryAspectMutationOperation, ForgeQueryGraphCompositionProgram,
    ForgeQueryGraphCompositionProgramStep, ForgeQueryWriteCommand,
};
...
fn sorted_unique_touches(
    values: impl IntoIterator<Item = crate::runtime::ForgeQueryAspectTouch>,

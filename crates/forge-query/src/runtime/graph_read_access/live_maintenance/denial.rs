use super::{ForgeQueryLiveGraphReadAccessPosture, ForgeQueryLiveGraphReadMaintenanceBudget};
use crate::identity::hash_parts;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryLiveGraphReadAccessDenial {
    digest: String,
...
impl ForgeQueryLiveGraphReadAccessDenial {
    ...
    pub(crate) fn new(
        ...
        let digest = hash_parts(&[
            "forge_query_live_graph_read_access_denial_v1".to_string(),

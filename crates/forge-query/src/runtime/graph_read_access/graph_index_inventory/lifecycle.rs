...
pub enum ForgeQueryGraphIndexLifecycleOwner {
    QueryRuntime,
    LowerRuntime,
    StoreOwned,
    DomainRegistration,
...
impl ForgeQueryGraphIndexLifecycleOwner {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum ForgeQueryGraphIndexLifecycleClass {
    RuntimeMaintained,
    LowerRuntimeOwned,
...
impl ForgeQueryGraphIndexLifecycleClass {
    pub fn as_str(&self) -> &'static str {
        match self {

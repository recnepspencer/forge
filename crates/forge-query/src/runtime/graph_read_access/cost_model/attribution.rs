use super::ForgeQueryGraphReadMemoryByteEstimate;
use crate::runtime::ForgeQueryGraphReadAccessRequirementKind;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadIntrinsicCostContribution {
...
impl ForgeQueryGraphReadIntrinsicCostContribution {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadSupportedCostContribution {
    memory: ForgeQueryGraphReadMemoryByteEstimate,
    allocation_lifecycle_count: usize,
}

impl ForgeQueryGraphReadSupportedCostContribution {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadCostAttributionRow {
    requirement_digest_part: String,
    requirement_kind: ForgeQueryGraphReadAccessRequirementKind,
    intrinsic: ForgeQueryGraphReadIntrinsicCostContribution,
    supported: ForgeQueryGraphReadSupportedCostContribution,
}

impl ForgeQueryGraphReadCostAttributionRow {
    ...
    pub fn intrinsic(&self) -> &ForgeQueryGraphReadIntrinsicCostContribution {
        &self.intrinsic
    }

    pub fn supported(&self) -> &ForgeQueryGraphReadSupportedCostContribution {
        &self.supported
    }

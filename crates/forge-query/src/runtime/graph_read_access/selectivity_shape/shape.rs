use super::super::{
    ForgeQueryAdmittedBooleanPredicateExpression, ForgeQueryBooleanPredicateTopology,
    ForgeQueryBooleanSelectivityAdmissionPosture, ForgeQueryBooleanSelectivityShapeDigest,
    ForgeQueryGraphReadAccessShape, ForgeQueryPredicateAnchorPosture,
    ForgeQueryTraversalPredicateOrderingPosture,
};
use super::{
    branch::ForgeQueryBooleanSelectivityBranch, counters::ForgeQueryBooleanSelectivityCounters,
    row::ForgeQueryBooleanPredicateSelectivityRow,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryBooleanSelectivityShape {
    digest: ForgeQueryBooleanSelectivityShapeDigest,
    read_graph_digest: String,
    access_shape_digest: String,
    boolean_topology: ForgeQueryBooleanPredicateTopology,
    ...
    admission_posture: ForgeQueryBooleanSelectivityAdmissionPosture,
    branches: Vec<ForgeQueryBooleanSelectivityBranch>,
    predicate_rows: Vec<ForgeQueryBooleanPredicateSelectivityRow>,
    counters: ForgeQueryBooleanSelectivityCounters,
}

impl ForgeQueryBooleanSelectivityShape {
    pub fn digest(&self) -> &ForgeQueryBooleanSelectivityShapeDigest {
        &self.digest
    }
    ...
    pub fn boolean_topology(&self) -> &ForgeQueryBooleanPredicateTopology {
    ...
    pub fn admission_posture(&self) -> &ForgeQueryBooleanSelectivityAdmissionPosture {
    ...
    pub fn branches(&self) -> &[ForgeQueryBooleanSelectivityBranch] {
        &self.branches
    }

    pub fn counters(&self) -> &ForgeQueryBooleanSelectivityCounters {
        &self.counters
    }
    ...
    pub(crate) fn new(
        ...
        let counters = ForgeQueryBooleanSelectivityCounters::from_expression(
            &expression,
            &predicate_rows,
        ...
        let digest = ForgeQueryBooleanSelectivityShapeDigest::from_parts(&parts);
        Self {
            digest,
            read_graph_digest,
            access_shape_digest,

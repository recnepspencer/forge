...
use crate::runtime::{ForgeQueryBranchBasisAdmission, ForgeQueryPreviewBasisAdmission};
use crate::tenant_basis::{SchemaVariantSnapshot, TenantBindingSnapshot};

#[derive(Clone, Debug, Eq, PartialEq)]
pub enum ForgeQueryGraphReadAccessAuthorityRequest {
    CurrentHead {
        policy_tenant: Option<AdmittedPolicyTenantContext>,
        relationship_proof: Option<RelationshipProofAdmission>,
    },
    Preview {
        basis: ForgeQueryPreviewBasisAdmission,
        policy_tenant: Option<AdmittedPolicyTenantContext>,
        relationship_proof: Option<RelationshipProofAdmission>,
    },
    Branch {
        basis: ForgeQueryBranchBasisAdmission,
        policy_tenant: Option<AdmittedPolicyTenantContext>,
        relationship_proof: Option<RelationshipProofAdmission>,
    },
}
...
pub struct ForgeQueryGraphReadPolicyTenantAuthorityRequest {
...
impl ForgeQueryGraphReadPolicyTenantAuthorityRequest {
    pub fn current_read(
        query: &CanonicalQueryArtifact,
        policy: PolicyRuleSnapshot,
        tenant: TenantBindingSnapshot,
...
impl ForgeQueryGraphReadAccessAuthorityRequest {
    ...
    pub fn preview(basis: &ForgeQueryPreviewBasisAdmission) -> Self {
        Self::Preview {
            basis: basis.clone(),
            policy_tenant: None,
            relationship_proof: None,
    ...
    pub fn branch(basis: &ForgeQueryBranchBasisAdmission) -> Self {
        Self::Branch {
            basis: basis.clone(),
            policy_tenant: None,
            relationship_proof: None,

use super::ForgeQueryAdmittedGraphReadAccessPlan;
use crate::identity::hash_parts;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadAccessExecutionCounters {
...
impl ForgeQueryGraphReadAccessExecutionCounters {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) struct ForgeQueryGraphReadAccessExecutionRecorder {
    executor_entry_count: usize,
    strategy_recompute_count: usize,
    ephemeral_index_allocation_count: usize,
    edge_scan_count: usize,
...
impl ForgeQueryGraphReadAccessExecutionRecorder {
    ...
    pub(crate) fn finish(self) -> ForgeQueryGraphReadAccessExecutionCounters {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadPersistentArtifactAudit {
...
impl ForgeQueryGraphReadPersistentArtifactAudit {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadAccessPlanConsumption {
    digest: String,
    admitted_plan_digest: String,
    admission_digest: String,
    execution_binding_digest: String,
    execution_strategy: String,
    execution_counters: ForgeQueryGraphReadAccessExecutionCounters,
}

impl ForgeQueryGraphReadAccessPlanConsumption {
    ...
    pub fn execution_counters(&self) -> &ForgeQueryGraphReadAccessExecutionCounters {
    ...
    pub(crate) fn from_plan_binding_and_execution_counters(
        ...
        let digest = hash_parts(&[
            "forge_query_graph_read_access_plan_consumption_v1".to_string(),

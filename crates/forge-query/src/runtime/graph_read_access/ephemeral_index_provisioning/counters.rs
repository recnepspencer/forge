use super::ForgeQueryEphemeralGraphIndexLifecycleRegistry;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryEphemeralGraphIndexCounters {
...
impl ForgeQueryEphemeralGraphIndexCounters {
    ...
    pub(in crate::runtime::graph_read_access::ephemeral_index_provisioning) fn from_lifecycle_registry(
        registry: &ForgeQueryEphemeralGraphIndexLifecycleRegistry,
    ) -> Self {
        Self {

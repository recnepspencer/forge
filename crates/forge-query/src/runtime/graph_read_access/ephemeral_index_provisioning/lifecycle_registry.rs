use super::{ForgeQueryEphemeralGraphIndex, ForgeQueryEphemeralGraphIndexCounters};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryEphemeralGraphIndexLifecycleRegistry {
...
impl ForgeQueryEphemeralGraphIndexLifecycleRegistry {
    ...
    pub(in crate::runtime::graph_read_access::ephemeral_index_provisioning) fn release_index(
        &mut self,
        _index: ForgeQueryEphemeralGraphIndex,
    ) {
    ...
    pub(in crate::runtime::graph_read_access::ephemeral_index_provisioning) fn close_scope_counters(
        &self,
    ) -> ForgeQueryEphemeralGraphIndexCounters {
        ForgeQueryEphemeralGraphIndexCounters::from_lifecycle_registry(self)
    }

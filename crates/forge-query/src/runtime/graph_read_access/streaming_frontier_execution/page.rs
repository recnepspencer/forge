use super::ForgeQueryGraphReadFrontierCursor;
use crate::identity::hash_parts;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadStreamingPageReceipt {
    digest: String,
    ...
    next_cursor: Option<ForgeQueryGraphReadFrontierCursor>,
}

impl ForgeQueryGraphReadStreamingPageReceipt {
    ...
    pub fn next_cursor(&self) -> Option<&ForgeQueryGraphReadFrontierCursor> {
    ...
    pub(crate) fn with_next_cursor(
        mut self,
        next_cursor: ForgeQueryGraphReadFrontierCursor,
    ) -> Self {
    ...
    pub(crate) fn digest_part(&self) -> String {
        format!(
            ...
            self.next_cursor
                .as_ref()
                .map(ForgeQueryGraphReadFrontierCursor::digest_part)
...
fn page_digest(
    ...
    hash_parts(&[
        "forge_query_graph_read_streaming_page_receipt_v1".to_string(),

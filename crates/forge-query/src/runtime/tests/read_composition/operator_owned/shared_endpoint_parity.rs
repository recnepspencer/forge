...
#[test]
fn compose_read_shared_endpoint_detail_matches_open_coded_local_detail_query_semantics() {
    let mut workspace = read_runtime()
        .workspace("runtime.read-composition.shared-endpoint-parity-detail")
...
#[test]
fn compose_read_shared_endpoint_collection_matches_open_coded_local_collection_query_semantics() {
    let mut workspace = read_runtime()
        .workspace("runtime.read-composition.shared-endpoint-parity-collection")
        .expect("read-backed runtime should open a workspace");

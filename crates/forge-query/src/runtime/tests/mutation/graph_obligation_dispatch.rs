...
fn runtime_with_relation_obligation(relation_kind: &str) -> ForgeQueryRuntime {
    complete_backend_from_parts_builder()
        .graph_obligation(
            ForgeQueryGraphObligationRegistration::schema_contract_validator(
                ...
                .unwrap(),
                ForgeQueryGraphTouchSelector::relation_kind(relation_kind).unwrap(),
...
fn runtime_with_collection_obligation(collection: &str) -> ForgeQueryRuntime {
...
fn runtime_with_blocking_collection_obligation(collection: &str) -> ForgeQueryRuntime {
    runtime_with_collection_registration(collection_registration(
        collection,
...
fn runtime_with_scalar_collection_obligation(collection: &str) -> ForgeQueryRuntime {
    runtime_with_collection_registration(collection_registration(
        collection,
        ForgeQueryGraphObligationSupportPosture::supported(
            ForgeQueryGraphObligationSupportLane::ScalarMutation,

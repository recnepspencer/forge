...
fn authoritative_intent_receipt_identity_keeps_typed_scope_under_delimiter_pressure() {
    ...
    assert_eq!(
        ...
        ForgeQueryEvidenceScope::IntentReceiptInspection
    );
    assert_eq!(
...
fn effect_triggered_intent_receipt_identity_keeps_nested_receipts_typed() {
    ...
    assert_eq!(
        ...
        ForgeQueryEvidenceScope::EffectIntentReceiptPhase
    );
    assert_eq!(
        inspection.inspection_identity().scope(),
    ...
    assert_eq!(
        ...
        ForgeQueryEvidenceScope::FeedbackPhaseGraph
    );
    assert_eq!(
        inspection
            .feedback_graph()
    ...
    assert_eq!(
        ...
        ForgeQueryEvidenceScope::FeedbackPhaseGraphInspection
    );
    assert_eq!(

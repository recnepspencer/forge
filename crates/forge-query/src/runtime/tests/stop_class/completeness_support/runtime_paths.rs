...
pub(in super::super) fn intent_commit_denied_error() -> ForgeQueryRuntimeError {
...
pub(in super::super) fn intent_execution_routing_failed_error() -> ForgeQueryRuntimeError {
...
pub(in super::super) fn preview_promotion_write_failed_error() -> ForgeQueryRuntimeError {
    let mut runtime = ForgeQueryRuntime::builder()
        .runtime_bridge(test_bridge())
        .schema_adapter(TestSchemaAdapter)
        .source_adapter(TestSourceAdapter::default())
...
pub(in super::super) fn preview_promotion_stale_basis_error() -> ForgeQueryRuntimeError {
    let mut runtime = ForgeQueryRuntime::builder()
        .runtime_bridge(test_bridge())
        .schema_adapter(TestSchemaAdapter)
        .source_adapter(TestSourceAdapter::default())
...
pub(in super::super) fn preview_promotion_atomic_batch_unsupported_error() -> ForgeQueryRuntimeError
{

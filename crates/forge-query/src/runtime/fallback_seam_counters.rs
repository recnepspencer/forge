...
pub(crate) enum ForgeQueryForbiddenFallbackSeam {
    ConsumeScalarFields,
    DecodeRowPair,
    DecodeRowTriple,
...
impl ForgeQueryForbiddenFallbackSeam {
    fn index(self) -> usize {
        match self {
...
pub(crate) fn record_forbidden_fallback_seam_invocation(seam: ForgeQueryForbiddenFallbackSeam) {
...
pub(crate) fn forbidden_fallback_seam_invocation_count(
    seam: ForgeQueryForbiddenFallbackSeam,
) -> usize {

...
pub struct ForgeQueryAuthoritativeMutationEvidenceSupport {
    ...
    bridge_backed_verification_support_rows: Vec<ForgeQueryBridgeBackedVerificationSupportRow>,
...
impl ForgeQueryAuthoritativeMutationEvidenceSupport {
    pub fn derive(support_profile: &ForgeQueryRuntimeSupportProfile) -> Self {

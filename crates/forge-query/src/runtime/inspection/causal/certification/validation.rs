...
pub(super) fn validate_redaction_identity(
    ...
    let same_identity =
        full_artifact.causal_identity_digest() == redacted_artifact.causal_identity_digest();
    let changed_detail = full_artifact.artifact_digest() != redacted_artifact.artifact_digest();

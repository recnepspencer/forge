    ...
    pub fn from_public_api_contract(contract: &ForgeQueryRuntimePublicApiContract) -> Self {
        ...
        let rows = vec![
            ...
            ForgeQueryHandleContractRow::new(
                ...
                family_status(ForgeQueryRuntimeFacadeFamily::Temporal),
                [
                    "support-posture",
                    "state-kind",
                    "basis-identity",
            ...
            ForgeQueryHandleContractRow::new(
                ...
                family_status(ForgeQueryRuntimeFacadeFamily::AsyncResource),
                [
                    "support-posture",
                    "state-kind",
                    "basis-identity",
            ...
            ForgeQueryHandleContractRow::new(
                ...
                family_status(ForgeQueryRuntimeFacadeFamily::MixedCauseDelivery),
                [
                    "support-posture",
                    "state-kind",
                    "basis-identity",

...
use crate::runtime::{
    ...
    ForgeQueryGraphReadAccessPlanConsumption, ForgeQueryGraphReadStreamingReceipt,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQueryGraphReadAccessComplexityCounters {
    digest: String,
...
impl ForgeQueryGraphReadAccessComplexityCounters {
    ...
    pub(in crate::runtime) fn from_execution_parts(
        ...
        let digest = hash_parts(&[
            "forge_query_graph_read_access_complexity_counters_v1".to_string(),

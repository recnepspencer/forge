...
pub(in crate::runtime) struct ForgeQueryPublishedArtifactCounters {
...
impl ForgeQueryPublishedArtifactCounters {
    ...
    pub(in crate::runtime) fn snapshot(&self) -> ForgeQueryPublishedArtifactCounterSnapshot {
        ForgeQueryPublishedArtifactCounterSnapshot::new(
...
pub struct ForgeQueryPublishedArtifactCounterSnapshot {
...
impl ForgeQueryPublishedArtifactCounterSnapshot {

...
pub struct ForgeQuerySharedReadPinningInventoryEvidence {
    failure_count: usize,
    missing_operation_count: usize,
    inventory_digest: String,
}

impl ForgeQuerySharedReadPinningInventoryEvidence {
    pub fn new(
        failure_count: usize,
        missing_operation_count: usize,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQuerySharedReadPinningHostileMatrixEvidence {
    certified: bool,
    matrix_digest: String,
}

impl ForgeQuerySharedReadPinningHostileMatrixEvidence {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQuerySharedReadPortabilityEvidence {
    scoped_thread_digest: String,
}

impl ForgeQuerySharedReadPortabilityEvidence {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQuerySharedReadStaleBasisDenialEvidence {
    typed_denial_digest: String,
}

impl ForgeQuerySharedReadStaleBasisDenialEvidence {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeQuerySharedReadPinningCounterEvidence {
...
impl ForgeQuerySharedReadPinningCounterEvidence {
    pub fn new(
        committed_read_hot_path_lock_count: usize,
        orphaned_generation_count: usize,
        unretired_pin_count: usize,
        ...
        let counter_digest =
            forge_query_evidence_identity(ForgeQueryEvidenceScope::ApplicationSupportReport)
                .field_usize(
                    ForgeQueryEvidenceTag::new("committed_read_hot_path_lock_count"),
                    committed_read_hot_path_lock_count,
                )
                .field_usize(
                    ForgeQueryEvidenceTag::new("orphaned_generation_count"),
                    orphaned_generation_count,
                )
                .field_usize(
                    ForgeQueryEvidenceTag::new("unretired_pin_count"),
                    unretired_pin_count,
                )
                .field_usize(
                    ForgeQueryEvidenceTag::new("shared_read_mint_row_clone_count"),
                    shared_read_mint_row_clone_count,
                )
                .field_usize(
                    ForgeQueryEvidenceTag::new("reader_derived_evaluation_count"),

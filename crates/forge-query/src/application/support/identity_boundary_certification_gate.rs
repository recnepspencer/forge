//! Milestone 9.6 certification gate — support `Closed` requires named suite modules
...
//! greenness is enforced by running `cargo test -p forge-query --lib` in CI and by the

...
pub struct ForgeQueryDeclarationCanonicalizationVersion {
    foundational: CanonicalizationRuleVersion,
}

impl ForgeQueryDeclarationCanonicalizationVersion {
    pub fn pinned_v1() -> Self {
        Self {
            foundational: CanonicalizationRuleVersion::new("forge.query.declaration.v1")
...
impl Default for ForgeQueryDeclarationCanonicalizationVersion {
    fn default() -> Self {
        Self::pinned_v1()
    }
}

...
pub(crate) fn derive_envelope_digest(
    ...
    receipt_digest: &str,
    envelope_class: ForgeQueryDeclarationEnvelopeClass,
...
fn canonical_basis_from_entries(
    ...
    match prepare_canonical_basis_sequence(
        version,
        CanonicalBasisDomain::Future("forge_query.declaration_envelope"),
        entries,
    ) {
        TransitionOutcome::Success(ready) => ready,
...
fn envelope_class_token(class: ForgeQueryDeclarationEnvelopeClass) -> &'static str {
    match class {

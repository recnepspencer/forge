...
fn signal_compatibility_denies_missing_and_conflicting_dependency_slices() {
    match handle("primary").signal_compatibility_checked(
        crate::application::ForgeQueryDeclarationSignalCompatibilityInput::enveloped(
            handle("primary")
        ...
        ForgeQueryDeclarationSignalCompatibilityChecked::Denied(denial) => assert_eq!(
            denial.cause(),
            crate::application::ForgeQueryDeclarationSignalCompatibilityDenialCause::AuthorityAspectGap
        ),

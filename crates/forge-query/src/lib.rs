...
pub use consumer_kit::{
    ...
    ForgeQueryHardProhibitionBoundaryAudit, ForgeQueryHardProhibitionDocumentationRow,
    ForgeQueryInMemoryTestRuntimeBuilder, ForgeQueryObservedSupportPin,
    ForgeQueryPinnedSupportStatus, ForgeQueryPinnedTeachingPosture, ForgeQueryProhibitedSeam,
    ForgeQueryProhibitionCompileFailFixture, ForgeQueryProhibitionEnforcementTier,
    ForgeQueryProhibitionRegistry, ForgeQueryProhibitionRegistryRow, ForgeQuerySupportPinContract,

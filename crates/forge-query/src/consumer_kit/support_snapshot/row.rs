use crate::runtime::ForgeQueryRuntimePublicSupportMatrixRow;
...
pub struct ForgeQuerySupportSnapshotRow {
    surface: String,
...
impl ForgeQuerySupportSnapshotRow {
    ...
    pub(crate) fn validate_snapshot_row_digest(
        ...
        if rebuilt == self.snapshot_row_digest {
            ...
            Err(ForgeQuerySupportSnapshotError::new(
    ...
    pub(crate) fn admit_schema_v1_semantics(&self) -> Result<(), ForgeQuerySupportSnapshotError> {
    ...
    fn reject_blank_required_field(
        ...
        if value.trim().is_empty() {
            Err(ForgeQuerySupportSnapshotError::with_surface_found(

...
pub struct EvidenceReport {
    ...
    field_inventory_identity: ForgeQueryEvidenceIdentity,
...
impl EvidenceReport {
    ...
    pub fn field_inventory_identity(&self) -> &ForgeQueryEvidenceIdentity {
        &self.field_inventory_identity
    }

    pub fn digest_participation_identity(&self) -> &ForgeQueryEvidenceIdentity {

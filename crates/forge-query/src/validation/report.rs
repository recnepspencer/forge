...
impl ValidationRejectionMatrix {
    ...
    pub(crate) fn record_projection_rejection(&mut self) {
        self.projection_rejections += 1;
    }

    pub(crate) fn record_ordering_rejection(&mut self) {
        self.ordering_rejections += 1;
    }

    pub(crate) fn record_predicate_rejection(&mut self) {
        self.predicate_rejections += 1;
    }

    pub(crate) fn record_traversal_rejection(&mut self) {
        self.traversal_rejections += 1;
    }

    pub(crate) fn record_result_shape_rejection(&mut self) {
        self.result_shape_rejections += 1;
    }
    pub(crate) fn record_compatibility_rejection(&mut self) {
...
impl QueryValidationReport {
    ...
    #[cfg(test)]
    pub(crate) fn events_mut_for_test(&mut self) -> &mut Vec<ValidationEvent> {
        &mut self.events
    }
}

...
fn scalar_operand(predicate: &CanonicalPredicateEntry) -> &ScalarPredicateValue {
...
fn integer_scalar(predicate: &CanonicalPredicateEntry) -> i64 {
...
fn string_scalar(predicate: &CanonicalPredicateEntry) -> &str {
    match scalar_operand(predicate) {

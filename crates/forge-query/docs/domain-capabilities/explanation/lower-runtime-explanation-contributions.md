...
- `forge_query_domain(...).for_lower_runtime_boundary_envelope(...).requires_cross_runtime_context(...).because(...).review()`
...
2. construct a `ForgeQueryLowerRuntimeExplanationRequest`

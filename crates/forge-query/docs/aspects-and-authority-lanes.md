...
- [Computed](./computed.md) uses aspects to make derived dependencies explicit.
- [Effects](./effects.md) uses aspects plus lanes to constrain routing and
  feedback.
- [Branches And Previews](./branches-and-previews.md) changes lane admission
  without rewriting declarations.
- [State](./state.md) exposes lane posture as a stable public snapshot.
- [Inspection](./inspection.md) makes both the aspect contract and lane posture
  visible.

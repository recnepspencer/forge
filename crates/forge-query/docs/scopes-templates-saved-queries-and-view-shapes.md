...
- Composition outputs should still pass [Schema Validation](./schema-validation.md).
- View-shape planning is often upstream of [Automatic Subscription Family Selection And Diagnostics](./subscription-selection-and-diagnostics.md)
...
- [Historical Basis, Diff, And Comparison Queries](./historical-diff-and-basis.md)
- [Automatic Subscription Family Selection And Diagnostics](./subscription-selection-and-diagnostics.md)

use forge_query::facade::runtime::{
    ...
    ForgeQueryReadFamily, ForgeQueryWorkspace,
};
...
fn workspace(name: &str) -> ForgeQueryWorkspace {
...
) -> forge_query::facade::AdmittedQueryBasisContext {
...
fn assert_unregistered_operation_admission(
    admission: &forge_query::facade::runtime::ForgeQueryGraphReadAccessAdmission,
) {
    assert!(admission

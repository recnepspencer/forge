use forge_query::facade::runtime::{
    ForgeQueryGraphReadAccessRequirementKind, ForgeQueryRuntimeSupportProfile, ForgeQueryWorkspace,
};
...
pub fn default_graph_support_workspace(workspace_name: &str) -> ForgeQueryWorkspace {
...
pub fn profile_requiring_graph_access_capability_registration(
    ...
    public_graph_support_profile().with_graph_index_access_capability_registration_required(
        requirement_kind,
        "forge-query-9.10-test-capability-registration",
    )
}
...
pub fn profile_requiring_store_backed_graph_index(
    ...
    public_graph_support_profile().with_store_backed_graph_index_requirement(
        requirement_kind,
        "forge-query-9.10-test-store-backed-index",
    )
}

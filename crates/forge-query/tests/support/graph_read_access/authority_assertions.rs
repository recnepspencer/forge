use forge_query::facade::runtime::ForgeQueryGraphReadAccessAuthorityDenial;

pub fn assert_authority_denial_before_buffers(denial: &ForgeQueryGraphReadAccessAuthorityDenial) {

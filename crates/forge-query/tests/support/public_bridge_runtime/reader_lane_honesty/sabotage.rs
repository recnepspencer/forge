use forge_query::{
    ForgeQueryPublicBridgeReaderLaneInventory, ForgeQueryPublicBridgeReaderLaneSabotage,
};
...
pub fn public_bridge_certification_inventory() -> ForgeQueryPublicBridgeReaderLaneInventory {
    ForgeQueryPublicBridgeReaderLaneInventory::scan(
        PUBLIC_BRIDGE_CERTIFICATION_SOURCES.iter().copied(),
    )
}

pub fn sabotaged_public_bridge_certification_inventory() -> ForgeQueryPublicBridgeReaderLaneInventory
{
    ForgeQueryPublicBridgeReaderLaneInventory::scan(
...
pub fn public_bridge_direct_materialization_sabotage() -> ForgeQueryPublicBridgeReaderLaneSabotage {
    ForgeQueryPublicBridgeReaderLaneSabotage::evaluate_direct_materialization_read(
...
pub fn direct_materialization_read_count(source: &str) -> usize {
    ForgeQueryPublicBridgeReaderLaneInventory::scan([("inline-sabotage", source)])

use forge_query::facade::runtime::{
    ...
    ForgeQueryGraphReadAccessRequirementKind, ForgeQueryGraphReadCheckpointInterval,
    ForgeQueryGraphReadMaterializationPolicy, ForgeQueryGraphReadMaterializationRequest,
    ForgeQueryGraphReadMaterializationRequestError,
};

use crate::support::graph_index_inventory::read_families::predicate_collection_family;
...
fn async_required_admission_derives_materialization_request_with_budget_proof() {
    ...
    let request = ForgeQueryGraphReadMaterializationRequest::from_required_admission(
        ...
        ForgeQueryGraphReadMaterializationPolicy::bounded()
            ...
            .with_checkpoint_interval(ForgeQueryGraphReadCheckpointInterval::frontier_pages(4)),
    )

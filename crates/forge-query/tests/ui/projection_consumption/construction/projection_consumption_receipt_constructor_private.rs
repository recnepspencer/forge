use forge_query::facade::{ProjectionConsumptionReceipt, ProjectionContractSupportPosture};
...
fn main() {
    let _ = ProjectionConsumptionReceipt {
        ...
        source_family: forge_query::facade::ProjectionSourceFamily::RelationalRowSet,

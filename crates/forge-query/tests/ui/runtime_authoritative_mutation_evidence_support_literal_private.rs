use forge_query::facade::ForgeQueryAuthoritativeMutationEvidenceSupport;

fn main() {
    let _ = ForgeQueryAuthoritativeMutationEvidenceSupport {
        ...
        fail_closed_denial_classes: Vec::new(),

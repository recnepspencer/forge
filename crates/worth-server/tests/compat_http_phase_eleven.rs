#[path = "support/compat_http/phase_eleven/assertions.rs"]
mod compat_http_phase_eleven_assertions;
#[path = "support/compat_http/phase_eleven/counter_honesty_cases.rs"]

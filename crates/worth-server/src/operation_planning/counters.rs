...
pub struct WorthServerOperationPlanCounters {
    support_rows_consulted: usize,
    footprint_breadth: usize,
    strategy_choice: WorthServerOperationExecutionStrategy,
    evidence_policy_lane: String,
    canonical_digest: String,
}

impl WorthServerOperationPlanCounters {
    pub(crate) fn new(
        support_rows_consulted: usize,
        footprint_breadth: usize,
        strategy_choice: WorthServerOperationExecutionStrategy,
        ...
        let canonical_digest = format!(
            "worth-server-operation-plan-counters-v1|support_rows={support_rows_consulted}|footprint_breadth={footprint_breadth}|strategy={}|evidence={evidence_policy_lane}",
    ...
    pub fn strategy_choice(&self) -> WorthServerOperationExecutionStrategy {

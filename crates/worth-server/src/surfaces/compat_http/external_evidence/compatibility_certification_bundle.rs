...
use super::{WorthServerExternalCounterSet, WorthServerExternalEvidenceRecord};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthServerCompatibilityCertificationBundle {
...
impl WorthServerCompatibilityCertificationBundle {
    pub(crate) fn new(
        support_posture_label: String,
        policy_digest: String,
        provenance_digest: String,
        ...
        let canonical_digest = format!(
            "worth-server-compat-certification-v1|support={support_posture_label}|policy={policy_digest}|provenance={provenance_digest}|response={response_digest}|external={}|evidence={}",

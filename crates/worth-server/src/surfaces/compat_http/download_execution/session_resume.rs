use super::WorthServerBinaryEgressSession;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthServerBinarySessionResume {
...
impl WorthServerBinarySessionResume {
    pub(crate) fn from_session(session: &WorthServerBinaryEgressSession) -> Self {

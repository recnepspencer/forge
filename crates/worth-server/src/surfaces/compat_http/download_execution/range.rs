...
pub enum WorthServerRangeRequest {
    Full,
...
impl WorthServerRangeRequest {
    ...
    pub(crate) fn resolve(
        ...
        range_admitted: bool,
        prepared_request: &WorthServerCompatibilityPreparedRequest,
    ) -> Result<(usize, usize, bool), WorthServerQueryHandoffDenial> {
        if !range_admitted {
...
fn parse_u64(
    ...
    raw: &str,
    label: &str,
) -> Result<u64, WorthServerQueryHandoffDenial> {

use crate::{
    WorthServerQueryHandoffDenial, WorthServerQueryHandoffDenialCode, WorthServerReadValidator,
};

use super::super::binary_digest::stable_byte_digest;
use super::{WorthServerBinaryDownloadRequest, WorthServerBinaryEgressSession};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthServerBinaryIntegrityDigest {
...
impl WorthServerBinaryIntegrityDigest {
    pub(crate) fn project(session: &WorthServerBinaryEgressSession) -> Self {

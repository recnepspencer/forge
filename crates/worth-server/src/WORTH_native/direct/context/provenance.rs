...
pub struct WorthServerDirectProvenance {
    artifact: FoundationalBoundaryEvidenceProvenanceArtifact,
    diagnostics_profile: DiagnosticRichnessProfile,
    provenance_digest: String,
}

impl WorthServerDirectProvenance {
    pub(crate) fn new(
        artifact: &FoundationalBoundaryEvidenceProvenanceArtifact,
        diagnostics_profile: DiagnosticRichnessProfile,
    ) -> Self {
        let provenance_digest = format!(
            "worth-server-direct-provenance-v1|locality:{}|freshness:{}|source:{}|authority:{}|strategy:{}|profile:{}|comparison:{}|canonical:{}|support_contexts:{}|diagnostics:{}",

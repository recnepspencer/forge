...
impl worth_proof::PhaseMarker for FoundationalDiagnosticCertifiedPhase {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalDiagnosticCertified;
impl worth_proof::ProofMarker for FoundationalDiagnosticCertified {}
...
pub fn readmit_certified_diagnostic_bundle_after_boundary<Source, Bundle>(
    ...
    authority: worth_proof::AuthorityWitness<FoundationalDiagnosticCertifiedReadmissionAuthority>,

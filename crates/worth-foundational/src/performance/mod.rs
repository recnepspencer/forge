...
impl worth_proof::PhaseMarker for FoundationalPerformanceProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalPerformanceProductionReadinessCertified;
impl worth_proof::ProofMarker for FoundationalPerformanceProductionReadinessCertified {}

...
pub use kill_face_make_ring_hole::{KillFaceMakeRingHoleMutation, KillFaceMakeRingHoleOutput};
...
pub use make_face_kill_ring_hole::{MakeFaceKillRingHoleMutation, MakeFaceKillRingHoleOutput};

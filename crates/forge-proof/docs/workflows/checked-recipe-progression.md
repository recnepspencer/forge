...
fn checked_progression(
    ...
    match outcome.kind() {
        forge_proof::ProofOutcomeKind::Success => {}
        forge_proof::ProofOutcomeKind::Denied => {}
        forge_proof::ProofOutcomeKind::Deferred => {}
        forge_proof::ProofOutcomeKind::Stale => {}
        forge_proof::ProofOutcomeKind::RebindRequired => {}
        forge_proof::ProofOutcomeKind::Failed => {}
    }
}

...
pub fn transition_digest() -> TransitionDigest {
    TransitionDigest::new(
        ...
        vec![
            ...
            type_name::<LowerRecipeTransition<super::super::milestone2::RepresentativeCapability>>(
            ),
            ...
            type_name::<
                RecipeLoweringReadiness<
                    u64,
                    u8,
                    super::super::milestone2::RepresentativeCapability,
                    &'static str,
                    &'static str,
                    &'static str,
                >,
            ...
            type_name::<
                TransitionReadiness<
                    ...
                    Recipe<
                        Lowered,
                        u64,
                        FreshnessScopedBasis<forge_proof::StaleReadable, AssumptionBasis<u8>>,
                    >,
                    Recipe<
                        Resolved,
                        u64,
                        FreshnessScopedBasis<forge_proof::RebindRequired, AssumptionBasis<u8>>,
                    >,
                    &'static str,
                >,
            >(),
            ...
            type_name::<
                fn(
                    ...
                    RecipeResolutionGate<u8, RepresentativeAuthority, &'static str, &'static str>,
                    &LowerRecipeTransition<super::super::milestone2::RepresentativeCapability>,

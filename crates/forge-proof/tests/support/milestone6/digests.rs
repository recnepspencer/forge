...
use forge_proof::{FamilyResolvedReference, ForkOutputs2, JoinInputs2, Pair};
...
pub fn transition_digest() -> TransitionDigest {
    TransitionDigest::new(
        ...
        vec![
            type_name::<
                fn(
                    forge_proof::TransitionOutcome<LeftReadyRecipe, &'static str>,
                    fn() -> forge_proof::TransitionOutcome<RightReadyRecipe, &'static str>,
                    fn(
                        JoinInputs2<LeftReadyRecipe, RightReadyRecipe>,
                    )
                        -> forge_proof::TransitionOutcome<JoinedReadyRecipe, &'static str>,
                )
                    -> forge_proof::TransitionOutcome<JoinedReadyRecipe, &'static str>,
            >(),
            type_name::<
                fn(
                    ...
                    fn(
                        ...
                        -> forge_proof::SuccessfulTransitionOutcome<JoinedReadyRecipe>,
                )
                    -> forge_proof::TransitionOutcome<JoinedReadyRecipe, &'static str>,
            >(),

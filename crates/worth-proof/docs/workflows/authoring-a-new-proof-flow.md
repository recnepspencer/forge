...
This workflow explains how a domain crate should build a new progression surface on top of `worth-proof` without smuggling in WORTHd progression, hidden trust boundaries, or flattened non-success topology.

## Why You Use It

- you are building a new domain-specific progression API
- you want to reuse `worth-proof` instead of inventing another bespoke typestate layer
...
fn domain_flow(
    resolution_authority: worth_proof::AuthorityWitness<DomainResolutionAuthority>,
    lowering_capability: worth_proof::CapabilityWitness<DomainLoweringCapability>,
    admission_authority: worth_proof::AuthorityWitness<DomainAdmissionAuthority>,
) {
...
impl worth_proof::AuthorityMarker for DomainResolutionAuthority {}

struct DomainLoweringCapability;
impl worth_proof::CapabilityMarker for DomainLoweringCapability {}

struct DomainAdmissionAuthority;
impl worth_proof::AuthorityMarker for DomainAdmissionAuthority {}
```
...
- Do not move shared progression law into `worth-foundational`; it belongs in `worth-proof`.

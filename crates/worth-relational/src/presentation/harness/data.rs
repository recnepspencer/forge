...
pub struct RelationalHarnessExpectations {
    pub execution_mode: worth_harness::facade::ExecutionMode,
    pub diagnostics_level: worth_harness::facade::DiagnosticsLevel,
    pub capture_depth: worth_harness::facade::CaptureDepth,
...
impl Default for RelationalHarnessExpectations {
    fn default() -> Self {
        Self {
            execution_mode: worth_harness::facade::ExecutionMode::Serial,
            diagnostics_level: worth_harness::facade::DiagnosticsLevel::Forensic,
            capture_depth: worth_harness::facade::CaptureDepth::Rich,

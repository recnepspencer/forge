...
use crate::transactions::data::{
    ...
    MutationIntent, RelationMutationIntent, TransactionOptions, UpdateEntityFieldsIntent,
...
) -> crate::transactions::ValidatedRelationalMutation {
...
fn project(
    validated: crate::transactions::ValidatedRelationalMutation,
) -> ValidatedMutationTouches {
    validated
        .mutation_touches()

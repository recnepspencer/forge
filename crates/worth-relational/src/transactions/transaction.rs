//! Transaction aggregate and its public phase progression.
...
impl<'a> RelationalTransaction<'a> {
    pub fn plan_bulk_mutation_batch(&self) -> Option<PlannedBulkMutationBatch> {
        let intents = super::planning::bulk::canonical_bulk_mutation_intents(
            &self.batches,
            self.runtime
                .runtime_config()
                .identity
        ...
        Some(PlannedBulkMutationBatch {
            ...
            scope: super::planning::bulk::bulk_mutation_scope(&intents),
            locality: super::planning::bulk::bulk_mutation_locality(&intents),
            naming: super::planning::bulk::bulk_mutation_naming(&intents),
    ...
    pub fn admit_naming_stable_bulk_mutation_batch(
        ...
        super::admission::bulk::validate_naming_plan(
            &planned,
            self.runtime
                .runtime_config()
                .identity
    ...
    pub fn admit_lineage_safe_bulk_mutation_batch(
        ...
        super::admission::bulk::validate_lineage_plan(naming_stable.planned())?;
        Ok(Some(
    ...
    pub fn admit_provenance_complete_bulk_mutation_batch(
        ...
        super::admission::bulk::validate_provenance_plan(lineage_safe.planned(), &self.batches)?;
        Ok(Some(

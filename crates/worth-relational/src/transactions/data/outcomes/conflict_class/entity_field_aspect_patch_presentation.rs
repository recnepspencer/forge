...
fn entity_field_patch_construction_denial_detail(
    field_locator: Option<&worth_foundational::facade::AspectFieldLocator>,
    denial: &worth_foundational::facade::AuthoritativePatchConstructionDenial,
) -> String {
    match field_locator {
...
fn entity_field_patch_application_denial_detail(
    ...
    denial: &worth_foundational::facade::AuthoritativePatchApplicationDenial,
) -> String {
    format!(

...
pub(super) fn canonical_bulk_mutation_intents(
...
pub(super) fn bulk_mutation_scope(intents: &[MutationIntent]) -> BulkMutationScope {
...
pub(super) fn bulk_mutation_locality(intents: &[MutationIntent]) -> BulkMutationLocalityFootprint {
...
pub(super) fn bulk_mutation_naming(intents: &[MutationIntent]) -> BulkMutationNamingPlan {
...
pub(super) fn bulk_mutation_lineage(intents: &[MutationIntent]) -> BulkMutationLineagePlan {
...
pub(super) fn bulk_mutation_provenance(

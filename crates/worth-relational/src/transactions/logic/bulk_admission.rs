...
use super::bulk_planning::{bulk_mutation_lineage, bulk_mutation_naming, bulk_mutation_provenance};

pub(super) fn validate_naming_plan(
...
pub(super) fn validate_lineage_plan(
    planned: &PlannedBulkMutationBatch,
) -> Result<(), CommitConflict> {
...
pub(super) fn validate_provenance_plan(
    planned: &PlannedBulkMutationBatch,

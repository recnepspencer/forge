...
impl PromotionEligibleCorrespondenceCandidate {
    fn new(
        ...
        branch_scoped_sources: Vec<crate::lineage::authority::phase_types::BranchScopedLineageRef>,
        branch_scoped_targets: Vec<crate::lineage::authority::phase_types::BranchScopedLineageRef>,
    ) -> Self {
        Self {
            candidate,
            authority,

...
pub enum StoreErrorKind {
    ...
    SubscriptionSupportAdmissionViolation,
    SubscriptionSupportPublicationViolation,
    SubscriptionSupportClassificationViolation,
...
impl StoreError {
    ...
    pub fn unknown_branch(branch_id: &BranchId) -> Self {
        Self::new(
            ...
            format!("branch `{}` is not registered in worth-store", branch_id.0),
        )
    }

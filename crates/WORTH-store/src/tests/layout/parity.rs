...
fn dedup_and_control_truth_remain_aligned_on_feature_branch_history() {
    ...
    let feature_branch = worth_relational::facade::history::BranchId("layout-feature".to_string());
...
fn structural_block_identity_is_stable_across_equivalent_branch_publications() {
    ...
    let feature_branch =
        worth_relational::facade::history::BranchId("layout-semantic-block".to_string());

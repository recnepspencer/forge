...
use crate::{
    ...
    CompatibilityRejectionKind, CompatibilityRelation, WORTHStore, WORTHStoreBuilder,
...
fn fetched_exact_report(store: &mut WORTHStore) -> SubscriptionSupportClassificationReport {

...
impl WorthServerQueryOperation {
    ...
    pub fn as_batch_commands(&self) -> Option<&[WorthQueryWriteCommand]> {
        match self {
...
#[derive(Clone, Debug)]
pub enum WorthServerQueryHandoffOperation {
    QueryRead {
        operation_name: String,
    },
    DirectRead {
    ...
    DirectMutation {
        operation_name: String,
        scheduled_operation: Option<WorthServerQueryOperation>,
    },
    QueryMutation {
        operation_name: String,
        scheduled_operation: Option<WorthServerQueryOperation>,
    ...
    DownstreamDelivery {
        view_name: String,
        freshness_mode: crate::WorthServerDirectFreshnessMode,
        delivery_class: crate::WorthServerDirectDeliveryClass,
        requested_resume: WorthServerQueryRequestedResume,
    },
}

impl PartialEq for WorthServerQueryOperation {
...
impl Eq for WorthServerQueryOperation {}

impl PartialEq for WorthServerQueryHandoffOperation {
    fn eq(&self, other: &Self) -> bool {
        use WorthServerQueryHandoffOperation as Operation;
...
impl Eq for WorthServerQueryHandoffOperation {}

impl WorthServerQueryHandoffOperation {
    ...
    pub fn query_mutation_execution(operation: WorthServerQueryOperation) -> Self {
        Self::QueryMutation {
    ...
    pub fn direct_mutation_execution(operation: WorthServerQueryOperation) -> Self {
        Self::DirectMutation {
            operation_name: operation.operation_name().to_string(),
            scheduled_operation: Some(operation),
        }
    ...
    pub fn scheduled_query_operation(&self) -> Option<&WorthServerQueryOperation> {
        match self {
            Self::DirectMutation {
                scheduled_operation,
                ..
...
pub enum WorthServerQueryOperationKind {
    QueryRead,
    DirectRead,
    DirectState,
    DirectInspection,
...
pub enum WorthServerQueryRequestedResume {
    None,
    RuntimeBacked { basis_digest: Option<String> },
    Durable,
}

impl WorthServerQueryRequestedResume {
    pub fn none() -> Self {
        Self::None
    }
    ...
    pub fn kind(&self) -> WorthServerQueryRequestedResumeKind {
        match self {
            Self::None => WorthServerQueryRequestedResumeKind::None,
            Self::RuntimeBacked { .. } => WorthServerQueryRequestedResumeKind::RuntimeBacked,
            Self::Durable => WorthServerQueryRequestedResumeKind::Durable,
        }
    }
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum WorthServerQueryRequestedResumeKind {
    None,
    RuntimeBacked,
    Durable,
}

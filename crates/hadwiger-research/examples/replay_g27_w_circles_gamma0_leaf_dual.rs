use hadwiger_research::facade::{
    admit_hadwiger_research_handle, replay_g27_w_circles_gamma0_leaf_dual_checked,
...
fn main() {
    ...
    let report = replay_g27_w_circles_gamma0_leaf_dual_checked(&handle)
        .expect("gamma0 leaf dual should replay");

use hadwiger_research::facade::{
    admit_hadwiger_research_handle, preflight_g27_same_field_mwis_lp_guided_top_prefix_checked,
...
fn main() {
    ...
    let report = preflight_g27_same_field_mwis_lp_guided_top_prefix_checked(&handle)
        .expect("same-field LP-guided top-prefix preflight should run");
    println!(

use hadwiger_research::facade::{
    admit_hadwiger_research_handle, preflight_g27_same_field_mwis_lp_guided_remaining_pair_checked,
...
fn main() {
    ...
    let report = preflight_g27_same_field_mwis_lp_guided_remaining_pair_checked(&handle)
        .expect("same-field LP-guided remaining-pair preflight should run");
    println!(

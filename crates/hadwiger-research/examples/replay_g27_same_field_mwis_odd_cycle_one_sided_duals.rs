use hadwiger_research::facade::{
    admit_hadwiger_research_handle, replay_g27_same_field_mwis_odd_cycle_one_sided_duals_checked,
...
fn main() {
    ...
    let report = replay_g27_same_field_mwis_odd_cycle_one_sided_duals_checked(&handle)
        .expect("one-sided odd-cycle dual replay should run");

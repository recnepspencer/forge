...
use worth_query::facade::runtime::{
    ...
    WorthQueryUnrefinedLiveShape, WorthQueryReadFamily, WorthQueryReadResult, WorthQueryRuntime,
    WorthQueryRuntimeError, WorthQueryWorkspace, WorthQueryWriteCommand, WorthQueryWriteReceipt,
};

use crate::support;
#[path = "intent_admission_public_dx/live_and_inspection.rs"]
mod public_dx_live_and_inspection;

use public_dx_live_and_inspection::*;
...
fn public_dx_signatures_are_referenced() {
    ...
    let _ = live_read_common_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryLiveView<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            worth_query::facade::runtime::WorthQueryLiveReadResult,
            WorthQueryRuntimeError,
        >;
    let _ = live_read_advanced_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryLiveView<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            ...
            WorthQueryRuntimeError,
        >;
    let _ = derived_materialization_common_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryDerivedViewHandle<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            worth_query::facade::runtime::WorthQueryDerivedMaterializationResult,
            WorthQueryRuntimeError,
        >;
    let _ = derived_materialization_advanced_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryDerivedViewHandle<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            ...
            WorthQueryRuntimeError,
        >;
    let _ = derived_inspection_common_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryDerivedViewHandle<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            ...
            WorthQueryRuntimeError,
        >;
    let _ = derived_inspection_advanced_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &mut WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryDerivedViewHandle<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            ...
            WorthQueryRuntimeError,
        >;
    let _ = generic_inspection_common_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryLiveView<WorthQueryUnrefinedLiveShape>,
        ) -> Result<
            ...
            WorthQueryRuntimeError,
        >;
    let _ = generic_inspection_advanced_path_compiles::<WorthQueryUnrefinedLiveShape>
        as fn(
            &WorthQueryWorkspace,
            &worth_query::facade::runtime::WorthQueryLiveView<WorthQueryUnrefinedLiveShape>,
        ) -> Result<

use worth_query::facade::runtime::{WorthQueryAuthorityLane, WorthQueryComputedInspectionEvidence};

fn main() {
    let _worthd = WorthQueryComputedInspectionEvidence {
        name: "computed.Worthd".to_string(),

...
impl WorthQueryDomainOperatingContext<GeometryDomain> for GeometryOperatingContext {
    ...
    fn required_config_sections(&self) -> &'static [WorthQueryConfigSectionFamily] {
        &[WorthQueryConfigSectionFamily::Query, WorthQueryConfigSectionFamily::Signal]
    }
...
fn main() {
    ...
    let _ = handle.signal_compatibility_from_progressed(progressed);
}

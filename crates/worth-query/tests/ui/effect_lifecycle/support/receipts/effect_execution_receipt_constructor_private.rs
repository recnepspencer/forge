...
use worth_query::facade::foundation::{EffectAuthorityLane, EffectExecutionReceipt, EffectFamily, EffectReceiptArtifactKind};
...
fn main() {
    let _ = EffectExecutionReceipt {
        ...
        basis_family: worth_query::facade::foundation::BasisFamily::CurrentHead,

use worth_query::facade::runtime::{WorthQueryBackendAdmissibleMutation, WorthQueryWriteCommand};
...
fn backend_admissible_fixture() -> WorthQueryBackendAdmissibleMutation {
    panic!("fixture only")
}

use worth_query::facade::{
    WorthQueryAuthorityLane, WorthQueryEffectPolicy, WorthQueryFeedbackPhaseGraphInspection,
...
fn main() {
    let _ = WorthQueryFeedbackPhaseGraphInspection {
        ...
        loop_prevention: worth_query::facade::WorthQueryEffectLoopPrevention::SingleCommitBoundary,
        idempotence: worth_query::facade::WorthQueryEffectIdempotence::DeliveryReceiptIdentity,

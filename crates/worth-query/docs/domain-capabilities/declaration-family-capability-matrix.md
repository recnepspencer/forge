...
- `WorthQueryAdmittedConfiguredDomainHandle::family_support::<F>()`
- `WorthQueryAdmittedConfiguredDomainHandle::family_support_checked::<F>()`
- `WorthQueryAdmittedConfiguredDomainHandle::declare_checked(...)`
- `WorthQueryDeclarationCapabilityVerb`
- `WorthQueryDeclarationCapabilityStatus`
- `WorthQueryDeclarationFamilySupportRow`
- `WorthQueryDeclarationFamilySupportReport`
- `WorthQueryDeclarationFamilySupportChecked`
- `WorthQueryDeclaredFamilyChecked`
- `WorthQueryDeclarationAdmissionError`
- `WorthQueryRelationalTruthDeclaration`
- `WorthQueryBridgeContinuationDeclaration`
- `WorthQuerySignalCompatibleDeclaration`
- `WorthQueryNeighborhoodCapableDeclaration`
- `WorthQueryBatchCapableDeclaration`
...
- `family_support::<F>() -> WorthQueryDeclarationFamilySupportReport<D, F>`
- `family_support_checked::<F>() -> WorthQueryDeclarationFamilySupportChecked<D, F>`
...
- `rows() -> &[WorthQueryDeclarationFamilySupportRow]`
- `row(verb) -> Option<&WorthQueryDeclarationFamilySupportRow>`
- `declare_status() -> WorthQueryDeclarationCapabilityStatus`
- `support_digest() -> &str`
...
- `WorthQueryDeclarationCapabilityVerb::as_str() -> &'static str`
- `WorthQueryDeclarationCapabilityStatus::as_str() -> &'static str`

Checked support outcomes:
- `WorthQueryDeclarationFamilySupportChecked::Admitted(WorthQueryDeclarationFamilySupportReport<D, F>)`
- `WorthQueryDeclarationFamilySupportChecked::Deferred(WorthQueryDeclarationFamilySupportReport<D, F>)`
- `WorthQueryDeclarationFamilySupportChecked::Unsupported(WorthQueryDeclarationFamilySupportReport<D, F>)`
- `WorthQueryDeclarationFamilySupportChecked::InvalidContext(WorthQueryDeclarationFamilySupportReport<D, F>)`
...
Witness wrappers:
- `WorthQueryRelationalTruthDeclaration<'a, D, I>`
- `WorthQueryBridgeContinuationDeclaration<'a, D, I>`
- `WorthQuerySignalCompatibleDeclaration<'a, D, I>`
- `WorthQueryNeighborhoodCapableDeclaration<'a, D, I>`
- `WorthQueryBatchCapableDeclaration<'a, D, I>`

Witness-wrapper inspection:
- `artifact() -> &WorthQueryCanonicalDeclarationArtifact<D, I>`
...
assert_eq!(
    support
        .row(WorthQueryDeclarationCapabilityVerb::RelationalTruthWitness)
        .unwrap()
        .status(),
    WorthQueryDeclarationCapabilityStatus::Admitted,
);

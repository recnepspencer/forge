...
- `WorthQueryDeclarationEntryInspection`
...
- `WorthQueryDeclarationEntryInspectionInput::relational_routing_checked(...)`
- `WorthQueryDeclarationEntryInspectionInput::bridge_routing_checked(...)`
- `WorthQueryDeclarationEntryInspectionInput::signal_compatibility_checked(...)`
- `WorthQueryDeclarationEntryInspectionInput::with_contribution_evidence(...)`
- `WorthQueryDeclarationEntryInspectionInput::with_admitted_plan_scope(...)`
- `WorthQueryDeclarationEntryInspectionInput::with_lower_runtime_boundary_scope(...)`
...
let evidence = WorthQueryDeclarationEntryContributionEvidenceSet::new(vec![
    WorthQueryDeclarationEntryContributionEvidence::from(domain_support_contribution),
    WorthQueryDeclarationEntryContributionEvidence::from(domain_explanation_contribution),
]);

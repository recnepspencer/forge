...
- `worth_query_platform_entry_closeout_surface()`
- `certify_platform_entry_closeout()`
- `WorthQueryPlatformEntryCloseoutSurface`
...
- `WorthQueryPlatformEntryUiProofKind`
- `WorthQueryPlatformEntryParityManifest`
- `WorthQueryPlatformEntryParityRow`
- `WorthQueryPlatformEntryParityLane`
- `WorthQueryPlatformEntryParityAssertionClass`
- `WorthQueryPlatformEntryParityAudit`
- `WorthQueryPlatformEntryHostileManifest`
- `WorthQueryPlatformEntryHostileRow`
- `WorthQueryPlatformEntryHostileDivergenceClass`
...
- `worth_query_platform_entry_parity_manifest()`
- `worth_query_platform_entry_hostile_manifest()`
...
`worth_query_platform_entry_closeout_surface()` does not rediscover the world
by scanning docs or tests heuristically.

It consumes the authority surfaces directly:

1. `WorthQueryOrchestrationSurfaceInventory::current()`
2. `WorthQueryPublicDocCoverageInventory::current()`
3. `worth_query_platform_entry_compile_fail_manifest()`
4. `worth_query_platform_entry_parity_manifest()`
5. `worth_query_platform_entry_hostile_manifest()`
...
```rust
let closeout = worth_query_platform_entry_closeout_surface();

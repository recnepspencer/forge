...
pub(crate) struct RowSpec {
    ...
    pub(crate) family: WorthQueryOrchestrationSurfaceFamily,
    pub(crate) visibility: WorthQueryOrchestrationSurfaceVisibility,
    pub(crate) ordinary_outcome_supported: bool,
    pub(crate) binding_projection: WorthQueryOrchestrationBindingProjection,
    pub(crate) checked_type_name: &'static str,
    pub(crate) proof_type_name: &'static str,
    pub(crate) transcript_family: WorthQueryOrchestrationTranscriptFamily,
    pub(crate) checked_topology_kind: WorthQueryOrchestrationCheckedTopologyKind,
    pub(crate) support_surface: WorthQueryOrchestrationSupportSurface,
    pub(crate) semantic_profile: WorthQueryOrchestrationSemanticProfile,
...
impl RowSpec {
    pub(crate) fn into_row(self) -> WorthQueryOrchestrationSurfaceRow {
        WorthQueryOrchestrationSurfaceRow::new(
            ...
            WorthQueryOrchestrationSurfaceDocReference::new(self.doc_path, self.doc_section),
            WorthQueryOrchestrationSurfaceCertificationReference::new(
...
pub(crate) fn push_four_lane_rows(rows: &mut Vec<RowSpec>, spec: FourLaneSpec) {
    for (public_name, visibility, doc_section) in [
        ...
        (
            ...
            WorthQueryOrchestrationSurfaceVisibility::OrdinaryOutcome,

use crate::application::{
    ...
    WorthQueryDeclarationEnvelope, WorthQueryDeclarationInput, WorthQueryDeclarationReceipt,
...
use super::WorthQueryBindingTargetSemantics;

impl WorthQueryBindingTargetSemantics {
    pub(crate) fn for_intent_declaration(declaration: &WorthQueryIntentDeclaration) -> Self {
    ...
    >(
        ...
        Self::IntentDeclaration {
            ...
            strategy_name: "worth-query.canonical-declaration".to_string(),
            strategy_version: format!("{:?}", declaration.canonicalization_version()),
            input_contract: "worth-query.canonical-declaration".to_string(),
            source_lane: crate::runtime::WorthQueryIntentSourceLane::UserAuthored,
            target_lane: crate::runtime::WorthQueryAuthorityLane::AuthoritativeTruth,
        }
    }

    pub(crate) fn for_admitted_intent_plan(plan: &WorthQueryAdmittedIntentPlan) -> Self {
    ...
    >(
        ...
        Self::DeclarationReceipt {
            ...
            receipt_posture_class: match receipt.class() {
                crate::application::WorthQueryDeclarationReceiptClass::CoveredCrossing => "covered",
                crate::application::WorthQueryDeclarationReceiptClass::DeferredCrossing => {
                    "deferred"
                }
                crate::application::WorthQueryDeclarationReceiptClass::DeniedCrossing => "denied",
                crate::application::WorthQueryDeclarationReceiptClass::FailedCrossing => "failed",
            },

...
use crate::consumer_kit::consumer_residue::{
    WorthQueryConsumerResidueFinding, WorthQueryConsumerResidueReport,
};
...
pub struct WorthQueryTestBackendResidueReport {
    consumer_name: String,
    audited_roots: Vec<String>,
    findings: Vec<WorthQueryTestBackendResidueFinding>,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryTestBackendResidueFinding {
    source_path: String,
    residue_class: &'static str,
    matched_pattern: String,
}

impl WorthQueryTestBackendResidueReport {
    ...
    pub fn findings(&self) -> &[WorthQueryTestBackendResidueFinding] {
        &self.findings
    }
    ...
    pub(crate) fn from_consumer_residue_report(report: WorthQueryConsumerResidueReport) -> Self {
        let findings = report
            .findings()
            .iter()
            .map(WorthQueryTestBackendResidueFinding::from_consumer_residue_finding)
            .collect::<Vec<_>>();
...
impl WorthQueryTestBackendResidueFinding {
    fn from_consumer_residue_finding(finding: &WorthQueryConsumerResidueFinding) -> Self {
        Self {

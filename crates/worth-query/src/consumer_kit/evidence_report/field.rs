...
impl EvidenceReportField {
    ...
    pub fn as_evidence_identity(&self) -> Option<&WorthQueryEvidenceIdentity> {
        match &self.value {
...
pub enum EvidenceReportFieldValue {
    ...
    Bool(bool),
    Usize(usize),
    EvidenceIdentity(WorthQueryEvidenceIdentity),
    ValueSequence(Vec<String>),
    EvidenceIdentitySequence(Vec<WorthQueryEvidenceIdentity>),
    OptionalValue(Option<String>),
    OptionalEvidenceIdentity(Option<WorthQueryEvidenceIdentity>),
}

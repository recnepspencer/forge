...
const PHASE_TWO_ROWS: &[Row] = &[
    ordinary("QueryExternalSchemaBasisToken::from_domain_parts", "src/basis/schema_authority.rs", "from_domain_parts", FOUNDATION, "QueryExternalSchemaBasisToken", "external schema admission", Owner::Identity),

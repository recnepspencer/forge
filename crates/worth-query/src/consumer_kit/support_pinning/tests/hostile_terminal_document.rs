use crate::consumer_kit::support_pinning::{
    WorthQueryExternalSupportPinContractTerminalJsonDocument, WorthQuerySupportPinContract,
};
...
impl HostileSupportPinContractTerminalDocument {
    pub(super) fn from_contract(contract: &WorthQuerySupportPinContract) -> Self {
        Self {
            text: contract

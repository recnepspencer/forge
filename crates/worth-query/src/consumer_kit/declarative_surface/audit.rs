...
fn current_sources() -> Vec<WorthQueryDeclarativeSurfaceSource> {
    vec![
        ...
        WorthQueryDeclarativeSurfaceSource::new("src/domain_installation/installed_authority/capabilities/mutation.rs", include_str!("../../domain_installation/installed_authority/capabilities/mutation.rs")),
        WorthQueryDeclarativeSurfaceSource::new("src/domain_installation/installed_authority/capabilities/workflow.rs", include_str!("../../domain_installation/installed_authority/capabilities/workflow.rs")),
        ...
        WorthQueryDeclarativeSurfaceSource::new("src/facade/exports_domain_capabilities.rs", include_str!("../../facade/exports_domain_capabilities.rs")),

...
const DECLARATIVE_MECHANISM_SOURCES: &[&str] = &[
    ...
    "src/domain_installation/installed_authority/capabilities/mutation.rs",
    "src/domain_installation/installed_authority/capabilities/workflow.rs",
    ...
    "src/facade/exports_domain_capabilities.rs",

...
pub use crate::projection_consumption::{
    ...
    consumed_projection_authority_support_matrix, discover_projection_consumption_support,
    ...
    projection_consumption_support_matrix, BoundProjectionFactFamily,
    ...
    ProjectionConsumptionCertifiedSourceSurface, ProjectionConsumptionDeferredNeighborFamily,
    ProjectionConsumptionDenialReason, ProjectionConsumptionEnvelopeSourceRefs,

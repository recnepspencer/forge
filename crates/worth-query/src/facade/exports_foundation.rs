...
pub use crate::projection_consumption::{
    ...
    evaluate_projection_consumption_eligibility, projection_consumption_family_inventory,
    ...
    AdmittedProjectionConsumption, BoundProjectionFactFamily, CompletedProjectionFactConsumption,
    ConsumedContinuityAuthorityIdentity, ConsumedEffectContinuityFact, ConsumedEntityIdentityFact,
    ConsumedFieldValueFact, ConsumedMembershipFact, ConsumedProjectionAuthorityCounters,
    ConsumedProjectionAuthorityDenial, ConsumedProjectionAuthorityDenialKind,
    ConsumedProjectionAuthorityEvidence, ConsumedProjectionFactSet, ConsumedRelationEndpointFact,
    ...
    DeniedProjectionConsumption, DownstreamAuthorityClosureContract,
    DownstreamAuthorityClosureRole, DownstreamAuthorityClosureRow, MaterializedProjectionContract,
    ProjectMaterializedFacts, ProjectionAuthorityContract, ProjectionAuthorityOutcome,
    ProjectionAuthorityRequirement, ProjectionConsumptionAuthoringSurface,
    ProjectionConsumptionBindingContext, ProjectionConsumptionCertificationBundle,
    ...
    ProjectionConsumptionDeclaration, ProjectionConsumptionDeclarationBuilder,
    ProjectionConsumptionDeclarationError, ProjectionConsumptionDeferredNeighborFamily,
    ...
    ProjectionFactExtractionCounters, ProjectionFactExtractionError, ProjectionFactFieldPath,
    ProjectionFactKind, ProjectionFactRequest, ProjectionSourceBasisAuthority,

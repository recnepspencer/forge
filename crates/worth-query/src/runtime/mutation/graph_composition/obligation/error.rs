...
pub enum WorthQueryGraphObligationDispatchError {
    EmptyRuleNamespace,
    EmptyRuleName,
    EmptyRuleVersion,
...
impl std::fmt::Display for WorthQueryGraphObligationDispatchError {
...
impl std::error::Error for WorthQueryGraphObligationDispatchError {}

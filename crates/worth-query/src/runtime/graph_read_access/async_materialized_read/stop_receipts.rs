use super::{
    WorthQueryGraphReadMaterializationCheckpoint, WorthQueryGraphReadMaterializationJobState,
    WorthQueryGraphReadMaterializationProgress,
};
use crate::identity::hash_parts;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryGraphReadMaterializationCancellationReceipt {
    digest: String,
    job_digest: String,
    ...
    final_job_state: WorthQueryGraphReadMaterializationJobState,
}

impl WorthQueryGraphReadMaterializationCancellationReceipt {
    ...
    pub fn final_job_state(&self) -> &WorthQueryGraphReadMaterializationJobState {
    ...
    pub(crate) fn from_job_progress(
        ...
        last_checkpoint: &WorthQueryGraphReadMaterializationCheckpoint,
        final_job_state: WorthQueryGraphReadMaterializationJobState,
    ) -> Self {
        ...
        let digest = hash_parts(&[
            "worth_query_graph_read_materialization_cancellation_receipt_v1".to_string(),
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryGraphReadMaterializationRecoveryHandle {
    digest: String,
    job_digest: String,
    request_digest: String,
    last_checkpoint_digest: String,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryGraphReadMaterializationResourceLimitReceipt {
    digest: String,
    job_digest: String,
    request_digest: String,
    progress_digest: String,
...
impl WorthQueryGraphReadMaterializationResourceLimitReceipt {
    pub fn digest(&self) -> &str {
        &self.digest
    }
    ...
    pub(crate) fn from_limit_breach(
        ...
        let digest = hash_parts(&[
            "worth_query_graph_read_materialization_resource_limit_receipt_v1".to_string(),
            format!("job:{job_digest}"),
            format!("request:{request_digest}"),
            format!("progress:{progress_digest}"),
            format!("last_checkpoint:{last_checkpoint_digest}"),
...
impl WorthQueryGraphReadMaterializationRecoveryHandle {
    pub fn digest(&self) -> &str {
        &self.digest
    }
    ...
    pub(crate) fn from_checkpoint(
        ...
        let digest = hash_parts(&[
            "worth_query_graph_read_materialization_recovery_handle_v1".to_string(),
            format!("job:{job_digest}"),
            format!("request:{request_digest}"),

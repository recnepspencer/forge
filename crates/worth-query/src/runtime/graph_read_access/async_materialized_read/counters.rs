...
pub struct WorthQueryGraphReadMaterializationCounters {
    digest: String,
    touched_edges: usize,
...
impl WorthQueryGraphReadMaterializationCounters {
    ...
    pub(crate) fn new(
        ...
        let digest = hash_parts(&[
            "worth_query_graph_read_materialization_counters_v1".to_string(),

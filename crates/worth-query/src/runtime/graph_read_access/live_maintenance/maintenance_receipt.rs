use super::{WorthQueryLiveGraphReadAccessPlan, WorthQueryLiveGraphReadMaintenanceCounters};
use crate::evidence_identity::WorthQueryEvidenceIdentity;
use crate::identity::hash_parts;
use crate::subscription::QuerySubscriptionMaintenanceDelta;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryLiveGraphReadMaintenanceReceipt {
    digest: String,
...
impl WorthQueryLiveGraphReadMaintenanceReceipt {
    ...
    pub fn maintenance_counters(&self) -> &WorthQueryLiveGraphReadMaintenanceCounters {
        &self.maintenance_counters
    }

    pub(crate) fn from_maintenance_delta(
        plan: &WorthQueryLiveGraphReadAccessPlan,
        delta: &QuerySubscriptionMaintenanceDelta,
        patch_group_width: usize,
    ) -> Self {
        let maintenance_counters =
            WorthQueryLiveGraphReadMaintenanceCounters::observed_mutation_delivery(
        ...
        let digest = hash_parts(&[
            "worth_query_live_graph_read_maintenance_receipt_v1".to_string(),

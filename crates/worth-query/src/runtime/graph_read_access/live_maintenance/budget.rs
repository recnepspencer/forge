...
pub struct WorthQueryLiveGraphReadMaintenanceBudget {
...
impl WorthQueryLiveGraphReadMaintenanceBudget {
    pub fn bounded() -> Self {
    ...
    fn new(
        ...
        let digest = hash_parts(&[
            "worth_query_live_graph_read_maintenance_budget_v1".to_string(),

...
impl WorthQueryGraphReadStreamingCursorDenialKind {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::WorthdCursorDenied => "worthd_cursor_denied",
        }
    }
}
...
impl WorthQueryGraphReadStreamingCursorDenial {
    ...
    pub fn kind(&self) -> &WorthQueryGraphReadStreamingCursorDenialKind {
        &self.kind
    }
    ...
    pub(crate) fn new(
        ...
        let digest = hash_parts(&[
            "worth_query_graph_read_streaming_cursor_denial_v1".to_string(),

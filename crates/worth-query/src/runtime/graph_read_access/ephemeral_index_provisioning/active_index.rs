use super::{WorthQueryEphemeralGraphIndexPlan, WorthQueryEphemeralGraphIndexScope};
use crate::identity::hash_parts;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct WorthQueryEphemeralGraphIndex {
    index_digest: String,
    plan_digest: String,
    scope_digest: String,
...
impl WorthQueryEphemeralGraphIndex {
    ...
    pub(in crate::runtime::graph_read_access::ephemeral_index_provisioning) fn build_from_plan_and_scope(
        plan: &WorthQueryEphemeralGraphIndexPlan,
        ...
        let rebuild_basis_digest = hash_parts(&[
            "worth_query_ephemeral_graph_index_rebuild_basis_v1".to_string(),
        ...
        let index_digest = hash_parts(&[
            "worth_query_ephemeral_graph_index_v1".to_string(),
...
fn observed_allocated_bytes(plan: &WorthQueryEphemeralGraphIndexPlan) -> usize {

use super::read_composition_shared::{
    build_shared_attachment_collection_read_intent, build_shared_attachment_detail_read_intent,
    build_shared_endpoint_collection_read_intent, build_shared_endpoint_detail_read_intent,
};
...
impl<Output> WorthQueryReadBuilder<Output> {
    pub fn local_shared_endpoint_collection(
        ...
        self.finish(build_shared_endpoint_collection_read_intent(
            root,
            schema_view,
            shared_relations,
            declare_query,
    ...
    pub fn local_shared_endpoint_detail(
        ...
        self.finish(build_shared_endpoint_detail_read_intent(
            root,
            schema_view,
            shared_relations,
            declare_query,
    ...
    pub fn local_shared_attachment_collection(
        ...
        self.finish(build_shared_attachment_collection_read_intent(
            root,
            schema_view,
            shared_relations,
            declare_query,
    ...
    pub fn local_shared_attachment_detail(
        ...
        self.finish(build_shared_attachment_detail_read_intent(
            root,
            schema_view,
            shared_relations,
            declare_query,

...
impl CausalDecisionTraceRow {
        ...
        let mut row = Self {
            ...
            row_identity: CausalInspectionDecisionTraceRowIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionDecisionTraceRow,
                )
                .seal(),
            ),
        };
    ...
    pub(super) fn evidence_identity(&self) -> &crate::WorthQueryEvidenceIdentity {
    ...
    pub(super) fn new(rows: Vec<CausalDecisionTraceRow>) -> Self {
        ...
        let mut trace = Self {
            ...
            trace_identity: CausalInspectionDecisionTraceIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionDecisionTraceIndex,
                )
                .seal(),
            ),
        };
    ...
    pub(super) fn new(
        ...
        let mut counters = Self {
            ...
            counter_identity: CausalInspectionAdmissionCountersIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionAdmissionCounters,
                )
                .seal(),
            ),
        };
    ...
    pub(super) fn new(
        ...
        let mut receipt = Self {
            receipt_identity: CausalInspectionAdmissionReceiptIdentity::from(
                crate::WorthQueryEvidenceIdentity::compose(
                    crate::WorthQueryEvidenceScope::CausalInspectionAdmissionReceipt,
                )
                .seal(),
            ),

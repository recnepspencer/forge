...
#[rustfmt::skip]
fn push_relational_rows<D: WorthQueryDomainEntryMarker, C: WorthQueryDomainOperatingContext<D>, I: WorthQueryDeclarationInput<D>>(rows: &mut Vec<WorthQueryDeclarationEntryCrossingRow>, handle: &WorthQueryInstalledDomainDeclarationContext<D, C>, primary_authority_family: WorthQueryDeclarationPrimaryAuthorityFamily) {
...
#[rustfmt::skip]
fn push_bridge_rows<D: WorthQueryDomainEntryMarker, C: WorthQueryDomainOperatingContext<D>, I: WorthQueryDeclarationInput<D>>(rows: &mut Vec<WorthQueryDeclarationEntryCrossingRow>, handle: &WorthQueryInstalledDomainDeclarationContext<D, C>, primary_authority_family: WorthQueryDeclarationPrimaryAuthorityFamily) {
...
#[rustfmt::skip]
fn push_signal_rows<D: WorthQueryDomainEntryMarker, C: WorthQueryDomainOperatingContext<D>, I: WorthQueryDeclarationInput<D>>(rows: &mut Vec<WorthQueryDeclarationEntryCrossingRow>, handle: &WorthQueryInstalledDomainDeclarationContext<D, C>, primary_authority_family: WorthQueryDeclarationPrimaryAuthorityFamily) {

...
pub struct WorthQueryDeclarationProgressionStale<
...
> {
    recipe: Recipe<
        ...
        StaleReadableBasis<WorthQueryDeclarationProgressionBasis>,
    >,
    progression_digest: String,
}

impl<D: WorthQueryDomainEntryMarker, I: WorthQueryDeclarationInput<D>>
    WorthQueryDeclarationProgressionStale<D, I>
{
    pub(crate) fn new(
        recipe: Recipe<
            Lowered,
    ...
    pub fn outcome(&self) -> WorthQueryDeclarationProgressionOutcomeView {
        WorthQueryDeclarationProgressionOutcomeView::new(ProofOutcomeKind::Stale)
    }

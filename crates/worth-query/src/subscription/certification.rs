...
struct PreviewCertificationEvidence {
    preview_isolation_identity: WorthQueryEvidenceIdentity,
    preview_residue_identity: WorthQueryEvidenceIdentity,
    counter_identities: Vec<WorthQueryEvidenceIdentity>,
    support_identities: Vec<WorthQueryEvidenceIdentity>,

...
impl QuerySubscriptionDeliveryCause {
    pub fn relational_patch(evidence_identity: &WorthQueryEvidenceIdentity) -> Self {
        Self::new(
...
pub(crate) fn delivery_cause_evidence_label_identity(label: &str) -> WorthQueryEvidenceIdentity {

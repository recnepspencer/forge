...
use crate::facade::lineage::{CorrespondencePromotionRejectionClass, LineageDecisionKind};
...
fn lineage_promotion_validation_resolves_anchor_truth_from_history_not_caller_shape() {
    ...
    let WORTHd_anchor = crate::facade::history::CommitReference {
    ...
    let promoted = runtime
        .lineage_authority()
        .promote_correspondence(candidate.candidate_id, WORTHd_anchor)
        .unwrap();
    ...
    assert_eq!(
        ...
        Some(promoted_commit.commit_id)
    );

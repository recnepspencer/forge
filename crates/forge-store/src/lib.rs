...
pub use evidence::{
    ...
    Milestone7ComplexitySurface, Milestone7CounterContract, Milestone9CertificationBundle,
    Milestone9CertificationSummary, ObservedModeFailure,
...
pub use layout::{
    ...
    ChunkShapeVersion, DedupAdmittedBlockReuse, DedupBackedReadResult,
    ...
    SingleEntityAspectScope, StructuralBlockId, StructuralBlockLookup,
    StructuralBlockLookupResult,

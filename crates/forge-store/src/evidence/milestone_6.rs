...
impl Milestone6ComplexitySurface {
    fn derive(
        ...
        let aspect_layout_read = if counter_contract.aspect_layout_admitted_count
        ...
        let structural_block_reuse =
            if (counter_contract.structural_block_reuse_admission_count
                >= counter_contract.aspect_layout_admitted_count
        ...
        let chunk_model_freeze = if (counter_contract.chunk_model_freeze_count
            >= counter_contract.aspect_layout_admitted_count
            || has_published_materialization)
        ...
        let milestone_7_layout_reference = if (counter_contract
            .milestone_7_layout_reference_admission_count
            >= counter_contract.aspect_layout_admitted_count
            || has_published_materialization)
        ...
        let milestone_9_physical_chunk_reference = if (counter_contract
            .milestone_9_physical_chunk_reference_admission_count
            >= counter_contract.aspect_layout_admitted_count
            || has_published_materialization)

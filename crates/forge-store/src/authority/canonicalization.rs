...
struct CanonicalCommitExport<'a> {
    ...
    schema_registry: &'a forge_relational::facade::schema::RelationalSchemaRegistry,
    merged_plan: &'a forge_relational::facade::transactions::MergedCommitPlan,
    patch: &'a forge_relational::facade::publication::RelationalPatchRecord,
    diagnostics_summary: &'a forge_relational::facade::diagnostics::RelationalDiagnosticArtifact,
    index_generation_ids: &'a [u64],
    ...
    index_generations: &'a [forge_relational::facade::indexes::DerivedIndexGeneration],
...
fn canonical_export(
    ...
    Ok(CanonicalCommitExport {
        ...
        index_generations: &envelope.index_generations,

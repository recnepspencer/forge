use crate::{modes::SimulatedCrashPoint, DurableMutationRequest, ForgeStore, ForgeStoreBuilder};
...
pub fn recovery_and_rebuild_equivalence() -> RecoveryScenarioResult {
    ...
    let rebuilt =
        ForgeStore::restore_from_authoritative_export(recovered_export.admit_restore()).unwrap();

...
fn started_maintenance_can_resume_after_restart_in_both_durable_lanes() {
    let local_path = unique_test_store_path("forge-store-m11-maintenance-resume-local");
    ...
    let sqlite_path = unique_test_sqlite_path("forge-store-m11-maintenance-resume-sqlite");

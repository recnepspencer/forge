...
impl StoreBackend {
    ...
    pub fn admit_milestone_7_independent_layout_reference(
        ...
        dispatch_ref!(self, |backend| backend.admit_milestone_7_independent_layout_reference(plan))
    }
    ...
    pub fn admit_milestone_9_physical_chunk_reference(
        ...
        dispatch_ref!(self, |backend| backend.admit_milestone_9_physical_chunk_reference(frozen))
    }
    ...
    pub fn materialize_milestone_6_layout_support(
        ...
        dispatch_mut!(self, |backend| backend.materialize_milestone_6_layout_support(request))
    }
    ...
    pub fn fetch_milestone_6_layout_support(
        ...
        dispatch_ref!(self, |backend| backend.fetch_milestone_6_layout_support(request))
    }
    ...
    pub(crate) fn note_milestone_6_scope_prepare(
        ...
        dispatch_mut!(self, |backend| backend.note_milestone_6_scope_prepare(request))
    }

    pub(crate) fn record_milestone_6_proof_only_prepare(&self) {
        dispatch_ref!(self, |backend| backend.record_milestone_6_proof_only_prepare())
    }

    pub(crate) fn record_milestone_6_on_demand_materialize(&self) {
        dispatch_ref!(self, |backend| backend.record_milestone_6_on_demand_materialize())
    }

    pub(crate) fn record_milestone_6_policy_eager_resolution(&self) {
        dispatch_ref!(self, |backend| backend.record_milestone_6_policy_eager_resolution())
    }

    pub(crate) fn record_milestone_6_policy_eager_publish(&self) {
        dispatch_ref!(self, |backend| backend.record_milestone_6_policy_eager_publish())
    }

    pub(crate) fn record_milestone_6_policy_eager_reuse_existing(&self) {
        dispatch_ref!(self, |backend| backend.record_milestone_6_policy_eager_reuse_existing())
    }

    pub(crate) fn milestone_6_branch_has_materialized_support(&self, branch_id: &BranchId) -> bool {
        dispatch_ref!(self, |backend| backend.milestone_6_branch_has_materialized_support(branch_id))
    }
    ...
    pub(crate) fn fetch_existing_milestone_6_layout_support(
        ...
        dispatch_ref!(self, |backend| backend.fetch_existing_milestone_6_layout_support(artifact_id))
    }
    ...
    pub fn rebuild_milestone_6_derived_artifacts_from_materializations(
        ...
        dispatch_mut!(self, |backend| backend.rebuild_milestone_6_derived_artifacts_from_materializations())
    }

    pub fn rebuild_milestone_6_derived_artifacts_from_authority(
        &mut self,
    ) -> Result<crate::Milestone6DerivedArtifactRebuildReport, StoreError> {
        dispatch_mut!(self, |backend| backend.rebuild_milestone_6_derived_artifacts_from_authority())
    }

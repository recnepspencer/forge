...
pub(super) fn load_retention(
    ...
    load_json_records(connection, "stable_basis_records", &mut state.stable_basis_records)?;
    load_json_records(
        connection,
        "compaction_product_records",
        &mut state.compaction_product_records,
    )?;
    load_json_records(connection, "retention_basis_records", &mut state.retention_basis_records)?;
    load_json_records(
        connection,
        "retention_closure_records",
        &mut state.retention_closure_records,
    )?;
    load_json_records(connection, "rebuild_debt_records", &mut state.rebuild_debt_records)?;
    load_json_records(
        connection,

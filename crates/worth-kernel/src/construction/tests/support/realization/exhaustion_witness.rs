...
pub(crate) struct PrimitiveConstructionRealizationExhaustionWitnessRow {
...
impl PrimitiveConstructionRealizationExhaustionWitnessRow {
    ...
    pub(crate) fn witness_kind(&self) -> PrimitiveRealizationExhaustionWitnessKind {
        self.witness_kind
    }
    ...
    pub(crate) fn exhaustion_reason(&self) -> PrimitiveRealizationExhaustionReason {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) struct PrimitiveConstructionRealizationExhaustionWitnessReport {
...
impl PrimitiveConstructionRealizationExhaustionWitnessReport {
    ...
    pub(crate) fn rows(&self) -> &[PrimitiveConstructionRealizationExhaustionWitnessRow] {
        &self.rows
    }
...
pub(crate) fn prepare_primitive_construction_realization_exhaustion_witness_report(

...
use super::point_event_contract_handles::predicate_consumption_handle;
use super::point_event_projection::{predicate_receipt, MOVEMENT, TOPOLOGY};
...
pub(crate) fn predicate_consumption_receipt(
    ...
    PredicateCertificateConsumption::for_planar_workload()
        ...
        .expect("point-event predicate consumption plan")
        .certify()
        .expect("point-event predicate consumption receipt")
}

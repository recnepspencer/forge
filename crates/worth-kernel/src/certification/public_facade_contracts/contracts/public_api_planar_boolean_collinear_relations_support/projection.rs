...
use super::contract_handles::predicate_handle;
use super::contract_handles::{frame_handle, precision_handle, projection_handle};

pub(crate) const MOVEMENT: &str = "movement:collinear-relation";
pub(crate) const TOPOLOGY: &str = "topology:collinear-relation";

pub(crate) fn certified_collinear_relation_frame(
    world: &'static str,
    frame_identity: &str,
    ...
    .expect("collinear-relation frame receipt")
}
...
pub(crate) fn project_synthetic_endpoint(
    ...
    let basis = ProjectPointToCertifiedPlane2DBasis::builder()
        ...
        .build()
        .expect("valid collinear-relation projection basis");
    ...
    .expect("collinear-relation projection receipt")
}
...
pub(crate) fn predicate_receipt(
    ...
    .expect("collinear-relation predicate receipt")
}
...
fn precision_receipt(
    ...
    let basis = PlanarPrecisionBasis::builder()
        ...
        .build()
        .expect("valid collinear-relation precision basis");
    ...
    .expect("collinear-relation precision receipt")
}

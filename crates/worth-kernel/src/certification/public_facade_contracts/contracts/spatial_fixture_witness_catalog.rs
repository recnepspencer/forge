...
pub(crate) struct SpatialFixtureWitnessCatalog {
...
impl SpatialFixtureWitnessCatalog {
    ...
    pub(crate) fn with_parameter_space_direction(
        mut self,
    ...
    pub(crate) fn with_feature_owned_direction(
        mut self,
    ...
    pub(crate) fn with_feature_owned_point(
        mut self,
        feature: impl Into<String>,

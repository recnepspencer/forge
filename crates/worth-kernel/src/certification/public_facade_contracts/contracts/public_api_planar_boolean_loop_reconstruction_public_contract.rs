...
fn loop_reconstruction_public_contract_surfaces_preserve_real_workload_backed_identities() {
    public_contract_support::assert_loop_public_contract_surfaces_preserve_real_workload_backed_identities();
}

#[test]
fn loop_reconstruction_public_contract_fences_reject_foreign_authority() {
    public_contract_support::assert_loop_public_contract_fences_reject_foreign_authority();
}

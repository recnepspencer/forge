...
pub(crate) const SPATIAL_EVIDENCE_LEDGER: WorthGraphReadAccessCoveredSource =
...
pub(crate) const SPATIAL_BOOLEAN_LOOP_RECONSTRUCTION: WorthGraphReadAccessCoveredSource =
...
pub(crate) const SPATIAL_BOOLEAN_EVENTS: WorthGraphReadAccessCoveredSource =
    WorthGraphReadAccessCoveredSource::access_capability_gap(

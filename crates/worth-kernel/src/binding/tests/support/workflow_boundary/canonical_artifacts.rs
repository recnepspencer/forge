use forge_query::facade::{
    ...
    ForgeQueryDeclarationEntryInspectionInput, ForgeQueryDeclarationEntryReadinessReport,
...
>(
    ...
    entry: I,
) -> Result<KernelCanonicalQueryWorkflowArtifactSet<D, I>, KernelWorkflowBoundaryError> {
...
fn canonical_query_workflow_artifacts_with_ordinary_shape<
    D: ForgeQueryDomainEntryMarker,
    C: ForgeQueryDomainOperatingContext<D>,
    I: ForgeQueryDeclarationInput<D> + Clone,
>(
    ...
    let progression = handle
        ...
        .map_err(|_| KernelWorkflowBoundaryError::Progression)?;
    ...
    let inspection = handle
        ...
        .map_err(|_| KernelWorkflowBoundaryError::Inspection)?;

...
use crate::workload_composition::conflict_independence::owner_backed_spatial_closeout_with_evidence_routing_posture;
use crate::workload_composition::{
    admit_spatial_conflict_input, lower_selected_spatial_conflict_plan,
    prove_spatial_conflict_independence, BatchAdmissionPairwiseIndependenceProof,
...
pub(crate) fn compatible_aspect_parallel_spatial_batch_execution_slice(
    ...
    let closeout =
        owner_backed_spatial_closeout_with_evidence_routing_posture(
            schema::facade::platform::authority::touched_graph_conflict::ConflictRoutingPosture::ProvenIndependent,
        );

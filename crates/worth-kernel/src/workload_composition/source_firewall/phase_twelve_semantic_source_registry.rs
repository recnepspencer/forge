...
const LOOKUP_CONSUMED_WORKLOAD_COMPATIBILITY_ALLOWED_SURFACES: &[&str] = &[
    "LookupConsumedWorkloadReuseResolutionDenied",
    "LookupConsumedWorkloadReuseResolutionDenied::from_spatial_denial",
    "LookupConsumedWorkloadReuseResolutionDenied::denial_identity_digest",
    "LookupConsumedWorkloadReuseResolutionDenied::mismatch_loci",
    "LookupConsumedWorkloadReuseResolutionDenied::selected_equivalence_family_identity",
    "LookupConsumedWorkloadReuseResolutionDenied::selected_equivalence_basis_identity_digest",
    "LookupConsumedWorkloadReuseResolutionDenied::selected_compatibility_basis_identity_digest",
    "LookupConsumedWorkloadReuseResolutionDenied::selected_reuse_basis_identity_digest",
    "LookupConsumedWorkloadReuseResolutionDenied::counters",
...
const PHASE_TWELVE_SEMANTIC_SOURCE_COVERAGES: &[SemanticSourceCoverage] = &[
        ...
        SemanticSourceCoverage::subtree_with_owned_files_and_allowed(
            ...
            "crates/worth-kernel/src/workload_composition/worth_workload/lookup_consumed_workload",
            LOOKUP_CONSUMED_WORKLOAD_OWNED_FILES,
            LOOKUP_CONSUMED_WORKLOAD_COMPATIBILITY_ALLOWED_SURFACES,
        ),
        SemanticSourceCoverage::subtree_with_owned_files_and_allowed(
            Forbidden::CallerOwnedCompatibility,

...
impl WorthTouchedGraphConflictProofChain {
    pub(crate) fn from_selected_route_packet(
        ...
        let evidence_lookup_public_closeout_digest = lowering.evidence_lookup_public_closeout_digest;
        let evidence_lookup_family_coverage_digest = lowering.evidence_lookup_family_coverage_digest;

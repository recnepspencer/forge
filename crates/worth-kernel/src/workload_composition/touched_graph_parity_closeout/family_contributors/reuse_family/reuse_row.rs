...
pub(crate) fn current_reuse_contributor_row(
    ...
    ReuseFamilyContributorCatalogRow::new(
        ...
        "current_worth_touched_graph_conflict_public_proof_input::selected_reuse_basis_identity_digest",
        "current_worth_touched_graph_conflict_public_proof_input::{reuse_decision_identity_digest,rebuild_denial_identity_digest,spatial_reuse_decision_identity_digest,spatial_rebuild_denial_identity_digest}",

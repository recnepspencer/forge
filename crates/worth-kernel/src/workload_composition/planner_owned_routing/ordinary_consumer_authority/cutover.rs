...
use super::batch_execution_receipt::current_worth_workload_ordinary_consumer_batch_execution_receipt;
...
pub(crate) fn ordinary_consumer_cutover_from_inventory_with_test_replay_undo_identity_override(
    ...
    replay_undo_row.route_witness = Some(
        super::route_witness::current_replay_undo_boundary_batch_execution_cluster_witness_with_test_override(

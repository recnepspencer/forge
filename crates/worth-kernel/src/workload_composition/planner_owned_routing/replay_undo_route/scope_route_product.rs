...
pub(crate) fn current_replay_undo_planner_scope_route_product(
    ...
    let split_boundary = current_boolean_split_spatial_boundary().map_err(current_route_error)?;
    let topology_boundary =
        topology::replay_undo_semantic_graph::current_replay_undo_topology_boundary()

...
impl WorthTouchedGraphConflictSelectedRoutePacket {
    ...
    pub(crate) fn new(
            ...
            &route_lineage_digests
                ...
                .chain(std::iter::once(format!(
                    ...
                    topology_support
                        ...
                        .or(topology_support.rebuild_denial_identity_digest())
        ...
        let packet_digest = truth_digest_parts(
            ...
            &overlap_identity_digests
                ...
                .chain(std::iter::once(format!("firewall:{source_firewall_digest}")))
                .chain(std::iter::once(format!("deletion:{deletion_closeout_digest}")))
                .chain(std::iter::once(
        ...
        Self {
            ...
            selected_reuse_basis_identity_digest: topology_support
                ...
                .to_string(),
            selected_witness_identity_digest: topology_support
                .reuse_decision_identity_digest()
                .map(str::to_string),
            rebuild_denial_identity_digest: topology_support
            ...
            spatial_freshness_requirement_posture: spatial_support
                .freshness_requirement_posture(),
    ...
    pub(crate) fn route_authority_digests(&self) -> &[String] { &self.route_authority_digests }
    pub(crate) fn route_lineage_digests(&self) -> &[String] { &self.route_lineage_digests }
    pub(crate) fn locality_footprint_digests(&self) -> &[String] { &self.locality_footprint_digests }
    pub(crate) fn selected_conflict_plan_digests(&self) -> &[String] { &self.selected_conflict_plan_digests }
    pub(crate) fn independence_proof_digests(&self) -> &[String] { &self.independence_proof_digests }
    pub(crate) fn selected_batch_plan_digest(&self) -> &str { &self.selected_batch_plan_digest }
    pub(crate) fn batch_execution_receipt_digest(&self) -> &str { &self.batch_execution_receipt_digest }
    pub(crate) fn replay_undo_boundary_proof_digests(&self) -> &[String] { &self.replay_undo_boundary_proof_digests }
    pub(crate) fn transaction_packet_identities(&self) -> &[String] { &self.transaction_packet_identities }
    pub(crate) fn replay_scope_identities(&self) -> &[String] { &self.replay_scope_identities }
    pub(crate) fn undo_scope_identities(&self) -> &[String] { &self.undo_scope_identities }
    pub(crate) fn evidence_lookup_public_closeout_digest(&self) -> &str { &self.evidence_lookup_public_closeout_digest }
    pub(crate) fn evidence_lookup_family_coverage_digest(&self) -> &str { &self.evidence_lookup_family_coverage_digest }
    pub(crate) fn evidence_lookup_query_surface_matrix_digest(&self) -> &str { &self.evidence_lookup_query_surface_matrix_digest }
    pub(crate) fn evidence_lookup_query_consumer_kit_digest(&self) -> &str { &self.evidence_lookup_query_consumer_kit_digest }
    pub(crate) fn evidence_lookup_query_boundary_support_digest(&self) -> &str { &self.evidence_lookup_query_boundary_support_digest }
    pub(crate) fn topology_query_backed_consumer_cutover_digest(&self) -> &str { &self.topology_query_backed_consumer_cutover_digest }
    pub(crate) fn topology_query_public_read_family_row_digest(&self) -> &str { &self.topology_query_public_read_family_row_digest }
    pub(crate) fn topology_query_handle_identity_digest(&self) -> &str { &self.topology_query_handle_identity_digest }
    pub(crate) fn topology_query_operating_context_identity_digest(&self) -> &str { &self.topology_query_operating_context_identity_digest }
    pub(crate) fn topology_query_support_snapshot_digest(&self) -> &str { &self.topology_query_support_snapshot_digest }
    ...
    pub(crate) fn selected_equivalence_policy_identity_digest(&self) -> &str { &self.selected_equivalence_policy_identity_digest }
    pub(crate) fn selected_equivalence_basis_identity_digest(&self) -> &str { &self.selected_equivalence_basis_identity_digest }
    ...
    pub fn deletion_closeout_digest(&self) -> &str { &self.deletion_closeout_digest }
    pub fn selected_route_identity_digest(&self) -> &str { &self.selected_route_identity_digest }
    pub fn decision_trace_identity_digest(&self) -> &str { &self.decision_trace_identity_digest }
    pub fn packet_digest(&self) -> &str { &self.packet_digest }
    ...
    pub(crate) fn lower_proof_chain_inputs(&self) -> RoutePacketProofChainLowering {
        RoutePacketProofChainLowering {
            ...
            evidence_lookup_public_closeout_digest: self.evidence_lookup_public_closeout_digest.clone(),
            evidence_lookup_family_coverage_digest: self.evidence_lookup_family_coverage_digest.clone(),
            evidence_lookup_query_surface_matrix_digest: self.evidence_lookup_query_surface_matrix_digest.clone(),
            evidence_lookup_query_consumer_kit_digest: self.evidence_lookup_query_consumer_kit_digest.clone(),
            evidence_lookup_query_boundary_support_digest: self.evidence_lookup_query_boundary_support_digest.clone(),
            topology_query_backed_consumer_cutover_digest: self.topology_query_backed_consumer_cutover_digest.clone(),
            topology_query_public_read_family_row_digest: self.topology_query_public_read_family_row_digest.clone(),
            topology_query_handle_identity_digest: self.topology_query_handle_identity_digest.clone(),
            topology_query_operating_context_identity_digest: self.topology_query_operating_context_identity_digest.clone(),
            topology_query_support_snapshot_digest: self.topology_query_support_snapshot_digest.clone(),
            topology_query_compiled_product_identity_digest: self.selected_product_identity_digest.clone(),
            topology_query_equivalence_policy_identity_digest: self.selected_equivalence_policy_identity_digest.clone(),
            topology_query_selected_equivalence_family_identity: self.selected_family_identity.clone(),
            topology_query_selected_equivalence_basis_identity_digest: self.selected_equivalence_basis_identity_digest.clone(),
            topology_query_selected_route_gate_basis_identity_digest: self.selected_compatibility_basis_identity_digest.clone(),
            topology_query_selected_reuse_basis_identity_digest: self.selected_reuse_basis_identity_digest.clone(),
            topology_query_reuse_decision_identity_digest: self.selected_witness_identity_digest.clone(),
            topology_query_rebuild_denial_identity_digest: self.rebuild_denial_identity_digest.clone(),
        }
    }
}

...
pub enum ConflictBatchAdmissionSurfaceIdentity {
    ...
    WorthTouchedGraphConflictSelectedRoutePacketSpatialSelectedCompatibilityBasisIdentityDigest,
    CompiledProductReusePlannerRoutePacketTopologySelectedCompatibilityBasisIdentityDigest,
    TopologyCompiledProductReuseRoutePacketSelectedCompatibilityBasisIdentityDigest,
    ...
    EvidenceLookupReuseRoutePacketSelectedCompatibilityBasisIdentityDigest,
    CompiledProductReusePlannerRoutePacketSpatialSelectedCompatibilityBasisIdentityDigest,
    WorthTouchedGraphConflictAdmittedPublicProofInputSpatialSelectedCompatibilityBasisIdentityDigest,
    WorthTouchedGraphConflictMilestoneFifteenPlannerProofInputSpatialSelectedCompatibilityBasisIdentityDigest,

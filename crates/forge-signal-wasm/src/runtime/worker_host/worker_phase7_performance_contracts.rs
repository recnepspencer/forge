...
) -> Result<WorkerPhase7PerformanceContractPackage, ForgeSignalJsError> {
...
fn reject_missing_counter_names(counter_names: &[&str]) -> Result<(), ForgeSignalJsError> {
...
fn reject_duplicate_counter_names(counter_names: &[&str]) -> Result<(), ForgeSignalJsError> {

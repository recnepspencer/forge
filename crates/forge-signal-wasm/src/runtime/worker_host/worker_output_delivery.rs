...
impl WorkerRuntimeShell {
    ...
    ) -> Result<WorkerOutputDeliveryPacket, ForgeSignalJsError> {
    ...
    pub fn certify_worker_output_delivery(
        &self,
    ) -> Result<WorkerOutputDeliveryCertificationPackage, ForgeSignalJsError> {
    ...
    fn deliver_output_value(
        &mut self,
        id: String,
    ) -> Result<WorkerDeliveredOutput, ForgeSignalJsError> {

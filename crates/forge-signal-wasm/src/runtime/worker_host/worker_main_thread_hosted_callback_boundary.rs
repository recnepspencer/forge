...
type CurrentHostedCallbackBoundaryBasis = forge_proof::FreshnessScopedBasis<
    forge_proof::CurrentValidity,
    forge_proof::AssumptionBasis<HostedCallbackBoundaryBasis>,
>;
...
impl forge_proof::PhaseMarker for HostedCallbackBoundaryPayload {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct HostedCallbackReadmissionAuthority;
impl forge_proof::AuthorityMarker for HostedCallbackReadmissionAuthority {}
...
pub(in crate::runtime::worker_host) type BridgedMainThreadHostedCallbackResult =
    forge_proof::Artifact<
        ...
        WorkerMainThreadHostedCallbackResult,
        forge_proof::NoProofs,
        forge_proof::BoundaryBridgedAuthorityRevalidationRequiredBasis<HostedCallbackBoundaryBasis>,
    >;
...
impl WorkerRuntimeShell {
    pub fn issue_main_thread_hosted_callback_request(
        &mut self,
        callback_id: &str,
    ) -> Result<WorkerMainThreadHostedCallbackRequestEnvelope, ForgeSignalJsError> {
        let request = self
            .core
    ...
    ) -> Result<WorkerMainThreadHostedCallbackResultReport, ForgeSignalJsError> {
    ...
    pub fn certify_main_thread_hosted_callback_execution(
        &self,
    ) -> Result<WorkerMainThreadHostedCallbackExecutionCertificationPackage, ForgeSignalJsError>
    {
...
fn readmit_main_thread_hosted_callback_result(
    request: &WorkerMainThreadHostedCallbackRequestEnvelope,
    result: WorkerMainThreadHostedCallbackResult,
) -> Result<ReadmittedMainThreadHostedCallbackResult, ForgeSignalJsError> {
...
) -> forge_proof::AuthorityWitness<HostedCallbackReadmissionAuthority> {
    forge_proof::AuthorityWitness::from_authority_marker(HostedCallbackReadmissionAuthority)
}

...
type CurrentHostEffectBoundaryBasis = forge_proof::FreshnessScopedBasis<
    forge_proof::CurrentValidity,
    forge_proof::AssumptionBasis<HostEffectBoundaryBasis>,
>;
...
pub struct WorkerHostEffectAcknowledgementReport {
    ...
    pub forge_proof_readmission_digest: String,
...
impl forge_proof::PhaseMarker for HostEffectAcknowledgementBoundaryPayload {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct HostEffectReadmissionAuthority;
impl forge_proof::AuthorityMarker for HostEffectReadmissionAuthority {}
...
pub(in crate::runtime::worker_host) type CurrentHostEffectAcknowledgement = forge_proof::Artifact<
    HostEffectAcknowledgementBoundaryPayload,
    WorkerHostEffectAcknowledgement,
    forge_proof::NoProofs,
    CurrentHostEffectBoundaryBasis,
>;

pub(in crate::runtime::worker_host) type BridgedHostEffectAcknowledgement = forge_proof::Artifact<
    HostEffectAcknowledgementBoundaryPayload,
    WorkerHostEffectAcknowledgement,
    forge_proof::NoProofs,
    forge_proof::BoundaryBridgedAuthorityRevalidationRequiredBasis<HostEffectBoundaryBasis>,
>;
...
impl WorkerHostEffectAcknowledgementReport {
    pub(in crate::runtime::worker_host) fn from_acknowledgement(
        ...
        Ok(Self {
            ...
            forge_proof_readmission_digest: canonical_worker_certification_digest(&(
                "forgeProofHostEffectBoundaryReadmission",
...
) -> Result<WorkerHostEffectReadmission, ForgeSignalJsError> {
...
) -> forge_proof::AuthorityWitness<HostEffectReadmissionAuthority> {
    forge_proof::AuthorityWitness::from_authority_marker(HostEffectReadmissionAuthority)
}

...
impl WorkerRuntimeShell {
    pub fn read_diagnostics_summary(
        &mut self,
    ) -> Result<WorkerDiagnosticsSummaryReadPacket, ForgeSignalJsError> {
    ...
    pub fn read_diagnostics_history(
        &mut self,
    ) -> Result<WorkerDiagnosticsHistoryReadPacket, ForgeSignalJsError> {
    ...
    pub fn certify_worker_diagnostics_summary_read(
        &self,
    ) -> Result<WorkerDiagnosticsSummaryReadCertificationPackage, ForgeSignalJsError> {

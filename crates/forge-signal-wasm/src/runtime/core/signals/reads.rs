...
use forge_signal::facade::{EvaluationContext, SignalError};
...
impl RuntimeCore {
    ...
    pub fn peek_value(&self, id: &str) -> Result<SignalValue, ForgeSignalJsError> {
        let store = self.lock_store()?;
    ...
    pub(in crate::runtime::core) fn apply_pending_callback_dependency_patches(
        ...
        for patch in pending {
            ...
            wasm_debug(format!(
                "[forge-signal-wasm] callback-patch id={} added={} removed={} retained={} runtime_reads={}",

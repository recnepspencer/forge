export const HOST_CAPABILITY_PLAN_BRAND = Symbol("forgeSignal.hostCapabilityPlan");
export const HOST_VIEWPORT_REGISTRATION_BRAND = Symbol("forgeSignal.hostViewportRegistration");
export const HOST_VIEWPORT_HANDLE_BRAND = Symbol("forgeSignal.hostViewportHandle");
export const HOST_VISIBILITY_REGISTRATION_BRAND = Symbol("forgeSignal.hostVisibilityRegistration");
export const HOST_VISIBILITY_HANDLE_BRAND = Symbol("forgeSignal.hostVisibilityHandle");
export const HOST_ONLINE_REGISTRATION_BRAND = Symbol("forgeSignal.hostOnlineRegistration");
export const HOST_ONLINE_HANDLE_BRAND = Symbol("forgeSignal.hostOnlineHandle");
export const HOST_CLOCK_REGISTRATION_BRAND = Symbol("forgeSignal.hostClockRegistration");
export const HOST_CLOCK_HANDLE_BRAND = Symbol("forgeSignal.hostClockHandle");
export const HOST_PERSISTENCE_REGISTRATION_BRAND = Symbol("forgeSignal.hostPersistenceRegistration");
export const HOST_PERSISTENCE_HANDLE_BRAND = Symbol("forgeSignal.hostPersistenceHandle");

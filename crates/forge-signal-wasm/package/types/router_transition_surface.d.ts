...
declare const forgeSignalRoutePrefetchArtifactBrand: unique symbol;
declare const forgeSignalRouteTransitionArtifactBrand: unique symbol;
...
export interface ProjectedRoutePrefetchArtifact {
  ...
  readonly [forgeSignalRoutePrefetchArtifactBrand]: "routePrefetchArtifact";
}
...
export interface RouteTransitionArtifact {
  ...
  readonly [forgeSignalRouteTransitionArtifactBrand]: "routeTransitionArtifact";
}

...
declare const forgeSignalRouterBrowserHistoryInspectionVerificationBrand: unique symbol;
declare const forgeSignalRouterBrowserHistoryOutletCompositionVerificationBrand: unique symbol;
declare const forgeSignalRouterNavigationAuditabilityVerificationBrand: unique symbol;

export interface RouterBrowserHistoryOutletCompositionVerificationPackage {
  readonly outletCompositionDigest: string;
  readonly [forgeSignalRouterBrowserHistoryOutletCompositionVerificationBrand]: "routerBrowserHistoryOutletCompositionVerificationPackage";
}
...
export interface RouterBrowserHistoryInspectionVerificationPackage {
  ...
  readonly [forgeSignalRouterBrowserHistoryInspectionVerificationBrand]: "routerBrowserHistoryInspectionVerificationPackage";
}
...
export interface RouterNavigationAuditabilityVerificationPackage {
  ...
  readonly [forgeSignalRouterNavigationAuditabilityVerificationBrand]: "routerNavigationAuditabilityVerificationPackage";
}

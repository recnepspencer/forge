...
declare const forgeSignalRouteDeclarationBrand: unique symbol;
declare const forgeSignalRouteLayoutReferenceBrand: unique symbol;
declare const forgeSignalRouteReferenceBrand: unique symbol;
declare const forgeSignalRouteLocationBrand: unique symbol;
declare const forgeSignalRouteNavigationIntentBuilderBrand: unique symbol;
declare const forgeSignalRouteNavigationPlanBrand: unique symbol;
declare const forgeSignalCanonicalRouteArtifactBrand: unique symbol;
...
export interface RouterRouteDeclaration<
  ...
  TGraphs extends RouteGraphMap = Record<string, never>,
> {
  readonly [forgeSignalRouteDeclarationBrand]: "routeDeclaration";
...
> {
  ...
  readonly [forgeSignalCanonicalRouteArtifactBrand]: "canonicalRouteArtifact";
}
...
> {
  ...
  readonly [forgeSignalRouteLocationBrand]: "routeLocation";
}
...
> {
  ...
  readonly [forgeSignalRouteNavigationPlanBrand]: "routeNavigationPlan";
}
...
> {
  ...
  readonly [forgeSignalRouteNavigationIntentBuilderBrand]: "routeNavigationIntentBuilder";
}
...
> {
  ...
  readonly [forgeSignalRouteReferenceBrand]: "routeReference";
}
...
> extends RouteReference<TRoute, TSearch, THash, TControllers, TGraphs> {
  ...
  readonly [forgeSignalRouteLayoutReferenceBrand]: "routeLayoutReference";
}

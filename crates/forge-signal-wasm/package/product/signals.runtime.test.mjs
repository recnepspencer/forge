...
test("wrapSignals history wrapper accepts numeric branch ids and normalizes preview requests", async () => {
  ...
  try {
    ...
    const rawSignals = {
      ...
      diagnostics() {
        return { latestObservation() { return null; }, latestFlow() { return null; }, performanceSummary() { return {}; }, subscribe() { return { free() {} }; } };
      },
      history() {
        return rawHistory;
      },
    ...
    history.restore_branch_snapshot(currentBranch.id, snapshot);

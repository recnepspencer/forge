...
These docs cover the shipped router surface in `forge-signal-wasm`.
...
speculation, restore, replay, and the boundary artifacts that explain why a
route is visible now.
...
This is the current router doc tree.

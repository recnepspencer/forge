...
pub struct ResolvedConfig {
    ...
    pub(in crate::configuration) config: KernelConfig,
    /// Which scope provided each value (for tracing/audit).
    pub(in crate::configuration) provenance: ConfigProvenance,
}
...
impl ResolvedConfig {
    ...
    pub fn scale_factor(&self) -> f64 {
        self.config.tolerance.unit_system.scale_factor()
    }
    ...
    pub fn cross_validate(&self) -> Result<(), KernelError> {
        ...
        let relaxed_limit = ambiguity_limit * tolerance_section::GAP_CLOSURE_RELAXATION_FACTOR;

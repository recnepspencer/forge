...
impl TangencyPolicy {
    ...
    pub fn from_section(section: &ToleranceSection) -> Self {
        Self {
            min_transversal_angle: section.min_transversal_angle,
            max_tangent_gap: section.max_tangent_gap,
        }
    }
...
impl Default for TangencyPolicy {
    fn default() -> Self {
        Self {
            min_transversal_angle: tolerance_section::MIN_TRANSVERSAL_ANGLE,
            max_tangent_gap: tolerance_section::MAX_TANGENT_GAP,
        }
    }
}

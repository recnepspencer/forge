...
pub fn add_block(name: &str, origin: [f64; 3], dimensions: [f64; 3]) -> NativeFeature {
    let feature = MakePrimitiveFeature::block_from_origin(name, origin, dimensions);
    NativeFeature::primitive(name, feature)
}

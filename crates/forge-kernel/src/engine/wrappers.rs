...
impl Feature for MakeCubeFeature {
    ...
    fn execute_typed(&self, _inputs: &MakeCubeInputs, _config: &ResolvedConfig) -> Result<FeatureOutput, KernelError> {
...
impl Feature for BooleanFeature {
    ...
    fn execute_typed(&self, inputs: &BooleanInputs, _config: &ResolvedConfig) -> Result<FeatureOutput, KernelError> {

...
use crate::shared_ops::vertex::equivalence::{are_solids_coincident, has_boundary_centroid};
...
fn has_overlapping_coplanar_faces(
    ...
    let coincidence_graph = crate::shared_ops::spatial::coincidence::build_face_coincidence_prepass(

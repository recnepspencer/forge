...
//! produce topologically valid output from both EMBER and parametric pipelines.
...
use crate::shared_ops::assembly::copy::{
    copy_faces, VertexDedup, VertexWelder,
};
use crate::operations::boolean::_deprecated::parametric::assemble::disjoint::compute_disjoint_scale;
use crate::operations::boolean::_deprecated::parametric::assemble::merge::eval::execute_boolean_direct;
...
fn vertex_count_preserved_after_copy() {
    ...
    let (topo, geom, _) = r2.into_states();
...
#[test]
#[ignore = "known parametric pipeline vertex-identity defect"]

...
use super::super::schema::{FaceOrigin, FaceClassification};
...
fn diagnose_half_overlap_pipeline() {
    ...
    eprintln!("  Target: inside={}, outside={}, boundary={}", t_inside, t_outside, t_boundary);
    eprintln!("  Tool:   inside={}, outside={}, boundary={}", l_inside, l_outside, l_boundary);
}

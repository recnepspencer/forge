...
fn different_surface_types_always_general() {
    ...
    assert_eq!(classify_surface_pair(&plane, &sphere), SurfaceRelation::General);
    assert_eq!(classify_surface_pair(&plane, &cylinder), SurfaceRelation::General);
    assert_eq!(classify_surface_pair(&sphere, &cylinder), SurfaceRelation::General);
    assert_eq!(classify_surface_pair(&cone, &torus), SurfaceRelation::General);
    assert_eq!(classify_surface_pair(&plane, &torus), SurfaceRelation::General);
}

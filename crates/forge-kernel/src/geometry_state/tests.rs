...
fn sub_millimeter_model_is_floored_at_absolute_minimum() {
    use crate::configuration::facade::ABSOLUTE_MINIMUM_TOLERANCE;
    let mut store = GeometryState::new();
    ...
    let mut cfg = crate::configuration::facade::ToleranceConfig::default();
...
fn scaled_vertex_tolerance_on_tolerance_config() {
    use crate::configuration::facade::ToleranceConfig;

...
fn adjacent_faces_opposite_passes() {
    ...
    let he_ab = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face1,
    ...
    let he_bc = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face1,
    ...
    let he_ca = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face1,
    ...
    let he_ba = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face2,
    ...
    let he_ad = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face2,
    ...
    let he_db = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face2,
...

    {
        ...
        arena
            .get_half_edge_mut(he_bc)
            .unwrap()
            .set_radial_next(he_bc);
        arena
            .get_half_edge_mut(he_ca)
            .unwrap()
            .set_radial_next(he_ca);
        arena
            .get_half_edge_mut(he_ad)
            .unwrap()
            .set_radial_next(he_ad);
        arena
            .get_half_edge_mut(he_db)
            .unwrap()
            .set_radial_next(he_db);
...
fn same_direction_detected() {
    ...
    match result.unwrap_err() {
        KernelError::TopologyViolation {
            err: TopologyError::ValidatorFailure { validator, .. },
            ..
        } => {
...
fn non_manifold_touching_corner() {
    ...
    assert!(
        result.is_ok(),
        "Faces touching only at a vertex (no shared edge) should pass"
    );
}
...
fn coincident_vertices_different_ids() {
    ...
    assert!(
        result.is_err(),
        "Coincident vertices with same-direction half-edges MUST be caught"
    );
    match result.unwrap_err() {
        KernelError::TopologyViolation {
            err: TopologyError::ValidatorFailure { validator, .. },
...
fn non_manifold_shared_edge_cycle() {
    ...
    let h2_ba = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f2,
    ...
    let h2_ad = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f2,
    ...
    let h2_db = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f2,
    ...
    let h3_ab = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f3,
    ...
    let h3_be = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f3,
    ...
    let h3_ea = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        f3,
...

    {
        ...
        arena
            .get_half_edge_mut(h1_ab)
            .unwrap()
            .set_radial_next(h2_ba);
        arena
            .get_half_edge_mut(h2_ba)
            .unwrap()
            .set_radial_next(h3_ab);
        arena
            .get_half_edge_mut(h3_ab)
            .unwrap()
            .set_radial_next(h1_ab);
    ...
    assert!(
        result.is_ok(),
        "Non-manifold 3-face edge cycle with alternating directions should pass"
    );
}
...
fn reversed_edge_different_lengths() {
    ...
    let h2_bc = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face2,
    ...
    let h2_cd = draft.insert_half_edge(HalfEdgeData::new(
        placeholder_he,
        placeholder_he,
        placeholder_he,
        face2,
...

    {
        ...
        arena
            .get_half_edge_mut(h1_bc)
            .unwrap()
            .set_radial_next(h2_bc);
        arena
            .get_half_edge_mut(h2_bc)
            .unwrap()
            .set_radial_next(h1_bc);
    ...
    assert!(
        result.is_err(),
        "Same-direction radially-linked half-edges should be caught"
    );
}

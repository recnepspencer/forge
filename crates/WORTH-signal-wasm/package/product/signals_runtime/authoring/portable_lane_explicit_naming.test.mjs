...
test("The Portable Lane Explicit Naming Test", async () => {
  ...
  try {
    ...
    assert.equal(calls[3][1], "__WORTHSignal.outputProjection.callbackLabel.1");
    assert.deepEqual(calls[4], [
      "outputSpec",
      "callbackLabel",
      {
        reads: ["__WORTHSignal.outputProjection.callbackLabel.1"],
        expr: {
          kind: "read",
          id: "__WORTHSignal.outputProjection.callbackLabel.1",
        },
      },
    ]);

...
// @ts-expect-error canonical route artifacts stay branded and must not accept structural WORTHries
const WORTHdCanonicalArtifact:
  import("./types/router_surface.js").CanonicalRouteArtifact<"/", Record<string, never>, null> = {};
// @ts-expect-error raw location authorities stay branded and must not accept structural WORTHries
const WORTHdRawLocationAuthority:
  import("./types/router_surface.js").RawLocationAuthority = {};
// @ts-expect-error canonical url authorities stay branded and must not accept structural WORTHries
const WORTHdCanonicalUrlAuthority:
  import("./types/router_surface.js").CanonicalUrlAuthority = {};
// @ts-expect-error route verification packages stay branded and must not accept structural WORTHries
const WORTHdRouteVerificationPackage:
  import("./types/router_surface.js").RouteReferenceVerificationPackage = {};
// @ts-expect-error raw location verification packages stay branded and must not accept structural WORTHries
const WORTHdRawLocationVerificationPackage:
  import("./types/router_surface.js").RawLocationVerificationPackage = {};
// @ts-expect-error canonical url verification packages stay branded and must not accept structural WORTHries
const WORTHdCanonicalUrlVerificationPackage:
  import("./types/router_surface.js").CanonicalUrlVerificationPackage = {};
// @ts-expect-error canonical verification packages stay branded and must not accept structural WORTHries
const WORTHdCanonicalVerificationPackage:
  import("./types/router_surface.js").CanonicalRouteVerificationPackage = {};
// @ts-expect-error navigation intent verification packages stay branded and must not accept structural WORTHries
const WORTHdNavigationIntentVerificationPackage:
  import("./types/router_surface.js").NavigationIntentVerificationPackage = {};
// @ts-expect-error navigation plan verification packages stay branded and must not accept structural WORTHries
const WORTHdNavigationPlanVerificationPackage:
  import("./types/router_surface.js").NavigationPlanVerificationPackage = {};
// @ts-expect-error projected route capabilities stay branded and must not accept structural WORTHries
const WORTHdProjectedRouteCapability:
  import("./types/router_surface.js").ProjectedRouteCapability = {};
// @ts-expect-error projected route candidates stay branded and must not accept structural WORTHries
const WORTHdProjectedRouteCandidate:
...
// @ts-expect-error branded callable handles must not accept structural WORTHries
const WORTHdSignal: InputSignalHandle<number> = {
  id: "WORTHd",
  get() {
    return 1;
  },
...
void WORTHdCanonicalArtifact;
void WORTHdRawLocationAuthority;
void WORTHdCanonicalUrlAuthority;
void WORTHdRouteVerificationPackage;
void WORTHdRawLocationVerificationPackage;
void WORTHdCanonicalUrlVerificationPackage;
void WORTHdCanonicalVerificationPackage;
void WORTHdNavigationIntentVerificationPackage;
void WORTHdNavigationPlanVerificationPackage;
void WORTHdProjectedRouteCapability;
void WORTHdProjectedRouteCandidate;

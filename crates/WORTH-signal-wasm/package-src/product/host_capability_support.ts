const HOST_CAPABILITY_PLAN_BRAND = Symbol("WORTHSignal.hostCapabilityPlan");
const HOST_VIEWPORT_REGISTRATION_BRAND = Symbol("WORTHSignal.hostViewportRegistration");
const HOST_VIEWPORT_HANDLE_BRAND = Symbol("WORTHSignal.hostViewportHandle");
const HOST_VISIBILITY_REGISTRATION_BRAND = Symbol("WORTHSignal.hostVisibilityRegistration");
const HOST_VISIBILITY_HANDLE_BRAND = Symbol("WORTHSignal.hostVisibilityHandle");
const HOST_ONLINE_REGISTRATION_BRAND = Symbol("WORTHSignal.hostOnlineRegistration");
const HOST_ONLINE_HANDLE_BRAND = Symbol("WORTHSignal.hostOnlineHandle");
const HOST_CLOCK_REGISTRATION_BRAND = Symbol("WORTHSignal.hostClockRegistration");
const HOST_CLOCK_HANDLE_BRAND = Symbol("WORTHSignal.hostClockHandle");
const HOST_PERSISTENCE_REGISTRATION_BRAND = Symbol("WORTHSignal.hostPersistenceRegistration");
const HOST_PERSISTENCE_HANDLE_BRAND = Symbol("WORTHSignal.hostPersistenceHandle");

...
) -> Result<WorkerUnavailableCompatibilityCertificationPackage, WORTHSignalJsError> {
...
fn compatibility_mode_placement_package(
    scenario: &WorkerCompatibilityCertificationScenario,
) -> Result<crate::runtime::placement::WorkerCallbackPlacementEligibilityPackage, WORTHSignalJsError>
{
...
fn worker_unavailable_policy_summary() -> Result<WorkerUnavailablePolicySummary, WORTHSignalJsError>
{
    ...
    {
        return Err(WORTHSignalJsError::internal(

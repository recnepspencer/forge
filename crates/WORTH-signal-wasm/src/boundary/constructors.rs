...
#[wasm_bindgen(js_name = WORTHSignalMaxAspects)]
pub fn worth_signal_max_aspects() -> u32 {
    MAX_ASPECTS as u32
}

#[wasm_bindgen(js_name = WORTHSignalCoreProfile)]
pub fn worth_signal_core_profile() -> String {
    worth_signal::facade::CORE_STORAGE_PROFILE_ID.to_owned()
}

use worth_store::{
    ...
    AspectScopeClass, ComplexityStatus, DedupAdmittedBlockReuse, EquivalenceContractVersion,
...
fn main() {
    ...
    let plan = AdmittedAspectLayoutReadPlan {
        request,
        ...
        performance: AspectLayoutPerformanceEnvelope {
            ...
            fallback_class: worth_store::AspectLayoutFallbackClass::None,
    ...
    let _ = DedupAdmittedBlockReuse::new(&plan, EquivalenceContractVersion::new(99));
}

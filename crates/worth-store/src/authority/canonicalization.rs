...
struct CanonicalCommitExport<'a> {
    commit: &'a worth_relational::facade::history::CommitReference,
    branch_context: &'a worth_relational::facade::history::BranchId,
    authority_kind: &'a worth_relational::facade::replay::CanonicalCommitAuthorityKind,
    strategy_artifacts:
        &'a Option<worth_relational::facade::commit_strategies::StrategyCommitArtifactBundle>,
    merge_execution_authority:
        &'a Option<worth_relational::facade::transactions::PublishedMergeExecutionAuthority>,
    merge_parent_branches: &'a [worth_relational::facade::history::BranchId],
    merge_base_commits: &'a [worth_relational::facade::history::CommitId],
    schema_version: &'a worth_relational::facade::schema::SchemaVersionId,
    schema_authority: &'a worth_relational::facade::schema::SchemaAuthoritySnapshot,
    merged_plan: &'a worth_relational::facade::transactions::MergedCommitPlan,
    patch: &'a worth_relational::facade::publication::PublishedAuthoritativePatchEnvelope,
    diagnostics_summary: &'a worth_relational::facade::diagnostics::RelationalDiagnosticArtifact,
    lineage_event_ids: &'a [u64],
    lineage_events: &'a [worth_relational::facade::lineage::LineageEventRecord],
    lineage_digest_basis: &'a worth_relational::facade::lineage::LineageDigestBasis,
    event_batch_digest_basis: &'a worth_relational::facade::lineage::LineageEventBatchDigestBasis,
    decision_log_digest_basis: &'a worth_relational::facade::lineage::LineageDecisionLogDigestBasis,
    lineage_artifact_counters: worth_relational::facade::lineage::LineageArtifactCounters,
    derived_index_artifacts: &'a worth_relational::facade::indexes::DerivedIndexArtifacts,
    schema_transition: &'a Option<worth_relational::facade::schema::SchemaTransitionArtifact>,
    schema_continuation_descriptor:
        &'a Option<worth_relational::facade::schema::SchemaContinuationDescriptor>,
    schema_reconciliation_descriptor:
        &'a Option<worth_relational::facade::schema::SchemaReconciliationDescriptor>,
    descriptor_semantics_version: &'a worth_relational::facade::schema::DescriptorSemanticsVersion,
}
...
pub fn canonicalize(
    ...
    if canonicalization_version != CURRENT_CANONICALIZATION_VERSION {
        return Err(StoreError::new(
            ...
            format!(
                "worth-store only supports canonicalization version {}",

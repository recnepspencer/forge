...
pub(crate) fn branch_key(branch_id: &worth_relational::facade::history::BranchId) -> String {
    branch_id.0.clone()
}

pub(crate) fn commit_artifact_id(commit_id: worth_relational::facade::history::CommitId) -> String {

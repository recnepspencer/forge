...
fn bulk_witness_index_highest_ordinal_regression_fails_local_file_reopen_closed() {
    let path = unique_test_store_path("worth-store-bulk-witness-index-regression");
...
fn bulk_witness_index_witness_count_drift_fails_local_file_reopen_closed() {
    let path = unique_test_store_path("worth-store-bulk-witness-index-count-drift");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();
...
fn bulk_witness_index_highest_ordinal_regression_fails_sqlite_reopen_closed() {
    let path = unique_test_sqlite_path("worth-store-bulk-witness-index-regression-sqlite");
    let mut store = WORTHStoreBuilder::new()
...
fn bulk_witness_index_witness_count_drift_fails_sqlite_reopen_closed() {
    let path = unique_test_sqlite_path("worth-store-bulk-witness-index-count-drift-sqlite");
    let mut store = WORTHStoreBuilder::new()
        .sqlite_file(path.clone())
        .build()
        .unwrap();
...
fn frozen_transform_basis_payload_drift_fails_local_file_reopen_closed() {
    let path = unique_test_store_path("worth-store-transform-basis-drift");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();
...
fn frozen_transform_partition_payload_drift_fails_sqlite_reopen_closed() {
    let path = unique_test_sqlite_path("worth-store-transform-partition-drift-sqlite");
    let mut store = WORTHStoreBuilder::new()
        .sqlite_file(path.clone())
        .build()
        .unwrap();
...
fn bulk_plan_payload_drift_fails_local_file_reopen_closed() {
    let path = unique_test_store_path("worth-store-bulk-plan-drift");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();

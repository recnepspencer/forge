use crate::{
    ...
    DurableCursorAcknowledgeRequest, WORTHStore, WORTHStoreBuilder, RetentionPolicyClass,
...
fn store_with_two_commits() -> (WORTHStore, BranchId, CommitId, CommitId) {
...
fn store_with_materialized_layout() -> (WORTHStore, BranchId, CommitId, String) {
    let mut runtime = runtime_with_demo_schema();
    create_entity(&mut runtime, "alpha");

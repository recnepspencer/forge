...
use crate::{
    WORTHStoreBuilder, Milestone12CertificationRunner, StoreErrorKind,
...
fn local_file_manifest_recovery_reopens_with_first_ship_frontier() {
    ...
    let path = unique_test_store_path("worth-store-compatibility-local");
...
fn local_file_missing_compatibility_manifest_record_is_rejected_on_open() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_store_path("worth-store-compatibility-local-gap");
...
fn local_file_manifest_digest_drift_is_rejected_on_open() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_store_path("worth-store-compatibility-local-digest-drift");
...
fn sqlite_manifest_recovery_reopens_with_first_ship_frontier() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_sqlite_path("worth-store-compatibility-sqlite");
...
fn sqlite_missing_compatibility_manifest_row_is_rejected_on_open() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_sqlite_path("worth-store-compatibility-gap");
...
fn sqlite_manifest_digest_drift_is_rejected_on_open() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_sqlite_path("worth-store-compatibility-digest-drift");
...
fn persisted_manifest_reopen_matches_certification_runtime_gap_status() {
    ...
    create_entity(&mut runtime, "alpha");
    let envelope = latest_envelope(&runtime);
    let path = unique_test_sqlite_path("worth-store-compatibility-certification-persistence");

...
pub(super) fn commit_coupled_seed_corruption() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-seed-corruption");
...
pub(super) fn chunk_export_corruption() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-chunk-corruption");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();
...
pub(super) fn chunk_export_boundary_mismatch() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-chunk-boundary");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();

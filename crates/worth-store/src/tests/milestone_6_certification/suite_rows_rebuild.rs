...
pub(super) fn authority_rebuild_parity() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-authority-rebuild");
...
pub(super) fn chunk_export_rebuild_parity() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-chunk-export");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();
...
pub(super) fn authority_rebuild_execution_parity() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_store_path("worth-store-m6-suite-rebuild-execution");
    let mut store = WORTHStoreBuilder::new()
        .local_file(path.clone())
        .build()
        .unwrap();
...
pub(super) fn sqlite_legacy_seed_migration_parity() -> Vec<LaneResult<String>> {
    ...
    let path = unique_test_sqlite_path("worth-store-m6-suite-legacy-seed");
    let mut store = WORTHStoreBuilder::new()

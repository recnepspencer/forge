...
pub struct TwoCommitAuthorityScenario {
    pub first: worth_relational::facade::replay::CanonicalCommitEnvelope,
    pub second: worth_relational::facade::replay::CanonicalCommitEnvelope,
}
...
pub fn append_two_commits_in_memory() -> (crate::WORTHStore, TwoCommitAuthorityScenario) {

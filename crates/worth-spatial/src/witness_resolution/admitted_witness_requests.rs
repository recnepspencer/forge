use crate::authored_refs::{SpatialDirectionWitnessRef, SpatialFrameRef, SpatialPointWitnessRef};
...
pub(crate) enum AdmittedSpatialPointWitnessRequest {
    ...
    CarrierPoint {
        requested: SpatialPointWitnessRef,
        carrier_kind: crate::authored_refs::SpatialCarrierKind,
        carrier: String,
    },
    ParameterSpacePoint {
        requested: SpatialPointWitnessRef,
    ...
    FeatureOwnedPoint {
        requested: SpatialPointWitnessRef,
        feature: String,
        role: crate::authored_refs::SpatialCarrierPointRole,
    },
}
...
pub(crate) enum AdmittedSpatialDirectionWitnessRequest {
    ...
    FrameAxis {
        requested: SpatialDirectionWitnessRef,
        frame: AdmittedSpatialFrameRef,
        axis: crate::authored_refs::SpatialAxis,
    },
    ...
    ParameterSpaceDirection {
        ...
        carrier: String,
        parameter: worth_geom::ParameterSpacePoint,
        role: crate::authored_refs::SpatialCarrierDirectionRole,
    },

...
use super::identity::query_declaration_identity;
...
pub struct PlanarBooleanSplitDecisionLogDeclaration {
...
impl PlanarBooleanSplitDecisionLogDeclaration {
    pub fn for_split_products(
    ...
    fn from_product_identities_impl(
            ...
            || split_persistent_naming_receipt_identity.is_empty()
        {
            return Err(PlanarBooleanSplitDecisionLogDenial::new(
                PlanarBooleanSplitDecisionLogDenialKind::EmptyQueryDeclarationIdentity,
                "empty-split-decision-log-query-declaration",
                Default::default(),
                "split decision log Query declaration requires product identities",
            ));
        }
        let declaration_identity = query_declaration_identity(
            &split_request_identity,
            &split_chain_validation_receipt_identity,
            &split_persistent_naming_receipt_identity,
        );

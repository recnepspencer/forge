use crate::workload_platform::evidence_lookup_public_closeout::EvidenceLookupPublicCloseoutAssemblyInput;
use crate::workload_platform::planner_owned_routing::evidence_lookup_route::EvidenceLookupRoutePacket;
...
impl EvidenceLookupPublicCloseoutRouteInput {
    ...
    pub fn route_packet(
        &self,
    ) -> &crate::workload_platform::planner_owned_routing::evidence_lookup_route::EvidenceLookupRoutePacket{
        &self.route_packet
    }

...
use super::extractions::{extraction_summary, operator_digest, CoplanarOverlapOperatorExtraction};
use super::receipt::CoplanarOverlapOperatorReceipt;
...
impl CoplanarOverlapOperatorDenial {
    pub fn human_reason(self) -> &'static str {
        match self {
            Self::MissingProjectedWorkload => "coplanar overlap operator requires projected planar workload evidence",
            Self::MissingTransformWorkload => "coplanar overlap operator requires transform workload evidence",
            Self::MissingRetainedReplayWorkload => "coplanar overlap operator requires retained replay workload evidence",
            Self::SyntheticProjectedWorkload => "coplanar overlap operator requires projected entities and local-basis evidence",
            Self::SyntheticTransformWorkload => "coplanar overlap operator requires real transform step evidence",
            Self::SyntheticRetainedReplayWorkload => "coplanar overlap operator requires retained artifact and replay checkpoint evidence",
            Self::MissingOverlapExtractionReceipts => "coplanar overlap operator requires real overlap extraction receipts",
            Self::SyntheticOverlapExtraction => "coplanar overlap operator requires overlap extraction receipts with candidate pairs and retained overlap facts",
            Self::MissingCertificationContext => "coplanar overlap operator requires a workload certification context compiled from the projected workload and transform receipts",
            Self::MismatchedCertificationContext => "coplanar overlap operator requires certification context, projection evidence, movement posture, and extraction bundle to describe the same workload",
            Self::MismatchedOverlapExtractionBundle => "coplanar overlap operator requires the overlap extraction bundle to be compiled from the same workload certification context",
        }
    }
}

use crate::facade::{refs, witness_catalog, witness_resolution};
use crate::spatial_intent::refs::SpatialCarrierKind;
...
fn point_request_admission_preserves_direct_world_success() {
    ...
    let resolved = resolve_admitted_spatial_point_witness_request(
        admitted,
        &crate::facade::witness_catalog::EmptySpatialWitnessCatalog,
    )
...
fn admitted_request_preserves_parameter_space_meaning_until_catalog_resolution() {
    ...
    let admission = crate::facade::witness_catalog::SpatialCatalogParameterAdmission::new(
        requested_parameter,
    ...
    let catalog = SpatialFixtureWitnessCatalog::new().with_parameter_space_point(
        ...
        requested_parameter,
        Ok(
            witness_catalog::SpatialCatalogResolvedPointWitness::with_parameter_admission(
                [8.0, 9.0, 10.0],

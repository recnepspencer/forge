...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct SpatialArbitrationPolicyProfile {
    name: &'static str,
...
pub struct SpatialArbitrationPolicyProfileOverride {
...
impl SpatialArbitrationPolicyProfileOverride {
...
impl SpatialArbitrationPolicyProfile {
    ...
    pub fn derive(
        self,
        override_spec: SpatialArbitrationPolicyProfileOverride,
    ) -> SpatialArbitrationPolicyProfile {
        SpatialArbitrationPolicyProfile {
...
mod tests {
    ...
    fn policy_profile_derive_preserves_base_and_overrides_named_fields() {
        let derived = SpatialArbitrationPolicyProfile::bim_host_friendly().derive(
            SpatialArbitrationPolicyProfileOverride::new()

...
pub(crate) fn segment_contracts(
    world: &'static str,
...
pub(crate) fn projected_point(
    ...
    let basis = ProjectPointToCertifiedPlane2DBasis::builder()
        ...
        .source_point_basis_digest("point-basis:segment-local-normalized")
...
pub(crate) fn certified_frame(
    ...
    let basis = PlanarLocalFrameBasis::builder()
        .frame_identity("frame:segment-local-xy")
        ...
        .tolerance_policy_identity("tolerance:segment-exact")
...
fn predicate_receipt(movement_rotation: &'static str) -> PlanarPredicateFactReceipt {
    let basis = PlanarPredicateInputBasis::from_projected_orient2d_points(
        "frame:segment-local-xy",
        "topology:segment-fixture",
        movement_rotation,
        "tolerance:segment-exact",
...
fn precision_receipt(
    ...
    let basis = PlanarPrecisionBasis::builder()
        .local_frame_identity("frame:segment-local-xy")
        .topology_basis_identity("topology:segment-fixture")
...
> {
    ForgeQueryApplicationFacade::runtime_backed_default()
        ...
        .with_operating_context(PlanarPredicateAuthorityQueryWorld::new("segment-predicate"))
        .validate()

...
> {
    ForgeQueryApplicationFacade::runtime_backed_default()
        ...
        .validate()
        .expect("validated projection-consumed planar facts test domain")
        .admit()
        .expect("admitted projection-consumed planar facts test domain")
}
...
> {
    ForgeQueryApplicationFacade::runtime_backed_default()
        .domain(PlanarContractBundleValidationQueryDomain)
        .with_operating_context(PlanarContractBundleValidationQueryWorld::new(world))
        .validate()
        .expect("validated bundle test domain")
        .admit()
        .expect("admitted bundle test domain")
}

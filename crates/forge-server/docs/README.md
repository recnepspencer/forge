...
How to think about `forge-server`:

- `ForgeServer::forge_native()` is the direct Rust surface.
- `ForgeServer::compat_http()` is the compatibility boundary that normalizes
  HTTP-shaped requests into canonical Forge execution.

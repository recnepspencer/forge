use crate::{ForgeServerOperationFamily, ForgeServerOperationInventory, ForgeServerRouteInventory};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerNoProductSemanticsCertification {
    ready: bool,
    detail: String,
...
impl ForgeServerNoProductSemanticsCertification {
    pub(crate) fn derive(
        ...
        let canonical_digest =
            format!("forge-server-no-product-semantics-v1|ready={ready}|detail={detail}");
        Self {
            ready,
            detail,

use crate::{ForgeServerOperationRequest, ForgeServerProductOperationPayload};

#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) struct ForgeServerProductIdempotencyBinding {
    storage_key: String,
    request_digest: String,
}

impl ForgeServerProductIdempotencyBinding {
    pub(crate) fn derive(
        ...
        let storage_key = format!(
            "forge-server-product-idempotency-scope-v1|tenant={}|workspace={}|key={}",
        ...
        let request_digest = format!(
            "forge-server-product-idempotency-binding-v1|tenant={}|workspace={}|branch={}|session={}|family={}|operation={}|base={}|payload={}",
            request_context.workspace_target().tenant_id(),
            request_context.workspace_target().workspace_id(),

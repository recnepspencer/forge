...
pub struct ForgeServerOperationPlanReceipt {
...
impl ForgeServerOperationPlanReceipt {
    pub(crate) fn new(
        ...
        let canonical_digest = format!(
            "forge-server-operation-plan-receipt-v1|support={support_composition_digest}|footprint={footprint_digest}|strategy={}|authorization={authorization_proof_digest}|precondition={precondition_posture_digest}|lane={expected_scheduler_lane}|plan={plan_identity}|evidence={evidence_identity}",
            strategy.as_str(),
        );
        Self {

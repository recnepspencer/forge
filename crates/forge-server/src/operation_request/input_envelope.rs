...
pub struct ForgeServerOperationInputEnvelope {
...
impl ForgeServerOperationInputEnvelope {
    pub fn json(
        ...
        let canonical_digest = format!(
            "forge-server-operation-input-envelope-v1|kind=json|schema={}|payload={payload_identity}|size={payload_size_bytes}",
    ...
    pub fn opaque_digest(
        ...
        let canonical_digest = format!(
            "forge-server-operation-input-envelope-v1|kind={payload_kind}|schema={}|payload={payload_identity}|size={payload_size_bytes}",

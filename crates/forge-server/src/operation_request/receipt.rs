use crate::{
    request_context::DiagnosticRichnessProfile, ForgeServerSurfaceFamily, ForgeServerTransportClass,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerOperationRequestReceipt {
...
impl ForgeServerOperationRequestReceipt {
    pub(crate) fn new(
        surface_family: ForgeServerSurfaceFamily,
        transport_class: ForgeServerTransportClass,
        diagnostics_profile: DiagnosticRichnessProfile,
        ...
        let canonical_digest = format!(
            "forge-server-operation-request-receipt-v1|surface={:?}|transport={:?}|diagnostics={:?}|request_context={request_context_digest}|source_contract={}",
            surface_family,
            transport_class,
            diagnostics_profile,

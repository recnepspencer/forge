use crate::{ForgeServerLoweredOperationPlan, ForgeServerOperationAuthorityKind};

use super::ForgeServerSchedulerConflictDenial;

#[derive(Clone, Debug, Eq, PartialEq)]
pub enum ForgeServerSchedulerLane {
    SharedRead,
...
impl ForgeServerSchedulerLane {
    pub(crate) fn from_lowered_plan(
            ...
            .authority_kind()
        {
            ...
            | ForgeServerOperationAuthorityKind::DiagnosticsOnly => Self::SharedRead,
            ...
            ForgeServerOperationAuthorityKind::ProductSessionCoordination => {
                ...
                match target {
                    ...
                    crate::ForgeServerProductSessionCoordinationTarget::SessionCreation => {
                        Self::DeterministicSubmission {

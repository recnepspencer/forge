...
pub struct ForgeServerProductSession {
    identity: ForgeServerProductSessionIdentity,
    lifecycle: ForgeServerProductSessionLifecycle,
    expiry_posture: ForgeServerProductSessionExpiryPosture,
...
impl ForgeServerProductSession {
    pub(crate) fn new(
        identity: ForgeServerProductSessionIdentity,
        lifecycle: ForgeServerProductSessionLifecycle,
        expiry_posture: ForgeServerProductSessionExpiryPosture,
        ...
        let canonical_digest = format!(
            "forge-server-product-session-v1|identity={}|lifecycle={}|expiry={:?}|operation={}|tenant={}|workspace={}|branch={}|basis={}",
            identity.as_str(),
            lifecycle.as_str(),
            expiry_posture,
            operation_name,
    ...
    pub fn identity(&self) -> &ForgeServerProductSessionIdentity {
        &self.identity
    }

    pub fn lifecycle(&self) -> ForgeServerProductSessionLifecycle {
        self.lifecycle
    }

    pub fn expiry_posture(&self) -> &ForgeServerProductSessionExpiryPosture {
        &self.expiry_posture
    }

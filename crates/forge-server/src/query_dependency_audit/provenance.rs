...
pub enum ForgeServerQueryDependencyAuditProvenance {
    QuerySupportPin(ForgeServerQueryDependencySupportPinProvenance),
    BoundaryAudit(ForgeServerQueryDependencyBoundaryAuditProvenance),
    TestBackendResidue(ForgeServerQueryDependencyTestBackendResidueProvenance),
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerQueryDependencySupportPinProvenance {
    workspace_name: String,
    required_families: Vec<ForgeQueryRuntimeFacadeFamily>,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerQueryDependencyBoundaryAuditProvenance {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerQueryDependencyTestBackendResidueProvenance {
...
impl ForgeServerQueryDependencyAuditProvenance {
    pub fn support_pin(&self) -> Option<&ForgeServerQueryDependencySupportPinProvenance> {
        match self {
    ...
    pub fn boundary_audit(&self) -> Option<&ForgeServerQueryDependencyBoundaryAuditProvenance> {
        match self {
    ...
    pub fn test_backend_residue(
        &self,
    ) -> Option<&ForgeServerQueryDependencyTestBackendResidueProvenance> {
        match self {
...
impl ForgeServerQueryDependencySupportPinProvenance {
    pub(crate) fn new(
        workspace_name: String,
        required_families: Vec<ForgeQueryRuntimeFacadeFamily>,
        support_matrix_digest: String,
    ...
    pub fn required_families(&self) -> &[ForgeQueryRuntimeFacadeFamily] {
...
impl ForgeServerQueryDependencyBoundaryAuditProvenance {
    pub(crate) fn new(
        required_roots: Vec<String>,
        source_paths: Vec<String>,
        source_inventory_identity: String,
...
impl ForgeServerQueryDependencyTestBackendResidueProvenance {
    pub(crate) fn new(
        audited_roots: Vec<String>,
        report_identity: String,
        finding_count: usize,

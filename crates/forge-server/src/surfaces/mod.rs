...
pub use compat_http::{
    ...
    ForgeServerCompatibilityVersion, ForgeServerConditionalRangeRequest,
    ForgeServerConditionalRead, ForgeServerExternalBasisRequest, ForgeServerExternalCounterSet,

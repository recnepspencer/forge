...
use crate::{ForgeServerBinaryCounterSet, ForgeServerExternalCounterSet};
...
pub(crate) fn external_counter_set(
    ...
    ForgeServerExternalCounterSet::new(counter_receipt(contract_name, rows))
}
...
pub(crate) fn binary_counter_set(
    ...
    ForgeServerBinaryCounterSet::new(counter_receipt(contract_name, rows))
}

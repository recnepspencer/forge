use crate::{
    ...
    ForgeServerQueryHandoffDenialCode, ForgeServerReadValidator,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerConditionalRangeRequest {
    if_range: Option<String>,
    canonical_digest: String,
}

impl ForgeServerConditionalRangeRequest {
    ...
    pub(crate) fn admits_range(&self, validator: &ForgeServerReadValidator) -> bool {
        self.if_range
            .as_deref()

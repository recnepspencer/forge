...
use super::response::ForgeServerCompatibilityMutation;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerIdempotencyKey {
    value: String,
    canonical_digest: String,
}

impl ForgeServerIdempotencyKey {
    pub(crate) fn from_prepared_request(
        prepared_request: &ForgeServerCompatibilityPreparedRequest,
    ) -> Result<Option<Self>, ForgeServerQueryHandoffDenial> {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum ForgeServerIdempotentReplayReceipt {
    Authoritative {
...
impl ForgeServerIdempotentReplayReceipt {
    pub(crate) fn authoritative(key: &ForgeServerIdempotencyKey, request_digest: &str) -> Self {
        Self::Authoritative {
...
#[derive(Clone, Debug)]
pub(crate) struct ForgeServerStoredCompatibilityMutation {
    request_digest: String,
    mutation: ForgeServerCompatibilityMutation,
}

impl ForgeServerStoredCompatibilityMutation {
    pub(crate) fn new(request_digest: String, mutation: ForgeServerCompatibilityMutation) -> Self {
        Self {
            request_digest,
            mutation,
        }
    ...
    pub(crate) fn mutation(&self) -> &ForgeServerCompatibilityMutation {
        &self.mutation
    }
}

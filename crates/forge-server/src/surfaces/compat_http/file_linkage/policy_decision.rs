...
pub struct ForgeServerBinaryPolicyDecision {
...
impl ForgeServerBinaryPolicyDecision {
    pub(crate) fn new(
        ...
        let canonical_digest = format!(
            "forge-server-file-policy-decision-v1|identity={metadata_identity}|tenant={tenant_id}|workspace={workspace_digest}|branch={branch_digest}|operation={operation_name}|lane={policy_lane}|support={support_posture_digest}|response={response_envelope_digest}|authorization={}|diagnostics={:?}",

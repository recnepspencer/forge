...
pub struct ForgeServerOperationFootprintReceipt {
    metadata_digest: String,
    footprint_digest: String,
    canonical_digest: String,
}

impl ForgeServerOperationFootprintReceipt {
    pub(crate) fn new(
        ...
        let canonical_digest = format!(
            "forge-server-operation-footprint-receipt-v1|metadata={metadata_digest}|footprint={footprint_digest}"
        );
        Self {
            metadata_digest,
            footprint_digest,

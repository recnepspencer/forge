...
use super::ForgeServerDirectMaterializationDigest;

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgeServerDirectProjectionFactReceipt {
    ...
    materialization_digest: ForgeServerDirectMaterializationDigest,
}

impl ForgeServerDirectProjectionFactReceipt {

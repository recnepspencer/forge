...
pub struct ForgeServerDirectDeclarationSnapshot {
...
impl ForgeServerDirectDeclarationSnapshot {
    pub(crate) fn from_admitted(declaration: &ForgeServerAdmittedDirectDeclaration) -> Self {
        ...
        let canonical_digest = format!(
            "forge-server-direct-declaration-snapshot-v1|declaration:{}|workspace:{}|support:{}|family:{}",

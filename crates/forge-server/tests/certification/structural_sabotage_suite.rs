...
fn structural_sabotage_suite_proves_non_bypass_and_forbidden_zero_artifacts() {
    ...
    compile_fail
        .compile_fail("tests/ui/cross_family/compat_http_cannot_import_forge_native_internal.rs");
    compile_fail
        .compile_fail("tests/ui/cross_family/forge_native_cannot_import_compat_http_internal.rs");

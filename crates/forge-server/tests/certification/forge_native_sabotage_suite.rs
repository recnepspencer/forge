...
use forge_server::ForgeServerDirectDeclarationDenialCode;

use super::certification_bundle::ForgeServerCertificationOutputDigest as Output;
...
#[test]
fn forge_native_sabotage_suite_blocks_direct_surface_shortcuts_and_leaves_zero_residue() {
    ...
    compile_fail.compile_fail("tests/ui/construction/forge_native/private_session_constructor.rs");
    compile_fail
        .compile_fail("tests/ui/construction/forge_native/private_direct_facade_constructor.rs");
    compile_fail
        .compile_fail("tests/ui/construction/forge_native/private_raw_query_workspace_access.rs");

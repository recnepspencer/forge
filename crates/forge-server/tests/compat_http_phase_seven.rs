...
use forge_server::{
    ...
    ForgeServerCompatibilityRequestInput, ForgeServerQueryHandoffDenialCode,
};
    ...
    let unauthorized = compat_download_denied(
        server
            ...
            .download(forge_server::ForgeServerBinaryDownloadExecutionInput::new(
                ...
                "files.asset.download",
                ForgeServerBinaryDownloadRequest::new(body.clone()).with_authorization(
                    ForgeServerBinaryDownloadAuthorization::admitted_window(4, 9),
                ),
            )),
    );
    let out_of_bounds = compat_download_denied(
        server
            ...
            .download(forge_server::ForgeServerBinaryDownloadExecutionInput::new(
                ...
                "files.asset.download",
                ForgeServerBinaryDownloadRequest::new(body),
            )),
    );

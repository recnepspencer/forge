...
use forge_server::{
    ...
    ForgeServerCompatibilityDenialCode, ForgeServerCompatibilityRequestInput,
};
...
fn compat_http_denies_conflicting_api_version_headers_before_request_context_lowering() {
    let denial = compat_http_denial(
        ...
        ForgeServerCompatibilityRequestInput::builder()
            ...
            .with_path("/v1/users/123")
            .with_header("x-forge-api-version", "1")
            .with_header("x-forge-api-version", "2")
            .build()
            .expect("input should validate"),
    );
...
fn compat_http_admits_options_preflight_as_a_distinct_route_family() {
    let request = compat_http_request(
        ...
        ForgeServerCompatibilityRequestInput::builder()
            ...
            .with_tenant_id("tenant-a")
            .with_workspace_id("workspace-42")
            .with_route_family(ForgeServerCompatHttpRouteFamily::Preflight)
            .with_method("OPTIONS")
            .with_path("/v1/users/123")

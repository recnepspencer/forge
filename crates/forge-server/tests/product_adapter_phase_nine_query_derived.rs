...
use forge_server::{
    ForgeServerOperationReadinessDenialCode, ForgeServerProductOperationInput,
    ForgeServerProductOperationPayload, ForgeServerProductOperationSurfaceDenialCode,
};
use serde_json::json;
...
fn query_derived_product_read_exposes_real_query_support_and_basis_proof() {
    ...
    assert_eq!(
        ...
        Some(ForgeServerOperationReadinessDenialCode::PreconditionFailed)
    );

...
use route_driver::ForgeServerRouteHttpTestDriver;

pub async fn observed_route_parity(
    server: &forge_server::ForgeServer,
    session: &forge_server::ForgeServerForgeNativeSession,
    initial_basis: &str,
    ...
    ForgeServerProductRouteParityCertificationProof::new(&[
        ForgeServerProductRouteParityEntry::new(
            "product_editor.render",
            &direct_render,
            &compat_render,

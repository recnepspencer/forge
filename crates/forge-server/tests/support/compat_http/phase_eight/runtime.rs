...
use forge_server::{
    ...
    ForgeServerBinaryEgressSession, ForgeServerCompatHttpRouteFamily,
...
pub(crate) fn compat_resume_success(
    outcome: ForgeServerBinaryDownloadOutcome<forge_server::ForgeServerBinarySessionResume>,
) -> forge_server::ForgeServerBinarySessionResume {
    match outcome {
        TransitionOutcome::Success(value) => value,
...
) -> forge_server::ForgeServerBinaryIntegrityDigest {

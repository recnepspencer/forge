use forge_server::{
    ForgeServerIngressPerformanceReceipt, ForgeServerQueryHandoffDenial,
    ForgeServerQueryHandoffDenialCode, ForgeServerUploadCleanupReason,
    ForgeServerUploadCleanupReceipt,
};

pub(crate) fn assert_cleanup_receipt(
    receipt: &ForgeServerUploadCleanupReceipt,
    expected_reason: ForgeServerUploadCleanupReason,
) {
...
pub(crate) fn assert_counter(
    receipt: &ForgeServerIngressPerformanceReceipt,
    name: &str,
    expected: u64,
) {

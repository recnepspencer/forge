...
impl worth_proof::PhaseMarker for FoundationalBoundaryEvidenceProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalBoundaryEvidenceProductionReadinessCertified;
impl worth_proof::ProofMarker for FoundationalBoundaryEvidenceProductionReadinessCertified {}

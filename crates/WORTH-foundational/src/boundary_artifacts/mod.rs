...
impl worth_proof::PhaseMarker for FoundationalBoundaryArtifactProductionTestReady {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalBoundaryArtifactProductionReadinessCertified;
impl worth_proof::ProofMarker for FoundationalBoundaryArtifactProductionReadinessCertified {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalBoundaryAuthorityAdmitted;
impl worth_proof::ProofMarker for FoundationalBoundaryAuthorityAdmitted {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalBoundaryCurrentBasisCertified;
impl worth_proof::ProofMarker for FoundationalBoundaryCurrentBasisCertified {}

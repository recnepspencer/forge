...
impl worth_proof::PhaseMarker for FoundationalPerformanceCertifiedPhase {}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct FoundationalPerformanceCertified;
impl worth_proof::ProofMarker for FoundationalPerformanceCertified {}
...
pub fn readmit_certified_performance_bundle_after_boundary<Source>(
    ...
    authority: worth_proof::AuthorityWitness<FoundationalPerformanceCertifiedReadmissionAuthority>,

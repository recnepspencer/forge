...
Reshape `worth-store-blob-chunks` so the directory tree teaches the blob
...
- `worth-store-blob-chunks/src/exports.rs`
...
- Cleaned `worth-store-blob-chunks` lifecycle tree and public facade grammar.

...
>
> - [\_docs/worth_signal/milestone-a-plan.md](../../../_docs/worth_signal/milestone-a-plan.md)
> - [\_docs/worth_signal/milestone-b-plan.md](../../../_docs/worth_signal/milestone-b-plan.md)
> - [\_docs/worth_signal/milestone-c-plan.md](../../../_docs/worth_signal/milestone-c-plan.md)
> - [\_docs/worth_signal/milestone-d-plan.md](../../../_docs/worth_signal/milestone-d-plan.md)
>
...
async-capability substrate already closed in core `worth-signal`, while
...
- `worth_signal_vision.md`
  The most important thing it protects is that `worth-signal` remains the
...
- `worth-signal` remains the owner of lifecycle, policy, replay, and temporal
  truth

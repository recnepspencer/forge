...
```powershell
cargo test -p forge-query --test graph_obligation_hostile_certification
cargo test -p forge-query --test graph_obligation_docs_agreement
cargo test -p forge-query --test graph_obligation_consumer_kit_facade
cargo test -p forge-query milestone_9_9_authority_matrix

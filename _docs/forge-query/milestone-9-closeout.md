...
certification scope in `forge-query`.
...
tenant/query artifact portability remain explicit Forge Store and later
milestone debt.
...
- policy and tenant basis admission in
  [crates/forge-query/src/policy_basis](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_basis)
  and
  [crates/forge-query/src/tenant_basis](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/tenant_basis)
- policy mask snapshots, authorized projection artifacts, masked influence
  denial, and immutable mask boundaries in
  [crates/forge-query/src/authorized_projection](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/authorized_projection)
- query-authored relationship-proof descriptors, admission, budgets, and typed
  denials in
  [crates/forge-query/src/relationship_proof](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/relationship_proof)
- pre-execution narrowing, policy-aware validation reports, optimizer inputs,
  ...
  [crates/forge-query/src/policy_narrowing](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_narrowing)
- policy-aware current, branch, runtime-historical, runtime-diff, and
  store-deferred plan lowering in
  [crates/forge-query/src/policy_plan](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_plan)
- policy-aware execution seam identities, counters, deferred handoff honesty,
  and durable overclaim denials in
  [crates/forge-query/src/policy_execution_seam](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_execution_seam)
- policy-aware live admission, drift evidence, density evidence, and dense
  restart debt classification in
  [crates/forge-query/src/policy_live](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_live)
- policy-aware delivery shape lowering and placeholder masking denial in
  [crates/forge-query/src/policy_delivery](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_delivery)
- concrete EmployeeRecord certification fixtures, scale-slope evidence, mask
  ...
  parity in
  [crates/forge-query/src/policy_certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/policy_certification)
- Milestone 9 certification in
  [crates/forge-query/src/harness/milestone_nine_certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/milestone_nine_certification)
...
- [crates/forge-query/src/harness/milestone_nine_certification/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/milestone_nine_certification/mod.rs)
- [crates/forge-query/src/harness/milestone_nine_certification/tests.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/milestone_nine_certification/tests.rs)
...
- the Forge Query test requirements document
...
- broader tenant-schema/runtime integration once Forge Store is ready
...
- Forge Store already provides store-backed policy execution parity
...
- durable tenant/query portability exists without Forge Store evidence
...
proof, and delivery-contract surface for the admitted `forge-query` product
scope.

`forge-query` no longer depends on post-read redaction, ambient tenant filters,
...
The remaining work is explicit Forge Store and later-milestone scope, not

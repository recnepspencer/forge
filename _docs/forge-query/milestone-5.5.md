...
>
> **Primary architectural driver:** make query-authored mutation, merge, conflict-inspection, post-merge inspection, and writeback declarations first-class query artifacts that lower into `forge-relational` and bridge authorities without turning `forge-query` into a second mutation engine or hiding authority transfer behind host workflow glue
>
> **Companion docs:**
...
> - [forge_runtime_bridge_roadmap.md](../forge-runtime-bridge/forge_runtime_bridge_roadmap.md)
> - [milestone-10.md](../forge-runtime-bridge/milestone-10.md)
> - [milestone-12.md](../forge-runtime-bridge/milestone-12.md)
> - [forge_relational_roadmap.md](../forge-relational/forge_relational_roadmap.md)
> - [milestone-7c-authoritative-merge-execution-spec.md](../forge-relational/milestone-7c-authoritative-merge-execution-spec.md)
> - [milestone-7d-deletion-and-topology-merge-execution-spec.md](../forge-relational/milestone-7d-deletion-and-topology-merge-execution-spec.md)
...
domain developers can stay inside `forge-query` for branch-native workflow
orchestration while all authoritative mutation, merge execution, writeback
safety, idempotence, and publication remain owned by `forge-relational` and
the runtime bridge.
...
Those milestones solved how `forge-query` reads, compares, and explains truth.
...
- then the developer must fall out of `forge-query` into raw relational merge
...
- merge semantics from `forge-relational` and writeback semantics from the
...
- that `forge-query` owns workflow declaration and lowering, not mutation truth
...
- `forge_query_vision.md`: `forge-query` is supposed to be the typed,
...
- `forge_query_roadmap.md`: Milestone 5.5 is the explicit roadmap home for
...
- `forge_runtime_bridge_roadmap.md`: the bridge remains the authority for
...
- `forge-runtime-bridge/milestone-10.md`: preview-session lifecycle,
...
- `forge-runtime-bridge/milestone-12.md`: bridge-mediated writeback is an
...
- `forge_relational_roadmap.md`: `forge-relational` remains authoritative for
...
> `forge-query` become a second mutation engine or letting host code fill in
...
- `forge-query` owns workflow declaration, workflow context binding, lowering,
...
- merge planning and merge execution authority remain in `forge-relational`
...
authority-owned by `forge-relational`.
...
Milestone 5.5 is complete only when `forge-query` can prove:
...
If `forge-query` starts inventing mutation batches, merge legality, or
...
- `forge-query` directly creating mutation batches
- `forge-query` directly executing bridge writeback
...
`forge-relational` and the bridge remain the only authorities for merge and
writeback truth.
...
layer that must exist before `forge-query` can honestly present itself as the

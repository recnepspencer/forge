...
```text
_docs/forge-query/bridge_truth_identity_phase2_first_red_cargo_check.txt
```
...
```text
workspace RED
forge-runtime-bridge failed to compile
277 bridge-local authority-category errors
```

## Frontier

The first dependency frontier is `forge-runtime-bridge`.

The root break was installed in `crates/forge-runtime-bridge/src/identity.rs`:
...
|------------|----------------|------------|--------------------|-------------------|---------------------|--------------|---------------|
| BTI-P2-001 | `E0308` | `BridgeIdentity::<Tag>::new` | raw `String` from `format!` | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/continuity/lowering.rs:46` | Phase 4 | Replace synthetic formatted bridge identity construction with owner-admitted bridge authority or terminal projection. |
| BTI-P2-002 | `E0308` | `BridgeIdentity::<Tag>::new` | raw `String` from digest formatting | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/continuity/lowering.rs:65` | Phase 4 | Carry digest as evidence/projection; do not mint authority from digest text. |
| BTI-P2-003 | `E0599` | removed `BridgeIdentityEvidence::AsRef<str>` | generic string projection via `as_ref()` | explicit terminal projection accessor | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/assembly/request.rs:66` | Phase 4 / Phase 7 | Rename/reporting-quarantine diagnostic output; do not pass evidence to generic string consumers. |
| BTI-P2-004 | `E0599` | removed `BridgeIdentityEvidence::AsRef<str>` | generic string projection via `as_ref()` | explicit terminal projection accessor | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/assembly/request.rs:67` | Phase 4 / Phase 7 | Same as BTI-P2-003 for causal observation anchor projection. |
| BTI-P2-005 | `E0599` | removed `BridgeIdentityEvidence::AsRef<str>` | generic string projection via `as_ref()` | explicit terminal projection accessor | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/assembly/request.rs:90` | Phase 4 / Phase 7 | Same as BTI-P2-003 for causal envelope reporting accessors. |
| BTI-P2-006 | `E0308` | `BridgeIdentity::<Tag>::from_reference_evidence` | `&BridgeIdentityEvidence` | `BridgeTruthBoundaryBridgedIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/retained_mapping/retained_artifact_digest/planning_checkpoint.rs:31` | Phase 4 / Phase 7 | Preserve retained evidence as typed bridged authority or keep it terminal evidence; do not reconstruct from text. |
...
| BTI-P2-008 | `E0308` | `BridgeIdentity::<Tag>::from_reference_evidence` | `&BridgeIdentityEvidence` used for stream checkpoint token reconstruction | `BridgeTruthBoundaryBridgedIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/retained_mapping/retained_artifact_digest/planning_checkpoint.rs:53` | Phase 4 / Phase 7 | Split retained checkpoint evidence from current bridge authority. |
| BTI-P2-009 | `E0308` | `BridgeIdentity::<Tag>::new` | raw `&str` from retained checkpoint token | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/retained_mapping/retained_artifact_digest/planning_checkpoint.rs:143` | Phase 4 / Phase 7 | Do not mint stream checkpoint authority from retained text. |
...
| BTI-P2-011 | `E0308` | `BridgeIdentity::<Tag>::new` | raw `&str` from bridge evidence reporting accessor | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/diagnostics/causal_envelope/retained_mapping/retained_artifact_digest/route_history_preview.rs:41` | Phase 4 / Phase 7 | Replace historical record lookup identity reconstruction with typed retained evidence or terminal projection. |
| BTI-P2-012 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `impl AsRef<str>` external evidence | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/writeback/declaration.rs:25` | Phase 4 / Phase 7 | Admit external bridge evidence through explicit external-token category before owner admission. |
| BTI-P2-013 | `E0308` | `BridgeIdentity::<Tag>::new` | raw digest `String` | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/writeback/candidate.rs:137` | Phase 4 / Phase 7 | Treat writeback candidate digest as digest evidence/projection until owner admission. |
| BTI-P2-014 | `E0308` | `BridgeIdentity::<Tag>::new` | raw digest `String` | `BridgeTruthAuthorityIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/writeback/contracts.rs:106` | Phase 4 / Phase 7 | Treat writeback contract digest as digest evidence/projection until owner admission. |
| BTI-P2-015 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `impl AsRef<str>` external evidence | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-runtime-bridge/src/writeback/effect/causality.rs:22` | Phase 4 / Phase 7 | Same external-token closure as BTI-P2-012. |
...
```text
_docs/forge-query/frontier2_query_root_break_cargo_check.txt
```
...
```text
_docs/forge-query/frontier2_workspace_root_break_cargo_check.txt
```
...
`ForgeQueryEvidenceIdentity: Display`,
`ForgeQueryEvidenceIdentity: AsRef<str>`, public
`ForgeQueryEvidenceIdentity::as_str()`, public bridge evidence export,
...
| 2B-E-003 | `E0599` | `Canonical*Digest::evidence_identity` removed | digest wrapper rebuilt a `ForgeQueryEvidenceIdentity` from its own text | owner digest/evidence derivation or typed evidence carried from source | `crates/forge-query/src/workflow/foundation.rs` | Phase 5-9 repair | Replace digest-to-evidence helpers with owner-specific digest evidence derivation; do not let digest text re-enter evidence composition through a crate-wide method. |
...
| Digest wrapper evidence converter removal | `E0599` | 26 | Callers rebuild `ForgeQueryEvidenceIdentity` from digest wrapper text through `Canonical*Digest::evidence_identity()`. | Replace with owner-specific digest evidence derivation or carry the original typed evidence. |
...
- `ForgeQueryEvidenceIdentityEncoder::field_bridge_authority_identity(...)`
  is an internal typed replacement while `forge-query` is red. Compile-fail
...
```powershell
cargo check -p forge-query --lib
cargo check -p forge-query --lib --tests
...
```text
forge-query lib GREEN
forge-query lib tests GREEN
forge-runtime-bridge lib GREEN
...
Post-2B Phase 7 QA: **CLEARED** for `forge-query` scope.
...
```text
_docs/forge-query/bridge_truth_identity_phase4_bridge_lib_check.txt
```

Result:

```text
forge-runtime-bridge lib PASS
```

Bridge-local closure:

- Added explicit bridge owner admission helpers in `crates/forge-runtime-bridge/src/identity_authority/admission.rs`.
...
```text
_docs/forge-query/bridge_truth_identity_phase4_workspace_check.txt
```
...
```text
workspace RED
forge-runtime-bridge passed
forge-query failed to compile
...
| Failure id | Compiler class | Broken API | Attempted category | Required category | First observed path | Owning phase | Closure route |
|------------|----------------|------------|--------------------|-------------------|---------------------|--------------|---------------|
| BTI-P4-QRY-001 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `&ForgeQueryEvidenceIdentity` | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-query/src/application/declaration_bridge_routing/lower.rs:341` | Phase 5 | Query must classify bridge-lowering evidence as external token, projection, digest evidence, or owner-admitted authority before entering bridge evidence. |
| BTI-P4-QRY-002 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `ForgeQueryEvidenceIdentity` | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-query/src/application/declaration_bridge_routing/lower.rs:416` | Phase 5 | Same query evidence-token boundary as BTI-P4-QRY-001. |
| BTI-P4-QRY-003 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `&str` observed digest | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-query/src/effect_lifecycle/oracle/bridge_oracle.rs:202` | Phase 5 / Phase 7 | Observed digest must remain digest evidence/projection unless explicitly tokenized for the bridge boundary. |
| BTI-P4-QRY-004 | `E0308` | `BridgeIdentityEvidence::from_query_evidence_identity` | raw scope `&str` plus raw identity `&str` | `BridgeTruthProjectionIdentity<Arc<str>, BridgeEvidenceReferenceIdentityKind>` plus `BridgeTruthDigestIdentityEvidence<BridgeCanonicalDigestIdentityBasis, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-query/src/evidence_identity/artifact.rs:60` | Phase 5 / Phase 7 | Query evidence identity export must provide typed projection and digest evidence, not raw string accessors. |
| BTI-P4-QRY-005 | `E0599` | removed `BridgeIdentityEvidence::AsRef<str>` | generic evidence string consumption | explicit terminal projection accessor | `crates/forge-query/src/evidence_identity/encoder.rs:77` | Phase 7 | Encoder must distinguish terminal reporting text from authority or evidence composition. |
| BTI-P4-QRY-006 | `E0277` | `ForgeQueryEvidenceIdentityEncoder::field_identity` | `&BridgeIdentityEvidence` through `impl AsRef<str>` | explicit terminal projection accessor or typed evidence field | `crates/forge-query/src/runtime/support/authority_artifacts/bridge_imports.rs:74` | Phase 7 | Evidence encoder API needs a bridge-evidence-specific path or terminal projection quarantine. |
| BTI-P4-QRY-007 | `E0308` | `BridgeIdentityEvidence::from_external_authority` | `ForgeQueryEvidenceIdentity` | `BridgeTruthExternalIdentityToken<Arc<str>, BridgeEvidenceReferenceIdentityKind>` | `crates/forge-query/src/workflow/lowering/writeback.rs:228` | Phase 5 | Writeback lowering must tokenize query evidence before bridge evidence admission. |
...
```text
_docs/forge-query/bridge_truth_identity_query_evidence_tokenization_check.txt
_docs/forge-query/bridge_truth_identity_query_evidence_tokenization_bridge_check.txt
_docs/forge-query/bridge_truth_identity_query_evidence_tokenization_trybuild.txt
```

Result:

```text
forge-query lib PASS
forge-runtime-bridge lib PASS
...
`ForgeQueryEvidenceIdentityEncoder::field_bridge_identity(...)`; do not restore
...
- `ForgeQueryEvidenceIdentity::bridge_external_identity_evidence()` now performs
  the explicit Query -> bridge external-token crossing.
- `ForgeQueryEvidenceIdentity::bridge_evidence_identity()` now exports Query
  evidence through bridge projection and digest evidence categories, not raw
  scope/token strings.
- Historical: `ForgeQueryEvidenceIdentityEncoder::field_bridge_identity(...)`
...
- `forge-server` compatibility HTTP surfaces still call removed digest accessors
  such as `basis_digest()` and `basis_binding_digest()`.
- `worth-topo` production mutation-authority paths still pass formatted
  `String` values where `ForgeQueryMutationAuthorityIdentity` is required.
...
The first post-bridge workspace frontier is `forge-query`, but Query should not
...
- `forge-relational/src/identity_authority/` exists and classifies relational
...
- Compile-fail guards added under
  `crates/forge-relational/tests/ui/phase_2a/` prove display labels such as
...
- `forge-signal` does not currently use a dedicated `FoundationalAuthorityIdentity`
...
- Compile-fail guards added under `crates/forge-signal/tests/ui/phase_2a/`
...
- `cargo test -p forge-relational --test phase_boundaries_compile_fail phase_2a_upstream_identity_boundaries_reject_projection_reentry` passed.
- `cargo test -p forge-signal --test phase_2a_signal_boundaries` passed.
- `cargo check -p forge-relational --lib` passed.
- `cargo check -p forge-signal --lib` passed.
- Captured logs:
  `_docs/forge-query/bridge_truth_identity_phase2a_relational_trybuild_verify.txt`,
  `_docs/forge-query/bridge_truth_identity_phase2a_signal_trybuild_verify.txt`,
  `_docs/forge-query/bridge_truth_identity_phase2a_relational_lib_check.txt`,
  `_docs/forge-query/bridge_truth_identity_phase2a_signal_lib_check.txt`.

Next action:

Resume at the current `forge-query` compiler frontier. Keep Phase 2A rows open
...
- `ActiveSubscriptionLaneAdmission` and `ActiveSubscriptionLane` now store the
  signal strategy as `ForgeQueryEvidenceIdentity` instead of
...
- `admit_subscription_continuation_evidence(...)` and
  ...
  typed `ForgeQueryEvidenceIdentity` values for source, target, basis,
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- `cargo test -p forge-query subscription::tests::active:: --lib` still fails
...
- Captured logs:
  `_docs/forge-query/bridge_truth_identity_signal_feeder_lifecycle_check.txt`,
  `_docs/forge-query/bridge_truth_identity_signal_feeder_lifecycle_trybuild.txt`,
  `_docs/forge-query/bridge_truth_identity_signal_feeder_lifecycle_tests.txt`.
...
- `forge-relational` remains sealed for the current source-truth bridge
...
- `forge-signal` remains quarantined as a signal proof/domain-token lane:
...
- `forge-runtime-bridge` now has all declared bridge truth identity compile-fail
...
- `cargo test -p forge-runtime-bridge --test phase_boundaries_bridge_truth_identity_compile_fail` passed.
- `cargo test -p forge-runtime-bridge --test phase_boundaries_bridge_truth_identity_digest` passed.
- `cargo test -p forge-relational --test phase_boundaries_compile_fail phase_2a_upstream_identity_boundaries_reject_projection_reentry` passed.
- `cargo test -p forge-signal --test phase_2a_signal_boundaries` passed.
- `cargo check -p forge-runtime-bridge --lib` passed.
- `cargo check -p forge-relational --lib` passed.
- `cargo check -p forge-signal --lib` passed.
- Captured logs:
  `_docs/forge-query/upstream_foundation_gate_runtime_bridge_trybuild_verify.txt`,
  `_docs/forge-query/upstream_foundation_gate_runtime_bridge_digest.txt`,
  `_docs/forge-query/upstream_foundation_gate_runtime_bridge_lib.txt`,
  `_docs/forge-query/upstream_foundation_gate_relational_trybuild.txt`,
  `_docs/forge-query/upstream_foundation_gate_relational_lib.txt`,
  `_docs/forge-query/upstream_foundation_gate_signal_trybuild.txt`,
  `_docs/forge-query/upstream_foundation_gate_signal_lib.txt`.
...
- `QuerySubscriptionManualBridgeWitness` stores typed
  `ForgeQueryEvidenceIdentity` values for query declaration, bridge
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- `cargo test -p forge-query subscription::tests::declaration::bridge_parity --lib`
...
- Captured logs:
  `_docs/forge-query/goal_mode_subscription_bridge_parity_typed_check.txt`,
  `_docs/forge-query/goal_mode_subscription_bridge_parity_typed_trybuild.txt`,
  `_docs/forge-query/goal_mode_subscription_bridge_parity_typed_tests.txt`.
...
- Workflow certification control evidence now uses
  `ForgeQueryEvidenceIdentity::bridge_external_identity_evidence()` rather than
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Targeted scan:
  `rg -n "BridgeIdentityEvidence::from_external_authority\\(|BridgeIdentityEvidence::from_query_evidence_identity\\(|evidence_identity\\(\\)\\s*\\)" crates/forge-query/src/runtime/tests/causal_inspection crates/forge-query/src/harness/workflow_certification/tests.rs`
  returns only the shared causal-inspection helper constructor calls.
- Captured logs:
  `_docs/forge-query/goal_mode_causal_fixture_bridge_evidence_frontier.txt`,
  `_docs/forge-query/goal_mode_causal_fixture_bridge_evidence_query_check.txt`,
  `_docs/forge-query/goal_mode_causal_fixture_bridge_evidence_trybuild.txt`.
...
- `ForgeQueryRuntimeSubscriptionActivationAdapter` now requires
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query subscription::tests::declaration::bridge_parity --lib` passed.
- `cargo test -p forge-query subscription::tests::active::active_lifecycle --lib` passed.
- `cargo test -p forge-query --test causal_inspection_public_dx` passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_subscription_support_typed_check.txt`,
  `_docs/forge-query/goal_mode_subscription_support_typed_bridge_parity_tests.txt`,
  `_docs/forge-query/goal_mode_subscription_support_typed_active_lifecycle_tests.txt`,
  `_docs/forge-query/goal_mode_subscription_support_typed_public_dx.txt`,
  `_docs/forge-query/goal_mode_subscription_support_typed_trybuild.txt`.
...
- `SubscriptionLifecycleCertificationContext` stores policy, tenant-basis,
  ...
  `ForgeQueryEvidenceIdentity` values. Digest-named accessors are reporting
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query subscription::tests::certification:: --lib`
  passed.
- `cargo test -p forge-query subscription::tests::active::active_preview_isolation --lib`
  passed.
- `cargo test -p forge-query subscription::tests::diagnostic_bundles --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_subscription_lifecycle_preview_typed_check.txt`,
  `_docs/forge-query/goal_mode_subscription_lifecycle_preview_typed_certification_tests.txt`,
  `_docs/forge-query/goal_mode_subscription_lifecycle_preview_typed_preview_tests.txt`,
  `_docs/forge-query/goal_mode_subscription_lifecycle_preview_typed_diagnostic_tests.txt`,
  `_docs/forge-query/goal_mode_subscription_lifecycle_preview_typed_trybuild.txt`.
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query subscription::tests::active::active_lifecycle --lib`
  passed.
- `cargo test -p forge-query subscription::tests::certification:: --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_active_lane_source_typed_check.txt`,
  `_docs/forge-query/goal_mode_active_lane_source_typed_active_lifecycle_tests.txt`,
  `_docs/forge-query/goal_mode_active_lane_source_typed_certification_tests.txt`,
  `_docs/forge-query/goal_mode_active_lane_source_typed_trybuild.txt`.
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query subscription::tests::certification::scale_slope --lib`
  passed.
- `cargo test -p forge-query subscription::tests::certification:: --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_scale_slope_typed_check.txt`,
  `_docs/forge-query/goal_mode_scale_slope_typed_scale_tests.txt`,
  `_docs/forge-query/goal_mode_scale_slope_typed_certification_tests.txt`,
  `_docs/forge-query/goal_mode_scale_slope_typed_trybuild.txt`,
  `_docs/forge-query/goal_mode_scale_slope_typed_runtime_bridge_digest.txt`.
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_runtime_certification_bundle_typed_check.txt`,
  `_docs/forge-query/goal_mode_runtime_certification_bundle_typed_tests.txt`,
  `_docs/forge-query/goal_mode_runtime_certification_bundle_typed_trybuild.txt`,
  `_docs/forge-query/goal_mode_runtime_certification_bundle_typed_runtime_bridge_digest.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_split_check.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_typed_check.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_typed_tests.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_typed_trybuild.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_typed_runtime_bridge_digest.txt`.
...
- `bridge_parity/identities.rs` defines local composition helpers over
  `ForgeQueryEvidenceIdentity` for bridge-parity counters, width, receipt,
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_bridge_parity_identity_check.txt`,
  `_docs/forge-query/goal_mode_bridge_parity_identity_tests.txt`,
  `_docs/forge-query/goal_mode_bridge_parity_identity_runtime_certification_tests.txt`,
  `_docs/forge-query/goal_mode_bridge_parity_identity_trybuild.txt`.
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_runtime_coverage_basis_view_typed_check.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_basis_view_typed_tests.txt`,
  `_docs/forge-query/goal_mode_runtime_coverage_basis_view_typed_trybuild.txt`.
...
- The legacy-named `runtime_subscription_budget_digest()` test helper now
  returns `ForgeQueryEvidenceIdentity` instead of reconstructing and returning a
  raw budget string.
- Runtime assembly tests compare
  `ForgeQueryRuntimeLiveSubscriptionInstallation::runtime_budget_identity()`
  with the typed helper identity directly.
- The runtime budget reporting accessor remains a terminal projection over the
  stored `ForgeQueryEvidenceIdentity`; it no longer participates in the tested
  verification path.

Verification:

- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query runtime::tests::assembly::builder:: --lib` passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_runtime_budget_identity_check.txt`,
  `_docs/forge-query/goal_mode_runtime_budget_identity_assembly_tests.txt`,
  `_docs/forge-query/goal_mode_runtime_budget_identity_trybuild.txt`.
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_preview_lifecycle_source_typed_check.txt`,
  `_docs/forge-query/goal_mode_preview_lifecycle_source_typed_preview_tests.txt`,
  `_docs/forge-query/goal_mode_preview_lifecycle_source_typed_certification_tests.txt`,
  `_docs/forge-query/goal_mode_preview_lifecycle_source_typed_trybuild.txt`.
...
- `cargo check -p forge-query --lib` completed successfully in the saved log.
- `cargo test -p forge-query subscription::tests::certification:: --lib`
  passed.
- `cargo test -p forge-query subscription::tests::runtime_certification:: --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_activation_coverage_typed_check.txt`,
  `_docs/forge-query/goal_mode_activation_coverage_typed_certification_tests.txt`,
  `_docs/forge-query/goal_mode_activation_coverage_typed_runtime_certification_tests.txt`,
  `_docs/forge-query/goal_mode_activation_coverage_typed_trybuild.txt`.
...
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_diagnostic_trace_source_typed_check.txt`,
  `_docs/forge-query/goal_mode_diagnostic_trace_source_typed_diagnostic_tests.txt`,
  `_docs/forge-query/goal_mode_diagnostic_trace_source_typed_runtime_certification_tests.txt`,
  `_docs/forge-query/goal_mode_diagnostic_trace_source_typed_trybuild.txt`.
...
- `cargo test -p forge-query subscription::tests::diagnostic_bundles --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed after
  refreshing the one intentional constructor-private stderr.
- Captured logs:
  `_docs/forge-query/goal_mode_diagnostic_bundle_support_identity_check.txt`,
  `_docs/forge-query/goal_mode_diagnostic_bundle_support_identity_runtime_certification_tests.txt`,
  `_docs/forge-query/goal_mode_diagnostic_bundle_support_identity_diagnostic_tests.txt`,
  `_docs/forge-query/goal_mode_diagnostic_bundle_support_identity_trybuild_verify.txt`.
...
- `certify_subscription_lifecycle(...)` now requires a typed
  `ForgeQueryEvidenceIdentity` delivery-window witness instead of accepting an
...
- `cargo test -p forge-query subscription::tests::certification:: --lib`
  passed.
- `cargo test -p forge-query subscription::tests::active::active_delivery --lib`
  passed.
- `cargo test -p forge-query subscription::tests::active::active_continuation --lib`
  passed.
- `cargo test -p forge-query subscription::tests::runtime_certification:: --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed after
...
- Captured logs:
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_check.txt`,
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_certification_tests_verify.txt`,
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_active_delivery_tests.txt`,
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_active_continuation_tests_fixed.txt`,
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_runtime_certification_tests.txt`,
  `_docs/forge-query/goal_mode_lifecycle_typed_sources_trybuild_verify.txt`.
...
- `ActiveSubscriptionLaneDigest` and
  ...
  The broader `ForgeQueryEvidenceIdentity` type remains non-ordered/non-hashable
...
- `cargo test -p forge-query subscription::tests::active::active_lifecycle --lib`
  passed.
- `cargo test -p forge-query subscription::tests::active::active_sharing --lib`
  passed.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed.
- Captured logs:
  `_docs/forge-query/goal_mode_active_registry_typed_keys_check.txt`,
  `_docs/forge-query/goal_mode_active_registry_typed_keys_active_lifecycle_tests.txt`,
  `_docs/forge-query/goal_mode_active_registry_typed_keys_active_sharing_tests.txt`,
  `_docs/forge-query/goal_mode_active_registry_typed_keys_trybuild.txt`.
...
- `ForgeQueryRuntimeLiveSubscriptionInstallation` stores that
...
- `ForgeQueryLiveReadReceipt` stores `CanonicalResultShapeDigest` plus typed
...
- `cargo check -p forge-query --lib` completed successfully before and after
  the accessor split.
- `cargo test -p forge-query projection_consumption::tests::retained_live --lib`
  passed before and after the accessor split.
- `cargo test -p forge-query runtime::tests::live --lib` passed before and
  after the accessor split.
- `cargo test -p forge-query runtime::tests::live_receipts --lib` passed before
  and after the accessor split.
- `cargo test -p forge-query --test phase_boundaries_compile_fail` passed before
  and after the accessor split.
- Captured logs:
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_check.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_check_after_split.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_retained_live_tests.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_retained_live_tests_after_split.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_runtime_live_tests.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_runtime_live_tests_after_split.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_live_receipts_tests.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_live_receipts_tests_after_split.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_trybuild.txt`,
  `_docs/forge-query/goal_mode_live_read_result_shape_typed_trybuild_after_split.txt`.
...
- `cargo check -p forge-query --lib` completed successfully.
- `cargo test -p forge-query live_view_declaration_receipt_captures_request_shape --lib`
  passed.
- Captured logs:
  `_docs/forge-query/goal_mode_live_declaration_admission_typed_shape_check.txt`,
  `_docs/forge-query/goal_mode_live_declaration_admission_typed_shape_test.txt`.
...
- `cargo test -p forge-query subscription::tests::active::active_lifecycle --lib`
  passed.
- `cargo test -p forge-query subscription::tests::active::active_closeout --lib`
  passed.
- Targeted scan found no remaining `source_digest()` string equality in
  `crates/forge-query/src/subscription` or `crates/forge-query/src/runtime`.
- Captured logs:
  `_docs/forge-query/goal_mode_active_lifecycle_denial_kind_check.txt`,
  `_docs/forge-query/goal_mode_active_lifecycle_denial_kind_active_lifecycle_tests.txt`,
  `_docs/forge-query/goal_mode_active_lifecycle_denial_kind_active_closeout_tests.txt`.
...
- `QuerySubscriptionSupportProfile::{admitted, denied,
  active_runtime_admitted}` now require `&ForgeQueryEvidenceIdentity` as the
  source input.
...
- `cargo check -p forge-query --lib` completed successfully.
- `cargo test -p forge-query subscription::tests::admission --lib` passed.
- `cargo test -p forge-query subscription::tests::diagnostics --lib` passed.
- `cargo test -p forge-query subscription::tests::active::active_closeout --lib`
  passed.
...
- Captured logs:
  `_docs/forge-query/goal_mode_support_profile_typed_source_check.txt`,
  `_docs/forge-query/goal_mode_support_profile_typed_source_admission_tests.txt`,
  `_docs/forge-query/goal_mode_support_profile_typed_source_diagnostics_tests.txt`,
  `_docs/forge-query/goal_mode_support_profile_typed_source_active_closeout_tests.txt`.
...
- `QuerySubscriptionSupportReport` now stores `source_identity:
  ForgeQueryEvidenceIdentity` beside the existing reporting projection.
...
- `cargo check -p forge-query --lib` completed successfully.
- `cargo test -p forge-query subscription::tests::support --lib` passed.
- `cargo test -p forge-query subscription::tests::runtime_certification --lib`
  passed.
- Captured logs:
  `_docs/forge-query/goal_mode_support_report_typed_source_check.txt`,
  `_docs/forge-query/goal_mode_support_report_typed_source_support_tests.txt`,
  `_docs/forge-query/goal_mode_support_report_typed_source_runtime_certification_tests.txt`.
...
- Runtime certification coverage variation sets now sort and deduplicate
  `ForgeQueryEvidenceIdentity` values by typed evidence scope, scheme, and
...
- `cargo test -p forge-query subscription::tests::runtime_certification --lib`
  passed.
- `cargo test -p forge-query subscription::tests::runtime_certification_closure_support --lib`
  passed.
- Targeted scan found no remaining diagnostic-bundle digest equality or
  `as_str()`-only runtime-certification variation dedup.
- Captured logs:
  `_docs/forge-query/goal_mode_runtime_certification_diagnostic_identity_check.txt`,
  `_docs/forge-query/goal_mode_runtime_certification_diagnostic_identity_tests.txt`,
  `_docs/forge-query/goal_mode_runtime_certification_diagnostic_identity_closure_support_tests.txt`.
...
- `SubscriptionConsumerAttachmentRequest` now carries a typed
  `delivery_cursor_seed_identity: ForgeQueryEvidenceIdentity` beside its
...
- `ForgeQueryRuntime::install_live_subscription_for_request(...)` passes
...
- `cargo test -p forge-query subscription::tests::active::active_sharing --lib`
  passed.
- `cargo test -p forge-query runtime::tests::live --lib` passed.
- Targeted scan found no remaining runtime-session
  `activation_for_reporting()` input to `from_consumer_identity(...)`.
- Captured logs:
  `_docs/forge-query/goal_mode_attachment_cursor_seed_identity_check.txt`,
  `_docs/forge-query/goal_mode_attachment_cursor_seed_identity_active_lifecycle_tests.txt`,
  `_docs/forge-query/goal_mode_attachment_cursor_seed_identity_active_sharing_tests.txt`,
  `_docs/forge-query/goal_mode_attachment_cursor_seed_identity_runtime_live_tests.txt`.
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query runtime::tests::live --lib` passed.
- `cargo test -p forge-query runtime::tests::session_label_outputs --lib`
...
- Captured logs:
  `_docs/forge-query/goal_mode_row_1051_runtime_session_split_check.txt`,
  `_docs/forge-query/goal_mode_row_1051_runtime_session_split_live_tests.txt`,
  `_docs/forge-query/goal_mode_row_1051_runtime_session_split_session_label_tests.txt`.
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query workflow::tests::inspection --lib` passed.
- `cargo test -p forge-query domain_capabilities::canonical_runtime_workflow_inspection_tests --lib`
  passed.
- `cargo test -p forge-query domain_capabilities::canonical_runtime_support_workflow_tests --lib`
  passed.
- `cargo test -p forge-query domain_capabilities::materialization_tests --lib`
  passed.
...
- Captured logs:
  `_docs/forge-query/goal_mode_workflow_domain_typed_identity_check.txt`,
  `_docs/forge-query/goal_mode_workflow_domain_typed_identity_workflow_tests.txt`,
  `_docs/forge-query/goal_mode_workflow_domain_typed_identity_domain_workflow_tests.txt`,
  `_docs/forge-query/goal_mode_workflow_domain_typed_identity_support_workflow_tests.txt`,
  `_docs/forge-query/goal_mode_workflow_domain_typed_identity_materialization_tests.txt`.
...
- `cargo check -p forge-query --lib` passed.
- `cargo test -p forge-query effect_lifecycle::tests::batch::admission --lib`
  passed.
- `cargo test -p forge-query effect_lifecycle::tests::batch --lib` passed.
...
- Captured logs:
  `_docs/forge-query/goal_mode_effect_batch_typed_coherence_check.txt`,
  `_docs/forge-query/goal_mode_effect_batch_typed_coherence_batch_admission_tests.txt`,
  `_docs/forge-query/goal_mode_effect_batch_typed_coherence_batch_tests.txt`.
...
- `cargo test -p forge-query runtime::tests::causal_inspection::certification --lib`
  passed.
- `cargo test -p forge-query runtime::tests::causal_inspection::materialization --lib`
  passed.
...
- Captured logs:
  `_docs/forge-query/goal_mode_causal_projection_quarantine_check.txt`,
  `_docs/forge-query/goal_mode_causal_projection_quarantine_certification_tests.txt`,
  `_docs/forge-query/goal_mode_causal_projection_quarantine_materialization_tests.txt`.
...
- Targeted lookup API scan found the production source/structural/stream
  ...
  compiler fallout.
- `cargo test -p forge-runtime-bridge retained_mapping --lib` passed after the

...
- runtime-backed continuation/recovery posture for temporal basis drift, async
  ...
  crossed residue
- one runtime-backed downstream delivery contract for `forge-server` and other
...
- runtime-backed docs:
  - [AI_README.md](../../crates/forge-query/docs/AI_README.md)
  - [workspace-overview.md](../../crates/forge-query/docs/foundations/workspace-overview.md)
  - [state.md](../../crates/forge-query/docs/foundations/state.md)
  - [support-matrix-and-admission.md](../../crates/forge-query/docs/foundations/support-matrix-and-admission.md)
  - [downstream-runtime-integration.md](../../crates/forge-query/docs/foundations/downstream-runtime-integration.md)
  - [async-resources-and-result-state.md](../../crates/forge-query/docs/capabilities/async-resources-and-result-state.md)
...
- `cargo test -p forge-query runtime_public_downstream_delivery_contract_freezes_runtime_backed_and_durable_resume_posture`
- `cargo test -p forge-query runtime_public_support_matrix_exposes_downstream_delivery_contract_row`
- `cargo test -p forge-query runtime_backed_reference_workload_exercises_temporal_async_preview_causal_and_follow_on_lanes`
- `cargo test -p forge-query runtime_backed_closure_matrix_preserves_equivalent_and_distinct_public_meaning`
- `cargo test -p forge-query runtime_support_profiles_expose_facade_family_posture`
- `cargo test -p forge-query runtime_public_support_matrix_freezes_stable_deferred_and_unsupported_rows`
...
## Handoff To Forge Server And Later Roadmap Work

`forge-server` now inherits:
...
That is the dependency handoff the Forge Server roadmap can now consume.

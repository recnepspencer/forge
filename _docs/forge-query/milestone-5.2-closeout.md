...
`forge-query` now has a real preview-session query substrate layered on top of
...
- preview basis binding, preview execution, promotion-parity comparison,
  ...
  [crates/forge-query/src/preview/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/preview/mod.rs)
...
- milestone-native preview certification artifacts, completeness reports, row
  ...
  [crates/forge-query/src/harness/preview_certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/preview_certification)
- shared milestone requirement wiring in
  [crates/forge-query/src/harness/certification/requirements.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/certification/requirements.rs)
  and
  [crates/forge-query/src/harness/certification/tests.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/certification/tests.rs)
...
- [preview_certification/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/preview_certification/mod.rs)
- [preview_certification/row_catalog.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/preview_certification/row_catalog.rs)
- [preview_certification/model.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/preview_certification/model.rs)
...
- `cargo test -p forge-query preview --no-fail-fast`
- `cargo test -p forge-query preview_certification --no-fail-fast`
- `cargo test -p forge-query --test phase_boundaries_compile_fail -- --nocapture`
- `cargo test -p forge-query --no-fail-fast`
...
`forge-query` no longer depends on branch aliases, ambient preview mode,

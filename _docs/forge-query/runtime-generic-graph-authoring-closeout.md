# Forge Query Runtime Generic Graph Authoring Closeout

## Status

The runtime generic graph authoring hardening gate is closed as of 2026-05-01
for the runtime-backed admitted surface in `forge-query`.
...
- [crates/forge-query/src/runtime/tests/mutation/graph_composition.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_lifecycle.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_lifecycle.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_followup.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_followup.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_mixed_existing.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_mixed_existing.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_verified_existing.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_verified_existing.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_retarget_existing.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_retarget_existing.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_supersede_existing.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_supersede_existing.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_denial.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_denial.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_existing_binding_denial.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_existing_binding_denial.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_retarget_existing_denial.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_retarget_existing_denial.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_boundary.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_boundary.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_lineage_summary_boundary.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_lineage_summary_boundary.rs)
...
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_geometry_pressure.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_geometry_pressure.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_face_inner_loop.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_face_inner_loop.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_invariant_pack.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_invariant_pack.rs)
- [crates/forge-query/src/runtime/tests/mutation/graph_composition_edge_split.rs](../../crates/forge-query/src/runtime/tests/mutation/graph_composition_edge_split.rs)
...
- [crates/forge-query/src/runtime/tests/assembly/support_profile/graph_composition_capabilities.rs](../../crates/forge-query/src/runtime/tests/assembly/support_profile/graph_composition_capabilities.rs)
- [crates/forge-query/src/runtime/tests/assembly/support_profile/authority_evidence_closeout.rs](../../crates/forge-query/src/runtime/tests/assembly/support_profile/authority_evidence_closeout.rs)
- [crates/forge-query/src/runtime/authoritative_mutation_evidence_support.rs](../../crates/forge-query/src/runtime/authoritative_mutation_evidence_support.rs)
- [crates/forge-query/src/runtime/authoritative_mutation_evidence_closeout.rs](../../crates/forge-query/src/runtime/authoritative_mutation_evidence_closeout.rs)
...
- [crates/forge-query/docs/graph-composition-authoring.md](../../crates/forge-query/docs/graph-composition-authoring.md)
- [crates/forge-query/docs/existing-truth-verified-updates.md](../../crates/forge-query/docs/existing-truth-verified-updates.md)
- [crates/forge-query/docs/existing-truth-verified-deletes.md](../../crates/forge-query/docs/existing-truth-verified-deletes.md)
- [crates/forge-query/docs/writes-and-intents.md](../../crates/forge-query/docs/writes-and-intents.md)
- [runtime-authoritative-mutation-evidence-closeout.md](./runtime-authoritative-mutation-evidence-closeout.md)
...
- `cargo test -p forge-query runtime_public_authoritative_mutation_evidence -- --nocapture`
- `cargo test -p forge-query graph_composition -- --nocapture`
...
`forge-query` now has one ordinary admitted mixed-shape graph-authoring runtime

# Forge Query Milestone 9.7 Phase 18 Closeout
...
- `cargo check -p forge-query --all-targets`
- `cargo test -p forge-query --lib milestone_nine_seven`
- `cargo test -p forge-query --test public_bridge_reader_lane_honesty`
- `cargo test -p forge-query --test phase_boundaries_projection_consumption_compile_fail`

...
compile-time boundary scope in `forge-query`.
...
- `forge_query_vision.md`: protects one typed query model that can become live
  without separate host-specific subscription semantics. 9.1 closes the
  declaration side of read-to-subscribe promotion.
- `forge_query_roadmap.md`: protects the sequence from policy-safe live meaning
...
- query-owned subscription family vocabulary in
  [crates/forge-query/src/subscription/family.rs](../../crates/forge-query/src/subscription/family.rs)
- subscription family selection and dimension validation in
  [crates/forge-query/src/subscription/selection.rs](../../crates/forge-query/src/subscription/selection.rs)
- subscription equivalence and meaning digests in
  [crates/forge-query/src/subscription/equivalence.rs](../../crates/forge-query/src/subscription/equivalence.rs)
- live admission input and immutable policy/tenant/relationship-proof
  evidence accessors in
  [crates/forge-query/src/subscription/input.rs](../../crates/forge-query/src/subscription/input.rs)
- query-owned declaration artifacts, declaration digests, delivery intent, and
  slice intent in
  [crates/forge-query/src/subscription/declaration.rs](../../crates/forge-query/src/subscription/declaration.rs),
  [crates/forge-query/src/subscription/declaration_digest.rs](../../crates/forge-query/src/subscription/declaration_digest.rs),
  [crates/forge-query/src/subscription/delivery.rs](../../crates/forge-query/src/subscription/delivery.rs), and
  [crates/forge-query/src/subscription/slice.rs](../../crates/forge-query/src/subscription/slice.rs)
- explicit query-to-bridge family and slice maps in
  [crates/forge-query/src/subscription/bridge_family.rs](../../crates/forge-query/src/subscription/bridge_family.rs) and
  [crates/forge-query/src/subscription/bridge_slice.rs](../../crates/forge-query/src/subscription/bridge_slice.rs)
- bridge lowering, basis binding requests, and signal strategy requests in
  [crates/forge-query/src/subscription/bridge_lowering.rs](../../crates/forge-query/src/subscription/bridge_lowering.rs),
  [crates/forge-query/src/subscription/basis_request.rs](../../crates/forge-query/src/subscription/basis_request.rs), and
  [crates/forge-query/src/subscription/signal_strategy.rs](../../crates/forge-query/src/subscription/signal_strategy.rs)
- runtime-backed admission, activation input, support profile, admission
  diagnostics, and certification in
  [crates/forge-query/src/subscription/admission.rs](../../crates/forge-query/src/subscription/admission.rs),
  [crates/forge-query/src/subscription/activation.rs](../../crates/forge-query/src/subscription/activation.rs),
  [crates/forge-query/src/subscription/support.rs](../../crates/forge-query/src/subscription/support.rs),
  [crates/forge-query/src/subscription/admission_diagnostics.rs](../../crates/forge-query/src/subscription/admission_diagnostics.rs), and
...
- exact declaration/admission counters in
  [crates/forge-query/src/subscription/counters.rs](../../crates/forge-query/src/subscription/counters.rs)
- milestone certification in
  [crates/forge-query/src/harness/milestone_nine_one_certification](../../crates/forge-query/src/harness/milestone_nine_one_certification)
- public facade exposure for the admitted subscription declaration surface in
  [crates/forge-query/src/facade.rs](../../crates/forge-query/src/facade.rs)
...
- [crates/forge-query/src/harness/milestone_nine_one_certification/mod.rs](../../crates/forge-query/src/harness/milestone_nine_one_certification/mod.rs)
- [crates/forge-query/src/harness/milestone_nine_one_certification/tests.rs](../../crates/forge-query/src/harness/milestone_nine_one_certification/tests.rs)
...
- [crates/forge-query/src/subscription/selection.rs](../../crates/forge-query/src/subscription/selection.rs)
- [crates/forge-query/src/subscription/equivalence.rs](../../crates/forge-query/src/subscription/equivalence.rs)
- [crates/forge-query/src/subscription/tests/family_selection.rs](../../crates/forge-query/src/subscription/tests/family_selection.rs)
- [crates/forge-query/src/subscription/tests/equivalence.rs](../../crates/forge-query/src/subscription/tests/equivalence.rs)
- [crates/forge-query/src/subscription/tests/diagnostics.rs](../../crates/forge-query/src/subscription/tests/diagnostics.rs)
...
- [crates/forge-query/src/subscription/declaration.rs](../../crates/forge-query/src/subscription/declaration.rs)
- [crates/forge-query/src/subscription/slice.rs](../../crates/forge-query/src/subscription/slice.rs)
- [crates/forge-query/src/subscription/delivery.rs](../../crates/forge-query/src/subscription/delivery.rs)
- [crates/forge-query/src/subscription/tests/declaration_parity.rs](../../crates/forge-query/src/subscription/tests/declaration_parity.rs)
- [crates/forge-query/src/subscription/tests/declaration_budget.rs](../../crates/forge-query/src/subscription/tests/declaration_budget.rs)
- [crates/forge-query/src/subscription/tests/delivery_intent.rs](../../crates/forge-query/src/subscription/tests/delivery_intent.rs)
...
- [crates/forge-query/src/subscription/bridge_lowering.rs](../../crates/forge-query/src/subscription/bridge_lowering.rs)
- [crates/forge-query/src/subscription/bridge_family.rs](../../crates/forge-query/src/subscription/bridge_family.rs)
- [crates/forge-query/src/subscription/bridge_slice.rs](../../crates/forge-query/src/subscription/bridge_slice.rs)
- [crates/forge-query/src/subscription/basis_request.rs](../../crates/forge-query/src/subscription/basis_request.rs)
- [crates/forge-query/src/subscription/signal_strategy.rs](../../crates/forge-query/src/subscription/signal_strategy.rs)
- [crates/forge-query/src/subscription/tests/bridge_lowering.rs](../../crates/forge-query/src/subscription/tests/bridge_lowering.rs)
...
- [crates/forge-query/src/subscription/admission.rs](../../crates/forge-query/src/subscription/admission.rs)
- [crates/forge-query/src/subscription/activation.rs](../../crates/forge-query/src/subscription/activation.rs)
- [crates/forge-query/src/subscription/admission_diagnostics.rs](../../crates/forge-query/src/subscription/admission_diagnostics.rs)
- [crates/forge-query/src/subscription/diagnostic.rs](../../crates/forge-query/src/subscription/diagnostic.rs)
- [crates/forge-query/src/subscription/support.rs](../../crates/forge-query/src/subscription/support.rs)
- [crates/forge-query/src/subscription/tests/admission.rs](../../crates/forge-query/src/subscription/tests/admission.rs)
- [crates/forge-query/src/subscription/tests/diagnostics.rs](../../crates/forge-query/src/subscription/tests/diagnostics.rs)
...
- [crates/forge-query/src/subscription/mod.rs](../../crates/forge-query/src/subscription/mod.rs)
- [crates/forge-query/src/facade.rs](../../crates/forge-query/src/facade.rs)
- [crates/forge-query/tests/phase_boundaries_compile_fail.rs](../../crates/forge-query/tests/phase_boundaries_compile_fail.rs)
- [crates/forge-query/tests/ui](../../crates/forge-query/tests/ui)
...
- Forge Query vision, roadmap, and test requirements
- Milestone 9 closeout
- the Forge coding guideline documents
...
- `cargo test -p forge-query milestone_nine_one`
- `cargo test -p forge-query`
- `git diff --check`

The final full test run passed:

- 588 `forge-query` unit tests
...
admission boundary for `forge-query`.

`forge-query` no longer depends on host observer inference, raw CDC filters,
...
- Is the adversarial constraint precise and load-bearing? Yes. The tests cover
  ...
  and scale drift.
- Does the milestone preserve crate authority boundaries? Yes. `forge-query`

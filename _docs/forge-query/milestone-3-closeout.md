...
`forge-query` now has a real proof-bearing execution substrate between
...
- explicit basis intent, basis resolution, and preflight coupling in
  [crates/forge-query/src/basis](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/basis)
- query-owned binding fulfillment and resolution in
  [crates/forge-query/src/binding](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/binding)
...
- plan/basis/binding/result digest authority in
  [crates/forge-query/src/identity](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/identity)
...
- a shared certification core and requirements registry under
  [crates/forge-query/src/harness/certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/certification)
...
- the named Milestone 3 certification surface under
  [crates/forge-query/src/harness/planning_certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/planning_certification)
  and
  [crates/forge-query/src/harness/planning_matrix](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/planning_matrix)
...
- [planning_certification/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/planning_certification/mod.rs)
- [planning_certification/tests.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/planning_certification/tests.rs)
- [planning_matrix](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/planning_matrix)
...
- shared certification grammar under
  [harness/certification](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/certification)
- Milestone 1, 2, and 3 completeness reports deriving from the shared
  requirements registry
- shared phase fixtures under
  [harness/fixtures](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-query/src/harness/fixtures)
...
`forge-query` no longer depends on ambient truth reads, host-local binding

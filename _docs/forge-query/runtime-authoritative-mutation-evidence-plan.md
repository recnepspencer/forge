...
This is exactly the kind of substrate gap that should be solved once in `forge-query`,
...
- support-matrix and closeout/support-digest participation for the new binding
  family
- compile-fail privacy tests proving callers cannot forge proof-bearing

...
>
> **Primary predecessors:** [milestone-9.3.7.md](./milestone-9.3.7.md), [milestone-9.3.8.md](./milestone-9.3.8.md), [runtime-api-public-stabilization-plan.md](./runtime-api-public-stabilization-plan.md), [runtime-authoritative-mutation-evidence-plan.md](./runtime-authoritative-mutation-evidence-plan.md), and [milestone-17.md](../forge-runtime-bridge/milestone-17.md)
>
...
- `forge-server` would later inherit half-Query, half-host delivery semantics
...
- `forge_query_roadmap.md`: `9.4` belongs after the public runtime and
...
- or requires downstream domains or `forge-server` to reopen lower-authority
...
- `forge-runtime-bridge` remains authoritative for temporal bridge basis,
  ...
  shape.
- `forge-signal` remains authoritative for temporal eligibility, previous-value
  semantics, wake readiness, async lifecycle, retry, timeout, cancellation,
  supersession, and revalidation policy.
- `forge-relational` remains authoritative for truth-view basis, branches,
...
**Relevant subsystems**
- `forge-query` public runtime facade and handle contract
- `forge-query` runtime-backed support posture
- `forge-runtime-bridge` temporal/async basis and lifecycle artifacts
...
- [runtime/handle_contract.rs](../../crates/forge-query/src/runtime/handle_contract.rs)
- [runtime/state.rs](../../crates/forge-query/src/runtime/state.rs)
- [runtime/inspection.rs](../../crates/forge-query/src/runtime/inspection.rs)
...
**Relevant subsystems**
- `forge-query` support matrix and family admission
- `forge-query` runtime support profiles
- `forge-runtime-bridge` capability availability and deferred-debt posture

**Relevant Query docs**
- [Support Matrix And Admission](../../crates/forge-query/docs/foundations/support-matrix-and-admission.md)
- [Downstream Runtime Integration](../../crates/forge-query/docs/foundations/downstream-runtime-integration.md)
...
- [runtime/support/mod.rs](../../crates/forge-query/src/runtime/support/mod.rs)
...
**Relevant subsystems**
- `forge-query` platform entry and configured-domain-handle lifecycle
- `forge-query` continuation execution readmission observation
- `forge-query` domain support snapshots

**Relevant Query docs**
- [Platform Entry](../../crates/forge-query/docs/domain-capabilities/platform-entry.md)
- [Configured Domain Handles](../../crates/forge-query/docs/domain-capabilities/configured-domain-handles.md)
...
**Relevant Query source surfaces**
- [application/domain_handle/mod.rs](../../crates/forge-query/src/application/domain_handle/mod.rs)
- [application/domain_handle/operating_context.rs](../../crates/forge-query/src/application/domain_handle/operating_context.rs)
- [application/domain_handle/admitted_world_basis.rs](../../crates/forge-query/src/application/domain_handle/admitted_world_basis.rs)
- [application/domain_entry/support_snapshot.rs](../../crates/forge-query/src/application/domain_entry/support_snapshot.rs)
...
**Relevant subsystems**
- `forge-query` declaration grammar and family taxonomy
- `forge-query` live-read and subscription-oriented declaration entry
- `forge-runtime-bridge` temporal basis and temporal subscription families

**Relevant Query docs**
- [Query Expressions And Result Shapes](../../crates/forge-query/docs/authoring/query-expressions-and-result-shapes.md)
- [Declaration Family Taxonomy](../../crates/forge-query/docs/domain-capabilities/declaration-family-taxonomy.md)
- [Canonical Domain Declarations](../../crates/forge-query/docs/domain-capabilities/canonical-domain-declarations.md)
...
- [application/declaration_entry_orchestration/grammar.rs](../../crates/forge-query/src/application/declaration_entry_orchestration/grammar.rs)
- [application/declaration_entry_seam/mod.rs](../../crates/forge-query/src/application/declaration_entry_seam/mod.rs)
...
**Relevant subsystems**
- `forge-query` declaration grammar and family taxonomy
- `forge-query` configured domain handles and declaration evidence
- `forge-runtime-bridge` async source declaration and request identity
...
**Relevant Query source surfaces**
- [runtime/workspace_declaration.rs](../../crates/forge-query/src/runtime/workspace_declaration.rs)
- [application/domain_handle/admitted_handle/declaration.rs](../../crates/forge-query/src/application/domain_handle/admitted_handle/declaration.rs)
- [application/declaration_entry_orchestration/grammar.rs](../../crates/forge-query/src/application/declaration_entry_orchestration/grammar.rs)
...
**Relevant subsystems**
- `forge-query` declaration legality and readiness projection
- `forge-query` support reports and declaration-entry inspection
- `forge-runtime-bridge` temporal admission and wake-evidence requirements

**Relevant Query docs**
- [Declaration Legality](../../crates/forge-query/docs/domain-capabilities/declaration-legality.md)
- [Declaration Entry Readiness](../../crates/forge-query/docs/domain-capabilities/declaration-entry-readiness.md)
- [Support Matrix And Admission](../../crates/forge-query/docs/foundations/support-matrix-and-admission.md)
...
**Relevant Query source surfaces**
- [application/declaration_entry_orchestration/lower/legality.rs](../../crates/forge-query/src/application/declaration_entry_orchestration/lower/legality.rs)
- [application/declaration_entry_seam/readiness_projection.rs](../../crates/forge-query/src/application/declaration_entry_seam/readiness_projection.rs)
- [application/declaration_entry_seam/inspection/mod.rs](../../crates/forge-query/src/application/declaration_entry_seam/inspection/mod.rs)
...
**Relevant subsystems**
- `forge-query` declaration legality, readiness, and support matrix
- `forge-runtime-bridge` async source admission and request identity binding
- `forge-signal` async capability family substrate
...
**Relevant subsystems**
- `forge-query` query-basis lifecycle and binding
- `forge-query` runtime state and inspection basis exposure
- `forge-runtime-bridge` temporal basis, async request identity, and resume basis

**Relevant Query docs**
- [Historical Diff And Basis](../../crates/forge-query/docs/capabilities/historical-diff-and-basis.md)
- [Inspection](../../crates/forge-query/docs/capabilities/inspection.md)
- [Configured Domain Handles](../../crates/forge-query/docs/domain-capabilities/configured-domain-handles.md)
...
**Relevant Query source surfaces**
- [query_basis_lifecycle/mod.rs](../../crates/forge-query/src/query_basis_lifecycle/mod.rs)
- [query_basis_lifecycle/binding.rs](../../crates/forge-query/src/query_basis_lifecycle/binding.rs)
- [query_basis_lifecycle/eligibility.rs](../../crates/forge-query/src/query_basis_lifecycle/eligibility.rs)
- [query_basis_lifecycle/compatibility.rs](../../crates/forge-query/src/query_basis_lifecycle/compatibility.rs)
- [runtime/state.rs](../../crates/forge-query/src/runtime/state.rs)
...
**Relevant subsystems**
- `forge-query` declaration route plans and bridge routing
- `forge-query` configured-domain-handle route entrypoints
- `forge-runtime-bridge` temporal/async continuation and boundary-envelope artifacts

**Relevant Query docs**
- [Declaration Route Plan](../../crates/forge-query/docs/domain-capabilities/declaration-route-plan.md)
...
**Relevant Query source surfaces**
- [application/declaration_bridge_routing/mod.rs](../../crates/forge-query/src/application/declaration_bridge_routing/mod.rs)
- [application/declaration_bridge_routing/lower.rs](../../crates/forge-query/src/application/declaration_bridge_routing/lower.rs)
- [application/declaration_bridge_routing/request.rs](../../crates/forge-query/src/application/declaration_bridge_routing/request.rs)
- [application/domain_handle/admitted_handle/bridge_routing.rs](../../crates/forge-query/src/application/domain_handle/admitted_handle/bridge_routing.rs)
...
**Relevant subsystems**
- `forge-query` declaration signal compatibility and orchestration
- `forge-query` continuation pipeline preparation artifacts
- `forge-runtime-bridge` temporal/async continuation posture and signal-facing readiness

**Relevant Query docs**
- [Declaration Signal Compatibility](../../crates/forge-query/docs/domain-capabilities/declaration-signal-compatibility.md)
- [Signal Compatibility Orchestration](../../crates/forge-query/docs/domain-capabilities/signal-compatibility-orchestration.md)
- [Continuation Pipeline](../../crates/forge-query/docs/domain-capabilities/continuation-pipeline.md)
...
**Relevant Query source surfaces**
- [application/domain_handle/admitted_handle/signal_compatibility.rs](../../crates/forge-query/src/application/domain_handle/admitted_handle/signal_compatibility.rs)
- [application/domain_handle/admitted_handle/signal_compatibility_orchestration.rs](../../crates/forge-query/src/application/domain_handle/admitted_handle/signal_compatibility_orchestration.rs)
- [application/declaration_signal_compatibility/handle_gate.rs](../../crates/forge-query/src/application/declaration_signal_compatibility/handle_gate.rs)
- [continuation_pipeline/mod.rs](../../crates/forge-query/src/continuation_pipeline/mod.rs)
- [continuation_pipeline/artifacts.rs](../../crates/forge-query/src/continuation_pipeline/artifacts.rs)
...
**Relevant subsystems**
- `forge-query` subscription family selection and diagnostics
- `forge-query` view-shape-aware live meaning
- `forge-runtime-bridge` time-aware and async-capable live families

**Relevant Query docs**
- [Subscription Selection And Diagnostics](../../crates/forge-query/docs/capabilities/subscription-selection-and-diagnostics.md)
...
**Relevant Query source surfaces**
- [subscription/selection.rs](../../crates/forge-query/src/subscription/selection.rs)
- [subscription/family.rs](../../crates/forge-query/src/subscription/family.rs)
- [subscription/signal_strategy.rs](../../crates/forge-query/src/subscription/signal_strategy.rs)
- [subscription/support/report.rs](../../crates/forge-query/src/subscription/support/report.rs)
...
**Relevant subsystems**
- `forge-query` subscription declaration, declaration digests, and basis requests
- `forge-query` query-basis lifecycle integration with live meaning
- `forge-runtime-bridge` temporal basis requests and async live declaration binding
...
**Relevant Query source surfaces**
- [subscription/declaration.rs](../../crates/forge-query/src/subscription/declaration.rs)
- [subscription/declaration_digest.rs](../../crates/forge-query/src/subscription/declaration_digest.rs)
- [subscription/basis_request.rs](../../crates/forge-query/src/subscription/basis_request.rs)
- [subscription/bridge_lowering.rs](../../crates/forge-query/src/subscription/bridge_lowering.rs)
...
**Relevant subsystems**
- `forge-query` active subscription lifecycle
- `forge-query` active sharing, fanout, continuation, and preview isolation
- `forge-runtime-bridge` mixed-cause live maintenance and restart posture

**Relevant Query docs**
- [Subscription Selection And Diagnostics](../../crates/forge-query/docs/capabilities/subscription-selection-and-diagnostics.md)
- [Continuation Pipeline](../../crates/forge-query/docs/domain-capabilities/continuation-pipeline.md)
- [Branches And Previews](../../crates/forge-query/docs/foundations/branches-and-previews.md)
...
**Relevant Query source surfaces**
- [subscription/activation.rs](../../crates/forge-query/src/subscription/activation.rs)
- [subscription/active.rs](../../crates/forge-query/src/subscription/active.rs)
- [subscription/active_handle.rs](../../crates/forge-query/src/subscription/active_handle.rs)
- [subscription/fanout.rs](../../crates/forge-query/src/subscription/fanout.rs)
- [subscription/continuation.rs](../../crates/forge-query/src/subscription/continuation.rs)
- [subscription/preview_isolation.rs](../../crates/forge-query/src/subscription/preview_isolation.rs)
...
**Relevant subsystems**
- `forge-query` delivery and retained runtime state
- `forge-query` ordinary outcomes and live inspection
- `forge-runtime-bridge` time-only cause routing

**Relevant Query docs**
- [Ordinary Outcomes](../../crates/forge-query/docs/domain-capabilities/ordinary-outcomes.md)
- [Inspection](../../crates/forge-query/docs/capabilities/inspection.md)
- [Workspace Overview](../../crates/forge-query/docs/foundations/workspace-overview.md)
...
**Relevant Query source surfaces**
- [runtime/delivery.rs](../../crates/forge-query/src/runtime/delivery.rs)
- [subscription/delivery.rs](../../crates/forge-query/src/subscription/delivery.rs)
- [runtime/state.rs](../../crates/forge-query/src/runtime/state.rs)
- [runtime/inspection/live.rs](../../crates/forge-query/src/runtime/inspection/live.rs)
...
**Relevant subsystems**
- `forge-query` retained state snapshots and delivery surfaces
- `forge-query` ordinary outcomes and support posture
- `forge-runtime-bridge` completion causality and denial taxonomy
...
- [runtime/state.rs](../../crates/forge-query/src/runtime/state.rs)
- [runtime/delivery.rs](../../crates/forge-query/src/runtime/delivery.rs)
- [ordinary_outcome/mod.rs](../../crates/forge-query/src/ordinary_outcome/mod.rs)
- [runtime/inspection.rs](../../crates/forge-query/src/runtime/inspection.rs)
...
**Relevant subsystems**
- `forge-query` delivery shaping, suppression, and view-shape delivery
- `forge-query` live inspection and ordinary outcomes
- `forge-runtime-bridge` mixed-cause ordering and suppression posture
...
- [ordinary_outcome/topology.rs](../../crates/forge-query/src/ordinary_outcome/topology.rs)
...
- `forge-query` retained runtime state snapshots
- `forge-query` ordinary inspection
...
**Relevant Query source surfaces**
- [ordinary_outcome/mod.rs](../../crates/forge-query/src/ordinary_outcome/mod.rs)
- [ordinary_outcome/posture.rs](../../crates/forge-query/src/ordinary_outcome/posture.rs)
- [runtime/state.rs](../../crates/forge-query/src/runtime/state.rs)
- [runtime/inspection/unified/mod.rs](../../crates/forge-query/src/runtime/inspection/unified/mod.rs)
...
**Relevant subsystems**
- `forge-query` causal inspection request, admission, materialization, and certification
- `forge-runtime-bridge` offline diagnostics, mixed-cause evidence, and failure taxonomy

**Relevant Query docs**
- [Inspection](../../crates/forge-query/docs/capabilities/inspection.md)
- [Cross-Runtime Causal Inspection](../../crates/forge-query/docs/capabilities/cross-runtime-causal-inspection.md)
...
**Relevant Query source surfaces**
- [runtime/inspection/causal/mod.rs](../../crates/forge-query/src/runtime/inspection/causal/mod.rs)
- [runtime/inspection/causal/materialization/mod.rs](../../crates/forge-query/src/runtime/inspection/causal/materialization/mod.rs)
- [runtime/inspection/causal/certification/mod.rs](../../crates/forge-query/src/runtime/inspection/causal/certification/mod.rs)
...
**Relevant subsystems**
- `forge-query` preview workflow, branch sessions, basis rebinding, and inspection
- `forge-query` active preview isolation and continuation
- `forge-runtime-bridge` preview residue and re-admission law
...
**Relevant Query source surfaces**
- [preview/mod.rs](../../crates/forge-query/src/preview/mod.rs)
- [preview/scoped.rs](../../crates/forge-query/src/preview/scoped.rs)
- [subscription/preview_isolation.rs](../../crates/forge-query/src/subscription/preview_isolation.rs)
- [runtime/inspection/preview.rs](../../crates/forge-query/src/runtime/inspection/preview.rs)
- [query_basis_lifecycle/binding.rs](../../crates/forge-query/src/query_basis_lifecycle/binding.rs)
...
**Relevant subsystems**
- `forge-query` policy basis, tenant basis, support matrix, and policy delivery
- `forge-query` runtime inspection and denial projection
- `forge-runtime-bridge` remask and drift denial artifacts
...
**Relevant Query source surfaces**
- [policy_basis/mod.rs](../../crates/forge-query/src/policy_basis/mod.rs)
- [tenant_basis/mod.rs](../../crates/forge-query/src/tenant_basis/mod.rs)
- [policy_delivery/mod.rs](../../crates/forge-query/src/policy_delivery/mod.rs)
- [relationship_proof/support.rs](../../crates/forge-query/src/relationship_proof/support.rs)
- [runtime/support_matrix.rs](../../crates/forge-query/src/runtime/support_matrix.rs)
...
**Relevant subsystems**
- `forge-query` view-shape support and delivery
- `forge-query` saved-query support and canonicalization
- `forge-query` declaration composition over scopes and templates
...
**Relevant Query source surfaces**
- [view_shape/support.rs](../../crates/forge-query/src/view_shape/support.rs)
- [view_shape/delivery.rs](../../crates/forge-query/src/view_shape/delivery.rs)
- [saved_query/support.rs](../../crates/forge-query/src/saved_query/support.rs)
- [canonicalization/projection.rs](../../crates/forge-query/src/canonicalization/projection.rs)
...
**Relevant subsystems**
- `forge-query` read composition and materialization
- `forge-query` projection consumption declarations, receipts, and facts
- `forge-runtime-bridge` temporal/async materialization and delivery artifacts
...
**Relevant Query source surfaces**
- [runtime/read_composition.rs](../../crates/forge-query/src/runtime/read_composition.rs)
- [runtime/read_composition_materialization.rs](../../crates/forge-query/src/runtime/read_composition_materialization.rs)
- [projection_consumption/mod.rs](../../crates/forge-query/src/projection_consumption/mod.rs)
...
**Relevant subsystems**
- `forge-query` continuation pipeline and execution readmission
- `forge-query` recovery boundary and checked stops
- `forge-runtime-bridge` resume basis and denial taxonomy
...
**Relevant Query source surfaces**
- [continuation_pipeline/mod.rs](../../crates/forge-query/src/continuation_pipeline/mod.rs)
- [continuation_pipeline/execution/readmission.rs](../../crates/forge-query/src/continuation_pipeline/execution/readmission.rs)
- [recovery_boundary/checked/continuation.rs](../../crates/forge-query/src/recovery_boundary/checked/continuation.rs)
- [application/domain_handle/admitted_handle/recovery.rs](../../crates/forge-query/src/application/domain_handle/admitted_handle/recovery.rs)
...
**Relevant subsystems**
- `forge-query` intent admission lattice and typed handoffs
- `forge-query` runtime effect lifecycle and delivery
- `forge-query` preview/workflow/write-adjacent orchestration
- `forge-runtime-bridge` completion causality and write-adjacent continuation posture

**Relevant Query docs**
- [Writes And Intents](../../crates/forge-query/docs/execution/writes-and-intents.md)
- [Intent Admission](../../crates/forge-query/docs/execution/intent-admission.md)
- [Continuation Pipeline](../../crates/forge-query/docs/domain-capabilities/continuation-pipeline.md)
...
**Relevant Query source surfaces**
- [intent_admission/mod.rs](../../crates/forge-query/src/intent_admission/mod.rs)
- [intent_admission/handoffs/mod.rs](../../crates/forge-query/src/intent_admission/handoffs/mod.rs)
- [intent_admission/trace/mod.rs](../../crates/forge-query/src/intent_admission/trace/mod.rs)
- [runtime/effect/mod.rs](../../crates/forge-query/src/runtime/effect/mod.rs)
- [runtime/effect/delivery.rs](../../crates/forge-query/src/runtime/effect/delivery.rs)
- [workflow/inspection.rs](../../crates/forge-query/src/workflow/inspection.rs)
...
downstream delivery contract so `forge-server` and later transport consumers
...
**Relevant subsystems**
- `forge-query` public delivery/result contracts
- `forge-query` lower-runtime routing support and integration posture
- `forge-runtime-bridge` delivery and restart/resume bundle artifacts
...
- [runtime/public_api.rs](../../crates/forge-query/src/runtime/public_api.rs)
- [runtime/handle_contract.rs](../../crates/forge-query/src/runtime/handle_contract.rs)
- [lower_runtime_routing/support.rs](../../crates/forge-query/src/lower_runtime_routing/support.rs)
...
**Relevant subsystems**
- `forge-query` subscription certification, preview certification, causal inspection certification, and public-doc/support closure
- `forge-runtime-bridge` temporal/async certification bundles and pricing-shock workload extensions

**Relevant Query docs**
- [Support Matrix And Admission](../../crates/forge-query/docs/foundations/support-matrix-and-admission.md)
- [Downstream Runtime Integration](../../crates/forge-query/docs/foundations/downstream-runtime-integration.md)
- [Public Doc Coverage](../../crates/forge-query/docs/domain-capabilities/public-doc-coverage.md)
...
**Relevant Query source surfaces**
- [subscription/certification.rs](../../crates/forge-query/src/subscription/certification.rs)
- [subscription/tests/runtime_certification.rs](../../crates/forge-query/src/subscription/tests/runtime_certification.rs)
- [runtime/inspection/causal/certification/mod.rs](../../crates/forge-query/src/runtime/inspection/causal/certification/mod.rs)
- [harness/preview_certification/mod.rs](../../crates/forge-query/src/harness/preview_certification/mod.rs)

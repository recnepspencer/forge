...
facade families in `forge-server`, including:
...
- [compat_http_entry.rs](../../crates/forge-server/tests/compat_http_entry.rs)
- [compat_http_phase_two.rs](../../crates/forge-server/tests/compat_http_phase_two.rs)
- [compat_http_phase_three.rs](../../crates/forge-server/tests/compat_http_phase_three.rs)
- [compat_http_phase_four.rs](../../crates/forge-server/tests/compat_http_phase_four.rs)
- [compat_http_phase_five.rs](../../crates/forge-server/tests/compat_http_phase_five.rs)
- [compat_http_phase_six.rs](../../crates/forge-server/tests/compat_http_phase_six.rs)
- [compat_http_phase_seven.rs](../../crates/forge-server/tests/compat_http_phase_seven.rs)
- [compat_http_phase_seven_boundary.rs](../../crates/forge-server/tests/compat_http_phase_seven_boundary.rs)
- [compat_http_phase_eight.rs](../../crates/forge-server/tests/compat_http_phase_eight.rs)
- [compat_http_phase_eight_boundary.rs](../../crates/forge-server/tests/compat_http_phase_eight_boundary.rs)
- [compat_http_phase_nine.rs](../../crates/forge-server/tests/compat_http_phase_nine.rs)
- [compat_http_phase_nine_boundary.rs](../../crates/forge-server/tests/compat_http_phase_nine_boundary.rs)
- [compat_http_phase_ten.rs](../../crates/forge-server/tests/compat_http_phase_ten.rs)
- [compat_http_phase_ten_boundary.rs](../../crates/forge-server/tests/compat_http_phase_ten_boundary.rs)
- [compat_http_phase_eleven.rs](../../crates/forge-server/tests/compat_http_phase_eleven.rs)
- [compat_http_phase_eleven_boundary.rs](../../crates/forge-server/tests/compat_http_phase_eleven_boundary.rs)
- [compat_http_phase_twelve.rs](../../crates/forge-server/tests/compat_http_phase_twelve.rs)
- [compat_http_phase_twelve_boundary.rs](../../crates/forge-server/tests/compat_http_phase_twelve_boundary.rs)
- [compat_http_phase_thirteen.rs](../../crates/forge-server/tests/compat_http_phase_thirteen.rs)
- [compat_http_phase_thirteen_boundary.rs](../../crates/forge-server/tests/compat_http_phase_thirteen_boundary.rs)

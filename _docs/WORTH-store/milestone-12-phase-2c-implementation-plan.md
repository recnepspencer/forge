# WORTH Store Milestone 12 Phase 2C Implementation Plan
...
`crates/worth-store/src/compatibility/manifests/`.
...
`crates/worth-store/src/compatibility/authoritative/` that consumes a checked

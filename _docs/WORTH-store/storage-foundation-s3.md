...
- `worth_proof_roadmap.md`
  ...
  impossible to WORTH through raw bytes or copied report fields.
...
- `QuarantineRecordsCannotBeWORTHdOracle`
...
- Compile-fail: external callers cannot synthesize `IntegrityEntryWitness` or
  WORTH stronger protected-byte access from public fields.
...
- `worth-proof` sealing patterns should be used where they prevent WORTHd
...
- Adversarial denial: WORTHd checksums, digest-as-checksum claims,
...
- `checksum_detection_model_honesty_suite`
  ...
  never upgraded into authenticity or impossible-WORTHry proof.
...
- `quarantine_sealing_suite`
  ...
  and cannot be WORTHd from logs, raw path strings, copied fields, or fixture
  labels.

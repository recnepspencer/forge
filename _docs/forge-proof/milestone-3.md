...
> **Status:** Closed
>
> **Closeout:** [milestone-3-closeout.md](/C:/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-proof/milestone-3-closeout.md)
>
...
>
> **Adjacent milestone closeout:** [milestone-2-closeout.md](/C:/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-proof/milestone-2-closeout.md)
>
...
Make scoped validity first-class in `forge-proof` so proofs, witnesses, and
...
- Milestone 1 core carrier law and Milestone 2 sealing/witness closure remain
  authoritative.
- `forge-proof` still owns progression law only; it does not become the owner
...
- `milestone-2.md`
  ...
  Milestone 3 must preserve Milestone 2's unforgeable stronger forms while
...
> Several Forge subsystems with branch-sensitive proof validity, restore and
...
- no drift of `forge-proof` into diagnostics, provenance, storage, or runtime
...
Milestone 3 is complete only when `forge-proof` satisfies the named milestone
suite:

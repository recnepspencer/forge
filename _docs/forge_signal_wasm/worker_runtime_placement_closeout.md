...
> Can `forge-signal-wasm` recommend worker-first execution as the canonical
...
- [worker_runtime_shell.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_runtime_shell.rs)
- [worker_runtime_shell_branches.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_runtime_shell_branches.rs)
- [worker_host_boundary_causality.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_host_boundary_causality.rs)
- [worker_host_boundary_performance.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_host_boundary_performance.rs)
- [worker_graph_publication.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_graph_publication.rs)

Typed host and browser boundary lanes:

- [worker_host_capability_ingress.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_host_capability_ingress.rs)
- [worker_browser_history_ingress.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_browser_history_ingress.rs)
- [worker_host_effect_boundary.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_host_effect_boundary.rs)
- [main_thread_host_bridge_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/main_thread_host_bridge_certification.rs)

Callback placement, hosted execution, and transport honesty:

- [worker_main_thread_hosted_callback_boundary.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_main_thread_hosted_callback_boundary.rs)
- [worker_main_thread_hosted_callback_validation.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_main_thread_hosted_callback_validation.rs)
- [worker_main_thread_hosted_callback_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_main_thread_hosted_callback_certification.rs)
- [worker_callback_capability_transport.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_callback_capability_transport.rs)
- [worker_callback_definition_publication.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_callback_definition_publication.rs)
- [worker_callback_phase4_closeout_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_callback_phase4_closeout_certification.rs)

Committed delivery and diagnostics:

- [worker_observation_delivery.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_observation_delivery.rs)
- [worker_output_delivery.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_output_delivery.rs)
- [worker_diagnostics_history_read.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_diagnostics_history_read.rs)
- [worker_lifecycle_control.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_lifecycle_control.rs)
- [worker_phase5_closeout_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase5_closeout_certification.rs)

Replay, restore, import/export, and unavailable-worker capability evidence:

- [worker_replay_restore_capability.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_replay_restore_capability.rs)
- [worker_replay_checkpoint_retained_history.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_replay_checkpoint_retained_history.rs)
- [worker_import_export_callback_unavailability.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_import_export_callback_unavailability.rs)
- [worker_unavailable_compatibility_artifact.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_unavailable_compatibility_artifact.rs)
- [worker_phase6_closeout_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase6_closeout_certification.rs)

Final Phase 7 certification:

- [worker_phase7_performance_contracts.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_performance_contracts.rs)
- [worker_phase7_performance_catalog.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_performance_catalog.rs)
- [worker_phase7_product_guidance.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_product_guidance.rs)
- [worker_phase7_test_requirements.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_test_requirements.rs)
- [worker_phase7_closeout_certification.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_closeout_certification.rs)

Wasm boundary surface:

- [worker.rs](../../crates/forge-signal-wasm/src/boundary/worker.rs)
- [worker_callback_reattachments.rs](../../crates/forge-signal-wasm/src/boundary/worker_callback_reattachments.rs)
- [worker_diagnostics_history_read.rs](../../crates/forge-signal-wasm/src/boundary/worker_diagnostics_history_read.rs)
- [worker_lifecycle_control.rs](../../crates/forge-signal-wasm/src/boundary/worker_lifecycle_control.rs)
- [worker_phase5_closeout.rs](../../crates/forge-signal-wasm/src/boundary/worker_phase5_closeout.rs)
- [worker_phase6_closeout.rs](../../crates/forge-signal-wasm/src/boundary/worker_phase6_closeout.rs)
- [worker_phase7_closeout.rs](../../crates/forge-signal-wasm/src/boundary/worker_phase7_closeout.rs)
- [worker_replay_restore_capability.rs](../../crates/forge-signal-wasm/src/boundary/worker_replay_restore_capability.rs)
- [diagnostics.rs](../../crates/forge-signal-wasm/src/boundary/diagnostics.rs)
...
- [worker_phase7_test_requirements.rs](../../crates/forge-signal-wasm/src/runtime/worker_host/worker_phase7_test_requirements.rs)
- [phase7/test_requirements.rs](../../crates/forge-signal-wasm/src/runtime/tests/worker_runtime/phase7/test_requirements.rs)
- [phase7/test_requirements.rs](../../crates/forge-signal-wasm/src/boundary/tests/phase7/test_requirements.rs)

## Final Closeout Gate

The final closeout gate is:

- [phase7/closeout.rs](../../crates/forge-signal-wasm/src/runtime/tests/worker_runtime/phase7/closeout.rs)
- [phase7/closeout.rs](../../crates/forge-signal-wasm/src/boundary/tests/phase7/closeout.rs)
...
- [runtime/tests/worker_runtime/phase7](../../crates/forge-signal-wasm/src/runtime/tests/worker_runtime/phase7)
- [boundary/tests/phase7](../../crates/forge-signal-wasm/src/boundary/tests/phase7)
...
```powershell
cargo fmt -p forge-signal-wasm --check
cargo test -p forge-signal-wasm phase7 -- --nocapture
cargo test -p forge-signal-wasm
git diff --check
```

Final result at closeout:

- `cargo fmt -p forge-signal-wasm --check` passed
- `cargo test -p forge-signal-wasm phase7 -- --nocapture` passed with `32`
  tests
- `cargo test -p forge-signal-wasm` passed with `208` unit tests, the
...
serious `forge-signal-wasm` applications: runtime-owned work lives off the UI

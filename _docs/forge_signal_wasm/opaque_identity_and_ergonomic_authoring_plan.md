# forge-signal-wasm Opaque Identity And Ergonomic Authoring Plan
...
>
> **Core DX reference:** [_docs/forge_signal/dx_plan.md](../../../_docs/forge_signal/dx_plan.md)
>
> **Core test requirements:** [_docs/forge_signal/test-requirements.md](../../../_docs/forge_signal/test-requirements.md)

## Goal

Make the main `forge-signal-wasm` app-authoring lane substantially easier
...
Rust `forge-signal::easy` proved one useful product truth:

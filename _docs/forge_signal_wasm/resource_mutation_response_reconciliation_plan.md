...
That gap encourages exactly the product shape Forge tries to eliminate:
...
- forged mutation response lens proof
...
- core `forge-signal` branch or merge semantics not intentionally added to the
  native crate first

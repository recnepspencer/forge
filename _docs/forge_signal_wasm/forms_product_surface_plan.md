# forge-signal-wasm Forms Product Surface Plan
...
Build a first-class forms product surface for `forge-signal-wasm` that gives app
...
- public TypeScript surfaces reject undeclared fields, illegal validator
  returns, illegal action/submit plans, forged host fact posture, forged
  accessibility posture, forged renderer capability posture, and illegal

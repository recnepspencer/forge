# WORTH Runtime Bridge Future Roadmap

## Purpose

This document defines the future work for the WORTH runtime bridge.
...
protocol layer between `worth-relational` and `worth-signal`.
...
- [aspect_native_refactor.md](aspect_native_refactor.md) is the active
  ...
  string-label, and digest-only authority residue with `worth-foundational`
  aspect contracts, masks, authoritative state, and patch/effect carriers.
- [../worth-query/runtime-authoritative-mutation-evidence-plan.md](../worth-query/runtime-authoritative-mutation-evidence-plan.md)
...
must not define truth semantics that belong to `worth-relational` or execution
semantics that belong to `worth-signal`.
...
Engineering spec: [milestone-3.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-3.md)
...
Engineering spec: [milestone-4.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-4.md)
Shipped closeout: [milestone-4-closeout.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-4-closeout.md)
...
Engineering spec: [milestone-5.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-5.md)
...
Engineering spec: [milestone-6.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-6.md)
Required certification suites: [test-requirements.md](C:/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/test-requirements.md)
...
Engineering spec: [milestone-7.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-7.md)
Shipped closeout: [milestone-7-closeout.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-7-closeout.md)
Required certification suites: [test-requirements.md](C:/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/test-requirements.md)
...
Engineering spec: [milestone-10.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-10.md)
...
Engineering spec: [milestone-11.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-11.md)
...
Engineering spec: [milestone-12.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-12.md)
...
Engineering spec: [milestone-12b.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-12b.md)
...
- truth authority stays in `worth-relational`
- derived execution authority stays in `worth-signal`
...
Engineering spec: [milestone-13.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-13.md)
Showcase extension companion: [milestone-13-showcase-extension.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-13-showcase-extension.md)
...
- the bridge does not redefine `worth-signal` observation semantics; it lowers
  admitted bridge families into the existing `worth-signal` strategy substrate
...
- different admitted declaration families differ mechanically in both bridge
  lowering and selected `worth-signal` strategy
...
Engineering spec: [milestone-15.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-15.md)
Shipped closeout: [milestone-15-closeout.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-15-closeout.md)
...
WORTH Query will eventually automate.
...
- delivery contract vocabulary for family-aware canonical member delivery,
  ...
  delivery, and other admitted bridge families lowered into `worth-signal`
  strategy space
...
- diagnostics that explain which admitted bridge family lowered into which
  `worth-signal` observation and delivery strategy for an active subscription
...
- delivery families remain extensible, but only through admitted bridge
  declaration families and admitted `worth-signal` strategy lowerings
...
Engineering spec: [milestone-16.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-16.md)
...
- certification coverage for multiple admitted bridge declaration families and
  their distinct `worth-signal` strategy lowerings
...
Make time-aware bridge flows explicit after `worth-signal` owns temporal
...
basis without turning `worth-relational` into a scheduler or letting bridge
...
- time-aware subscription admission for bridge families that depend on
  admitted `worth-signal` temporal policies
...
`worth-signal` async/resource lifecycle truth without leaving request identity,
...
- bridge async/resource declaration families that lower into admitted
  `worth-signal` async/resource node lifecycle surfaces
...
- async/resource state remains derived state unless an admitted writeback path
  commits authoritative truth through `worth-relational`
...
Close the bridge roadmap after `worth-signal` temporal and async/resource
...
- those subscription scenarios prove multiple admitted subscription families
  lowered into `worth-signal`'s extensible observation and delivery substrate
...
- [_docs/worth-runtime-bridge/worth_runtime_bridge_vision.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/worth_runtime_bridge_vision.md)
- [_docs/worth-runtime-bridge/aspect_native_refactor.md](aspect_native_refactor.md)
- [_docs/worth-runtime-bridge/test-requirements.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/test-requirements.md)
- [_docs/worth-relational/worth_relational_roadmap.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-relational/worth_relational_roadmap.md)
- [_docs/worth_signal/worth_signal_vision.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth_signal/worth_signal_vision.md)
- [_docs/worth_signal/worth_signals2.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth_signal/worth_signals2.md)

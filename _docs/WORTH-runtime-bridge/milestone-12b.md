...
>
> **Prior milestone:** [milestone-12.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-12.md)
>
> **Next milestone:** [milestone-13.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-13.md)
>
...
- family-specific no-op, retry, replay, and loop semantics can drift outside
  the bridge boundary
- domain extensibility in `worth-relational` and `worth-signal` can exist while
...
- replacing `worth-relational` commit authority or `worth-signal` derivation
  authority

...
>
> **Prior milestone:** [milestone-11.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-runtime-bridge/milestone-11.md)
>
...
>
> **Relational authority companion:** [milestone-8.5-plan.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-relational/milestone-8.5-plan.md)
>
...
allowing a `worth-signal` node to write back into `worth-relational` through the
bridge without:
...
- `worth-relational` commit strategies remain the only authority-owned way to
...
- Authority boundaries are preserved: the bridge proposes; `worth-relational`
  decides and commits.

# Forge Signal Public Export Inventory

## Purpose

This document is the strict public export audit for `forge-signal`.

It inventories:

- every root public module exposed from [`crates/forge-signal/src/lib.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/lib.rs)
- every public namespace exported from [`crates/forge-signal/src/facade.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/facade.rs)
- every additional direct public export path exposed through
  [`crates/forge-signal/src/diagnostics/mod.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/diagnostics/mod.rs)
  and [`crates/forge-signal/src/easy/mod.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/easy/mod.rs)
...
From [`crates/forge-signal/src/lib.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/lib.rs):

- `forge_signal::facade` → main public boundary
- `forge_signal::easy` → convenience surface
- `forge_signal::diagnostics` → direct diagnostics surface
...
Source: [`crates/forge-signal/src/facade.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/facade.rs)
...
Source: [`crates/forge-signal/src/easy/mod.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/easy/mod.rs)
...
Source: [`crates/forge-signal/src/diagnostics/mod.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/diagnostics/mod.rs)
...
- `forge_signal::diagnostics` is broader than `facade::diagnostics`
...
From [`crates/forge-signal/src/facade.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/facade.rs):
...
From [`crates/forge-signal/src/easy/runtime.rs`](/Users/spenstar/Documents/programming/forge/forge/crates/forge-signal/src/easy/runtime.rs):
...
4. `forge_signal::diagnostics` is a second major public boundary and is broader

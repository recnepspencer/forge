...
> Can `forge-signal` now own async/resource policy variation as deterministic,
...
- [policy.rs](../../crates/forge-signal/src/data/resource/policy.rs)
- [policy_registry.rs](../../crates/forge-signal/src/data/resource/policy_registry.rs)
- [policy/retry.rs](../../crates/forge-signal/src/data/resource/policy/retry.rs)
- [policy/timeout.rs](../../crates/forge-signal/src/data/resource/policy/timeout.rs)
- [policy/cancellation.rs](../../crates/forge-signal/src/data/resource/policy/cancellation.rs)
- [policy/supersession.rs](../../crates/forge-signal/src/data/resource/policy/supersession.rs)
- [policy/revalidation.rs](../../crates/forge-signal/src/data/resource/policy/revalidation.rs)
- [policy/observation.rs](../../crates/forge-signal/src/data/resource/policy/observation.rs)
- [policy/output_continuity.rs](../../crates/forge-signal/src/data/resource/policy/output_continuity.rs)
- [policy/retention.rs](../../crates/forge-signal/src/data/resource/policy/retention.rs)
- [policy/diagnostics.rs](../../crates/forge-signal/src/data/resource/policy/diagnostics.rs)
- [policy/compatibility.rs](../../crates/forge-signal/src/data/resource/policy/compatibility.rs)
- [policy/replay.rs](../../crates/forge-signal/src/data/resource/policy/replay.rs)
...
- [resource_observation.rs](../../crates/forge-signal/src/logic/transaction/runtime/state/resource_observation.rs)
- [revalidation.rs](../../crates/forge-signal/src/data/resource/revalidation.rs)
- [retention.rs](../../crates/forge-signal/src/data/resource/retention.rs)
- [replay_availability.rs](../../crates/forge-signal/src/data/resource/replay_availability.rs)
- [summary.rs](../../crates/forge-signal/src/data/resource/summary.rs)
- [diagnostics.rs](../../crates/forge-signal/src/data/resource/diagnostics.rs)
- [observation.rs](../../crates/forge-signal/src/data/resource/observation.rs)
- [telemetry.rs](../../crates/forge-signal/src/data/telemetry.rs)

Certification and public surface:

- [certification.rs](../../crates/forge-signal/src/data/resource/certification.rs)
- [facade.rs](../../crates/forge-signal/src/facade.rs)
- [resource_runtime.rs](../../crates/forge-signal/src/tests/resource_runtime.rs)
...
- [resource compile-fail fixtures](../../crates/forge-signal/tests/ui)
...
git diff --check -- _docs/forge_signal/milestone-c-closeout.md _docs/forge_signal/milestone-c-plan.md _docs/forge_signal/forge_signal_temporal_async_roadmap.md
```
...
- full `cargo test -p forge-signal`: `854 passed`, `0 failed`, `23 ignored`

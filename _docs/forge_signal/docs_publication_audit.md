# Forge Signal Docs Publication Audit

## Purpose

This document classifies the current `forge-signal` docs by publication value.
...
### `crates/forge-signal/docs/API_SURFACE.md`
...
### `crates/forge-signal/docs/ADVANCED_PATTERNS.md`
...
### `crates/forge-signal/docs/TRANSACTIONS_AND_KEYED_RUNTIME.md`
...
### `crates/forge-signal/docs/HARNESS_AND_CERTIFICATION.md`
...
### `crates/forge-signal/docs/CHECKPOINTS_AND_TIERS.md`
...
### `crates/forge-signal/docs/LINEAGE_MODEL.md`
...
### `crates/forge-signal/docs/CONDITIONS_AND_COMPARATORS.md`
...
### `crates/forge-signal/docs/ARTIFACT_ACCESS_MATRIX.md`
...
### `crates/forge-signal/docs/LIFECYCLE_AND_GC.md`
...
- `_docs/forge_signal/dx_api_matrix.md`
- `_docs/forge_signal/dx_boundary_spec.md`
- `_docs/forge_signal/dx_canonical_surface_spec.md`
- `_docs/forge_signal/dx_compatibility_transition_plan.md`
- `_docs/forge_signal/dx_condensation_map.md`
- `_docs/forge_signal/dx_diagnostics_product_map.md`
- `_docs/forge_signal/dx_export_decision_matrix.md`
- `_docs/forge_signal/dx_export_inventory.md`
- `_docs/forge_signal/dx_exposure_cleanup_strategy.md`
- `_docs/forge_signal/dx_plan.md`
- `_docs/forge_signal/dx_wording_map.md`
...
- `_docs/forge_signal/forge_signal_vision.md`
- `_docs/forge_signal/forge_signals2.md`
- `_docs/forge_signal/signal_architecture.md`
- `_docs/forge_signal/signal_architecture2.md`
- `_docs/forge_signal/signal_compile_time_safety.md`
...
- `_docs/forge_signal/milestone-2.md`
- `_docs/forge_signal/milestone-2-field-classification.md`
- `_docs/forge_signal/milestone-3.md`
- `_docs/forge_signal/milestone-4.md`
- `_docs/forge_signal/milestone-4-access-matrix.md`
- `_docs/forge_signal/milestone-4-interior-heat-audit.md`
- `_docs/forge_signal/s9_16_acceptance_map.md`
- `_docs/forge_signal/s9_missing_substrate_completion.md`
...
- `_docs/forge_signal/performance.md`
- `_docs/forge_signal/signal_performance.md`
- `_docs/forge_signal/signal_performance_architecture.md`
- `_docs/forge_signal/signal_performance_baseline.md`

...
> Can `forge-signal` now own async/resource lifecycle truth as a deterministic,
...
- [declaration.rs](../../crates/forge-signal/src/data/resource/declaration.rs)
- [descriptor.rs](../../crates/forge-signal/src/data/resource/descriptor.rs)
...
- [request.rs](../../crates/forge-signal/src/data/resource/request.rs)
- [lifecycle.rs](../../crates/forge-signal/src/data/resource/lifecycle.rs)
- [denial.rs](../../crates/forge-signal/src/data/resource/denial.rs)
- [completion.rs](../../crates/forge-signal/src/data/resource/completion.rs)
...
- [transaction_resource.rs](../../crates/forge-signal/src/logic/transaction/runtime/transaction/transaction_resource.rs)
- [transaction_observation.rs](../../crates/forge-signal/src/logic/transaction/runtime/transaction/transaction_observation.rs)
- [branching state](../../crates/forge-signal/src/logic/transaction/runtime/state/branching)
...
- initial lifecycle policy cannot be forged into pending or terminal states
- milestone certification, scenario, hostile-evidence, performance-closeout,
  and final-run artifacts cannot be forged or deserialized as proof objects
...
git diff --check -- _docs/forge_signal/milestone-b-closeout.md _docs/forge_signal/forge_signal_temporal_async_roadmap.md _docs/forge_signal/milestone-b-plan.md
```

Final result at closeout:

- `cargo check -p forge-signal --tests`: passed
- focused closeout test: passed
- resource compile-fail boundary suite: passed
- full `cargo test -p forge-signal`: `714 passed`, `0 failed`, `23 ignored`
- doc-tests: `3 passed`

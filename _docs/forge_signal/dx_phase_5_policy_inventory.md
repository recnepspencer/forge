# Forge Signal DX Phase 5 Policy Inventory
...
Phase 4 already gave `forge-signal` better workflow shapes.
...
- Current public path:
  `forge_signal::facade::SignalRuntime::build_for`
...
- Owner module:
  [runtime_state.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/runtime_state.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::*_for`
- What it really controls:
...
- Current public path:
  `forge_signal::facade::runtime::SignalRuntimeBuilder::runtime_policy`
- What it really controls:
...
- Owner module:
  [observation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/observation.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::set_runtime_policy`
- What it really controls:
...
- Owner module:
  [runtime.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/graph/diagnostics_access/runtime.rs)
- Current public path:
...
- Owner module:
  [mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/mod.rs)
- Current public path:
  `forge_signal::facade::SignalRuntimePolicy`
- What it really controls:
...
- Owner module:
  [profile.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/profile.rs)
- Current public path:
  `forge_signal::facade::DiagnosticsTier`
- What it really controls:
...
- Owner module:
  [observation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/observation.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::set_diagnostics_profile`
- What it really controls:
...
- Owner module:
  [mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/mod.rs)
- Current public path:
  `forge_signal::facade::RetentionBudget`,
  `forge_signal::facade::ReconstructionBudget`
...
- Owner module:
  [mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/mod.rs)
- Current public path:
  `forge_signal::facade::ParallelAdmissionPolicy`
- What it really controls:
...
- Owner module:
  [mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/mod.rs)
- Current public path:
  `forge_signal::facade::SignalRuntimePolicy::with_parallel_admission`
- What it really controls:
...
- Current public path:
  `forge_signal::facade::advanced::StageExecutor`
- What it really controls:
...
- Owner module:
  [facade.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/facade.rs)
- Current public path:
  `forge_signal::facade::advanced::ParallelExecutionPolicy`
- What it really controls:
...
- Owner module:
  [comparator.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/comparator.rs)
- Current public path:
  `forge_signal::facade::advanced::VersionComparatorPolicy`
- What it really controls:
...
- Owner module:
  [builder.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/builder.rs)
- Current public path:
  `forge_signal::facade::runtime::SignalRuntimeBuilder::fallback_comparator`
- What it really controls:
...
- Owner module:
  [observation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/observation.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::set_fallback_comparator`
- What it really controls:
...
- Owner module:
  [tier.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/tier.rs)
- Current public path:
  `forge_signal::facade::runtime::TierPolicy::with_default_comparator`
- What it really controls:
...
- Owner module:
  [computation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/computation.rs)
- Current public path:
  `forge_signal::facade::runtime::Recipe::with_comparator`
- What it really controls:
...
- Owner module:
  [facade.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/facade.rs)
- Current public path:
  `forge_signal::facade::EvaluationCondition`
- What it really controls:
...
- Owner module:
  [tier.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/tier.rs)
- Current public path:
  `forge_signal::facade::runtime::TierPolicy`
- What it really controls:
...
- Owner module:
  [builder.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/builder.rs)
- Current public path:
  `forge_signal::facade::runtime::SignalRuntimeBuilder::tier_policy`
- What it really controls:
...
- Owner module:
  [observation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/observation.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::set_tier_policy`
- What it really controls:
...
- Owner module:
  [observation.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/observation.rs)
- Current public path:
  `forge_signal::facade::SignalRuntime::set_node_tier`
- What it really controls:
...
- Owner module:
  [checkpoint.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/checkpoint.rs)
- Current public path:
  `forge_signal::facade::runtime::CheckpointBarrier`
- What it really controls:
...
- Owner module:
  [checkpoint_policy.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/data/checkpoint_policy.rs)
- Current public path:
  `forge_signal::facade::runtime::CheckpointPolicy`
- What it really controls:
...
- Owner module:
  [builder.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/builder.rs)
- Current public path:
  `forge_signal::facade::runtime::SignalRuntimeBuilder::*`
- What they really control:
...
- Owner module:
  [guided.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/guided.rs)
- Current public path:
  `forge_signal::facade::runtime::RuntimeHistory`
- What it really controls:
...
- Owner modules:
  [state/mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/state/mod.rs),
  [facade.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/facade.rs)
- Current public path:
...
- Owner module:
  [mod.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/diagnostics/policy/mod.rs)
- Current public path:
  `forge_signal::facade::SnapshotRestoreLineageMode`
- What it really controls:
...
- Owner module:
  [guided.rs](C:/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-signal/src/logic/transaction/runtime/state/guided.rs)
- Current public path:
  `forge_signal::facade::runtime::RuntimeMerge`
- What it really controls:
...
- Current public path:
  `forge_signal::facade::integration::*`
- What they really control:

...
- public proof-like digest/result bags were sealed so callers can no longer
  forge "proof happened" surfaces without passing through the proving path
...
[_docs/coding_guidelines/performance_guidelines.md](C:\Users\Esther\Documents\Programming\forge_workspace\forge\_docs\coding_guidelines\performance_guidelines.md),
...
- `cargo test -p forge-relational -- --nocapture`
- 436 tests enumerated for `forge-relational`

...
- merge planning ontology in `crates/forge-relational/src/merge`
...
- serialized commit pipeline in `crates/forge-relational/src/authority/commit/pipeline.rs`
...
crates/forge-relational/src/merge/data/execution_errors.rs
crates/forge-relational/src/merge/facade.rs
crates/forge-relational/src/facade.rs
```
...
```text
crates/forge-relational/src/merge/data/execution.rs
crates/forge-relational/src/merge/logic/execution_preflight.rs
crates/forge-relational/src/history/logic/access.rs
crates/forge-relational/src/schema/data/mod.rs
```
...
```text
crates/forge-relational/src/merge/data/execution.rs
crates/forge-relational/src/merge/data/execution_artifacts.rs
crates/forge-relational/src/merge/logic/execution_compilation.rs
```
...
crates/forge-relational/src/transactions/data/outcomes.rs
crates/forge-relational/src/transactions/data/intents/*
```
...
```text
crates/forge-relational/src/authority/commit/pipeline.rs
crates/forge-relational/src/authority/commit/phases/merge_prepare.rs
crates/forge-relational/src/authority/commit/phases/merge_history.rs
crates/forge-relational/src/history/logic/authority.rs
crates/forge-relational/src/replay/data/mod.rs
crates/forge-relational/src/durability/authority.rs
```
...
```text
crates/forge-relational/src/merge/data/execution_artifacts.rs
crates/forge-relational/src/diagnostics/data/mod.rs
crates/forge-relational/src/performance/data/mod.rs
crates/forge-relational/src/performance/logic/access.rs
```
...
```text
crates/forge-relational/src/tests/history/
crates/forge-relational/src/tests/publication/
crates/forge-relational/src/tests/complexity/contracts/
crates/forge-relational/src/tests/support/
```
...
```text
crates/forge-relational/src/merge/
  data/
    execution.rs
...
```text
crates/forge-relational/src/authority/commit/phases/
  merge_prepare.rs
  merge_history.rs
```

...
- `crates/forge-relational/src/merge/logic/policy.rs`
- `crates/forge-relational/src/merge/data/artifacts.rs`
- `crates/forge-relational/src/merge/logic/planning_artifact.rs`
- `crates/forge-relational/src/tests/history/milestone_7d_phase_a.rs`
...
- `crates/forge-relational/src/tests/history/milestone_7d_phase_b.rs`
...
- `crates/forge-relational/src/merge/logic/execution_diagnostics.rs`
- `crates/forge-relational/src/tests/history/milestone_7d_phase_c.rs`
...
- `crates/forge-relational/src/merge/logic/conflicts.rs`
- `crates/forge-relational/src/merge/logic/policy.rs`
- `crates/forge-relational/src/merge/logic/identity.rs`
- `crates/forge-relational/src/merge/logic/execution.rs`
- `crates/forge-relational/src/merge/logic/execution_mutation_plan.rs`
- `crates/forge-relational/src/merge/logic/naming.rs`
- `crates/forge-relational/src/tests/history/milestone_7d_phase_d.rs`
- `crates/forge-relational/src/tests/complexity/contracts/merge_budgets.rs`
...
- `cargo check -p forge-relational`
- `cargo test -p forge-relational milestone_7d_phase_c -- --nocapture`
- `cargo test -p forge-relational milestone_7d_phase_d -- --nocapture`
- `cargo test -p forge-relational --lib -- --nocapture`

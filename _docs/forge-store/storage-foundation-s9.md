...
- `forge_store_roadmap_2.md` protects the physical database foundation gate.
...
- an independent abstraction function from runtime receipt -> modeled action
  owned by `forge-store-formal-models`
...
- new `forge_store_formal_models::protocol_inventory::StoreProtocolInventory`
- `forge_store_layout_indexes::S8LayoutHazardInventory`
- `forge_store_layout_indexes::layout_closeout`
- `forge_store_recovery_physics::layout_access`
- `forge_store_operations::OperationalRecoveryPosture`
...
- Inventory ownership denial test: `forge-store-layout-indexes` cannot publish
...
- `forge-store-formal-models` assembles runtime-owned inventory rows into the
...
**Relevant subsystems**
- `forge-store-formal-models` (new)
- `forge-store-certification`
- all runtime owner crates that must expose protocol-observation facades

**Relevant APIs**
- new `forge_store_formal_models::protocol_inventory`
- new `forge_store_formal_models::checked_models`
- new `forge_store_formal_models::runtime_mapping`
- new `forge_store_formal_models::backend_profile`
- new runtime-owned `protocol_observation` facades
- new `forge_store_certification::s9_formal_models_closeout`
...
**Test requirements**
- Topology freeze test: required `forge-store-formal-models` directories,
...
**Engineering decisions**
- Introduce a dedicated `forge-store-formal-models` crate as production-owned
...
- `forge-store-buffer-pool`
- `forge-store-operations`
- `forge-store-formal-models`

**Relevant APIs**
- new runtime-owned sealed `*TransitionReceipt` surfaces
- new runtime-owned `protocol_observation::*`
- new `forge_store_formal_models::runtime_mapping::AbstractionFunction`
- new `forge_store_formal_models::runtime_mapping::MappingCompletenessReport`
...
**Relevant APIs**
- `forge_store_recovery_physics::WalAppendPlan`
- `forge_store_recovery_physics::CheckpointPublicationPlan`
- `forge_store_recovery_physics::RecoverySourceDecisionTrace`
- `forge_store_recovery_physics::RecoveryDeterminismReport`
- new `forge_store_formal_models::protocols::durability_recovery_frontier`
...
**Relevant APIs**
- `forge_store_recovery_physics::AdmittedRecoverySource`
- `forge_store_recovery_physics::RecoverySourceDecisionTrace`
- `forge_store_recovery_physics::RecoveryCandidateDiscoveryTrace`
- `forge_store_recovery_physics::CheckpointBaseAdmission`
- `forge_store_recovery_physics::WalTailRedoSource`
- new `forge_store_formal_models::protocols::recovery_source_precedence`
...
**Relevant APIs**
- `forge_store_recovery_physics::AdmittedCompactionCutoverRecord`
- `forge_store_recovery_physics::CompactionGenerationVisibility`
- `forge_store_recovery_physics::CompactionVisibleProductEvidence`
- `forge_store_layout_indexes::S8IndexPublicationProtocol`
- `forge_store_layout_indexes::S8IndexMaintenanceTransitionOutcome`
- new `forge_store_formal_models::protocols::compaction_visibility`
...
**Relevant APIs**
- `forge_store_buffer_pool::PageLease`
- `forge_store_buffer_pool::PinnedPageLease`
- `forge_store_buffer_pool::LeaseEpoch`
- `forge_store_physical_format::PhysicalReclaimRegion`
- new `forge_store_formal_models::protocols::lease_reclaim`
...
**Relevant APIs**
- `forge_store_operations::RepairBlastRadiusReadiness`
- `forge_store_operations::RepairQuarantineScopePreservation`
- `forge_store_offline_verifier::OfflineRepairBlastRadiusObservation`
- `forge_store_recovery_physics::RecoveryCorruptionReadmissionHandoff`
- new `forge_store_formal_models::protocols::repair_quarantine`
...
**Relevant APIs**
- `forge_store_operations::BackupImportCustodyReadmission`
- `forge_store_operations::ImportPlacementPlan`
- new import-owned admission receipts
- new `forge_store_formal_models::protocols::import_admission`
...
- new `forge_store_formal_models::protocols::replication_admission`
...
**Relevant APIs**
- new `forge_store_formal_models::protocols::shared_frontiers`
- all family-local receipt and mapping surfaces from Phases 4-10
- new `forge_store_formal_models::counterexample::CrossProtocolLocalizationReport`
...
**Relevant APIs**
- new `forge_store_formal_models::model_runner`
- new `forge_store_formal_models::scenario_trace`
- new `forge_store_formal_models::counterexample`
- new `forge_store_formal_models::checked_models`
- `forge_store_certification::courtroom`
...
**Relevant APIs**
- `forge_store_formal_models::backend_profile::*`
- `forge_store_certification::s9_formal_models_closeout::backend_matrix`
- `forge_store_certification::s9_formal_models_closeout::counter_assertions`
...
**Relevant APIs**
- new `forge_store_formal_models::*`
- new `forge_store_certification::s9_formal_models_closeout::*`
- existing `forge_store_certification::courtroom::*`
...
```text
workspaces/forge-store/crates/forge-store-formal-models/
  src/
    lib.rs
    protocol_inventory/
      mod.rs
...
workspaces/forge-store/crates/forge-store-certification/
  src/
...
- `forge-store-formal-models` owns protocol inventory, runtime mapping, model
  replay, and counterexample interpretation.
- `forge-store-certification` owns lane assembly and milestone closeout
  evidence.
...
- a dedicated `forge-store-formal-models` crate

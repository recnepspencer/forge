...
The first Forge Store roadmap built a strong semantic durability program:
...
- `_docs/forge-store/milestone-*.md`
- `_docs/forge-store/*-closeout.md`
- `_docs/forge-store/test-requirements.md`
- `_docs/forge-store/test-requirements-2.md`
- `crates/forge-store/src/**/*.rs`
- `crates/forge-store/tests/**/*.rs`
...
- terminology scanning may not broaden from Forge Store docs/source into all
...
- `forge-relational` remains owner of truth semantics, transaction semantics,

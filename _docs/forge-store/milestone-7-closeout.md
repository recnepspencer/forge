...
`forge-store` now durably preserves the support-truth families that restart,
...
- explicit schema-boundary support persistence and fetch surfaces in
  [crates/forge-store/src/backend/integrity/support_records.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/integrity/support_records.rs),
  [crates/forge-store/src/backend/engine.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/engine.rs),
  and
  [crates/forge-store/src/facade.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/facade.rs)
- explicit lineage support persistence and first-class historical identity
  ...
  `ForgeStore::fetch_lineage_history(...)` in
  [crates/forge-store/src/authority/proofs.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/authority/proofs.rs),
  [crates/forge-store/src/backend/engine.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/engine.rs),
  and
  [crates/forge-store/src/facade.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/facade.rs)
- commit-coupled support publication and deterministic support identities in
  [crates/forge-store/src/backend/state/commit_append.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/state/commit_append.rs)
  and
  [crates/forge-store/src/backend/integrity/support_records.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/integrity/support_records.rs)
...
- proof-bearing embedded checkpoint admission and persistence in
  [crates/forge-store/src/modes/embedded.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/embedded.rs)
- durable restart and support-gap recovery classification in
  [crates/forge-store/src/recovery/support.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/recovery/support.rs),
  [crates/forge-store/src/recovery/report.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/recovery/report.rs),
  and
  [crates/forge-store/src/modes/durable.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/durable.rs)
- backend-open access-structure verification and backend-family-specific
  complexity proof surfaces in
  [crates/forge-store/src/evidence/milestone_7.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/milestone_7.rs)
  and
  [crates/forge-store/src/backend/engine.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/engine.rs)
- Milestone 7 counter extensions and named hot-path accounting in
  [crates/forge-store/src/evidence/counters.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/counters.rs)
...
- milestone-grade evidence and certification in
  [crates/forge-store/src/evidence/milestone_7.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/milestone_7.rs)
  and
  [crates/forge-store/src/tests/milestone_7_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/milestone_7_certification.rs)
...
- [crates/forge-store/src/tests/milestone_7_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/milestone_7_certification.rs)
- [crates/forge-store/src/tests/cursor_support.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/cursor_support.rs)
...
- [crates/forge-store/tests/ui/raw_external_checkpoint_envelope_rejected.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/tests/ui/raw_external_checkpoint_envelope_rejected.rs)
- [crates/forge-store/tests/ui/basis_free_checkpoint_rejects_basis_binding.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/tests/ui/basis_free_checkpoint_rejects_basis_binding.rs)
- [crates/forge-store/src/modes/embedded.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/embedded.rs)
...
These changes matter because the bar for `forge-store` is production-grade
...
- `cargo test -p forge-store cursor_support -- --nocapture`
- `cargo test -p forge-store milestone_7_certification -- --nocapture`
...
`forge-store` no longer relies on ambient session memory, replay-only lineage

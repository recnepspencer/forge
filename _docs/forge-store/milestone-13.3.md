...
> - [milestone-13.1.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.1.md)
> - [milestone-13.1-closeout.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.1-closeout.md)
> - [milestone-13.2.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.2.md)
>
> **Follow-on milestone:**
...
- `forge-relational` owns canonical truth, schema semantics, lineage semantics,
  and transaction meaning.
- `forge-signal`, `forge-runtime-bridge`, `forge-query`, and later server
...
- writing one large `classify_support_trust(...)` function that internally
  branches over raw data and silently forgets which proofs were actually
  established.
...
- runtime bridge, `forge-signal`, `forge-query`, and server layers remain owners

...
Parent spec: [milestone-13.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.md)
...
`forge-store` now has explicit hot/warm/cold placement vocabulary, durable
...
- public tiering vocabulary and proof-bearing placement types in
  [crates/forge-store/src/tiering](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tiering)
- backend tiering planning, execution, observation, recall, interleaving, and
  recovery logic in
  [crates/forge-store/src/backend/tiering](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/tiering)
- scalar SQLite tiering persistence for residency, transfer, observation, and
  recall records in
  [crates/forge-store/src/backend/sqlite](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/sqlite)
- typed placement, recall, witness-misuse, manifest, and open-failure taxonomy
  in
  [crates/forge-store/src/failure/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/failure/mod.rs)
- milestone-specific counters, complexity surfaces, artifact reports, and
  certification bundles in
  [crates/forge-store/src/evidence/milestone_13.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/milestone_13.rs)
...
- named certification coverage in
  [crates/forge-store/src/tests/milestone_13_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/milestone_13_certification.rs)
- phase-scoped hostile coverage in
  [crates/forge-store/src/tests/tiering_phase1.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/tiering_phase1.rs),
  [crates/forge-store/src/tests/tiering_phase2.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/tiering_phase2.rs),
  [crates/forge-store/src/tests/tiering_phase3.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/tiering_phase3.rs),
  [crates/forge-store/src/tests/tiering_phase4_recall_coalescing.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/tiering_phase4_recall_coalescing.rs),
  and
  [crates/forge-store/src/tests/tiering_phase5_interleaving.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/tiering_phase5_interleaving.rs)
...
- `cargo test -p forge-store tiering -- --test-threads=1`
...
`forge-store` no longer treats tiering as an implicit cache policy. Placement,

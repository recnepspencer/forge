...
- `forge-proof README` and `forge_proof_roadmap.md`
...
- `forge-store-test-support` owns reusable mechanics and fixtures.
- `forge-store-certification` owns oracle meaning, verdicts, coverage matrices,
  closeout reports, and certification evidence.
- `forge-store-physical-certification` owns reusable physical certification
...
`workspaces/forge-store/crates/forge-store-physical-certification/src/`
...
`workspaces/forge-store/crates/forge-store-certification/tests/`

- `s4_5_simulation_harness_*.rs`
  owns runtime and certification tests for each S.4.5 phase.
- `ui/s4_5_simulation_harness/`
  owns compile-fail tests for forged scenarios, skipped progression, JSON
...
- The older `crates/forge-store/src/tests/harness` tree contains semantic
  ...
  for Roadmap 2.
- The dedicated `workspaces/forge-store/crates/forge-store-test-support` crate
  ...
  mechanics.
- The dedicated `workspaces/forge-store/crates/forge-store-certification`
...
**Relevant subsystems**
- `forge-store-physical-certification::authoring`
- `forge-store-physical-certification::scenario`
...
**Relevant subsystems**
- `forge-store-physical-certification::planning`
- `forge-store-physical-certification::profiles`
- `forge-store-physical-certification::coverage`
- `forge-store-test-support::physical_simulation`
- `forge-proof`
...
**Relevant subsystems**
- `forge-store-physical-certification::actors`
- `forge-store-physical-certification::drivers`
...
**Relevant subsystems**
- `forge-store-physical-certification::schedule`
- `forge-store-physical-certification::execution`
- `forge-store-test-support::physical_simulation`
- `forge-proof`
- `forge-foundational`
...
**Relevant subsystems**
- `forge-store-physical-certification::faults`
- `forge-store-physical-certification::drivers`
- `forge-store-test-support::physical_simulation`
...
**Relevant subsystems**
- `forge-store-physical-certification::observation`
- `forge-store-physical-certification::oracles`
- `forge-store-certification`
- `forge-store-offline-verifier`
- `forge-foundational`
- `forge-proof`
...
**Warnings**
- Do not let `forge-store-test-support` own expected truth or final verdicts.
...
**Relevant subsystems**
- `forge-store-physical-certification::counters`
- `forge-store-physical-certification::profiles`
- `forge-store-budgets`
...
**Relevant subsystems**
- `forge-store-physical-certification::fixtures`
- `forge-store-test-support::physical_simulation`
...
**Relevant subsystems**
- `forge-store-physical-certification::transcript`
- `forge-store-physical-certification::evidence`
- `forge-store-physical-certification::execution`
- `forge-store-certification`
- `forge-foundational`
- `forge-proof`
...
- `forge-store-test-support` owns mechanics and fixtures, not certification
  verdicts.
- `forge-store-certification` owns oracle meaning and closeout evidence.
- `forge-foundational` owns shared boundary vocabulary, not Store simulation
  authority.
- `forge-proof` owns progression law, not the runtime scheduler.

...
Make the dedicated Forge Store workspace aspect-native before the physical
...
Forge Query and Forge Relational both exposed the cost of bolting aspect-native
...
- `forge_store_roadmap_2.md` protects physical database credibility. The
...
No Forge Store workspace authority, evidence, digest basis, handoff, recovery
...
- Legacy `crates/forge-store` serde/JSON persistence is residue inventory for
  migration and compatibility quarantine. It is not precedent for the dedicated
  Roadmap 2 workspace.
- The new workspace may use `forge_foundational::compatibility().json()` only
...
```text
workspaces/forge-store/crates/forge-store-aspect-native/
  src/
    lib.rs
    value_admission.rs
...
workspaces/forge-store/crates/forge-store-aspect-native-certification/
  src/
    lib.rs
...
- `store_json_residue_inventory_classifies_every_occurrence`: scans
  `crates/forge-store` and `workspaces/forge-store`, classifies each
...
- Classify the older root `crates/forge-store` persistence path as legacy
...
**Relevant APIs**
- `forge_foundational::AspectValue`
- `forge_foundational::StructAspectValue`
- `forge_foundational::AspectKey`
- `forge_foundational::CanonicalFieldPath`
- `forge_foundational::AspectMask`, `MutationMask`, `ProjectionMask`,
  `DiagnosticMask`
- `forge_foundational::ContractValidatedAspectValue`
- `forge_foundational::AuthoritativeRecordAspectState`
- `forge_foundational::AuthoritativeRecordAspectPatch`
- `forge_foundational::AspectLocator`, `AspectFieldLocator`,
...
**Relevant subsystems**
- `forge-store-aspect-native::terminal_projection`
- `forge-store-aspect-native::terminal_json_projection`
- `forge-store-aspect-native::json_ingress_readmission`
...
**Relevant subsystems**
- `forge-store-aspect-native::canonical_basis`
- `forge-store-aspect-native::canonical_basis_sources`
- `forge-store-certification`
- `forge-store-readiness`
...
**Relevant subsystems**
- `forge-store-aspect-native::digest_authority`
- `forge-store-aspect-native::equivalence_basis`
- `forge-store-aspect-native::canonical_basis`
- `forge-store-certification`
- `forge-store-readiness`
...
**Relevant subsystems**
- `forge-store-aspect-native::terminal_projection_digest_separation`
- `forge-store-aspect-native::terminal_projection`
- `forge-store-aspect-native::terminal_json_projection`
- `forge-store-aspect-native::digest_authority`
- external operator export/import surfaces
...
**Relevant subsystems**
- `forge-store-aspect-native::identity_authority`
- `forge-store-aspect-native::boundary_locators`
- `forge-store-authority`
...
**Relevant subsystems**
- `workspaces/forge-store/crates/forge-store/src/lib.rs`
...
**Relevant subsystems**
- `forge-store-aspect-native::s0_handoff`
- `forge-store-readiness`
- `forge-store-s0-reclassification`
- `forge-store-certification`

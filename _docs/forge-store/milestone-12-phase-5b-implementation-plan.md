# Forge Store Milestone 12 Phase 5B Implementation Plan
...
```text
crates/forge-store/src/compatibility/certification_runner.rs
```
...
Phase 5B is complete when `forge-store` has a deterministic

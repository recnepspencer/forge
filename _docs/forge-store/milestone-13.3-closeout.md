...
Parent spec:
[milestone-13.3.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.3.md)

## What Shipped

- Dedicated trust subdomain under
  [crates/forge-store/src/subscription_support/trust](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/subscription_support/trust).
...
| Public API exposes the protocol without raw construction bypass | facade exports from `forge_store` and private fields/constructors | phase-boundary compile-fail suite |
...
```text
cargo fmt --all
cargo test -p forge-store subscription_support::trust::tests::phase7_ -- --nocapture
cargo test -p forge-store --test phase_boundaries_compile_fail -- --nocapture
cargo test -p forge-store
git diff --check -- crates/forge-store/src/lib.rs crates/forge-store/src/subscription_support/mod.rs crates/forge-store/src/subscription_support/trust/certification.rs crates/forge-store/src/subscription_support/trust/domain_certification.rs crates/forge-store/src/subscription_support/trust/mod.rs crates/forge-store/src/subscription_support/trust/named_suite.rs crates/forge-store/tests/ui/subscription_support_accuracy_run_fields_private.rs crates/forge-store/tests/ui/subscription_support_accuracy_run_fields_private.stderr crates/forge-store/tests/ui/subscription_support_accuracy_runner_fields_private.rs crates/forge-store/tests/ui/subscription_support_accuracy_runner_fields_private.stderr
```
...
- full `forge-store` suite: 640 tests passed plus trybuild/doc-tests

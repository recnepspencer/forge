...
- Law 41 restore-boundary correction from forgeable witness to admitted restore
  request
...
`forge-store` now has an honest media and crash-recovery substrate:

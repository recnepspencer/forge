...
Parent spec: [milestone-5.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-5.md)
...
`forge-store` now supports shared-base branch creation, persisted branch-delta
...
[crates/forge-store/src/tests/milestone_5_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/milestone_5_certification.rs)
and covers:
...
- `cargo test -p forge-store milestone_5_certification -- --nocapture`
- `cargo test -p forge-store --lib`
- `cargo test -p forge-store --test phase_boundaries_compile_fail`

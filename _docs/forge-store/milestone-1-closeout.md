...
`forge-store` now has a real authoritative durability boundary instead of a
...
- one public `forge-store` facade and builder surface
...
- the `forge-store` crate wired into the workspace
...
- proof-bearing authority types, canonicalization, and authoritative export
  basis under
  [authority](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/authority)
- a store-owned backend contract, embedded backend baseline, and SQLite backend
  family in
  [backend/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/mod.rs)
  plus
  [backend/embedded.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/embedded.rs)
  and
...
- separated state mutation, integrity, and persistence subsystems under
  [backend/state](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/state)
  and
  [backend/integrity](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/integrity)
- exact counters and machine-checkable evidence bundles under
  [evidence](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence)
- typed failure families under
  [failure](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/failure)
- hostile test coverage for append legality, branch-head authority, corruption
  ...
  [crates/forge-store/src/tests](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests)
...
These changes were made because the bar for `forge-store` is certifiable
...
`forge-store` no longer depends on backend-local row shape, reload luck, or

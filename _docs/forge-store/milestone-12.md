...
> - [milestone-13.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-store/milestone-13.md) is already closed and supplies placement and recall vocabulary that compatibility must preserve.
>
...
It is the milestone that decides whether `forge-store` can survive long-lived
...
- `forge-relational` still owns truth, schema semantics, identity semantics, and

# Forge Store Milestone 12 Phase 5A Implementation Plan
...
```text
crates/forge-store/src/compatibility/certification.rs
```
...
Extend or add to `crates/forge-store/src/evidence/milestone_12.rs`.
...
Add compile-fail fixtures under `crates/forge-store/tests/ui/`.

...
`forge-store` now has explicit operating-mode authority boundaries instead of
...
- mode surfaces under
  [modes](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes)
- a lifecycle proof subdomain under
  [modes/lifecycle](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/lifecycle)
...
- embedded-mode external commit intake, checkpoint classification, and
  ...
  [modes/embedded.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/embedded.rs)
- absent-mode semantic witness and certification lane support in
  [modes/absent.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/absent.rs)
- Milestone 2 certification evidence in
  [evidence/milestone_2.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/milestone_2.rs)
...
- runtime-mode scenario coverage in
  [tests/operating_modes.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/operating_modes.rs)
  and
  [tests/mode_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/mode_certification.rs)
- compile-fail phase-boundary proof in
  [tests/phase_boundaries_compile_fail.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/tests/phase_boundaries_compile_fail.rs)
  and
  [tests/ui](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/tests/ui)
...
- `ForgeStoreBuilder` does not expose an absent-mode constructor
...
These changes were made because the bar for `forge-store` is platform-grade
...
`forge-store` no longer treats operating mode as an ambient convention or a

...
`forge-store` now has a real crash-safe durable-mode boundary instead of a
...
- WAL artifact families and integrity verification in
  [wal/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/wal/mod.rs)
- a dedicated publication subdomain with phase-bearing internal wrappers in
  [publication/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/publication/mod.rs)
- recovery planning and recovery execution subdomains in
  [recovery/planning.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/recovery/planning.rs)
  and
  [recovery/execution.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/recovery/execution.rs)
- durable-mode lifecycle and recovery gating in
  [modes/durable.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/modes/durable.rs)
...
- WAL state persistence and integrity verification inside the backend state and
  integrity layers in
  [backend/state/wal.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/state/wal.rs)
  and
  [backend/integrity/verification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/backend/integrity/verification.rs)
- Milestone 3 evidence surfaces in
  [evidence/milestone_3.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/evidence/milestone_3.rs)
...
- typed recovery and durable-mode failure families in
  [failure/mod.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/failure/mod.rs)
- crash-boundary scenario coverage in
  [tests/wal_recovery.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/wal_recovery.rs)
- Milestone 3 certification coverage in
  [tests/milestone_3_certification.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/milestone_3_certification.rs)
...
- existing persistence corruption lanes in
  [tests/persistence.rs](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-store/src/tests/persistence.rs)
...
These changes were made because the bar for `forge-store` is certifiable crash
...
`forge-store` no longer depends on process luck or startup convention to make

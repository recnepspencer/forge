...
- `crates/forge-store/src/failure/mod.rs`
- `crates/forge-store/src/backend/integrity/support_records.rs`
- `crates/forge-store/src/backend/engine.rs`
...
- `ForgeStore::fetch_lineage_history(...)`

Primary surfaces:

- `crates/forge-store/src/authority/proofs.rs`
- `crates/forge-store/src/facade.rs`
- `crates/forge-store/src/tests/cursor_support.rs`
...
- `crates/forge-store/src/modes/embedded.rs`
- `crates/forge-store/tests/phase_boundaries_compile_fail.rs`
- `crates/forge-store/tests/ui/`
...
- `crates/forge-store/src/authority/proofs.rs`
- `crates/forge-store/src/backend/state/commit_append.rs`
- `crates/forge-store/src/facade.rs`
- `crates/forge-store/src/modes/embedded.rs`

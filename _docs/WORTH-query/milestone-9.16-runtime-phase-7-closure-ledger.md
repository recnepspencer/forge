...
world and elevation helpers with named specifications. Every dirty Rust file is
at or below the 400-line hard cap, and the repository dirty-function audit has no
remaining production composition finding.

...
>
> **Prior milestone:** [milestone-3.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-query/milestone-3.md)
>
> **Prior closeout:** [milestone-3-closeout.md](/Users/Esther/Documents/Programming/WORTH_workspace/WORTH/_docs/worth-query/milestone-3-closeout.md)
>
...
single declared query meaning. Milestone 4 is where `worth-query` either
...
- `worth_query_vision.md`: pagination, bounded results, aggregation,
...
- `worth_query_roadmap.md`: Milestone 4 is the runtime-backed collection
...
- live subscription promotion, incremental maintenance, or `worth-signal`
  invalidation work

...
>
> **Prior milestone:** [milestone-15.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-runtime-bridge/milestone-15.md)
>
> **Prior closeout:** [milestone-15-closeout.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-runtime-bridge/milestone-15-closeout.md)
>
...
- certification coverage for multiple admitted declaration families and their distinct `forge-signal` strategy lowerings
...
Milestone 16 also creates the clean handoff to Forge Query. Query may later
...
- `forge-relational` remains the authority for truth identity, mutation history, lineage, merge ontology, branches, historical retention, and authoritative publication.
- `forge-signal` remains the authority for observation execution, scheduling, internal delivery strategy mechanics, and derived recomputation.
...
- certification of suites 35 through 37 in [test-requirements.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-runtime-bridge/test-requirements.md)
...
- redefining `forge-signal` observation or delivery scheduler internals
- redefining `forge-relational` branch, lineage, merge, preview, or retention authority
...
- `forge-relational` owns products, components, component costs, branches, history, and authoritative commits
- `forge-signal` owns derived tariff, tax, margin, product total, collection membership, and comparison nodes
...
- two distinct `forge-signal` strategy lowerings
...
- certification satisfying suites 35 through 37 in [test-requirements.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-runtime-bridge/test-requirements.md)
...
- observation and derived execution authority remains in `forge-signal`

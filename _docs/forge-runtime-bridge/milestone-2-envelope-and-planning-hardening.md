...
>
> **Primary milestone:** [milestone-2.md](/Users/Esther/Documents/Programming/forge_workspace/forge/_docs/forge-runtime-bridge/milestone-2.md)
>
...
>
> **Companion crate reference:** [forge-relational facade bridge export](/Users/Esther/Documents/Programming/forge_workspace/forge/crates/forge-relational/src/facade.rs)
>
> **Primary architectural driver:** make bridge envelope ingress, route planning, and lowering as proof-carrying and authority-shaped as the rest of Forge
...
What remains softer than the rest of Forge is not the high-level design. It is
...
cleaner than ad hoc code but weaker than Forge's strongest lowered-plan
patterns.
...
compatibility-aware, replay-safe, and structurally aligned with Forge
...
Strengthen lowering and execution admission to match Forge lowered-plan
standards.
...
The strongest pattern to borrow from `forge-relational` is not field count or

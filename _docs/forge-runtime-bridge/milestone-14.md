...
>
> **Roadmap parent:** [forge_runtime_bridge_roadmap.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/forge_runtime_bridge_roadmap.md)
>
> **Vision parent:** [forge_runtime_bridge_vision.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/forge_runtime_bridge_vision.md)
>
> **Prior milestone:** [milestone-13.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/milestone-13.md)
>
> **Prior closeout:** [milestone-13-closeout.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/milestone-13-closeout.md)
>
> **Bridge certification companion:** [test-requirements.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/test-requirements.md)
>
> **Signal companion:** [milestone-11-plan.md](/Users/shepworth/Documents/programming/forge/_docs/forge_signal/milestone-11-plan.md)
>
> **Earlier subscription substrate companions:** [milestone-2.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/milestone-2.md), [milestone-3.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/milestone-3.md)
>
> **Primary architectural driver:** turn fine-grained subscription slices, basis-aware bridge artifacts, and `forge-signal` observation strategies into one bridge-owned subscription declaration framework that a manual host can admit, activate, diagnose, and replay without host-local folklore
...
`a host may declare an ongoing truth-backed subscription family once, bind it to an explicit truth basis once, admit it once, lower it once into admitted forge-signal observation strategies, and then reason about that subscription as a bridge protocol entity rather than as host-local glue`

That missing surface matters because the stack now wants two things at once:

1. Forge Query should be able to automatically lower live query intent into
...
- `forge-signal` observation policies and extensible delivery strategies that
...
- explicit lowering into admitted `forge-signal` observation and delivery
  strategies
...
binding, lifecycle identity, and `forge-signal` strategy lowering.
...
- the bridge reaches into `forge-signal` internals instead of lowering into
...
- `forge-signal` remains the owner of observation semantics
...
> set, and the same selected `forge-signal` observation strategy every time,
...
- `forge-relational` remains the authority for truth identity, lineage,
  historical retention, branch semantics, and truth-view legality.
- `forge-signal` already owns observation policy, delivery strategy,
...
- the bridge lowers into admitted `forge-signal` observation policies and
...
- harness coverage satisfying suites 28 through 30 in
  [test-requirements.md](/Users/shepworth/Documents/programming/forge/_docs/forge-runtime-bridge/test-requirements.md)
...
- what observation means inside `forge-signal`
...
- how `forge-signal` executes that strategy once lowered
...
- explicit lowering from admitted bridge declaration families into admitted
  `forge-signal` observation and delivery/coalescing strategies
...
- define one concrete bridge-side lowering seam, such as a signal-strategy
  ...
  - lowered slice set
  into canonical admitted `forge-signal` strategy descriptors
...
- explicit lowering into admitted `forge-signal` observation policies and
...
- observation and delivery execution authority remains in `forge-signal`
...
- every admitted declaration records which `forge-signal` observation and
...
It also depends deliberately on `forge-signal` Milestone 11:
...
`forge-signal` observation and delivery strategies, replay the same declaration

...
- Trace store/query models (`crates/forge-view/src/trace/store.rs`)
- Trace HTTP server/router (`crates/forge-view/src/trace/server.rs`)
- Native trace viewer app (`crates/forge-view/src/trace/viewer.rs`)

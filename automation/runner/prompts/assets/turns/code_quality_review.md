...
Keep the gate concrete. Fail on real ownership, topology, file-shape, or
public-surface defects that would make the next correct edit materially harder
or teach the wrong architecture. Do not reopen the phase for architecture taste
disputes once the touched structure is already coherent enough to preserve the
phase boundary honestly.

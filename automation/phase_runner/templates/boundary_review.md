...
1. What authority, evidence, state, or physical fact enters this phase.
2. What this phase is allowed to publish, witness, certify, adapt, or deny.
...
4. Which weaker representations must be insufficient after this phase, such as
   ...
   JSON, serde declarations, projections, or terminal artifacts.
5. Which old or adjacent paths must be cut over so the new boundary is not only
   an added wrapper.
6. The common failure modes worth keeping in mind during planning, using
   ...
   authority, whole-object buffering, copied-counter paths, downstream consumers
   still accepting weaker witnesses, digest equality standing in for custody or
   scope, and terminal projection data re-entering runtime authority.
